...
setup(
    ...
    keywords='tendril',
    url='https://github.com/tendril-framework/tendril-config',
    project_urls={
        'Documentation': 'https://tendril-config.readthedocs.io/en/latest',
        'Bug Tracker': 'https://github.com/tendril-framework/tendril-config/issues',
        'Source Repository': 'https://github.com/tendril-framework/tendril-config',
    },
