...
class BetaGoApi(object):
    def __init__(self, port_name=None):
        ...
        self.calibra_h_car = [
            [1.26913551e+00, 1.60629000e-02,
             -1.37630806e+02],  # 此处后续需改为读取上位机标定保存的数据
            [7.10831530e-02, -9.70150553e-01, -1.68839450e+02],
            [-1.08036486e-04, 1.39191533e-04, 1.00000000e+00]
        ]
