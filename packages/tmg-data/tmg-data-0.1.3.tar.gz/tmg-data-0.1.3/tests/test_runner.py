...
class TestRunner(unittest.TestCase):
    ...
    def test_add(self):
        ...
        parallel_runner.add(test, "a", "b", c=2)

        function, args, kwargs = parallel_runner.processes[0]
    ...
    def test_run(self):
        ...
        parallel_runner = runner.ParallelRunner()
        parallel_runner.add(test_function, "run_1")
        parallel_runner.add(test_function, "run_2", sleep_length=10)
