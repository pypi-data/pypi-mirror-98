...
class ContentInstallerPackagesApi(object):
    ...
    def list(self, **kwargs):  # noqa: E501
        ...
        An InstallerPackage represents a '.udeb' installer package.  Associated artifacts: Exactly one '.udeb' installer package file.  Note that installer packages are currently used exclusively for verbatim publications. The APT publisher (both simple and structured mode) will not include these packages.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def read(self, deb_installer_package_href, **kwargs):  # noqa: E501
        """Inspect an installer package  # noqa: E501

        An InstallerPackage represents a '.udeb' installer package.  Associated artifacts: Exactly one '.udeb' installer package file.  Note that installer packages are currently used exclusively for verbatim publications. The APT publisher (both simple and structured mode) will not include these packages.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.read(deb_installer_package_href, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str deb_installer_package_href: (required)
        :param str fields: A list of fields to include in the response.
        :param str exclude_fields: A list of fields to exclude from the response.
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.read_with_http_info(deb_installer_package_href, **kwargs)  # noqa: E501

    def read_with_http_info(self, deb_installer_package_href, **kwargs):  # noqa: E501
        """Inspect an installer package  # noqa: E501

        An InstallerPackage represents a '.udeb' installer package.  Associated artifacts: Exactly one '.udeb' installer package file.  Note that installer packages are currently used exclusively for verbatim publications. The APT publisher (both simple and structured mode) will not include these packages.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.read_with_http_info(deb_installer_package_href, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('deb_installer_package_href' not in local_var_params or  # noqa: E501
                                                        local_var_params['deb_installer_package_href'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `deb_installer_package_href` when calling `read`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'deb_installer_package_href' in local_var_params:
            path_params['deb_installer_package_href'] = local_var_params['deb_installer_package_href']  # noqa: E501
        ...
        return self.api_client.call_api(
            '{deb_installer_package_href}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
