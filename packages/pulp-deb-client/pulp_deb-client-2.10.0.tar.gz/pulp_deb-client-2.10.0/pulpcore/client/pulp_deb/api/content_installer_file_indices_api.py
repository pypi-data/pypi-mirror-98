...
class ContentInstallerFileIndicesApi(object):
    ...
    def list_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(PaginateddebInstallerFileIndexResponseList, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='PaginateddebInstallerFileIndexResponseList',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def read(self, deb_installer_file_index_href, **kwargs):  # noqa: E501
        """Inspect an installer file index  # noqa: E501

        An InstallerFileIndex represents the indices for a set of installer files.  Associated artifacts: Exactly one 'SHA256SUMS' and/or 'MD5SUMS' file.  Each InstallerFileIndes is associated with a single component-architecture combination within a single Release. Note that installer files are currently used exclusively for verbatim publications. The APT publisher (both simple and structured mode) does not make use of installer content.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.read(deb_installer_file_index_href, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str deb_installer_file_index_href: (required)
        :param str fields: A list of fields to include in the response.
        :param str exclude_fields: A list of fields to exclude from the response.
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.read_with_http_info(deb_installer_file_index_href, **kwargs)  # noqa: E501

    def read_with_http_info(self, deb_installer_file_index_href, **kwargs):  # noqa: E501
        """Inspect an installer file index  # noqa: E501

        An InstallerFileIndex represents the indices for a set of installer files.  Associated artifacts: Exactly one 'SHA256SUMS' and/or 'MD5SUMS' file.  Each InstallerFileIndes is associated with a single component-architecture combination within a single Release. Note that installer files are currently used exclusively for verbatim publications. The APT publisher (both simple and structured mode) does not make use of installer content.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.read_with_http_info(deb_installer_file_index_href, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('deb_installer_file_index_href' not in local_var_params or  # noqa: E501
                                                        local_var_params['deb_installer_file_index_href'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `deb_installer_file_index_href` when calling `read`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'deb_installer_file_index_href' in local_var_params:
            path_params['deb_installer_file_index_href'] = local_var_params['deb_installer_file_index_href']  # noqa: E501
        ...
        return self.api_client.call_api(
            '{deb_installer_file_index_href}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
