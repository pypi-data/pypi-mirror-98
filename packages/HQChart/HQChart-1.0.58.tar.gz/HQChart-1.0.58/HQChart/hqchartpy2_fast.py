...
class FastHQChart :
    ...
    def Run(jsonConfig, hqData, proSuccess=None,procFailed=None):
        ...
        bResult=Run(jsonConfig,callbackConfig)
        return bResult
    ...
    def GetTrialAuthorize(mac, url="http://py2.hqchart.cn:8712/api/v1/CreateAuthorize"):
        ...
        postData = { "MAC":mac, "Version":"hqchartPy2 {0}".format(version) }
...
class SystemIndex:
    MAP_INDEX= {
        ...
        u"KDJ":{
            ...
            J:3*K-2*D;
            ''',
            u"Args": [ { u"Name":u"N", u"Value":9 }, { u"Name":u"M1", u"Value":3 }, { u"Name":u"M2", u"Value":3} ]
            },
