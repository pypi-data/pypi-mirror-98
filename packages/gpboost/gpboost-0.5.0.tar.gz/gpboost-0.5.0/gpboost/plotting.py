...
def plot_importance(booster, ax=None, height=0.2,
    ...
    Parameters
    ----------
    booster : Booster or GPBoostModel
        Booster or GPBoostModel instance which feature importance should be plotted.
    ...
    **kwargs
    ...
    if isinstance(booster, GPBoostModel):
...
def plot_split_value_histogram(booster, feature, bins=None, ax=None, width_coef=0.8,
    ...
    ----------
    booster : Booster or GPBoostModel
        Booster or GPBoostModel instance of which feature split value histogram should be plotted.
...
def plot_metric(booster, metric=None, dataset_names=None,
    ...
    Parameters
    ----------
    booster : dict or GPBoostModel
        Dictionary returned from ``gpboost.train()`` or GPBoostModel instance.
    ...
    if isinstance(booster, GPBoostModel):
        ...
        raise TypeError('booster must be dict or GPBoostModel.')
...
def create_tree_digraph(booster, tree_index=0, show_info=None, precision=3,
    ...
    ----------
    booster : Booster or GPBoostModel
        Booster or GPBoostModel instance to be converted.
...
def plot_tree(booster, ax=None, tree_index=0, figsize=None, dpi=None,
    ...
    ----------
    booster : Booster or GPBoostModel
        Booster or GPBoostModel instance to be plotted.
    ax : matplotlib.axes.Axes or None, optional (default=None)
        Target axes instance.
        If None, new figure and axes will be created.
    tree_index : int, optional (default=0)
