	...
	*/
	...
	public:
		...
		*/
		...
		/*!
		* \brief Get leaf indices
		* \param tree Tree*
		* \param[out] data_leaf_index Leaf index for every data point (array of size num_data)
		*/
		virtual void GetDataLeafIndices(Tree* tree, int* data_leaf_index) const = 0;
	};
