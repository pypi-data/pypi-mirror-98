...
from vrt_lss_clustering.exceptions import ApiTypeError, ApiValueError, ApiException
from vrt_lss_clustering.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = ClusterApi()
        api_instance.cluster  # this is an instance of the class Endpoint
        api_instance.cluster()  # this invokes api_instance.cluster.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.cluster.callable or self.callable in this class
