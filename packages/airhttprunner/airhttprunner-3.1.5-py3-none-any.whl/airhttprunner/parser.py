...
from airhttprunner import loader, utils, exceptions
from airhttprunner.models import VariablesMapping, FunctionsMapping
...
def get_mapping_function(
    ...
    if function_name in functions_mapping:
        ...
        from airhttprunner.ext import uploader
