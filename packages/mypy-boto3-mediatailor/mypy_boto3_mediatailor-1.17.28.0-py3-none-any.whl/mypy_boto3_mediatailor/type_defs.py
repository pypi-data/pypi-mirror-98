...
_RequiredProgramTypeDef = TypedDict(
    "_RequiredProgramTypeDef",
    {
        "Arn": str,
        "ChannelName": str,
        "ProgramName": str,
...
_OptionalProgramTypeDef = TypedDict(
    "_OptionalProgramTypeDef",
    {"AdBreaks": List["AdBreakTypeDef"], "CreationTime": datetime, "LastModifiedTime": datetime},
    total=False,
)


class ProgramTypeDef(_RequiredProgramTypeDef, _OptionalProgramTypeDef):
    pass
...
ListProgramsResponseTypeDef = TypedDict(
    "ListProgramsResponseTypeDef", {"Items": List["ProgramTypeDef"], "NextToken": str}, total=False
)
