...
[boto3.CostandUsageReportService 1.17.25](https://boto3.amazonaws.com/v1/documentation/api/1.17.25/reference/services/cur.html#CostandUsageReportService) service
compatible with
