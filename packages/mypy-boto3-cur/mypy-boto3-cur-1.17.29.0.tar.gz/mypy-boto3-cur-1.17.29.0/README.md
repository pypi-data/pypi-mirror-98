...
[boto3.CostandUsageReportService 1.17.29](https://boto3.amazonaws.com/v1/documentation/api/1.17.29/reference/services/cur.html#CostandUsageReportService) service
compatible with
