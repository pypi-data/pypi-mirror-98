...
setup(name='DLStudio',
      ...
      url='https://engineering.purdue.edu/kak/distDLS/DLStudio-2.0.6.html',
...
::
      ...
      classifiers=['Topic :: Scientific/Engineering', 'Programming Language :: Python :: 2.7', 'Programming Language :: Python :: 3.8'],
      packages=['DLStudio','AdversarialNetworks']
)
