...
"""
This script uses a variant of the TEXTnet by including the previous
...
text_cl.run_code_for_training_with_TEXTnetOrder2_no_gru(model, hidden_size)

import pymsgbox
response = pymsgbox.confirm("Finished training.  Start testing on unseen data?")
if response == "OK": 
    text_cl.run_code_for_testing_with_TEXTnetOrder2_no_gru(model, hidden_size)
