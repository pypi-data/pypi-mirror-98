...
from .doc_commands import collection, current, devel, plugin, redirects, stable
...
ARGS_MAP: Dict[str, Callable] = {'devel': devel.generate_docs,
                                 ...
                                 'redirect': redirects.generate_redirects,
                                 }
...
def parse_args(program_name: str, args: List[str]) -> argparse.Namespace:
    ...
    redirect_parser = subparsers.add_argument('redirects', parents=[],
                                              description='Generate apache redirects for'
                                              ' documentation that has moved.')
