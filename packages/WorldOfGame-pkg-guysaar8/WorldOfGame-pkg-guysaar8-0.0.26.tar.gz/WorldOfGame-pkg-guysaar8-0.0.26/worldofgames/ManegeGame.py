...
class GameManager:
    ...
    def run(game_id, difficulty):
        if game_id == "Memory Game":
            from worldofgames.MemoryGame import memory_game
            memory_game(difficulty)

        elif game_id == "Guess Game":
            from worldofgames.GuessGame import guess_game
            guess_game(difficulty)

        elif game_id == "Currency Roulette":
            from worldofgames.CurrencyRoulette import currency_roulette
