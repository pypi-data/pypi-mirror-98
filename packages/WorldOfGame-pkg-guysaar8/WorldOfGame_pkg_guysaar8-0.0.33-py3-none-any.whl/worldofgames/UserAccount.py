...
def loging():
    # Loads Accounts DB
    account_path = site.getusersitepackages()
    with open(account_path+'/worldofgames/account_db.json') as account_db:
    ...
    while True:
        try:
            ...
            with open(account_path+'/worldofgames/account_db.json', "w") as account_db:
