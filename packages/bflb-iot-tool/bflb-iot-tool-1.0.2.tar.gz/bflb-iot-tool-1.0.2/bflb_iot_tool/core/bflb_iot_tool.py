...
class BflbIotTool(object):
    ...
    def bl60x_image_gen(self,
        ...
        if key or (publickey is not None and privarekey is not None):
            ...
            cfg.set('EFUSE_CFG', 'file', efusefile.replace("\\", "/"))
            cfg.set('EFUSE_CFG', 'maskfile', efusemaskfile.replace("\\", "/"))
    ...
    def bl60x_mfg_flasher_eflash_loader_cfg(self,
        ...
        if boot2 is True:
            if bind_bootinfo is True:
                ...
                whole_img_data = bl_create_flash_default_data(whole_img_len)
                filedata = bl_get_file_data([chipnamedir + "/img_create_iot/bootinfo_boot2.bin"])[0]
                whole_img_data[0:len(filedata)] = filedata
                filedata = bl_get_file_data([chipnamedir + "/img_create_iot/img_boot2.bin"])[0]
                whole_img_data[0x2000:0x2000 + len(filedata)] = filedata
                fp = open(whole_img, 'wb+')
                fp.write(whole_img_data)
                fp.close()
                d_files.append(chipnamedir + "/img_create_iot/whole_img_boot2.bin")
                d_addrs.append("00000000")
            else:
                d_files.append(chipnamedir + "/img_create_iot/bootinfo_boot2.bin")
                d_addrs.append("00000000")
                d_files.append(chipnamedir + "/img_create_iot/img_boot2.bin")
        ...
        if pt_parcel is not None and len(pt_parcel) > 0 and pt_parcel['pt_new'] is True:
            d_files.append(chipnamedir + "/partition/partition.bin")
        ...
        if bin_file is True and 'fw_cpu0_addr' in pt_parcel:
            if bind_bootinfo is True:
                ...
                whole_img_data = bl_create_flash_default_data(whole_img_len)
                filedata = bl_get_file_data([chipnamedir + "/img_create_iot/bootinfo_cpu0.bin"])[0]
                whole_img_data[0:len(filedata)] = filedata
                filedata = bl_get_file_data([chipnamedir + "/img_create_iot/img_cpu0.bin"])[0]
                whole_img_data[0x1000:0x1000 + len(filedata)] = filedata
                fp = open(whole_img, 'wb+')
                fp.write(whole_img_data)
                fp.close()
                d_files.append(chipnamedir + "/img_create_iot/whole_img_cpu0.bin")
                d_addrs.append(hex(pt_parcel['fw_cpu0_addr'])[2:])
            else:
                d_files.append(chipnamedir + "/img_create_iot/bootinfo_cpu0.bin")
                d_addrs.append(hex(pt_parcel['fw_cpu0_addr'])[2:])
                d_files.append(chipnamedir + "/img_create_iot/img_cpu0.bin")
        ...
        if bin_file is True and 'fw_addr' in pt_parcel:
            if bind_bootinfo is True:
                ...
                whole_img_data = bl_create_flash_default_data(whole_img_len)
                filedata = bl_get_file_data([chipnamedir + "/img_create_iot/bootinfo.bin"])[0]
                whole_img_data[0:len(filedata)] = filedata
                filedata = bl_get_file_data([chipnamedir + "/img_create_iot/img.bin"])[0]
                whole_img_data[0x1000:0x1000 + len(filedata)] = filedata
                fp = open(whole_img, 'wb+')
                fp.write(whole_img_data)
                fp.close()
                d_files.append(chipnamedir + "/img_create_iot/whole_img.bin")
                d_addrs.append(hex(pt_parcel['fw_addr'])[2:])
            else:
                d_files.append(chipnamedir + "/img_create_iot/bootinfo.bin")
                d_addrs.append(hex(pt_parcel['fw_addr'])[2:])
                d_files.append(chipnamedir + "/img_create_iot/img.bin")
        ...
        if ro_params is not None and len(ro_params) > 0 and pt_parcel['conf_addr'] is not None:
            ...
            d_files.append(chipnamedir + "/device_tree/ro_params.dtb")
            d_addrs.append(hex(pt_parcel['conf_addr'])[2:])
    
        if media is True and pt_parcel['media_addr'] is not None:
            d_files.append(chipnamedir + "/img_create_iot/media.bin")
        ...
        if mfg is True:
            if bind_bootinfo is True:
                ...
                whole_img_data = bl_create_flash_default_data(whole_img_len)
                filedata = bl_get_file_data([chipnamedir + "/img_create_iot/bootinfo_mfg.bin"])[0]
                whole_img_data[0:len(filedata)] = filedata
                filedata = bl_get_file_data([chipnamedir + "/img_create_iot/img_mfg.bin"])[0]
                whole_img_data[0x1000:0x1000 + len(filedata)] = filedata
                fp = open(whole_img, 'wb+')
                fp.write(whole_img_data)
                fp.close()
                d_files.append(chipnamedir + "/img_create_iot/whole_img_mfg.bin")
                d_addrs.append(hex(pt_parcel['mfg_addr'])[2:])
            else:
                d_files.append(chipnamedir + "/img_create_iot/bootinfo_mfg.bin")
                d_addrs.append(hex(pt_parcel['mfg_addr'])[2:])
                d_files.append(chipnamedir + "/img_create_iot/img_mfg.bin")
