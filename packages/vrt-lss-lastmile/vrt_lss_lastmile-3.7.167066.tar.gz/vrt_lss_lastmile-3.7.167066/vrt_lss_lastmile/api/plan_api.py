    ...
    def __init__(self, api_client=None):
        ...
        self.delete_result = _Endpoint(
            settings={
                ...
                'endpoint_path': '/lastmile/result/{id}',
        ...
        self.get_result_xlsx = _Endpoint(
            settings={
                'response_type': (str,),
                'auth': [
                    'ApiKeyAuth'
                ],
                'endpoint_path': '/lastmile/result/xlsx/{id}',
                'operation_id': 'get_result_xlsx',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.run_plan = _Endpoint(
            settings={
                ...
                'endpoint_path': '/lastmile/run_plan',
        ...
        def __run_plan_xlsx(
            ...
            **kwargs
            ...
            Args:
                body (str): Planning request in the XLSX format.
        ...
        self.run_plan_xlsx = _Endpoint(
            settings={
                'response_type': (PlanId,),
                'auth': [
                    'ApiKeyAuth'
                ],
                'endpoint_path': '/lastmile/run_plan/xlsx',
                'operation_id': 'run_plan_xlsx',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
