...
from vrt_lss_lastmile.api_client import ApiClient, Endpoint as _Endpoint
    ...
    def __init__(self, api_client=None):
        ...
        def __convert_to_json(
            ...
            **kwargs
            ...
            Args:
                convert_task (ConvertTask): Conversion request to the JSON format.
        ...
        self.convert_to_json = _Endpoint(
            settings={
                'response_type': (str,),
                'auth': [
                    'ApiKeyAuth'
                ],
                'endpoint_path': '/lastmile/convert/json',
                'operation_id': 'convert_to_json',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            callable=__convert_to_json
        )

        def __convert_to_lss(
            self,
            body,
            **kwargs
        ):
            ...
            Args:
                body (str): Conversion request to the LSS format.
        ...
        self.convert_to_lss = _Endpoint(
            settings={
                'response_type': (str,),
                'auth': [
                    'ApiKeyAuth'
                ],
                'endpoint_path': '/lastmile/convert/lss',
                'operation_id': 'convert_to_lss',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__convert_to_lss
        )

        def __convert_to_processing(
            self,
            convert_task,
            **kwargs
        ):
        ...
        self.convert_to_processing = _Endpoint(
            settings={
                'response_type': (str,),
                'auth': [
                    'ApiKeyAuth'
                ],
                'endpoint_path': '/lastmile/convert/processing',
                'operation_id': 'convert_to_processing',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__convert_to_processing
        )

        def __convert_to_xlsx(
            self,
            convert_task,
            **kwargs
        ):
            ...
            Args:
                convert_task (ConvertTask): Conversion request to the XLSX.
        ...
        self.convert_to_xlsx = _Endpoint(
            settings={
                'response_type': (str,),
                'auth': [
                    'ApiKeyAuth'
                ],
                'endpoint_path': '/lastmile/convert/xlsx',
                'operation_id': 'convert_to_xlsx',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
