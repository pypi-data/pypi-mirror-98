...
class Hardlink(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'key': (str,),  # noqa: E501
            'links': ([HardlinkElement],),  # noqa: E501
        }
    ...
    @convert_js_args_to_python_args
    def __init__(self, key, links, *args, **kwargs):  # noqa: E501
        """Hardlink - a model defined in OpenAPI

        Args:
            key (str): Assignment key.
            links ([HardlinkElement]): List of items in the assignment group.
