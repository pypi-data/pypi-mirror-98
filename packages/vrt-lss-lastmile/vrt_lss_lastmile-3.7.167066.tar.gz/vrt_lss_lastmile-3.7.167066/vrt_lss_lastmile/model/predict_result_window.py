...
class PredictResultWindow(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, time_window, cost, *args, **kwargs):  # noqa: E501
        """PredictResultWindow - a model defined in OpenAPI

        Args:
            time_window (TimeWindow):
            cost (float): Order fulfillment cost during this time window.
