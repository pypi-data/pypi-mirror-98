...
class PredictTask(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, order, locations, *args, **kwargs):  # noqa: E501
        """PredictTask - a model defined in OpenAPI

        Args:
            id (str): Calculation ID.
            order (Order):
            locations ([AdvancedLocation]): List of locations used in the order for window prediction.
