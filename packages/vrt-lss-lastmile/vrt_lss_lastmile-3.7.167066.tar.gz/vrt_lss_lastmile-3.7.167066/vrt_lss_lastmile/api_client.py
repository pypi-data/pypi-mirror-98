...
from vrt_lss_lastmile.exceptions import ApiTypeError, ApiValueError, ApiException
from vrt_lss_lastmile.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.actualize  # this is an instance of the class Endpoint
        api_instance.actualize()  # this invokes api_instance.actualize.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.actualize.callable or self.callable in this class
