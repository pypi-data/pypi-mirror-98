...
class LinkActionDto(Enum):
    ...
    @classmethod
    def loadFromBinary(cls, payload: bytes) -> LinkActionDto:
        """Creates an instance of LinkActionDto from binary payload.
        Args:
            payload: Byte payload to use to serialize the object.
        Returns:
            Instance of LinkActionDto.
        """
        value: int = GeneratorUtils.bufferToUint(GeneratorUtils.getBytes(bytes(payload), 1))
        return LinkActionDto(value)
