...
class EmbeddedAccountOperationRestrictionTransactionBuilder(EmbeddedTransactionBuilder):
    ...
    Attributes:
        body: Account operation restriction transaction body.
    """
    type_hints = {
    ...
    def __init__(self, signerPublicKey, network: NetworkTypeDto):
        ...
        self.body = AccountOperationRestrictionTransactionBodyBuilder()
    ...
    def loadFromBinary(cls, payload: bytes) -> EmbeddedAccountOperationRestrictionTransactionBuilder:
        ...
        body = AccountOperationRestrictionTransactionBodyBuilder.loadFromBinary(bytes_)  # kind:CUSTOM1_nonbyte
        bytes_ = bytes_[body.getSize():]

        # create object and call
        result = EmbeddedAccountOperationRestrictionTransactionBuilder(superObject.signerPublicKey, superObject.network)
