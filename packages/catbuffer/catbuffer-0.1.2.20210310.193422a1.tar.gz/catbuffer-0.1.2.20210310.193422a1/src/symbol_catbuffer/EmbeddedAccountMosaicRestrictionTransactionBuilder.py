...
class EmbeddedAccountMosaicRestrictionTransactionBuilder(EmbeddedTransactionBuilder):
    ...
    Attributes:
        body: Account mosaic restriction transaction body.
    """
    type_hints = {
    ...
    def __init__(self, signerPublicKey, network: NetworkTypeDto):
        ...
        self.body = AccountMosaicRestrictionTransactionBodyBuilder()
    ...
    def loadFromBinary(cls, payload: bytes) -> EmbeddedAccountMosaicRestrictionTransactionBuilder:
        ...
        body = AccountMosaicRestrictionTransactionBodyBuilder.loadFromBinary(bytes_)  # kind:CUSTOM1_nonbyte
        bytes_ = bytes_[body.getSize():]

        # create object and call
        result = EmbeddedAccountMosaicRestrictionTransactionBuilder(superObject.signerPublicKey, superObject.network)
