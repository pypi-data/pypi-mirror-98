...
class AggregateBondedTransactionBuilder(TransactionBuilder):
    ...
    @classmethod
    def loadFromBinary(cls, payload: bytes) -> AggregateBondedTransactionBuilder:
        """Creates an instance of AggregateBondedTransactionBuilder from binary payload.
        Args:
            payload: Byte payload to use to serialize the object.
        Returns:
            Instance of AggregateBondedTransactionBuilder.
        """
        ...
        body = AggregateTransactionBodyBuilder.loadFromBinary(bytes_)  # kind:CUSTOM1_nonbyte
        bytes_ = bytes_[body.getSize():]

        # create object and call
        result = AggregateBondedTransactionBuilder(superObject.signerPublicKey, superObject.network)
    ...
    def transactionsHash(self):
        return self.body.transactionsHash

    @transactionsHash.setter
    def transactionsHash(self, transactionsHash): # MARKER1 AttributeKind.CUSTOM
        self.body.transactionsHash = transactionsHash
