...
class EmbeddedMosaicAddressRestrictionTransactionBuilder(EmbeddedTransactionBuilder):
    ...
    Attributes:
        body: Mosaic address restriction transaction body.
    """
    type_hints = {
    ...
    def __init__(self, signerPublicKey, network: NetworkTypeDto):
        ...
        self.body = MosaicAddressRestrictionTransactionBodyBuilder()
    ...
    def loadFromBinary(cls, payload: bytes) -> EmbeddedMosaicAddressRestrictionTransactionBuilder:
        ...
        body = MosaicAddressRestrictionTransactionBodyBuilder.loadFromBinary(bytes_)  # kind:CUSTOM1_nonbyte
        bytes_ = bytes_[body.getSize():]

        # create object and call
        result = EmbeddedMosaicAddressRestrictionTransactionBuilder(superObject.signerPublicKey, superObject.network)
