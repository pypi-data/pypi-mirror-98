...
class ProofScalarDto:
    ...
    @classmethod
    def loadFromBinary(cls, payload: bytes) -> ProofScalarDto:
        ...
        proofScalar = GeneratorUtils.getBytes(bytes_, 32)
    ...
    def serialize(self) -> bytes:
        ...
        """
        bytes_ = bytes()
        bytes_ = GeneratorUtils.concatTypedArrays(bytes_, self.proofScalar)
        return bytes_
