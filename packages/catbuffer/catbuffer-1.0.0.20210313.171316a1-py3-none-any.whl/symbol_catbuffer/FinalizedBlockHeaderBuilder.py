...
class FinalizedBlockHeaderBuilder:
    ...
    @classmethod
    def loadFromBinary(cls, payload: bytes) -> FinalizedBlockHeaderBuilder:
        ...
        round = FinalizationRoundBuilder.loadFromBinary(bytes_)  # kind:CUSTOM1
        bytes_ = bytes_[round.getSize():]
    ...
    def getRound(self) -> FinalizationRoundBuilder:
    ...
    def serialize(self) -> bytes:
        ...
        """
        bytes_ = bytes()
        bytes_ = GeneratorUtils.concatTypedArrays(bytes_, self.round.serialize())  # kind:CUSTOM
