...
class ImportanceHeightDto:
    ...
    """
    def __init__(self, importanceHeight: int = 0):
        """Constructor.
    ...
    def serialize(self) -> bytes:
        ...
        """
        bytes_ = bytes()
        bytes_ = GeneratorUtils.concatTypedArrays(bytes_, GeneratorUtils.uintToBuffer(self.getImportanceHeight(), 8))
        return bytes_

    def __str__(self):
        result = hexlify(GeneratorUtils.uintToBuffer(self.getImportanceHeight(), 8)).decode('utf-8')
        return result
