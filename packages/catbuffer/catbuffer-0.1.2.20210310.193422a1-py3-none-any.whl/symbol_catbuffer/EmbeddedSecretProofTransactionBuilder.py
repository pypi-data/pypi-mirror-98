...
class EmbeddedSecretProofTransactionBuilder(EmbeddedTransactionBuilder):
    ...
    def loadFromBinary(cls, payload: bytes) -> EmbeddedSecretProofTransactionBuilder:
        ...
        body = SecretProofTransactionBodyBuilder.loadFromBinary(bytes_)  # kind:CUSTOM1_nonbyte
        bytes_ = bytes_[body.getSize():]

        # create object and call
        result = EmbeddedSecretProofTransactionBuilder(superObject.signerPublicKey, superObject.network)
