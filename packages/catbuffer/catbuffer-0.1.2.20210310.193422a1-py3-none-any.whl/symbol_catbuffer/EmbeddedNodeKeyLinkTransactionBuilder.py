...
class EmbeddedNodeKeyLinkTransactionBuilder(EmbeddedTransactionBuilder):
    ...
    def loadFromBinary(cls, payload: bytes) -> EmbeddedNodeKeyLinkTransactionBuilder:
        ...
        body = NodeKeyLinkTransactionBodyBuilder.loadFromBinary(bytes_)  # kind:CUSTOM1_nonbyte
        bytes_ = bytes_[body.getSize():]

        # create object and call
        result = EmbeddedNodeKeyLinkTransactionBuilder(superObject.signerPublicKey, superObject.network)
