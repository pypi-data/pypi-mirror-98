...
class ProofGammaDto:
    ...
    @classmethod
    def loadFromBinary(cls, payload: bytes) -> ProofGammaDto:
        ...
        proofGamma = GeneratorUtils.getBytes(bytes_, 32)
    ...
    def serialize(self) -> bytes:
        ...
        """
        bytes_ = bytes()
        bytes_ = GeneratorUtils.concatTypedArrays(bytes_, self.proofGamma)
        return bytes_
