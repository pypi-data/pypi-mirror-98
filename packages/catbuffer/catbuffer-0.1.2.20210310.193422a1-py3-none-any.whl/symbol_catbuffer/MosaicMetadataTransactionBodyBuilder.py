...
class MosaicMetadataTransactionBodyBuilder:
    ...
    def __init__(self):
        ...
        self.targetMosaicId = UnresolvedMosaicIdDto().unresolvedMosaicId
    ...
    def loadFromBinary(cls, payload: bytes) -> MosaicMetadataTransactionBodyBuilder:
        ...
        bytes_ = bytes_[8:]
        targetMosaicId_ = UnresolvedMosaicIdDto.loadFromBinary(bytes_)  # kind:CUSTOM1_byte
        targetMosaicId = targetMosaicId_.unresolvedMosaicId
        bytes_ = bytes_[targetMosaicId_.getSize():]
    ...
    def getSize(self) -> int:
        ...
        size += UnresolvedMosaicIdDto(self.targetMosaicId).getSize()
    ...
    def serialize(self) -> bytes:
        ...
        bytes_ = GeneratorUtils.concatTypedArrays(bytes_, UnresolvedMosaicIdDto(self.targetMosaicId).serialize())  # kind:CUSTOM
    ...
    def __str__(self):
        ...
        result += '{:24s} : {}\n'.format('targetMosaicId', toHexString(UnresolvedMosaicIdDto(self.targetMosaicId).serialize()))
