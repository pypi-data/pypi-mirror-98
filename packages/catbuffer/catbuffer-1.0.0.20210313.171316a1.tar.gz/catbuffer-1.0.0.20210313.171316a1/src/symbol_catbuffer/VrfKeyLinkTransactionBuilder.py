...
class VrfKeyLinkTransactionBuilder(TransactionBuilder):
    ...
    @classmethod
    def loadFromBinary(cls, payload: bytes) -> VrfKeyLinkTransactionBuilder:
        """Creates an instance of VrfKeyLinkTransactionBuilder from binary payload.
        Args:
        ...
        result = VrfKeyLinkTransactionBuilder(superObject.signerPublicKey, superObject.network)
