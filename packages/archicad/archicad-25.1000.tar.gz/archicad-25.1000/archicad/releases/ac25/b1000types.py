...
class AddOnId(_ACBaseType):
    """ The Add-On identifier.

    Attributes:
        developerId (:obj:`int`): The ID of the Add-On's developer.
        localId (:obj:`int`): The local ID of the Add-On.

    """
    __slots__ = ("developerId", "localId", )

    def __init__(self, developerId: int, localId: int):
        self.developerId: int = developerId
        self.localId: int = localId

AddOnId.get_classinfo().add_field('developerId', int)
AddOnId.get_classinfo().add_field('localId', int)
...
class AddOnCommandId(_ACBaseType):
    ...
    Attributes:
        addOnId (:obj:`AddOnId`): The Add-On identifier.
        commandName (:obj:`str`): The name of the Add-On command.

    """
    __slots__ = ("addOnId", "commandName", )

    def __init__(self, addOnId: AddOnId, commandName: str):
        self.addOnId: AddOnId = addOnId
        self.commandName: str = commandName

AddOnCommandId.get_classinfo().add_field('addOnId', AddOnId)
