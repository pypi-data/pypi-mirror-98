...
from .b2310types import NavigatorItemId, LayoutParameters, Subset, FolderParameters, NavigatorItemIdWrapper, ExecutionResult, ElementIdArrayItem, BoundingBox2DOrError, BoundingBox3DOrError, ClassificationSystemId, ClassificationItemArrayItem, ClassificationSystem, PropertyUserId, ClassificationSystemIdArrayItem, ElementClassificationOrError, ClassificationItemIdArrayItem, ClassificationItemOrError, PropertyIdArrayItem, PropertyDefinitionOrError, ClassificationItemId, ElementsOrError, NavigatorTreeId, NavigatorTree, PropertyIdOrError, PropertyValuesOrErrorForElement, ElementClassification, ElementPropertyValue
...
class Commands:
    ...
    def GetPropertyValuesOfElements(self, elements: List[ElementIdArrayItem], properties: List[PropertyIdArrayItem]) -> List[PropertyValuesOrErrorForElement]:
        ...
        Returns:
            :obj:`list` of :obj:`PropertyValuesOrErrorForElement`: List of property value lists for elements
        ...
        if not result["succeeded"]:
            raise UnsucceededCommandCall(result)
        propertyValuesForElementsListBuilder = _ListBuilder(PropertyValuesOrErrorForElement)
