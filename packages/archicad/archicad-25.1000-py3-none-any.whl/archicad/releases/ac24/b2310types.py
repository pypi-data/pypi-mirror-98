...
class PropertyValuesOrErrorForElement(_ACUnionType):
    """ Contains either a list of property values or an error for the element

    Attributes:
        propertyValues (:obj:`list` of :obj:`PropertyValueOrErrorItem`, optional): List of property values for an element.
        error (:obj:`Error`, optional): Error details.
...
class Types:
    ...
    PropertyValuesOrErrorForElement=PropertyValuesOrErrorForElement
