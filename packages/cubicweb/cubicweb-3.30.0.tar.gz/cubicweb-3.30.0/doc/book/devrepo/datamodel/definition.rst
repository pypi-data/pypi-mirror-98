...
* `RegexpConstraint`: set allowed patterns as a regexp
...
.. sourcecode:: python
     ...
     class Organisation(EntityType):
         name = String(constraints=[RegexpConstraint('^[^_]*$')])
...
See `YAMS constraint module documentation <https://yams.readthedocs.io/en/latest/yams.html#module-yams.constraints>`_.
