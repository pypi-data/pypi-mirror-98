...
_SECRETDATAINFO = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='encrypted_data', full_name='spaceone.api.secret.v1.SecretDataInfo.encrypted_data', index=1,
      number=4, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='encrypted', full_name='spaceone.api.secret.v1.SecretDataInfo.encrypted', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='encrypt_options', full_name='spaceone.api.secret.v1.SecretDataInfo.encrypt_options', index=3,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='secret_data', full_name='spaceone.api.secret.v1.SecretDataInfo.secret_data',
...
_SECRETDATAINFO.oneofs_by_name['secret_data'].fields.append(
  _SECRETDATAINFO.fields_by_name['data'])
_SECRETDATAINFO.fields_by_name['data'].containing_oneof = _SECRETDATAINFO.oneofs_by_name['secret_data']
_SECRETDATAINFO.oneofs_by_name['secret_data'].fields.append(
  _SECRETDATAINFO.fields_by_name['encrypted_data'])
_SECRETDATAINFO.fields_by_name['encrypted_data'].containing_oneof = _SECRETDATAINFO.oneofs_by_name['secret_data']
