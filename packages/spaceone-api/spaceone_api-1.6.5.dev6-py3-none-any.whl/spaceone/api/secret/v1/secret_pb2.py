...
_SECRETDATAINFO = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='encrypted_options', full_name='spaceone.api.secret.v1.SecretDataInfo.encrypted_options', index=2,
...
_SECRETDATAINFO.fields_by_name['encrypted_options'].message_type = google_dot_protobuf_dot_struct__pb2._STRUCT
