...
def save_xyz(f_name:str, labels:list, coords:list, with_numbers:bool=False, verbose:bool=True, mask:list=[], 
...
def get_adjacency(labels:list, coords:list, adjust_cutoff:dict={}, save:bool=False, f_name:str="adjacency.dat"):
    """
...
def get_bonds(labels:list, coords:list, neigh_list=None, f_name:str='bonds.dat', save:bool=False,
...
def get_angles(labels:list, coords:list, neigh_list=None, f_name:str='angles.dat', save:bool=False,
              verbose:bool=True, style:bool='indices'):
    """
...
def get_dihedrals(labels:list, coords:list, neigh_list=None, f_name:str='dihedrals.dat', save:bool=False,
              verbose:bool=True, style:bool='indices'):
    """
...
def remove_broken(labels:list, coords:list, formulae:list, adjust_cutoff:dict={}, verbose:bool=False,
                  save:bool = False, frag_f_name:str="fragments.xyz", clean_f_name:str="clean.xyz", 
                  mask:list=[], skip:list=[]):
    """
    ...
    Positional arguments:
        ...
        coords (list) : list of lists of xyz coordinates of each atom
        formulae (list) : list of chemical formulae stored as dictionaries with atomic symbol (key) count (val) pairs
