...
static const char __pyx_k_easy_tcp_cython_src_server_pyx[] = "easy_tcp/cython_src/server.pyx";
static PyObject *__pyx_n_s_cline_in_traceback;
static PyObject *__pyx_n_s_easy_tcp;
static PyObject *__pyx_kp_s_easy_tcp_cython_src_server_pyx;
...
/* "easy_tcp/cython_src/server.pyx":3
 * cimport cserver
 * 
 * def server():             # <<<<<<<<<<<<<<
...
static PyObject *__pyx_pf_8easy_tcp_server(CYTHON_UNUSED PyObject *__pyx_self) {
  ...
  /* "easy_tcp/cython_src/server.pyx":4
 * 
 * def server():
 *     cserver.ET_server(7070)             # <<<<<<<<<<<<<<
 */
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_s_easy_tcp_cython_src_server_pyx, __pyx_k_easy_tcp_cython_src_server_pyx, sizeof(__pyx_k_easy_tcp_cython_src_server_pyx), 0, 0, 1, 0},
 ...
 *     cserver.ET_server(7070)
 */
  __pyx_codeobj_ = (PyObject*)__Pyx_PyCode_New(0, 0, 0, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_easy_tcp_cython_src_server_pyx, __pyx_n_s_server, 3, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj_)) __PYX_ERR(0, 3, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
 ...
 */
  ...
  /* "easy_tcp/cython_src/server.pyx":1
 * cimport cserver             # <<<<<<<<<<<<<<
 * 
 * def server():
 */
