from bingads.v13.bulk.entities.audiences.bulk_ad_group_negative_audience_association import *

class BulkAdGroupNegativeSimilarRemarketingListAssociation(BulkAdGroupNegativeAudienceAssociation):
