...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, pulp_created=None, pulp_labels=None, name=None, pulp_href=None, repository_version=None, base_path=None, repository=None, content_guard=None, registry_path=None, namespace=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
