...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, name=None, repository=None, pulp_labels=None, pulp_href=None, content_guard=None, base_path=None, repository_version=None, pulp_created=None, registry_path=None, namespace=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
