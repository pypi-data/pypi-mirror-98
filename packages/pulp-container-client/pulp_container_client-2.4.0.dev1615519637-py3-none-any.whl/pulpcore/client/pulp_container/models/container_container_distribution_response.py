...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, repository_version=None, pulp_created=None, repository=None, pulp_labels=None, base_path=None, pulp_href=None, name=None, content_guard=None, registry_path=None, namespace=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
