...
class PatchedcontainerContainerDistribution(object):
    ...
    def __init__(self, repository_version=None, base_path=None, name=None, content_guard=None, repository=None, pulp_labels=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
