...
class PatchedcontainerContainerDistribution(object):
    ...
    def __init__(self, pulp_labels=None, name=None, repository_version=None, base_path=None, repository=None, content_guard=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
