...
from vrt_lss_account.exceptions import ApiTypeError, ApiValueError, ApiException
from vrt_lss_account.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.change_password  # this is an instance of the class Endpoint
        api_instance.change_password()  # this invokes api_instance.change_password.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.change_password.callable or self.callable in this class
