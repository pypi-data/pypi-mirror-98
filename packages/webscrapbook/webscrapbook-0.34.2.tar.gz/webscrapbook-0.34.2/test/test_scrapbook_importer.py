...
class TestImporter(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.test_output_wsb = os.path.join(cls.test_output, WSB_DIR)
        cls.test_output_config = os.path.join(cls.test_output_wsb, 'config.ini')
        cls.test_output_tree = os.path.join(cls.test_output_wsb, 'tree')
