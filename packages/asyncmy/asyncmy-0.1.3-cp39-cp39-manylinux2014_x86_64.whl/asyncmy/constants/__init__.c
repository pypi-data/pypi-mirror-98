...
{
    "distutils": {
        "name": "asyncmy.constants.__init__",
        "sources": [
            "asyncmy/constants/__init__.py"
        ]
    },
    "module_name": "asyncmy.constants.__init__"
}
END: Cython Metadata */
...
#define __PYX_HAVE__asyncmy__constants____init__
#define __PYX_HAVE_API__asyncmy__constants____init__
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from 'asyncmy.constants.__init__' */
#define __Pyx_MODULE_NAME "asyncmy.constants.__init__"
extern int __pyx_module_is_main_asyncmy__constants____init__;
int __pyx_module_is_main_asyncmy__constants____init__ = 0;

/* Implementation of 'asyncmy.constants.__init__' */
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_asyncmy__constants____init__) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  if (!CYTHON_PEP489_MULTI_PHASE_INIT) {
    if (unlikely(__Pyx_SetPackagePathFromImportLib("asyncmy", __pyx_n_u_constants) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "asyncmy.constants")) {
      if (unlikely(PyDict_SetItemString(modules, "asyncmy.constants", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "asyncmy/constants/__init__.py":1
             # <<<<<<<<<<<<<<
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init asyncmy.constants.__init__", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init asyncmy.constants.__init__");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
