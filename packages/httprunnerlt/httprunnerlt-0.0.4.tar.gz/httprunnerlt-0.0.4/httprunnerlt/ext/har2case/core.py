...
from httprunnerlt.compat import ensure_path_sep
from loguru import logger
from sentry_sdk import capture_exception

from httprunnerlt.ext.har2case import utils
from httprunnerlt.make import make_testcase, format_pytest_with_black
            ...
            entry_json (dict):
                {
                    "request": {
                        "headers": [
                            {"name": "Host", "value": "httprunnerlt.top"},
