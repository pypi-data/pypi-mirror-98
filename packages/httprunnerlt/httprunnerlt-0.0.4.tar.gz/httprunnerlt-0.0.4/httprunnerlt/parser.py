...
from httprunnerlt import loader, utils, exceptions
from httprunnerlt.models import VariablesMapping, FunctionsMapping
...
def get_mapping_function(
    ...
    if function_name in functions_mapping:
        ...
        from httprunnerlt.ext import uploader
