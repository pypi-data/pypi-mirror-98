...
setup(
  ...
  description='A Python 3 toolset for creating and optimizing Echo State Networks. Visit github.com/blindedjoy/RcTorch for more information. This library is an extension and expansion of the previous library written by Reinier Maat: https://github.com/1Reinier/Reservoir',
