...
if __name__ == '__main__':
    db = DictToDb('Demo.db')
    # db.insert({"aa#pk": 11, "bb": 22, "cc": 33}, table_name="测试")
    # db.insert({"aa#pk": 12, "新增字段": datetime.datetime.now(), '李四': object()}, table_name="测试")
    db.insert_or_replace({"aa#pk": 12, "replace": datetime.datetime.now(), 'replace1': object()}, table_name="测试")
    # db.update({"update": 88, "delete": 99}, where={"aa": 11}, table_name="测试")
