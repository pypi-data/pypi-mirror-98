...
TEST_DIRECTORY = (
    str(pathlib.Path(__file__).parent.absolute()) + "/data/gis_vector/"
)
# TEST_DIRECTORY = "//utr-3fs-01.nens.local/WorkDir/C_Kerklaan/scripts/base/tests/input/gis_vector/"
...
def test_multipart_to_singlepart():
    ...
    singles = multi.multipart2singlepart()
