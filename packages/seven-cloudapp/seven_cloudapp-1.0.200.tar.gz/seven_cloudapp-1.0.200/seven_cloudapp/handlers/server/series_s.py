...
class SeriesListHandler(SevenBaseHandler):
    ...
    def get_async(self):
        ...
        page_list, total = IpSeriesModel().get_dict_page_list("*", page_index, page_size, condition, "", order_by, params)
...
class SeriesDelHandler(SevenBaseHandler):
    ...
    def get_async(self):
        ...
        IpSeriesModel().del_entity("id=%s", series_id)
...
class SeriesReleaseHandler(SevenBaseHandler):
    ...
    def get_async(self):
        ...
        IpSeriesModel().update_table("is_release=%s", "id=%s", [is_release, series_id])
