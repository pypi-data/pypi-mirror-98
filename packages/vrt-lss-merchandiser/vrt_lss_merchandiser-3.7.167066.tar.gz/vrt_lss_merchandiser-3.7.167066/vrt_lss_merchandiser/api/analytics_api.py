    ...
    def __init__(self, api_client=None):
        ...
        def __analytics(
            ...
            **kwargs
            ...
            Used to get [analytics]()https://docs.veeroute.com/#/lss/analytics) on the results of planning.  # noqa: E501
            ...
            Args:
                analytics_task (AnalyticsTask): Request for analytics.
            ...
            kwargs['analytics_task'] = \
                analytics_task
            return self.call_with_http_info(**kwargs)

        self.analytics = _Endpoint(
            settings={
                'response_type': (str,),
                'auth': [
                    'ApiKeyAuth'
                ],
                'endpoint_path': '/merchandiser/analytics/xlsx',
