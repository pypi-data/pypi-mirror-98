...
with DAG("example_fileshare", schedule_interval="@once", start_date=days_ago(2)) as dag:
    create = PythonOperator(task_id="create-share", python_callable=create_fileshare,provide_context=True)
    delete = PythonOperator(task_id="delete-share", python_callable=delete_fileshare,provide_context=True)
