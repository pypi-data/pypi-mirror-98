...
def detect(frame, camera_params,size=0.04,code = DICT_ARUCO_ORIGINAL):
    ...
    if ids is not None:
        ...
        cv2.putText(frame, str(ids.tolist()), (2,16), font, 0.5, (0,255,0),2,cv2.LINE_4)
        mid = ids.tolist()[0][0]
    else:
        cv2.putText(frame, "NoMarker", (2,16), font, 0.5, (0,255,0),2,cv2.LINE_4)
    return frame, rvec, tvec,mid
