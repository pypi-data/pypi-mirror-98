...
class sendThread (threading.Thread):
	def __init__(self, axlimits, aylimits, udp, port, wait, base_ipaddr):
...
class SourceScanner(object):
	...
	def scan_servers(self):
			...
			sthread = sendThread(self.axlimits,self.aylimits,self.udp,self.port,self.wait,self.base_ipaddr)
			sthread.start()
			sthread.join()
