...
class NextJsProject(
    ...
    def __init__(
        ...
        *,
        ...
        projen_version: typing.Optional[_Semver_421032ab] = None,
        ...
        :param projen_version: (experimental) Version of projen to install. Default: Semver.latest()
...
class NextJsProjectOptions(NextJsCommonProjectOptions, _NodeProjectOptions_0a6b3d0f):
    ...
    @builtins.property
    def projen_version(self) -> typing.Optional[_Semver_421032ab]:
        ...
        return typing.cast(typing.Optional[_Semver_421032ab], result)
