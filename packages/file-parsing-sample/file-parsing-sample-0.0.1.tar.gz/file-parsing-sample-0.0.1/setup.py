...
setup(
    ...
    author="Sue Hannum", # Optional

    # This should be a valid email address corresponding to the author listed above.
    author_email="sue.hannum@sas.com", # Optional

    # This is a one-line description or tagline of what your project does. This
    # corresponds to the "Summary" metadata field:
    # https://packaging.python.org/specifications/core-metadata/#summary
    description="A small package exercising file parsing", # Optional
