...
def pkg_info() -> Mapping:
    ...
    """
    sphinx_src_dir = pathlib.Path(__file__).parent
    info_path = sphinx_src_dir / ".." / "pycsphere.egg-info" / "PKG-INFO"
...
htmlhelp_basename = "Pycsou-sphere"
html_context = {
    'menu_links_name': 'Repository',
    'menu_links': [
        ('<i class="fa fa-github fa-fw"></i> Source Code', 'https://github.com/matthieumeo/pycsou-sphere'),
