...
[boto3.SagemakerEdgeManager 1.17.25](https://boto3.amazonaws.com/v1/documentation/api/1.17.25/reference/services/sagemaker-edge.html#SagemakerEdgeManager) service
compatible with
