...
setup(
    name='tendril-connector-mq',
    use_scm_version={"root": ".", "relative_to": __file__},
    author="Chintalagiri Shashank",
    author_email="shashank@chintal.in",
    description="Tendril Connector to RabbitMQ",
    long_description='\n'.join([read('README.rst'), read('CHANGELOG.rst')]),
    long_description_content_type='text/x-rst',
    keywords='tendril',
    url='https://github.com/tendril-framework/tendril-connector-mq',
    project_urls={
        'Documentation': 'https://tendril-connector-mq.readthedocs.io/en/latest',
        'Bug Tracker': 'https://github.com/tendril-framework/tendril-connector-mq/issues',
        'Source Repository': 'https://github.com/tendril-framework/tendril-connector-mq',
    },
