...
from vrt_lss_stock import rest
from vrt_lss_stock.configuration import Configuration
from vrt_lss_stock.exceptions import ApiTypeError, ApiValueError, ApiException
from vrt_lss_stock.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = PlanApi()
        api_instance.plan  # this is an instance of the class Endpoint
        api_instance.plan()  # this invokes api_instance.plan.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.plan.callable or self.callable in this class
