"""
    module(keyword) - 关键词提取，参考代码：https://github.com/vi3k6i5/flashtext.

    Main members:

        # KeywordProcessor - 关键词匹配工具类.
"""
__all__ = [
    'KeywordProcessor'
]
...
class KeywordProcessor(object):
    ...
    def __init__(self, case_sensitive=False, white_space_chars=['\t', '\n', '\a', ' ', ','], non_word_boundaries=[]):
        """
        Args:
        ...
        self._white_space_chars = set(white_space_chars)
        try:
            # python 2.x
            self.non_word_boundaries = set(non_word_boundaries)
                ...
                if self._keyword in current_dict or char in current_dict:
                    ...
                    if char in current_dict:
                        ...
                        if is_longer_seq_found:
                            ...
                            idx = sequence_end_pos - 1  # 修复相邻关键词，后面的识别不出来的bug
                    current_dict = self.keyword_trie_dict
        ...
        while idx < sentence_len:
            ...
            if char not in self.non_word_boundaries:
                ...
                if self._keyword in current_dict or char in current_dict:
                    ...
                    if longest_sequence_found:
                        curr_cost = max_cost
                        if is_longer_seq_found:  # 修复相邻关键词，后面的识别不出来的bug
