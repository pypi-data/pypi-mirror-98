...
def _is_horizontal(orientation):
    if isinstance(orientation, str):
        warnings.warn(__("deprecated_string_literals"),
                      DeprecationWarning)
    elif isinstance(orientation, bool):
        warnings.warn(__("deprecated_boolean_value"),
                      DeprecationWarning)
...
def auto_commit(widget, master, value, label, auto_label=None, box=False,
    ...
    if not auto_label:
        if checkbox_label:
            ...
            auto_label = __("btn.automatically") + label.title()
...
def auto_send(widget, master, value="auto_send", **kwargs):
    ...
    :return: the box
    """
    return auto_commit(widget, master, value, __("btn.send_selection"), __("btn.send_automatically"), **kwargs)
...
def auto_apply(widget, master, value="auto_apply", **kwargs):
    ...
    :return: the box
    """
    return auto_commit(widget, master, value, __("btn.apply"), __("btn.apply_automatically"), **kwargs)
