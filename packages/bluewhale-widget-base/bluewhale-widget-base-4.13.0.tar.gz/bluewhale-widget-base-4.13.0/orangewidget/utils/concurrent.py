...
def __(key):
    return i18n.t("widget.concurrent." + key)
...
class FutureWatcher(QObject, PyOwned):
    ...
    def isCancelled(self):
        warnings.warn(__("warn.deprecate_iscancelled"), DeprecationWarning,
                      stacklevel=2)
        return self.__future.cancelled()

    def isDone(self):
        warnings.warn(__("warn.deprecated_isdone"), DeprecationWarning,
                      stacklevel=2)
