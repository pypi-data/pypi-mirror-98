...
def __(key):
    return i18n.t("widget.settings." + key)
    ...
    def _default_packer(setting, instance):
        ...
        if setting.packable:
            if hasattr(instance, setting.name):
                ...
                warnings.warn(__("warn.miss_instance").format(setting.name, instance))
...
class SettingsHandler:
    ...
    def read_defaults(self):
        ...
        if os.path.isfile(filename):
            ...
            # pylint: disable=broad-except
                ...
                warnings.warn(__("warn.read_defaults_error").format(self.widget_class, ex))
            finally:
                settings_file.close()
    ...
    def _select_provider(self, instance):
        ...
        if provider is None:
            message = __("warn.setting_error").format(instance.__class__, self.widget_class)
