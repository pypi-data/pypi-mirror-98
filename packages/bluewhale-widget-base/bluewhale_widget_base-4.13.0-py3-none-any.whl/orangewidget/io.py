...
class MatplotlibFormat:
    ...
    EXTENSIONS = ('.py',)
    DESCRIPTION = __('matplotlib_desc')
    PRIORITY = 300
...
class MatplotlibPDFFormat(MatplotlibFormat):
    EXTENSIONS = ('.pdf',)
    DESCRIPTION = __('matplotlibpdf_desc')
    PRIORITY = 200
