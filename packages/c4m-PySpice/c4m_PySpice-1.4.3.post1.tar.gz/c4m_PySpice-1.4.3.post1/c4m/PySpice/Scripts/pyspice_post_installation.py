...
class CircuitTest:
    ...
    def test_spinit(self):
        ...
        import c4m.PySpice as PySpice
        from c4m.PySpice.Spice.Netlist import Circuit
        from c4m.PySpice import Unit as U
...
class PySpicePostInstallation:
    ...
    def ngspice_version(self):
        if not hasattr(self, '_ngspice_version'):
            ...
            if version is None:
                from c4m.PySpice.Spice.NgSpice import NGSPICE_SUPPORTED_VERSION
    ...
    def install_ngspice_dll(self):
        ...
        from c4m.PySpice import NgSpice
    ...
    def check_installation(self):
        ...
        import c4m.PySpice.Logging.Logging as Logging
        logger = Logging.setup_logging(logging_level='INFO')

        from c4m.PySpice.Config import ConfigInstall
        from c4m.PySpice.Spice import NgSpice
        from c4m.PySpice.Spice.NgSpice import NGSPICE_SUPPORTED_VERSION
        from c4m.PySpice.Spice.NgSpice.Shared import NgSpiceShared
