...
class CircuitSimulator(CircuitSimulation):
    ...
    def factory(cls, circuit, *args, **kwargs):
        ...
        """Return a :obj:`c4m.PySpice.Spice.Simulation.SubprocessCircuitSimulator` or
        :obj:`c4m.PySpice.Spice.Simulation.NgSpiceSharedCircuitSimulator` instance depending of the
