...
def ar_mergeData(downloaded_tables):
    ...
    # Dados do Cliente
    #-----------------------
    ar_merged_data = ar_merged_data.merge(downloaded_tables['mdbusinesspartnerdocreference'],
                                     left_on=['businesspartner_id'],
                                     right_on=['businesspartner_id'],
                                     how='left')
    
    ar_merged_data = ar_merged_data.merge(downloaded_tables['mddocreference'],
