...
class Text(GraphicsObject):
    ...
    def __init__(self, p, text, font_size=None, font_face=None, font_style=None, font_colour=None,
        ...
        if isinstance(font_colour, Colour):
            ...
            self.outline = STYLES["default"]["font colour"]
        else:
    ...
    def _draw(self, canvas, options):
        ...
        return canvas.create_text(x, y, font=(self.font_face, self.font_size, self.font_style), angle=self.rotation,
