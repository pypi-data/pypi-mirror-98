...
"""Setup.py for the apache-airflow-backport-providers-pagerduty package."""
...
def do_setup():
    """Perform the package apache-airflow-backport-providers-pagerduty setup."""
    setup(
        name='apache-airflow-backport-providers-pagerduty',
        description='Backport provider package '
        'apache-airflow-backport-providers-pagerduty for Apache Airflow',
        ...
        install_requires=['apache-airflow~=1.10', 'pdpyras>=4.1.2,<5'],
