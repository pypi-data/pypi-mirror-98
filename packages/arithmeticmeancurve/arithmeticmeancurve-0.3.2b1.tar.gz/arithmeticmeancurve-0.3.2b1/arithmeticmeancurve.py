...
def _number_column_name(column_name: str, number: int) -> str:
    ...
    Examples:
        >>> from arithmeticmeancurve import _number_column_name
        >>> _number_column_name("", 1)
        '_1'
        >>> _number_column_name("name", 1)
        'name_1'
    """
...
class MeanCurvePlotter(object):
    ...
    def plot(
        ...
        fig = cls._plot(a_mean_curve=a_mean_curve, title=title, with_marker=with_marker)
        plt.show()
        plt.close(fig)
    ...
    def plot_default(
        ...
        if with_marker:
            curve_plot_kwargs = {"marker": "o", "markersize": 3}
