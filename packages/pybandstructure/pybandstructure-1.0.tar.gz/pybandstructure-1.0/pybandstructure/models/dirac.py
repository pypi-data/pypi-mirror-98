...
def dirac(hv, delta):
    ...
    hamiltonian = Momentum_Conserving_Operator(matrices = [[sigma_x, sigma_y], sigma_z],
                                               coefficients = [_f_dirac(hv = hv, der = (0,0)), delta]) 
    overlap = None
    p_x = Momentum_Conserving_Operator(matrices = [[sigma_x, sigma_y]],
                                       coefficients =[_f_dirac(hv = hv, der = (1,0))])
    p_y = Momentum_Conserving_Operator(matrices = [[sigma_x, sigma_y]],
                                       coefficients = [_f_dirac(hv = hv, der = (0,1))])
