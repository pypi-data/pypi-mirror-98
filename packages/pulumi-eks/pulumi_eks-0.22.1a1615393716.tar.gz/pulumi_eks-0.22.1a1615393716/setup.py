...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'eks', '0.22.1-alpha.1615393716+0f8e4427'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource eks 0.22.1-alpha.1615393716+0f8e4427`
                """)
            else:
                raise
