...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'eks', '0.22.1-alpha.1615390223+d54eb786'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource eks 0.22.1-alpha.1615390223+d54eb786`
                """)
            else:
                raise
