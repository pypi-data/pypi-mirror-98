...
class UserInfo(object):
    ...
    def __init__(self, id=None, username=None, first_name=None, last_name=None, middle_name=None, email=None, description=None, user_role_list=None, user_group_list=None, local_vars_configuration=None):  # noqa: E501
