...
class ItemLocationInformation(object):
    ...
    def __init__(self, locatable_item=None, location_item=None, location_string=None, location_details=None, location_single_node_hierarchy=None, local_vars_configuration=None):  # noqa: E501
