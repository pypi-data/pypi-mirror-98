...
class ItemDomainInventory(object):
    ...
    def __init__(self, id=None, name=None, item_identifier1=None, item_identifier2=None, qr_id=None, derived_from_item=None, item_source_list=None, domain_id=None, item_category_list_import=None, primary_image_for_item=None, max_sort_order=None, description=None, entity_type_list=None, item_category_list=None, item_type_list=None, item_project_list=None, serial_number=None, tag=None, catalog_item=None, local_vars_configuration=None):  # noqa: E501
