...
class PlanTask(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, orders, performers, *args, **kwargs):  # noqa: E501
        """PlanTask - a model defined in OpenAPI

        Args:
            orders ([Order]): List of planned works.
            performers ([Performer]): List of performers with their schedules.
