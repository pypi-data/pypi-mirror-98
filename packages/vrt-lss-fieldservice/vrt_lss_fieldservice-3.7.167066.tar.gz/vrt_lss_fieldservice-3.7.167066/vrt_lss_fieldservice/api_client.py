...
from vrt_lss_fieldservice import rest
from vrt_lss_fieldservice.configuration import Configuration
from vrt_lss_fieldservice.exceptions import ApiTypeError, ApiValueError, ApiException
from vrt_lss_fieldservice.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.analytics  # this is an instance of the class Endpoint
        api_instance.analytics()  # this invokes api_instance.analytics.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.analytics.callable or self.callable in this class
