...
_lr_productions = [
  ...
  ('elem -> COALESCE elems','elem',2,'p_elem_selector','parser.py',29),
  ('elem -> NULLIF elems','elem',2,'p_elem_selector','parser.py',30),
  ('elem -> ABS elem','elem',2,'p_elem_func','parser.py',35),
  ('elem -> SUM elem','elem',2,'p_elem_func','parser.py',36),
  ('elem -> FLOOR elem','elem',2,'p_elem_func','parser.py',37),
  ('elem -> ISNULL LPAREN elems RPAREN','elem',4,'p_elem_func_args','parser.py',43),
  ('elem -> ROUND LPAREN elems RPAREN','elem',4,'p_elem_func_args','parser.py',44),
  ('elem -> SUM LPAREN elem RPAREN','elem',4,'p_elem_func_sum','parser.py',50),
  ('elem -> elem PLUS elem','elem',3,'p_elem_math','parser.py',56),
  ('elem -> elem MINUS elem','elem',3,'p_elem_math','parser.py',57),
  ('elem -> elem MULTIPLY elem','elem',3,'p_elem_math','parser.py',58),
  ('elem -> elem DIVIDE elem','elem',3,'p_elem_math','parser.py',59),
  ('elem -> ELEM_START coords ELEM_END','elem',3,'p_elem','parser.py',65),
  ('elem -> NUM','elem',1,'p_num_elem','parser.py',70),
  ('coords -> CODE','coords',1,'p_coords','parser.py',75),
  ('coords -> coords CODE','coords',2,'p_coords','parser.py',76),
  ('elems -> elem COMMA elem','elems',3,'p_elem_group','parser.py',85),
  ('elems -> elems COMMA elem','elems',3,'p_elem_group','parser.py',86),
  ('elem -> MINUS elem','elem',2,'p_ne_elem','parser.py',95),
  ('elem -> LPAREN elem RPAREN','elem',3,'p_elem_in_parens','parser.py',100),
  ('elems -> LPAREN elems RPAREN','elems',3,'p_elem_in_parens','parser.py',101),
]
