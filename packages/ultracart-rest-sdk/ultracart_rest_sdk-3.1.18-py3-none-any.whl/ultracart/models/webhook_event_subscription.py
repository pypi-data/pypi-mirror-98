...
class WebhookEventSubscription(object):
    ...
    def __init__(self, comments=None, deprecated_flag=None, discontinued_flag=None, event_description=None, event_name=None, expansion=None, subscribed=None, supports_reflow=None, webhook_event_oid=None):  # noqa: E501
