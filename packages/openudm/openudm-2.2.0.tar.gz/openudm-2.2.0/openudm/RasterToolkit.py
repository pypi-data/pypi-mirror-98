...
class Tile(_object):
    ...
    __repr__ = _swig_repr
    __swig_setmethods__["dph"] = _RasterToolkit.Tile_dph_set
    __swig_getmethods__["dph"] = _RasterToolkit.Tile_dph_get
    if _newclass:
        dph = _swig_property(_RasterToolkit.Tile_dph_get, _RasterToolkit.Tile_dph_set)
    __swig_setmethods__["str"] = _RasterToolkit.Tile_str_set
    __swig_getmethods__["str"] = _RasterToolkit.Tile_str_get
    if _newclass:
        str = _swig_property(_RasterToolkit.Tile_str_get, _RasterToolkit.Tile_str_set)
    __swig_setmethods__["str90"] = _RasterToolkit.Tile_str90_set
    __swig_getmethods__["str90"] = _RasterToolkit.Tile_str90_get
    if _newclass:
        str90 = _swig_property(_RasterToolkit.Tile_str90_get, _RasterToolkit.Tile_str90_set)
    __swig_setmethods__["ras"] = _RasterToolkit.Tile_ras_set
    __swig_getmethods__["ras"] = _RasterToolkit.Tile_ras_get
    if _newclass:
        ras = _swig_property(_RasterToolkit.Tile_ras_get, _RasterToolkit.Tile_ras_set)
    __swig_setmethods__["ras90"] = _RasterToolkit.Tile_ras90_set
    __swig_getmethods__["ras90"] = _RasterToolkit.Tile_ras90_get
    if _newclass:
        ras90 = _swig_property(_RasterToolkit.Tile_ras90_get, _RasterToolkit.Tile_ras90_set)

    def __init__(self, tile_dph):
        this = _RasterToolkit.new_Tile(tile_dph)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    __swig_destroy__ = _RasterToolkit.delete_Tile
    __del__ = lambda self: None
Tile_swigregister = _RasterToolkit.Tile_swigregister
