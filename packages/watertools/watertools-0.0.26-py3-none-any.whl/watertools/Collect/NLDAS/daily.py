...
def main(Dir, Vars, Startdate, Enddate, latlim, lonlim, cores=False,
    ...
    """
    This function downloads NLDAS daily data for a given variable, time
    interval, and spatial extent.

    Keyword arguments:
    Dir -- 'C:/file/to/path/'
    Vars -- ['tmp2m','spfh2m'] (array of strings) Variable code: VariablesInfo('day').descriptions.keys()
    ...
    for Var in Vars:
        ...
        if Waitbar == 1:
            print('\nDownloading daily NLDAS NOAH %s data for the period %s till %s' %(Var, Startdate, Enddate))
