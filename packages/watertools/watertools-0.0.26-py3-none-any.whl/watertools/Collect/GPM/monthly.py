...
def main(Dir, Startdate='', Enddate='',
         latlim=[-90, 90], lonlim=[-180, 180], cores=False, Waitbar = 1):

    """
    This function downloads GPM (monthly) data
    ...
    """
     # Download data
    print('\nDownload monthly GPM precipitation data for period %s till %s' %(Startdate, Enddate))
