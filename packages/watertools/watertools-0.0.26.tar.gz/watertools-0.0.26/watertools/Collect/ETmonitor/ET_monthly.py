...
import os
import sys
from watertools.Collect.ETmonitor.DataAccess import DownloadData
...
def main(Dir, Startdate='', Enddate='', latlim=[-60, 70], lonlim=[-180, 180], Waitbar = 1):
    ...
    """
    print('\nDownload monthly ETmonitor evapotranspiration data for the period %s till %s' %(Startdate, Enddate))
