...
class QsciScintillaBase(QtWidgets.QAbstractScrollArea):
    ...
    def SCN_MACRORECORD(self, a0: int, a1: int, a2: PyQt5.sip.voidptr) -> None: ...
    ...
    def SendScintillaPtrResult(self, msg: int) -> PyQt5.sip.voidptr: ...
    @typing.overload
    def SendScintilla(self, msg: int, wParam: int = ..., lParam: int = ...) -> int: ...
    @typing.overload
    def SendScintilla(self, msg: int, wParam: int, lParam: PyQt5.sip.voidptr) -> int: ...
    @typing.overload
...
class QsciCommand(PyQt5.sip.wrapper):
...
class QsciCommandSet(PyQt5.sip.wrapper):
...
class QsciDocument(PyQt5.sip.wrapper):
...
class QsciLexer(QtCore.QObject):
    ...
    def blockStartKeyword(self) -> typing.Tuple[bytes, int]: ...
    def blockStart(self) -> typing.Tuple[bytes, int]: ...
    def blockLookback(self) -> int: ...
    def blockEnd(self) -> typing.Tuple[bytes, int]: ...
...
class QsciStyle(PyQt5.sip.wrapper):
...
class QsciStyledText(PyQt5.sip.wrapper):
