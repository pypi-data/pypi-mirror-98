...
"""Setup.py for the apache-airflow-backport-providers-datadog package."""
...
def do_setup():
    ...
    setup(
        name='apache-airflow-backport-providers-datadog',
        description='Backport provider package '
        'apache-airflow-backport-providers-datadog for Apache Airflow',
        ...
        install_requires=['apache-airflow~=1.10', 'datadog>=0.14.0'],
