...
var IconLightning = React.forwardRef(function IconLightning(_a, ref) {
    var _b = _a.isSolid, isSolid = _b === void 0 ? false : _b, props = __rest(_a, ["isSolid"]);
    return (<SvgIcon {...props} ref={ref}>
      {isSolid ? (<React.Fragment>
...
//# sourceMappingURL=iconLightning.jsx.map