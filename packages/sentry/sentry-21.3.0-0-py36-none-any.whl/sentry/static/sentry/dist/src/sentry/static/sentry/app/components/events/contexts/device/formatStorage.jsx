...
function formatStorage(storage_size, free_storage, external_storage_size, external_free_storage) {
    ...
    var storage = "Total: " + formatBytes(storage_size);
    ...
    if (Number.isInteger(external_storage_size) &&
        ...
        storage = storage + " (External Total: " + formatBytes(external_storage_size) + " / Free: " + formatBytes(external_free_storage) + ")";
    }
    return storage;
}
export default formatStorage;
//# sourceMappingURL=formatStorage.jsx.map