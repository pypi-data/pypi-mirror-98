...
export var COLORS = (_a = {},
    ...
    _a[NOT_INSTALLED] = 'gray300',
    _a[PENDING] = 'orange300',
    _a[LEARN_MORE] = 'gray300',
    _a);
/**
...
export var documentIntegrationList = [
    ...
    },
    {
        ...
        description: 'Notify Sentry of any Bitbucket Pipelines builds to automatically manage releases and quickly surface any errors associated with a given build.\n\n**Requirement:** Bitbucket source code integration must be installed for the release pipe to work.',
        features: [
            {
                featureGate: 'release-management',
                description: 'Notify Sentry of new releases being deployed.',
