...
export var route = '/settings/account/notifications/';
export var fields = {
    subscribeByDefault: {
        ...
        help: t('Enable this to receive notifications for Alerts sent to your teams. You will always receive alerts configured to be sent directly to you.'),
    },
