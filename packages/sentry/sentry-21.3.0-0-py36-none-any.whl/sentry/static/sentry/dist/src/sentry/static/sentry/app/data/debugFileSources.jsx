export var DEBUG_SOURCE_LAYOUTS = {
...
export var DEBUG_SOURCE_CASINGS = {
    default: 'Default (mixed case)',
    uppercase: 'Uppercase',
    lowercase: 'Lowercase',
};
export var AWS_REGIONS = [
...
export function getDebugSourceName(type) {
    var _a;
    return (_a = DEBUG_SOURCE_TYPES[type]) !== null && _a !== void 0 ? _a : 'Unknown';
}
//# sourceMappingURL=debugFileSources.jsx.map