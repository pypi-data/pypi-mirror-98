...
import { BooleanField, EmailField, RadioBooleanField, TextField, } from 'app/components/forms';
...
var definitions = [
    ...
    },
    {
        ...
        defaultValue: function () { return ConfigStore.get('user').email; },
    },
    {
...
var definitionsMap = keyBy(definitions, function (def) { return def.key; });
var disabledReasons = {
...
export function getOptionField(option, field) {
    var meta = __assign(__assign({}, getOption(option)), field);
    var Field = meta.component || TextField;
...
export function getForm(fieldMap) {
    var e_1, _a, e_2, _b;
    var sets = [];
    try {
        for (var sections_1 = __values(sections), sections_1_1 = sections_1.next(); !sections_1_1.done; sections_1_1 = sections_1.next()) {
            ...
            var set = [];
            try {
                for (var _c = (e_2 = void 0, __values(optionsForSection(section))), _d = _c.next(); !_d.done; _d = _c.next()) {
                    var option = _d.value;
