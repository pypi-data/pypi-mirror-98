...
var IconBusinessComponent = function IconBusinessComponent(_a) {
    ...
    return (<SvgIcon {...props} ref={forwardRef}>
      ...
      <rect fill={gradient ? 'url(#icon-power-features-gradient)' : 'currentColor'} mask="url(#icon-power-features-mask)" height="100%" width="100%"/>

      {withShine && (<g mask="url(#icon-power-features-mask)">
          <ShineRect fill="url(#icon-power-features-shine" height="100%" width="100%"/>
        </g>)}
    </SvgIcon>);
};
var IconBusiness = React.forwardRef(function (props, ref) { return (<IconBusinessComponent {...props} forwardRef={ref}/>); });
IconBusiness.displayName = 'IconBusiness';
var shine = keyframes(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  0% {\n    transform: translateX(-100%);\n  }\n  94% {\n    transform: translateX(-100%);\n  }\n  100% {\n    transform: translateX(100%);\n  }\n"], ["\n  0% {\n    transform: translateX(-100%);\n  }\n  94% {\n    transform: translateX(-100%);\n  }\n  100% {\n    transform: translateX(100%);\n  }\n"])));
var ShineRect = styled('rect')(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  transform: translateX(-100%);\n  animation: ", " 8s ease-in-out infinite;\n"], ["\n  transform: translateX(-100%);\n  animation: ", " 8s ease-in-out infinite;\n"])), shine);
export { IconBusiness };
var templateObject_1, templateObject_2;
//# sourceMappingURL=iconBusiness.jsx.map