 ...
 * value will fall in.
 */
export function findNearestBucketIndex(chartData, xAxis) {
    var width = getBucketWidth(chartData);
 ...
 */
export function asPixelRect(chartRef, dataRect) {
    var point1 = chartRef.convertToPixel({ xAxisIndex: 0, yAxisIndex: 0 }, [
        dataRect.point1.x,
        dataRect.point1.y,
    ]);
    ...
    var point2 = chartRef.convertToPixel({ xAxisIndex: 0, yAxisIndex: 0 }, [
        dataRect.point2.x,
        dataRect.point2.y,
    ]);
 ...
 */
export function mapPoint(point, srcRect, destRect) {
    ...
    var xPercentage = (point.x - srcRect.point1.x) / (srcRect.point2.x - srcRect.point1.x);
    var yPercentage = (point.y - srcRect.point1.y) / (srcRect.point2.y - srcRect.point1.y);
    return {
