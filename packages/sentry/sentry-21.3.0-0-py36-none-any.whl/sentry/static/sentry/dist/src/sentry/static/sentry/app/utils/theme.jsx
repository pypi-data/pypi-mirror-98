 ...
 */
var backgroundSecondary = '#FAF9FB';
var aliases = {
    /**
     * Primary text color
     */
...
var generateAlertTheme = function (alias) { return ({
    muted: {
...
var generateBadgeTheme = function (alias) { return ({
    default: {
...
var generateButtonTheme = function (alias) { return ({
    borderRadius: '3px',
    default: {
...
var commonTheme = __assign(__assign({ breakpoints: ['800px', '992px', '1200px', '1440px', '2560px'] }, colors), { iconSizes: iconSizes, iconDirections: {
        up: '0',
        right: '90',
        down: '180',
        left: '270',
    ...
    zIndex: {
        ...
        hovercard: 10002,
        tooltip: 10003,
    }, grid: 8, borderRadius: '4px', borderRadiusBottom: '0 0 4px 4px', borderRadiusTop: '4px 4px 0 0', headerSelectorRowHeight: 44, headerSelectorLabelHeight: 28, dropShadowLightest: '0 1px 2px rgba(0, 0, 0, 0.04)', dropShadowLight: '0 2px 0 rgba(37, 11, 54, 0.04)', dropShadowHeavy: '0 1px 4px 1px rgba(47,40,55,0.08), 0 4px 16px 0 rgba(47,40,55,0.12)', 
    // Relative font sizes
...
var darkAliases = __assign(__assign({}, aliases), { bodyBackground: colors.black, headerBackground: colors.gray500, background: colors.black, backgroundSecondary: colors.gray500, border: colors.gray400, innerBorder: colors.gray500, textColor: colors.white, subText: colors.gray200, linkColor: colors.blue200, linkHoverColor: colors.blue300, disabled: colors.gray400, active: colors.pink300, focus: colors.gray500, inactive: colors.gray200, error: colors.red300, success: colors.green300, primaryButtonBorder: colors.purple200, primaryButtonBorderActive: colors.purple200, secondaryButtonText: colors.purple200, secondaryButtonBorder: colors.purple200, sidebarGradient: 'linear-gradient(6.01deg, #0A090F -8.44%, #1B0921 85.02%)', formPlaceholder: colors.gray400, formText: colors.white, formInputBorder: colors.gray400, rowBackground: colors.gray500, chartLineColor: colors.gray500, chartLabel: colors.gray400, progressBar: colors.purple200, progressBackground: colors.gray400, badgeBackground: colors.gray400, alertBackgroundAlpha: 0.1 });
export var lightTheme = __assign(__assign(__assign({}, commonTheme), aliases), { alert: generateAlertTheme(aliases), badge: generateBadgeTheme(aliases), button: generateButtonTheme(aliases) });
export var darkTheme = __assign(__assign(__assign({}, commonTheme), darkAliases), { alert: generateAlertTheme(darkAliases), badge: generateBadgeTheme(darkAliases), button: generateButtonTheme(darkAliases) });
