...
export var route = '/settings/:orgId/projects/:projectId/alerts/';
...
export var fields = {
    subjectTemplate: {
        ...
        help: t('The email subject to use (excluding the prefix) for individual alerts. Usable variables include: $title, $shortID, $projectID, $orgID, and ${tag:key}, such as ${tag:environment} or ${tag:release}.'),
    },
    digestsMinDelay: {
