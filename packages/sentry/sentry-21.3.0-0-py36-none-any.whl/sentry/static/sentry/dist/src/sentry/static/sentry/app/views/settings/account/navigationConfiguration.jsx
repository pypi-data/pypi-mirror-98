            ...
            items: [
                {
                    ...
                    description: t('Change your account details and preferences (e.g. timezone/clock, avatar, language)'),
                },
                {
                ...
                },
                {
                    ...
                    description: t('Add or remove secondary emails, change your primary email, verify your emails'),
                },
                {
                    path: pathPrefix + "/subscriptions/",
                    title: t('Subscriptions'),
                    description: t('Change Sentry marketing subscriptions you are subscribed to (GDPR)'),
                },
                {
                    path: pathPrefix + "/authorizations/",
                    title: t('Authorized Applications'),
                    description: t('Manage third-party applications that have access to your Sentry account'),
                },
                {
                    path: pathPrefix + "/identities/",
                    title: t('Identities'),
                    description: t('Manage your third-party identities that are associated to Sentry'),
                },
                {
        ...
        },
        {
            ...
            items: __spread([
                ...
                },
                {
                    ...
                    title: t('Auth Tokens'),
                    description: t("Authentication tokens allow you to perform actions against the Sentry API on behalf of your account. They're the easiest way to get started using the API."),
                }
            ], HookStore.get('settings:api-navigation-config').flatMap(function (cb) {
