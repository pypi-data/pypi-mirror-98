...
function getDeviceKnownDataDetails(event, data, type) {
    switch (type) {
        ...
        case DeviceKnownDataType.MODEL:
            return {
                subject: t('Model'),
                value: typeof data.model === 'string' ? (<DeviceName value={data.model + " " + ((data === null || data === void 0 ? void 0 : data.model_id) ? "(" + data.model_id + ")" : '')}/>) : undefined,
            };
        ...
        case DeviceKnownDataType.EXTERNAL_STORAGE_SIZE: {
            return {
                ...
                value: data.external_storage_size ? (<FileSize bytes={data.external_storage_size}/>) : undefined,
            };
        }
        case DeviceKnownDataType.EXTERNAL_FREE_STORAGE: {
            return {
                subject: t('External Free Storage'),
                value: data.external_free_storage ? (<FileSize bytes={data.external_free_storage}/>) : undefined,
            };
        }
