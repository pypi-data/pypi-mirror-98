...
export var route = '/settings/:orgId/security-and-privacy/';
export default [
    {
        ...
        fields: [
            {
                ...
                confirm: {
                    true: t('This will remove all members without two-factor authentication' +
                    ...
                    false: t('Are you sure you want to allow users to access your organization without having two-factor authentication enabled?'),
                },
            },
            {
            ...
            },
            {
                ...
                confirm: {
                    false: t('Disabling this can have privacy implications for ALL projects, are you sure you want to continue?'),
                },
            },
            {
                ...
                type: 'boolean',
                confirm: {
                    false: t("Are you sure you want to disable sourcecode fetching for JavaScript events? This will affect Sentry's ability to aggregate issues if you're not already uploading sourcemaps as artifacts."),
                },
            ...
            },
            {
                ...
                help: t('Store native crash reports such as Minidumps for improved processing and download in issue details'),
                visible: function (_a) {
                ...
                choices: function () {
                    return getStoreCrashReportsValues(SettingScope.Organization).map(function (value) { return [
                        value,
            ...
            },
            {
                ...
                confirm: {
                    true: t('Are you sure you want to allow users to request to join your organization?'),
                },
                visible: function (_a) {
    ...
    },
    {
        ...
        fields: [
            ...
            },
            {
                ...
                help: t('Additional field names to match against when scrubbing data for all projects. Separate multiple entries with a newline.'),
                extraHelp: t('Note: These fields will be used in addition to project specific fields.'),
