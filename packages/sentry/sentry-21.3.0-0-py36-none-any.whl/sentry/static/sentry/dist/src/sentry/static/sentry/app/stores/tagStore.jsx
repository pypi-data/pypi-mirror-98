...
var tagStoreConfig = {
    ...
    onLoadTagsSuccess: function (data) {
        var newTags = data.reduce(function (acc, tag) {
            acc[tag.key] = __assign({ values: [] }, tag);
            return acc;
        }, {});
        this.state = __assign(__assign({}, this.state), newTags);
        this.trigger(this.state);
    },
};
var TagStore = Reflux.createStore(tagStoreConfig);
