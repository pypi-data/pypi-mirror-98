    ...
    """
{
    ...
    "package_data": {
        "cloudcomponents.cdk_cloudfront_authorization._jsii": [
            "cdk-cloudfront-authorization@1.31.1.jsii.tgz"
        ],
        "cloudcomponents.cdk_cloudfront_authorization": [
            "py.typed"
        ]
    ...
    "python_requires": ">=3.6",
    "install_requires": [
        "aws-cdk.aws-certificatemanager>=1.94.1, <2.0.0",
        "aws-cdk.aws-cloudfront-origins>=1.94.1, <2.0.0",
        "aws-cdk.aws-cloudfront>=1.94.1, <2.0.0",
        "aws-cdk.aws-cognito>=1.94.1, <2.0.0",
        ...
        "cloudcomponents.cdk-lambda-at-edge-pattern>=1.30.1, <2.0.0",
