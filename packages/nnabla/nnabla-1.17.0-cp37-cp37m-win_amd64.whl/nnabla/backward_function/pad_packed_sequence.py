...
class PadPackedSequenceBackward(BackwardFunction):

    @property
    def name(self):
        return 'PadPackedSequenceBackward'
    ...
    def backward_impl(self, inputs, outputs, prop_down, accum):
        ...
        raise NotImplementedError(
            "The backward method of PadPackedSequenceBackward class is not implemented.")
