...
class PackPaddedSequenceBackward(BackwardFunction):

    @property
    def name(self):
        return 'PackPaddedSequenceBackward'
    ...
    def backward_impl(self, inputs, outputs, prop_down, accum):
        ...
        raise NotImplementedError(
            "The backward method of PackPaddedSequenceBackward class is not implemented.")
