...
class WeightNormalizationBackward(BackwardFunction):

    @property
    def name(self):
        return 'WeightNormalizationBackward'
    ...
    def backward_impl(self, inputs, outputs, prop_down, accum):
        ...
        raise NotImplementedError(
            "The backward method of WeightNormalizationBackward class is not implemented.")
