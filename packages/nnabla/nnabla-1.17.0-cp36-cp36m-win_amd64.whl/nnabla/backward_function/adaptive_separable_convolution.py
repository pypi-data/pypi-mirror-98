...
class AdaptiveSeparableConvolutionBackward(BackwardFunction):

    @property
    def name(self):
        return 'AdaptiveSeparableConvolutionBackward'
    ...
    def backward_impl(self, inputs, outputs, prop_down, accum):
        ...
        raise NotImplementedError(
            "The backward method of AdaptiveSeparableConvolutionBackward class is not implemented.")
