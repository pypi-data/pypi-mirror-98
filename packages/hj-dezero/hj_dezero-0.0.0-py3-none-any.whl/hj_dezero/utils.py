...
import numpy as np
from hj_dezero import as_variable
from hj_dezero import Variable
...
def plot_dot_graph(output, verbose=True, to_file='graph.png'):
    ...
    tmp_dir = os.path.join(os.path.expanduser('~'), '.hj_dezero')
...
def reshape_sum_backward(gy, x_shape, axis, keepdims):
    """Reshape gradient appropriately for hj_dezero.functions.sum's backward.
...
cache_dir = os.path.join(os.path.expanduser('~'), '.hj_dezero')
