import numpy as np
from hj_dezero import Layer
import hj_dezero.functions as F
import hj_dezero.layers as L
from hj_dezero import utils
...
# =============================================================================
class VGG16(Model):
    WEIGHTS_PATH = 'https://github.com/koki0702/hj_dezero-models/releases/download/v0.1/vgg16.npz'
...
# =============================================================================
class ResNet(Model):
    WEIGHTS_PATH = 'https://github.com/koki0702/hj_dezero-models/releases/download/v0.1/resnet{}.npz'
