import numpy as np
from hj_dezero import cuda
from hj_dezero.core import Function, as_variable
from hj_dezero.utils import pair, get_conv_outsize, get_deconv_outsize
from hj_dezero.functions import linear, broadcast_to
...
def im2col(x, kernel_size, stride=1, pad=0, to_matrix=True):
    ...
    Args:
        x (`hj_dezero.Variable` or `ndarray`): Input variable of shape
            `(N, C, H, W)`
    ...
    Returns:
        `hj_dezero.Variable`: Output variable. If the `to_matrix` is False, the
