import numpy as np
import hj_dezero
from hj_dezero import cuda, utils
from hj_dezero.core import Function, Variable, as_variable, as_array
...
class GetItemGrad(Function):
    ...
    def forward(self, gy):
        xp = hj_dezero.cuda.get_array_module(gy)
...
class BroadcastTo(Function):
    ...
    def forward(self, x):
        self.x_shape = x.shape
        xp = hj_dezero.cuda.get_array_module(x)
...
# =============================================================================
from hj_dezero.functions_conv import conv2d
from hj_dezero.functions_conv import deconv2d
from hj_dezero.functions_conv import conv2d_simple
from hj_dezero.functions_conv import im2col
from hj_dezero.functions_conv import col2im
from hj_dezero.functions_conv import pooling_simple
from hj_dezero.functions_conv import pooling
from hj_dezero.functions_conv import average_pooling
from hj_dezero.core import add
from hj_dezero.core import sub
from hj_dezero.core import rsub
from hj_dezero.core import mul
from hj_dezero.core import div
from hj_dezero.core import neg
from hj_dezero.core import pow