...
from mastapy.math_utility.optimisation import _1319, _1317
...
class ParetoOptimistaionVariable(_1317.ParetoOptimisationVariableBase):
    '''ParetoOptimistaionVariable
    ...
    @property
    def property_target_for_dominant_candidate_search(self) -> '_1319.PropertyTargetForDominantCandidateSearch':
        ...
        return constructor.new(_1319.PropertyTargetForDominantCandidateSearch)(value) if value else None

    @property_target_for_dominant_candidate_search.setter
    def property_target_for_dominant_candidate_search(self, value: '_1319.PropertyTargetForDominantCandidateSearch'):
