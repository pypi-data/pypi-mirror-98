...
from mastapy.utility_gui.charts import _1574, _1575
from mastapy.bearings.bearing_results import (
    _1647, _1648, _1651, _1659
)
...
from mastapy.system_model.analyses_and_results.modal_analyses.reporting import _4892, _4896
...
class DynamicCustomReportItem(_1505.CustomReportNameableItem):
    ...
    @property
    def inner_item_of_type_custom_line_chart(self) -> '_1574.CustomLineChart':
        ...
        if _1574.CustomLineChart.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_custom_table_and_chart(self) -> '_1575.CustomTableAndChart':
        ...
        if _1575.CustomTableAndChart.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_loaded_ball_element_chart_reporter(self) -> '_1647.LoadedBallElementChartReporter':
        ...
        if _1647.LoadedBallElementChartReporter.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_loaded_bearing_chart_reporter(self) -> '_1648.LoadedBearingChartReporter':
        ...
        if _1648.LoadedBearingChartReporter.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_loaded_bearing_temperature_chart(self) -> '_1651.LoadedBearingTemperatureChart':
        ...
        if _1651.LoadedBearingTemperatureChart.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_loaded_roller_element_chart_reporter(self) -> '_1659.LoadedRollerElementChartReporter':
        ...
        if _1659.LoadedRollerElementChartReporter.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_shaft_system_deflection_sections_report(self) -> '_2514.ShaftSystemDeflectionSectionsReport':
        ...
        if _2514.ShaftSystemDeflectionSectionsReport.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_parametric_study_histogram(self) -> '_4047.ParametricStudyHistogram':
        ...
        if _4047.ParametricStudyHistogram.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_campbell_diagram_report(self) -> '_4892.CampbellDiagramReport':
        ...
        if _4892.CampbellDiagramReport.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
    ...
    @property
    def inner_item_of_type_per_mode_results_report(self) -> '_4896.PerModeResultsReport':
        ...
        if _4896.PerModeResultsReport.TYPE not in self.wrapped.InnerItem.__class__.__mro__:
