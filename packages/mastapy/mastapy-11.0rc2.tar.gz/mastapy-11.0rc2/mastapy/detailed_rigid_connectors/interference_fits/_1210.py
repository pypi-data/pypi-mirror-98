...
from mastapy.bearings.tolerances import _1625, _1611, _1617
...
class InterferenceFitHalfDesign(_1152.DetailedRigidConnectorHalfDesign):
    ...
    @property
    def tolerance(self) -> '_1625.SupportTolerance':
        ...
        if _1625.SupportTolerance.TYPE not in self.wrapped.Tolerance.__class__.__mro__:
    ...
    @property
    def tolerance_of_type_inner_support_tolerance(self) -> '_1611.InnerSupportTolerance':
        ...
        if _1611.InnerSupportTolerance.TYPE not in self.wrapped.Tolerance.__class__.__mro__:
    ...
    @property
    def tolerance_of_type_outer_support_tolerance(self) -> '_1617.OuterSupportTolerance':
        ...
        if _1617.OuterSupportTolerance.TYPE not in self.wrapped.Tolerance.__class__.__mro__:
