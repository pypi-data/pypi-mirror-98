...
from mastapy.system_model.fe import _2040
from mastapy.bearings.bearing_results.rolling import _1675
from mastapy.system_model.part_model.configurations import _2288, _2286, _2289
...
from mastapy.bearings.bearing_designs.rolling import _1852
...
class Design(_0.APIBase):
    ...
    @property
    def thermal_expansion_for_grounded_nodes(self) -> '_1906.ThermalExpansionOptionForGroundedNodes':
        ...
        return constructor.new(_1906.ThermalExpansionOptionForGroundedNodes)(value) if value else None

    @thermal_expansion_for_grounded_nodes.setter
    def thermal_expansion_for_grounded_nodes(self, value: '_1906.ThermalExpansionOptionForGroundedNodes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def default_system_temperatures(self) -> '_1907.TransmissionTemperatureSet':
        ...
        return constructor.new(_1907.TransmissionTemperatureSet)(self.wrapped.DefaultSystemTemperatures) if self.wrapped.DefaultSystemTemperatures else None
    ...
    @property
    def selected_gear_set_selection_group(self) -> '_2186.ActiveGearSetDesignSelectionGroup':
        ...
        return constructor.new(_2186.ActiveGearSetDesignSelectionGroup)(self.wrapped.SelectedGearSetSelectionGroup) if self.wrapped.SelectedGearSetSelectionGroup else None

    @property
    def system(self) -> '_1905.SystemReporting':
        ...
        return constructor.new(_1905.SystemReporting)(self.wrapped.System) if self.wrapped.System else None

    @property
    def fe_batch_operations(self) -> '_2040.BatchOperations':
        ...
        return constructor.new(_2040.BatchOperations)(self.wrapped.FEBatchOperations) if self.wrapped.FEBatchOperations else None

    @property
    def iso14179_settings_per_bearing_type(self) -> 'List[_1675.ISO14179SettingsPerBearingType]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ISO14179SettingsPerBearingType, constructor.new(_1675.ISO14179SettingsPerBearingType))
        return value

    @property
    def gear_set_configurations(self) -> 'List[_2186.ActiveGearSetDesignSelectionGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSetConfigurations, constructor.new(_2186.ActiveGearSetDesignSelectionGroup))
        return value

    @property
    def shaft_detail_configurations(self) -> 'List[_2288.ActiveShaftDesignSelectionGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftDetailConfigurations, constructor.new(_2288.ActiveShaftDesignSelectionGroup))
        return value

    @property
    def fe_substructure_configurations(self) -> 'List[_2286.ActiveFESubstructureSelectionGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FESubstructureConfigurations, constructor.new(_2286.ActiveFESubstructureSelectionGroup))
        return value

    @property
    def bearing_detail_configurations(self) -> 'List[_2289.BearingDetailConfiguration]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BearingDetailConfigurations, constructor.new(_2289.BearingDetailConfiguration))
        return value

    @property
    def design_states(self) -> 'List[_5318.DesignState]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignStates, constructor.new(_5318.DesignState))
        return value

    @property
    def static_loads(self) -> 'List[_6597.StaticLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StaticLoads, constructor.new(_6597.StaticLoadCase))
        return value

    @property
    def duty_cycles(self) -> 'List[_5319.DutyCycle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DutyCycles, constructor.new(_5319.DutyCycle))
        return value

    @property
    def root_assembly(self) -> '_2150.RootAssembly':
        ...
        return constructor.new(_2150.RootAssembly)(self.wrapped.RootAssembly) if self.wrapped.RootAssembly else None

    @property
    def gear_set_config(self) -> '_2207.GearSetConfiguration':
        '''GearSetConfiguration: 'GearSetConfig' is the original name of this property.'''

        return constructor.new(_2207.GearSetConfiguration)(self.wrapped.GearSetConfig) if self.wrapped.GearSetConfig else None

    @gear_set_config.setter
    def gear_set_config(self, value: '_2207.GearSetConfiguration'):
    ...
    @property
    def databases(self) -> '_1943.Databases':
        ...
        return constructor.new(_1943.Databases)(self.wrapped.Databases) if self.wrapped.Databases else None

    @property
    def masta_settings(self) -> '_1887.MastaSettings':
        ...
        return constructor.new(_1887.MastaSettings)(self.wrapped.MastaSettings) if self.wrapped.MastaSettings else None
    ...
    def new_belt_creation_options(self, centre_distance: Optional['float'] = 0.1, pulley_a_diameter: Optional['float'] = 0.08, pulley_b_diameter: Optional['float'] = 0.08, name: Optional['str'] = 'Belt Drive') -> '_2245.BeltCreationOptions':
    ...
    def new_planet_carrier_creation_options(self, number_of_planets: Optional['int'] = 3, diameter: Optional['float'] = 0.05) -> '_2248.PlanetCarrierCreationOptions':
    ...
    def new_shaft_creation_options(self, length: Optional['float'] = 0.1, outer_diameter: Optional['float'] = 0.025, bore: Optional['float'] = 0.0, name: Optional['str'] = 'Shaft') -> '_2249.ShaftCreationOptions':
    ...
    def new_cylindrical_gear_linear_train_creation_options(self, number_of_gears: Optional['int'] = 3, name: Optional['str'] = 'Gear Train') -> '_2247.CylindricalGearLinearTrainCreationOptions':
    ...
    def new_cycloidal_assembly_creation_options(self, number_of_discs: Optional['int'] = 1, number_of_pins: Optional['int'] = 10, name: Optional['str'] = 'Cycloidal Assembly') -> '_2246.CycloidalAssemblyCreationOptions':
    ...
    def design_state_named(self, name: 'str') -> '_5318.DesignState':
    ...
    def duty_cycle_named(self, name: 'str') -> '_5319.DutyCycle':
    ...
    def save_with_progess(self, file_name: 'str', save_results: 'bool', progress: '_7195.TaskProgress') -> '_1524.Status':
        ''' 'Save' is the original name of this method.
    ...
    def remove_synchroniser_shift(self, shift: '_2647.SynchroniserShift'):
    ...
    def add_synchroniser_shift(self, name: 'str') -> '_2647.SynchroniserShift':
    ...
    def add_synchroniser_shift_empty(self) -> '_2647.SynchroniserShift':
        ''' 'AddSynchroniserShift' is the original name of this method.
    ...
    def add_design_state(self, name: Optional['str'] = 'New Design State') -> '_5318.DesignState':
    ...
    def add_duty_cycle(self, name: Optional['str'] = 'New Duty Cycle') -> '_5319.DutyCycle':
    ...
    def all_parts_of_type_assembly(self) -> 'List[_2111.Assembly]':
        ''' 'AllParts' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.AllParts[_2111.Assembly.TYPE](), constructor.new(_2111.Assembly))
    ...
    def remove_bearing_from_database(self, rolling_bearing: '_1852.RollingBearing'):
