...
from mastapy.system_model.part_model.gears import _2200, _2216, _2199
from mastapy._internal.cast_exception import CastException
from mastapy.math_utility.measured_ranges import _1329
...
class CylindricalGearMesh(_1992.GearMesh):
    '''CylindricalGearMesh
    ...
    @property
    def cylindrical_gear_set(self) -> '_2200.CylindricalGearSet':
        ...
        if _2200.CylindricalGearSet.TYPE not in self.wrapped.CylindricalGearSet.__class__.__mro__:
    ...
    @property
    def centre_distance_range(self) -> '_1329.ShortLengthRange':
        ...
        return constructor.new(_1329.ShortLengthRange)(self.wrapped.CentreDistanceRange) if self.wrapped.CentreDistanceRange else None
