...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5593, _5673
...
class HarmonicAnalysisViewable(_1926.DynamicAnalysisViewable):
    '''HarmonicAnalysisViewable
    ...
    @property
    def dynamic_analysis_draw_style(self) -> '_5967.DynamicAnalysisDrawStyle':
        ...
        if _5967.DynamicAnalysisDrawStyle.TYPE not in self.wrapped.DynamicAnalysisDrawStyle.__class__.__mro__:
    ...
    @property
    def dynamic_analysis_draw_style_of_type_modal_analysis_draw_style(self) -> '_4830.ModalAnalysisDrawStyle':
        ...
        if _4830.ModalAnalysisDrawStyle.TYPE not in self.wrapped.DynamicAnalysisDrawStyle.__class__.__mro__:
    ...
    @property
    def dynamic_analysis_draw_style_of_type_harmonic_analysis_draw_style(self) -> '_5673.HarmonicAnalysisDrawStyle':
        ...
        if _5673.HarmonicAnalysisDrawStyle.TYPE not in self.wrapped.DynamicAnalysisDrawStyle.__class__.__mro__:
