...
from mastapy.system_model.analyses_and_results.harmonic_analyses.results import _5758, _5759
...
class ModalContributionViewOptions(_0.APIBase):
    ...
    @property
    def modes_to_display(self) -> '_5758.ModalContributionDisplayMethod':
        ...
        return constructor.new(_5758.ModalContributionDisplayMethod)(value) if value else None

    @modes_to_display.setter
    def modes_to_display(self, value: '_5758.ModalContributionDisplayMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ModesToDisplay = value

    @property
    def filtering_method(self) -> '_5759.ModalContributionFilteringMethod':
        ...
        return constructor.new(_5759.ModalContributionFilteringMethod)(value) if value else None

    @filtering_method.setter
    def filtering_method(self, value: '_5759.ModalContributionFilteringMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
