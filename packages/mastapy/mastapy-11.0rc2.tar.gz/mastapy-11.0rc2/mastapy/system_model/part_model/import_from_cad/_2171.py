...
from mastapy.system_model.part_model.import_from_cad import _2177, _2178
...
class ConnectorFromCAD(_2178.MountableComponentFromCAD):
    '''ConnectorFromCAD
    ...
    @property
    def mounting(self) -> '_2177.HousedOrMounted':
        '''HousedOrMounted: 'Mounting' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.Mounting)
        return constructor.new(_2177.HousedOrMounted)(value) if value else None

    @mounting.setter
    def mounting(self, value: '_2177.HousedOrMounted'):
