...
from mastapy.system_model.connections_and_sockets import (
    _1949, _1970, _1951, _1975
)
from mastapy.system_model.part_model import _2122, _2144
...
class Component(_2144.Part):
    ...
    @property
    def two_d_drawing_full_model(self) -> '_7200.SMTBitmap':
        ...
        return constructor.new(_7200.SMTBitmap)(self.wrapped.TwoDDrawingFullModel) if self.wrapped.TwoDDrawingFullModel else None
    ...
    @property
    def component_connections(self) -> 'List[_1949.ComponentConnection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentConnections, constructor.new(_1949.ComponentConnection))
        return value
    ...
    def set_position_and_axis_of_component_and_connected_components(self, origin: 'Vector3D', z_axis: 'Vector3D') -> '_1970.RealignmentResult':
    ...
    def set_position_and_rotation_of_component_and_connected_components(self, new_coordinate_system: '_1261.CoordinateSystem3D') -> '_1970.RealignmentResult':
    ...
    def set_position_of_component_and_connected_components(self, position: 'Vector3D') -> '_1970.RealignmentResult':
    ...
    def diameter_at_middle_of_connection(self, connection: '_1951.Connection') -> 'float':
    ...
    def diameter_of_socket_for(self, connection: '_1951.Connection') -> 'float':
    ...
    def possible_sockets_to_connect_with(self, socket: '_1975.Socket') -> 'List[_1975.Socket]':
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.PossibleSocketsToConnectWith.Overloads[_SOCKET](socket.wrapped if socket else None), constructor.new(_1975.Socket))

    def connect_to_socket(self, socket: '_1975.Socket') -> '_2122.ComponentsConnectedResult':
    ...
    def possible_sockets_to_connect_with_component(self, component: 'Component') -> 'List[_1975.Socket]':
        ''' 'PossibleSocketsToConnectWith' is the original name of this method.
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.PossibleSocketsToConnectWith.Overloads[_COMPONENT](component.wrapped if component else None), constructor.new(_1975.Socket))

    def try_connect_to(self, component: 'Component', hint_offset: Optional['float'] = float('nan')) -> '_2122.ComponentsConnectedResult':
    ...
    def connect_to(self, component: 'Component') -> '_2122.ComponentsConnectedResult':
        ''' 'ConnectTo' is the original name of this method.
    ...
    def can_delete_connection(self, connection: '_1951.Connection') -> 'bool':
    ...
    def socket_named(self, socket_name: 'str') -> '_1975.Socket':
