...
from mastapy.system_model.part_model.gears import _2197, _2206
...
class ConicalGearSet(_2206.GearSet):
    '''ConicalGearSet
    ...
    @property
    def conical_gears(self) -> 'List[_2197.ConicalGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConicalGears, constructor.new(_2197.ConicalGear))
        return value
