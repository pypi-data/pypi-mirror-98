...
from mastapy.system_model.part_model.gears import _2193, _2194
from mastapy.system_model.connections_and_sockets.gears import _1982
...
class BevelDifferentialGearSet(_2194.BevelGearSet):
    '''BevelDifferentialGearSet
    ...
    @property
    def bevel_gears(self) -> 'List[_2193.BevelGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelGears, constructor.new(_2193.BevelGear))
        return value

    @property
    def bevel_meshes(self) -> 'List[_1982.BevelGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BevelMeshes, constructor.new(_1982.BevelGearMesh))
        return value
