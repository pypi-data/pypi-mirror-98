...
class FlexiblePinAssembly(_2152.SpecialisedAssembly):
    '''FlexiblePinAssembly
    ...
    @property
    def planet_gear(self) -> '_2199.CylindricalGear':
        ...
        if _2199.CylindricalGear.TYPE not in self.wrapped.PlanetGear.__class__.__mro__:
