...
from mastapy.system_model.part_model.couplings import _2282, _2284, _2257
...
class TorqueConverter(_2257.Coupling):
    '''TorqueConverter
    ...
    @property
    def pump(self) -> '_2282.TorqueConverterPump':
        ...
        return constructor.new(_2282.TorqueConverterPump)(self.wrapped.Pump) if self.wrapped.Pump else None

    @property
    def turbine(self) -> '_2284.TorqueConverterTurbine':
        ...
        return constructor.new(_2284.TorqueConverterTurbine)(self.wrapped.Turbine) if self.wrapped.Turbine else None
