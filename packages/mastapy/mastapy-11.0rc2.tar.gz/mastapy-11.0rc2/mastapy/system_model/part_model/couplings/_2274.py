...
class SpringDamper(_2257.Coupling):
    '''SpringDamper
    ...
    @property
    def connection(self) -> '_2029.SpringDamperConnection':
        ...
        return constructor.new(_2029.SpringDamperConnection)(self.wrapped.Connection) if self.wrapped.Connection else None
