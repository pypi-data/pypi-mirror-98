...
class PartToPartShearCoupling(_2257.Coupling):
    '''PartToPartShearCoupling
    ...
    @property
    def part_to_part_shear_coupling_connection(self) -> '_2027.PartToPartShearCouplingConnection':
        ...
        return constructor.new(_2027.PartToPartShearCouplingConnection)(self.wrapped.PartToPartShearCouplingConnection) if self.wrapped.PartToPartShearCouplingConnection else None
