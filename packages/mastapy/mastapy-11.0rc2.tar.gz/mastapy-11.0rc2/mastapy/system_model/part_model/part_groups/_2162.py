...
from mastapy.system_model.part_model.part_groups import _2163, _2161
...
class ConcentricPartGroup(_2161.ConcentricOrParallelPartGroup):
    '''ConcentricPartGroup
    ...
    @property
    def parallel_groups(self) -> 'List[_2163.ConcentricPartGroupParallelToThis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ParallelGroups, constructor.new(_2163.ConcentricPartGroupParallelToThis))
        return value
