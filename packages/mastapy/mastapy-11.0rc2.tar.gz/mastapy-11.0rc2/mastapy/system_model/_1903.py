...
T = TypeVar('T', bound='_2121.Component')
...
class RelativeComponentAlignment(_0.APIBase, Generic[T]):
    ...
    @property
    def axial_offset(self) -> '_1904.RelativeOffsetOption':
        ...
        return constructor.new(_1904.RelativeOffsetOption)(value) if value else None

    @axial_offset.setter
    def axial_offset(self, value: '_1904.RelativeOffsetOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
