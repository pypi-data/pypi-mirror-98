...
class FELink(_0.APIBase):
    ...
    def socket(self) -> '_1975.Socket':
        ...
        if _1975.Socket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_bearing_inner_socket(self) -> '_1945.BearingInnerSocket':
        ...
        if _1945.BearingInnerSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_bearing_outer_socket(self) -> '_1946.BearingOuterSocket':
        ...
        if _1946.BearingOuterSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_cvt_pulley_socket(self) -> '_1953.CVTPulleySocket':
        ...
        if _1953.CVTPulleySocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
            raise CastException('Failed to cast socket to CVTPulleySocket. Expected: {}.'.format(self.wrapped.Socket.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Socket.__class__)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_cylindrical_socket(self) -> '_1955.CylindricalSocket':
        ...
        if _1955.CylindricalSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_electric_machine_stator_socket(self) -> '_1957.ElectricMachineStatorSocket':
        ...
        if _1957.ElectricMachineStatorSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_inner_shaft_socket(self) -> '_1958.InnerShaftSocket':
        ...
        if _1958.InnerShaftSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
            raise CastException('Failed to cast socket to InnerShaftSocket. Expected: {}.'.format(self.wrapped.Socket.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Socket.__class__)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_inner_shaft_socket_base(self) -> '_1959.InnerShaftSocketBase':
        ...
        if _1959.InnerShaftSocketBase.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_mountable_component_inner_socket(self) -> '_1961.MountableComponentInnerSocket':
        ...
        if _1961.MountableComponentInnerSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_mountable_component_outer_socket(self) -> '_1962.MountableComponentOuterSocket':
        ...
        if _1962.MountableComponentOuterSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_mountable_component_socket(self) -> '_1963.MountableComponentSocket':
        ...
        if _1963.MountableComponentSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_outer_shaft_socket(self) -> '_1964.OuterShaftSocket':
        ...
        if _1964.OuterShaftSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
            raise CastException('Failed to cast socket to OuterShaftSocket. Expected: {}.'.format(self.wrapped.Socket.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Socket.__class__)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_outer_shaft_socket_base(self) -> '_1965.OuterShaftSocketBase':
        ...
        if _1965.OuterShaftSocketBase.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_planetary_socket(self) -> '_1967.PlanetarySocket':
        ...
        if _1967.PlanetarySocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
            raise CastException('Failed to cast socket to PlanetarySocket. Expected: {}.'.format(self.wrapped.Socket.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Socket.__class__)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_planetary_socket_base(self) -> '_1968.PlanetarySocketBase':
        ...
        if _1968.PlanetarySocketBase.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_pulley_socket(self) -> '_1969.PulleySocket':
        ...
        if _1969.PulleySocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
            raise CastException('Failed to cast socket to PulleySocket. Expected: {}.'.format(self.wrapped.Socket.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Socket.__class__)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_rolling_ring_socket(self) -> '_1972.RollingRingSocket':
        ...
        if _1972.RollingRingSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_shaft_socket(self) -> '_1973.ShaftSocket':
        ...
        if _1973.ShaftSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
            raise CastException('Failed to cast socket to ShaftSocket. Expected: {}.'.format(self.wrapped.Socket.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Socket.__class__)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_agma_gleason_conical_gear_teeth_socket(self) -> '_1979.AGMAGleasonConicalGearTeethSocket':
        ...
        if _1979.AGMAGleasonConicalGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_bevel_differential_gear_teeth_socket(self) -> '_1981.BevelDifferentialGearTeethSocket':
        ...
        if _1981.BevelDifferentialGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_bevel_gear_teeth_socket(self) -> '_1983.BevelGearTeethSocket':
        ...
        if _1983.BevelGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_concept_gear_teeth_socket(self) -> '_1985.ConceptGearTeethSocket':
        ...
        if _1985.ConceptGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_conical_gear_teeth_socket(self) -> '_1987.ConicalGearTeethSocket':
        ...
        if _1987.ConicalGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_cylindrical_gear_teeth_socket(self) -> '_1989.CylindricalGearTeethSocket':
        ...
        if _1989.CylindricalGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_face_gear_teeth_socket(self) -> '_1991.FaceGearTeethSocket':
        ...
        if _1991.FaceGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_gear_teeth_socket(self) -> '_1993.GearTeethSocket':
        ...
        if _1993.GearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
            raise CastException('Failed to cast socket to GearTeethSocket. Expected: {}.'.format(self.wrapped.Socket.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Socket.__class__)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_hypoid_gear_teeth_socket(self) -> '_1995.HypoidGearTeethSocket':
        ...
        if _1995.HypoidGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_klingelnberg_conical_gear_teeth_socket(self) -> '_1996.KlingelnbergConicalGearTeethSocket':
        ...
        if _1996.KlingelnbergConicalGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_klingelnberg_hypoid_gear_teeth_socket(self) -> '_2000.KlingelnbergHypoidGearTeethSocket':
        ...
        if _2000.KlingelnbergHypoidGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_klingelnberg_spiral_bevel_gear_teeth_socket(self) -> '_2001.KlingelnbergSpiralBevelGearTeethSocket':
        ...
        if _2001.KlingelnbergSpiralBevelGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_spiral_bevel_gear_teeth_socket(self) -> '_2003.SpiralBevelGearTeethSocket':
        ...
        if _2003.SpiralBevelGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_straight_bevel_diff_gear_teeth_socket(self) -> '_2005.StraightBevelDiffGearTeethSocket':
        ...
        if _2005.StraightBevelDiffGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_straight_bevel_gear_teeth_socket(self) -> '_2007.StraightBevelGearTeethSocket':
        ...
        if _2007.StraightBevelGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_worm_gear_teeth_socket(self) -> '_2009.WormGearTeethSocket':
        ...
        if _2009.WormGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_zerol_bevel_gear_teeth_socket(self) -> '_2011.ZerolBevelGearTeethSocket':
        ...
        if _2011.ZerolBevelGearTeethSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_cycloidal_disc_axial_left_socket(self) -> '_2012.CycloidalDiscAxialLeftSocket':
        ...
        if _2012.CycloidalDiscAxialLeftSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_cycloidal_disc_axial_right_socket(self) -> '_2013.CycloidalDiscAxialRightSocket':
        ...
        if _2013.CycloidalDiscAxialRightSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_cycloidal_disc_inner_socket(self) -> '_2015.CycloidalDiscInnerSocket':
        ...
        if _2015.CycloidalDiscInnerSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_cycloidal_disc_outer_socket(self) -> '_2016.CycloidalDiscOuterSocket':
        ...
        if _2016.CycloidalDiscOuterSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_cycloidal_disc_planetary_bearing_socket(self) -> '_2018.CycloidalDiscPlanetaryBearingSocket':
        ...
        if _2018.CycloidalDiscPlanetaryBearingSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_ring_pins_socket(self) -> '_2019.RingPinsSocket':
        ...
        if _2019.RingPinsSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
            raise CastException('Failed to cast socket to RingPinsSocket. Expected: {}.'.format(self.wrapped.Socket.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Socket.__class__)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_clutch_socket(self) -> '_2022.ClutchSocket':
        ...
        if _2022.ClutchSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
            raise CastException('Failed to cast socket to ClutchSocket. Expected: {}.'.format(self.wrapped.Socket.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Socket.__class__)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_concept_coupling_socket(self) -> '_2024.ConceptCouplingSocket':
        ...
        if _2024.ConceptCouplingSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_coupling_socket(self) -> '_2026.CouplingSocket':
        ...
        if _2026.CouplingSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
            raise CastException('Failed to cast socket to CouplingSocket. Expected: {}.'.format(self.wrapped.Socket.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Socket.__class__)(self.wrapped.Socket) if self.wrapped.Socket else None

    @property
    def socket_of_type_part_to_part_shear_coupling_socket(self) -> '_2028.PartToPartShearCouplingSocket':
        ...
        if _2028.PartToPartShearCouplingSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_spring_damper_socket(self) -> '_2030.SpringDamperSocket':
        ...
        if _2030.SpringDamperSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_torque_converter_pump_socket(self) -> '_2032.TorqueConverterPumpSocket':
        ...
        if _2032.TorqueConverterPumpSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def socket_of_type_torque_converter_turbine_socket(self) -> '_2033.TorqueConverterTurbineSocket':
        ...
        if _2033.TorqueConverterTurbineSocket.TYPE not in self.wrapped.Socket.__class__.__mro__:
    ...
    @property
    def alignment_in_world_coordinate_system(self) -> '_2073.LinkComponentAxialPositionErrorReporter':
        ...
        return constructor.new(_2073.LinkComponentAxialPositionErrorReporter)(self.wrapped.AlignmentInWorldCoordinateSystem) if self.wrapped.AlignmentInWorldCoordinateSystem else None

    @property
    def alignment_in_fe_coordinate_system(self) -> '_2073.LinkComponentAxialPositionErrorReporter':
        ...
        return constructor.new(_2073.LinkComponentAxialPositionErrorReporter)(self.wrapped.AlignmentInFECoordinateSystem) if self.wrapped.AlignmentInFECoordinateSystem else None

    @property
    def alignment_in_component_coordinate_system(self) -> '_2073.LinkComponentAxialPositionErrorReporter':
        ...
        return constructor.new(_2073.LinkComponentAxialPositionErrorReporter)(self.wrapped.AlignmentInComponentCoordinateSystem) if self.wrapped.AlignmentInComponentCoordinateSystem else None

    @property
    def nodes(self) -> 'List[_2063.FESubstructureNode]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Nodes, constructor.new(_2063.FESubstructureNode))
        return value
    ...
    def add_or_replace_node(self, node: '_2063.FESubstructureNode'):
    ...
    def nodes_grouped_by_angle(self) -> 'OrderedDict[float, List[_2063.FESubstructureNode]]':
        ...
        return conversion.pn_to_mp_objects_in_list_in_ordered_dict(self.wrapped.NodesGroupedByAngle(), constructor.new(_2063.FESubstructureNode))
