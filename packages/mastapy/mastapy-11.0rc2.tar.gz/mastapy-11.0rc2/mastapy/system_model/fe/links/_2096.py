...
class FELinkWithSelection(_0.APIBase):
    ...
    def link(self) -> '_2094.FELink':
        ...
        if _2094.FELink.TYPE not in self.wrapped.Link.__class__.__mro__:
    ...
    @property
    def link_of_type_electric_machine_stator_fe_link(self) -> '_2095.ElectricMachineStatorFELink':
        ...
        if _2095.ElectricMachineStatorFELink.TYPE not in self.wrapped.Link.__class__.__mro__:
    ...
    @property
    def link_of_type_gear_mesh_fe_link(self) -> '_2097.GearMeshFELink':
        ...
        if _2097.GearMeshFELink.TYPE not in self.wrapped.Link.__class__.__mro__:
            raise CastException('Failed to cast link to GearMeshFELink. Expected: {}.'.format(self.wrapped.Link.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Link.__class__)(self.wrapped.Link) if self.wrapped.Link else None

    @property
    def link_of_type_gear_with_duplicated_meshes_fe_link(self) -> '_2098.GearWithDuplicatedMeshesFELink':
        ...
        if _2098.GearWithDuplicatedMeshesFELink.TYPE not in self.wrapped.Link.__class__.__mro__:
    ...
    @property
    def link_of_type_multi_angle_connection_fe_link(self) -> '_2099.MultiAngleConnectionFELink':
        ...
        if _2099.MultiAngleConnectionFELink.TYPE not in self.wrapped.Link.__class__.__mro__:
    ...
    @property
    def link_of_type_multi_node_connector_fe_link(self) -> '_2100.MultiNodeConnectorFELink':
        ...
        if _2100.MultiNodeConnectorFELink.TYPE not in self.wrapped.Link.__class__.__mro__:
    ...
    @property
    def link_of_type_multi_node_fe_link(self) -> '_2101.MultiNodeFELink':
        ...
        if _2101.MultiNodeFELink.TYPE not in self.wrapped.Link.__class__.__mro__:
            raise CastException('Failed to cast link to MultiNodeFELink. Expected: {}.'.format(self.wrapped.Link.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Link.__class__)(self.wrapped.Link) if self.wrapped.Link else None

    @property
    def link_of_type_planetary_connector_multi_node_fe_link(self) -> '_2102.PlanetaryConnectorMultiNodeFELink':
        ...
        if _2102.PlanetaryConnectorMultiNodeFELink.TYPE not in self.wrapped.Link.__class__.__mro__:
    ...
    @property
    def link_of_type_planet_based_fe_link(self) -> '_2103.PlanetBasedFELink':
        ...
        if _2103.PlanetBasedFELink.TYPE not in self.wrapped.Link.__class__.__mro__:
            raise CastException('Failed to cast link to PlanetBasedFELink. Expected: {}.'.format(self.wrapped.Link.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Link.__class__)(self.wrapped.Link) if self.wrapped.Link else None

    @property
    def link_of_type_planet_carrier_fe_link(self) -> '_2104.PlanetCarrierFELink':
        ...
        if _2104.PlanetCarrierFELink.TYPE not in self.wrapped.Link.__class__.__mro__:
            raise CastException('Failed to cast link to PlanetCarrierFELink. Expected: {}.'.format(self.wrapped.Link.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Link.__class__)(self.wrapped.Link) if self.wrapped.Link else None

    @property
    def link_of_type_point_load_fe_link(self) -> '_2105.PointLoadFELink':
        ...
        if _2105.PointLoadFELink.TYPE not in self.wrapped.Link.__class__.__mro__:
            raise CastException('Failed to cast link to PointLoadFELink. Expected: {}.'.format(self.wrapped.Link.__class__.__qualname__))

        return constructor.new_override(self.wrapped.Link.__class__)(self.wrapped.Link) if self.wrapped.Link else None

    @property
    def link_of_type_rolling_ring_connection_fe_link(self) -> '_2106.RollingRingConnectionFELink':
        ...
        if _2106.RollingRingConnectionFELink.TYPE not in self.wrapped.Link.__class__.__mro__:
    ...
    @property
    def link_of_type_shaft_hub_connection_fe_link(self) -> '_2107.ShaftHubConnectionFELink':
        ...
        if _2107.ShaftHubConnectionFELink.TYPE not in self.wrapped.Link.__class__.__mro__:
    ...
    @property
    def link_of_type_single_node_fe_link(self) -> '_2108.SingleNodeFELink':
        ...
        if _2108.SingleNodeFELink.TYPE not in self.wrapped.Link.__class__.__mro__:
