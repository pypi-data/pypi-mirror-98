...
from mastapy.system_model.fe import _2044
...
class BearingRaceNodeLink(_0.APIBase):
    ...
    @property
    def race_position(self) -> '_2044.BearingRacePosition':
        ...
        return constructor.new(_2044.BearingRacePosition)(value) if value else None
