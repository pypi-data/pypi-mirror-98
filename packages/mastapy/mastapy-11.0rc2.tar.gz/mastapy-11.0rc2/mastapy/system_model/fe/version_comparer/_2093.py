...
from mastapy.math_utility.measured_vectors import _1326, _1328
...
class NodeComparisonResult(_0.APIBase):
    ...
    @property
    def original_result(self) -> '_1326.NodeResults':
        ...
        return constructor.new(_1326.NodeResults)(self.wrapped.OriginalResult) if self.wrapped.OriginalResult else None

    @property
    def new_result(self) -> '_1326.NodeResults':
        ...
        return constructor.new(_1326.NodeResults)(self.wrapped.NewResult) if self.wrapped.NewResult else None

    @property
    def displacement_change(self) -> '_1328.VectorWithLinearAndAngularComponents':
        ...
        return constructor.new(_1328.VectorWithLinearAndAngularComponents)(self.wrapped.DisplacementChange) if self.wrapped.DisplacementChange else None
