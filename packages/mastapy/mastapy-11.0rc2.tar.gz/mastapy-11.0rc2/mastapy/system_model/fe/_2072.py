...
class IndependentMastaCreatedCondensationNode(_0.APIBase):
    ...
    @property
    def fe_substructure_node(self) -> '_2063.FESubstructureNode':
        ...
        return constructor.new(_2063.FESubstructureNode)(self.wrapped.FESubstructureNode) if self.wrapped.FESubstructureNode else None
