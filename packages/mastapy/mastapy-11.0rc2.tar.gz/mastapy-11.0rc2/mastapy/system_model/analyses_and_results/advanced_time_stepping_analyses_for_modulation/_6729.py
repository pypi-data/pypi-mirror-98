...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5771
...
class PartAdvancedTimeSteppingAnalysisForModulation(_7186.PartStaticLoadAnalysisCase):
    '''PartAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def results(self) -> '_5771.HarmonicAnalysisResultsPropertyAccessor':
        ...
        return constructor.new(_5771.HarmonicAnalysisResultsPropertyAccessor)(self.wrapped.Results) if self.wrapped.Results else None
