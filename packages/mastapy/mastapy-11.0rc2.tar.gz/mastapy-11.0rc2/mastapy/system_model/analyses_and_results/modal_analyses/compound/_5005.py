...
class SpringDamperCompoundModalAnalysis(_4940.CouplingCompoundModalAnalysis):
    '''SpringDamperCompoundModalAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4861.SpringDamperModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4861.SpringDamperModalAnalysis))
        return value

    @property
    def assembly_modal_analysis_load_cases(self) -> 'List[_4861.SpringDamperModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyModalAnalysisLoadCases, constructor.new(_4861.SpringDamperModalAnalysis))
        return value
