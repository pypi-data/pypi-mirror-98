...
from mastapy.system_model.analyses_and_results.modal_analyses import _4799, _4798, _4812
...
class CylindricalGearSetModalAnalysis(_4812.GearSetModalAnalysis):
    '''CylindricalGearSetModalAnalysis
    ...
    @property
    def cylindrical_gears_modal_analysis(self) -> 'List[_4799.CylindricalGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsModalAnalysis, constructor.new(_4799.CylindricalGearModalAnalysis))
        return value

    @property
    def cylindrical_meshes_modal_analysis(self) -> 'List[_4798.CylindricalGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesModalAnalysis, constructor.new(_4798.CylindricalGearMeshModalAnalysis))
        return value
