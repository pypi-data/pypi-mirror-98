...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _5018
...
class SynchroniserHalfCompoundModalAnalysis(_5018.SynchroniserPartCompoundModalAnalysis):
    '''SynchroniserHalfCompoundModalAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4870.SynchroniserHalfModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4870.SynchroniserHalfModalAnalysis))
        return value

    @property
    def component_modal_analysis_load_cases(self) -> 'List[_4870.SynchroniserHalfModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentModalAnalysisLoadCases, constructor.new(_4870.SynchroniserHalfModalAnalysis))
        return value
