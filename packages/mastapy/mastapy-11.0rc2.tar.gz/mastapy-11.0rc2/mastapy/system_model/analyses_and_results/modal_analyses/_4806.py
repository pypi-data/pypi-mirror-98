...
from mastapy.system_model.analyses_and_results.modal_analyses import _4805, _4804, _4812
...
class FaceGearSetModalAnalysis(_4812.GearSetModalAnalysis):
    '''FaceGearSetModalAnalysis
    ...
    @property
    def face_gears_modal_analysis(self) -> 'List[_4805.FaceGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsModalAnalysis, constructor.new(_4805.FaceGearModalAnalysis))
        return value

    @property
    def face_meshes_modal_analysis(self) -> 'List[_4804.FaceGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesModalAnalysis, constructor.new(_4804.FaceGearMeshModalAnalysis))
        return value
