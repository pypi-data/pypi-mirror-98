...
from mastapy.system_model.analyses_and_results.modal_analyses import (
    _4787, _4881, _4880, _4834,
    _4882
)
from mastapy.system_model.analyses_and_results.harmonic_analyses.results import (
    _5751, _5754, _5762, _5763
)
from mastapy.system_model.drawing.options import _1942, _1940
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5664, _5718
...
class WhineWaterfallSettings(_0.APIBase):
    ...
    @property
    def coordinate_system(self) -> '_4787.CoordinateSystemForWhine':
        ...
        return constructor.new(_4787.CoordinateSystemForWhine)(value) if value else None

    @coordinate_system.setter
    def coordinate_system(self, value: '_4787.CoordinateSystemForWhine'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def connected_component_type(self) -> '_5751.ConnectedComponentType':
        ...
        return constructor.new(_5751.ConnectedComponentType)(value) if value else None

    @connected_component_type.setter
    def connected_component_type(self, value: '_5751.ConnectedComponentType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ConnectedComponentType = value

    @property
    def whine_waterfall_export_option(self) -> '_4881.WhineWaterfallExportOption':
        ...
        return constructor.new(_4881.WhineWaterfallExportOption)(value) if value else None

    @whine_waterfall_export_option.setter
    def whine_waterfall_export_option(self, value: '_4881.WhineWaterfallExportOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def selected_excitations(self) -> '_5754.ExcitationSourceSelectionGroup':
        ...
        return constructor.new(_5754.ExcitationSourceSelectionGroup)(self.wrapped.SelectedExcitations) if self.wrapped.SelectedExcitations else None

    @property
    def waterfall_chart_settings(self) -> '_4880.WaterfallChartSettings':
        ...
        return constructor.new(_4880.WaterfallChartSettings)(self.wrapped.WaterfallChartSettings) if self.wrapped.WaterfallChartSettings else None

    @property
    def order_cuts_chart_settings(self) -> '_4834.OrderCutsChartSettings':
        ...
        return constructor.new(_4834.OrderCutsChartSettings)(self.wrapped.OrderCutsChartSettings) if self.wrapped.OrderCutsChartSettings else None

    @property
    def modal_contribution_view_options(self) -> '_1942.ModalContributionViewOptions':
        ...
        return constructor.new(_1942.ModalContributionViewOptions)(self.wrapped.ModalContributionViewOptions) if self.wrapped.ModalContributionViewOptions else None

    @property
    def mode_view_options(self) -> '_1940.AdvancedTimeSteppingAnalysisForModulationModeViewOptions':
        ...
        return constructor.new(_1940.AdvancedTimeSteppingAnalysisForModulationModeViewOptions)(self.wrapped.ModeViewOptions) if self.wrapped.ModeViewOptions else None

    @property
    def frequency_options(self) -> '_5664.FrequencyOptionsForHarmonicAnalysisResults':
        ...
        return constructor.new(_5664.FrequencyOptionsForHarmonicAnalysisResults)(self.wrapped.FrequencyOptions) if self.wrapped.FrequencyOptions else None

    @property
    def reference_speed_options(self) -> '_5718.SpeedOptionsForHarmonicAnalysisResults':
        ...
        return constructor.new(_5718.SpeedOptionsForHarmonicAnalysisResults)(self.wrapped.ReferenceSpeedOptions) if self.wrapped.ReferenceSpeedOptions else None

    @property
    def very_short_length_reference_values(self) -> '_4882.WhineWaterfallReferenceValues[_1417.LengthVeryShort]':
        ...
        return constructor.new(_4882.WhineWaterfallReferenceValues)[_1417.LengthVeryShort](self.wrapped.VeryShortLengthReferenceValues) if self.wrapped.VeryShortLengthReferenceValues else None

    @property
    def small_angle_reference_values(self) -> '_4882.WhineWaterfallReferenceValues[_1370.AngleSmall]':
        ...
        return constructor.new(_4882.WhineWaterfallReferenceValues)[_1370.AngleSmall](self.wrapped.SmallAngleReferenceValues) if self.wrapped.SmallAngleReferenceValues else None

    @property
    def small_velocity_reference_values(self) -> '_4882.WhineWaterfallReferenceValues[_1469.VelocitySmall]':
        ...
        return constructor.new(_4882.WhineWaterfallReferenceValues)[_1469.VelocitySmall](self.wrapped.SmallVelocityReferenceValues) if self.wrapped.SmallVelocityReferenceValues else None

    @property
    def angular_velocity_reference_values(self) -> '_4882.WhineWaterfallReferenceValues[_1376.AngularVelocity]':
        ...
        return constructor.new(_4882.WhineWaterfallReferenceValues)[_1376.AngularVelocity](self.wrapped.AngularVelocityReferenceValues) if self.wrapped.AngularVelocityReferenceValues else None

    @property
    def acceleration_reference_values(self) -> '_4882.WhineWaterfallReferenceValues[_1367.Acceleration]':
        ...
        return constructor.new(_4882.WhineWaterfallReferenceValues)[_1367.Acceleration](self.wrapped.AccelerationReferenceValues) if self.wrapped.AccelerationReferenceValues else None

    @property
    def angular_acceleration_reference_values(self) -> '_4882.WhineWaterfallReferenceValues[_1372.AngularAcceleration]':
        ...
        return constructor.new(_4882.WhineWaterfallReferenceValues)[_1372.AngularAcceleration](self.wrapped.AngularAccelerationReferenceValues) if self.wrapped.AngularAccelerationReferenceValues else None

    @property
    def force_reference_values(self) -> '_4882.WhineWaterfallReferenceValues[_1391.Force]':
        ...
        return constructor.new(_4882.WhineWaterfallReferenceValues)[_1391.Force](self.wrapped.ForceReferenceValues) if self.wrapped.ForceReferenceValues else None

    @property
    def torque_reference_values(self) -> '_4882.WhineWaterfallReferenceValues[_1464.Torque]':
        ...
        return constructor.new(_4882.WhineWaterfallReferenceValues)[_1464.Torque](self.wrapped.TorqueReferenceValues) if self.wrapped.TorqueReferenceValues else None

    @property
    def energy_reference_values(self) -> '_4882.WhineWaterfallReferenceValues[_1385.Energy]':
        ...
        return constructor.new(_4882.WhineWaterfallReferenceValues)[_1385.Energy](self.wrapped.EnergyReferenceValues) if self.wrapped.EnergyReferenceValues else None

    @property
    def power_small_reference_values(self) -> '_4882.WhineWaterfallReferenceValues[_1435.PowerSmall]':
        ...
        return constructor.new(_4882.WhineWaterfallReferenceValues)[_1435.PowerSmall](self.wrapped.PowerSmallReferenceValues) if self.wrapped.PowerSmallReferenceValues else None

    @property
    def power_small_per_unit_area_reference_values(self) -> '_4882.WhineWaterfallReferenceValues[_1436.PowerSmallPerArea]':
        ...
        return constructor.new(_4882.WhineWaterfallReferenceValues)[_1436.PowerSmallPerArea](self.wrapped.PowerSmallPerUnitAreaReferenceValues) if self.wrapped.PowerSmallPerUnitAreaReferenceValues else None

    @property
    def pressure_reference_values(self) -> '_4882.WhineWaterfallReferenceValues[_1439.Pressure]':
        ...
        return constructor.new(_4882.WhineWaterfallReferenceValues)[_1439.Pressure](self.wrapped.PressureReferenceValues) if self.wrapped.PressureReferenceValues else None

    @property
    def result_location_selection_groups(self) -> '_5762.ResultLocationSelectionGroups':
        ...
        return constructor.new(_5762.ResultLocationSelectionGroups)(self.wrapped.ResultLocationSelectionGroups) if self.wrapped.ResultLocationSelectionGroups else None

    @property
    def active_result_locations(self) -> 'List[_5763.ResultNodeSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ActiveResultLocations, constructor.new(_5763.ResultNodeSelection))
        return value
