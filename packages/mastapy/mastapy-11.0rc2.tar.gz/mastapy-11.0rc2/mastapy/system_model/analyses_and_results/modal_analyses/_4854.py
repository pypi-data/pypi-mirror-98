...
class ShaftToMountableComponentConnectionModalAnalysis(_4753.AbstractShaftToMountableComponentConnectionModalAnalysis):
    '''ShaftToMountableComponentConnectionModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2470.ShaftToMountableComponentConnectionSystemDeflection':
