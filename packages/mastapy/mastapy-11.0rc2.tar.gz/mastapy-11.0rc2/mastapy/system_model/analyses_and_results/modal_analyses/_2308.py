...
from mastapy.system_model.analyses_and_results.modal_analyses import _4831, _4829
...
class ModalAnalysis(_7188.StaticLoadAnalysisCase):
    '''ModalAnalysis
    ...
    @property
    def modal_analysis_results(self) -> '_2300.DynamicAnalysis':
        ...
        if _2300.DynamicAnalysis.TYPE not in self.wrapped.ModalAnalysisResults.__class__.__mro__:
    ...
    @property
    def analysis_settings(self) -> '_4831.ModalAnalysisOptions':
        ...
        return constructor.new(_4831.ModalAnalysisOptions)(self.wrapped.AnalysisSettings) if self.wrapped.AnalysisSettings else None

    @property
    def bar_model_export(self) -> '_4829.ModalAnalysisBarModelFEExportOptions':
        ...
        return constructor.new(_4829.ModalAnalysisBarModelFEExportOptions)(self.wrapped.BarModelExport) if self.wrapped.BarModelExport else None
