...
class FlexiblePinAnalysisManufactureLevel(_5907.FlexiblePinAnalysis):
    '''FlexiblePinAnalysisManufactureLevel
    ...
    @property
    def planetary_mesh_analysis(self) -> '_4004.CylindricalGearMeshParametricStudyTool':
        ...
        return constructor.new(_4004.CylindricalGearMeshParametricStudyTool)(self.wrapped.PlanetaryMeshAnalysis) if self.wrapped.PlanetaryMeshAnalysis else None
