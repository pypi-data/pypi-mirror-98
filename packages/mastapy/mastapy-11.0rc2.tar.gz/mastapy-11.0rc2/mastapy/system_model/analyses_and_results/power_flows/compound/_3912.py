...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3877
...
class PlanetaryGearSetCompoundPowerFlow(_3877.CylindricalGearSetCompoundPowerFlow):
    '''PlanetaryGearSetCompoundPowerFlow
