...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3844
...
class StraightBevelDiffGearCompoundPowerFlow(_3844.BevelGearCompoundPowerFlow):
    '''StraightBevelDiffGearCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3804.StraightBevelDiffGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3804.StraightBevelDiffGearPowerFlow))
        return value

    @property
    def component_power_flow_load_cases(self) -> 'List[_3804.StraightBevelDiffGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentPowerFlowLoadCases, constructor.new(_3804.StraightBevelDiffGearPowerFlow))
        return value
