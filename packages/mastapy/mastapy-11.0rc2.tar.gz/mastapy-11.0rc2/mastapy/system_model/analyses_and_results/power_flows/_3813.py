...
from mastapy.system_model.analyses_and_results.power_flows import _3811, _3796
...
class SynchroniserPowerFlow(_3796.SpecialisedAssemblyPowerFlow):
    '''SynchroniserPowerFlow
    ...
    @property
    def cones(self) -> 'List[_3811.SynchroniserHalfPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Cones, constructor.new(_3811.SynchroniserHalfPowerFlow))
        return value
