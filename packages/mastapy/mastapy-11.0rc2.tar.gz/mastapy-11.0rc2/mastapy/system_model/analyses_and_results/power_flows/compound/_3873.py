...
class CycloidalDiscCompoundPowerFlow(_3829.AbstractShaftCompoundPowerFlow):
    '''CycloidalDiscCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3741.CycloidalDiscPowerFlow]':
        '''List[CycloidalDiscPowerFlow]: 'LoadCaseAnalysesReady' is the original name of this property.

        Note:
            This property is readonly.
        '''

        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3741.CycloidalDiscPowerFlow))
        return value

    @property
    def component_power_flow_load_cases(self) -> 'List[_3741.CycloidalDiscPowerFlow]':
        '''List[CycloidalDiscPowerFlow]: 'ComponentPowerFlowLoadCases' is the original name of this property.

        Note:
            This property is readonly.
        '''

        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentPowerFlowLoadCases, constructor.new(_3741.CycloidalDiscPowerFlow))
        return value
