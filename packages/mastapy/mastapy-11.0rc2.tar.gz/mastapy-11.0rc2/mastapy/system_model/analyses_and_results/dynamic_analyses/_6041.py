...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6039, _6040, _5976
...
class WormGearSetDynamicAnalysis(_5976.GearSetDynamicAnalysis):
    '''WormGearSetDynamicAnalysis
    ...
    @property
    def worm_gears_dynamic_analysis(self) -> 'List[_6039.WormGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsDynamicAnalysis, constructor.new(_6039.WormGearDynamicAnalysis))
        return value

    @property
    def worm_meshes_dynamic_analysis(self) -> 'List[_6040.WormGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesDynamicAnalysis, constructor.new(_6040.WormGearMeshDynamicAnalysis))
        return value
