...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _5944, _5945, _5976
...
class ConceptGearSetDynamicAnalysis(_5976.GearSetDynamicAnalysis):
    '''ConceptGearSetDynamicAnalysis
    ...
    @property
    def concept_gears_dynamic_analysis(self) -> 'List[_5944.ConceptGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsDynamicAnalysis, constructor.new(_5944.ConceptGearDynamicAnalysis))
        return value

    @property
    def concept_meshes_dynamic_analysis(self) -> 'List[_5945.ConceptGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesDynamicAnalysis, constructor.new(_5945.ConceptGearMeshDynamicAnalysis))
        return value
