...
class RingPinsCompoundDynamicAnalysis(_6122.MountableComponentCompoundDynamicAnalysis):
    '''RingPinsCompoundDynamicAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_6005.RingPinsDynamicAnalysis]':
        '''List[RingPinsDynamicAnalysis]: 'LoadCaseAnalysesReady' is the original name of this property.

        Note:
            This property is readonly.
        '''

        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_6005.RingPinsDynamicAnalysis))
        return value

    @property
    def component_dynamic_analysis_load_cases(self) -> 'List[_6005.RingPinsDynamicAnalysis]':
        '''List[RingPinsDynamicAnalysis]: 'ComponentDynamicAnalysisLoadCases' is the original name of this property.

        Note:
            This property is readonly.
        '''

        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentDynamicAnalysisLoadCases, constructor.new(_6005.RingPinsDynamicAnalysis))
        return value
