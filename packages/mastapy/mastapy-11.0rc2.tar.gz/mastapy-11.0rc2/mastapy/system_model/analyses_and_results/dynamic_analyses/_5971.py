...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _5969, _5970, _5976
...
class FaceGearSetDynamicAnalysis(_5976.GearSetDynamicAnalysis):
    '''FaceGearSetDynamicAnalysis
    ...
    @property
    def face_gears_dynamic_analysis(self) -> 'List[_5969.FaceGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsDynamicAnalysis, constructor.new(_5969.FaceGearDynamicAnalysis))
        return value

    @property
    def face_meshes_dynamic_analysis(self) -> 'List[_5970.FaceGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesDynamicAnalysis, constructor.new(_5970.FaceGearMeshDynamicAnalysis))
        return value
