...
class WormGearHarmonicAnalysis(_5665.GearHarmonicAnalysis):
    '''WormGearHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2503.WormGearSystemDeflection':
        ...
        return constructor.new(_2503.WormGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
