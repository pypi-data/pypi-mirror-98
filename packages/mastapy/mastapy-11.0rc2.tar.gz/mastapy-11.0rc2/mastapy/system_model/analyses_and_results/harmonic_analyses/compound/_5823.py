...
class CycloidalDiscPlanetaryBearingConnectionCompoundHarmonicAnalysis(_5780.AbstractShaftToMountableComponentConnectionCompoundHarmonicAnalysis):
    '''CycloidalDiscPlanetaryBearingConnectionCompoundHarmonicAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5640.CycloidalDiscPlanetaryBearingConnectionHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5640.CycloidalDiscPlanetaryBearingConnectionHarmonicAnalysis))
        return value

    @property
    def connection_harmonic_analysis_load_cases(self) -> 'List[_5640.CycloidalDiscPlanetaryBearingConnectionHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionHarmonicAnalysisLoadCases, constructor.new(_5640.CycloidalDiscPlanetaryBearingConnectionHarmonicAnalysis))
        return value
