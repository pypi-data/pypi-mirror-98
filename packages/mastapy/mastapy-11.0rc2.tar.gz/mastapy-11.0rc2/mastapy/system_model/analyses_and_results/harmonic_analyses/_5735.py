...
from mastapy.system_model.analyses_and_results.system_deflections import _2487, _2486, _2488
...
class SynchroniserPartHarmonicAnalysis(_5632.CouplingHalfHarmonicAnalysis):
    '''SynchroniserPartHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2487.SynchroniserPartSystemDeflection':
