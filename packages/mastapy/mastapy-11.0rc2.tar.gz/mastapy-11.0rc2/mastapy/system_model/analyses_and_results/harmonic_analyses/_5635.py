...
class CVTHarmonicAnalysis(_5603.BeltDriveHarmonicAnalysis):
    '''CVTHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2401.CVTSystemDeflection':
        ...
        return constructor.new(_2401.CVTSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
