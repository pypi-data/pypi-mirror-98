...
class HarmonicAnalysis(_7175.CompoundAnalysisCase):
    '''HarmonicAnalysis
    ...
    @property
    def harmonic_analyses_of_single_excitations(self) -> 'List[_5395.HarmonicAnalysisOfSingleExcitation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HarmonicAnalysesOfSingleExcitations, constructor.new(_5395.HarmonicAnalysisOfSingleExcitation))
        return value
