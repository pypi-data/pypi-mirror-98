...
class CycloidalDiscHarmonicAnalysis(_5594.AbstractShaftHarmonicAnalysis):
    '''CycloidalDiscHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2405.CycloidalDiscSystemDeflection':
        ...
        return constructor.new(_2405.CycloidalDiscSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
