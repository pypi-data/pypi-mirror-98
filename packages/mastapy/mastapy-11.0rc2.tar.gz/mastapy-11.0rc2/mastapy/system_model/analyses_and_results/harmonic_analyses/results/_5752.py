...
from mastapy.system_model.analyses_and_results.harmonic_analyses.results import _5757, _5753
...
class ExcitationSourceSelection(_5753.ExcitationSourceSelectionBase):
    '''ExcitationSourceSelection
    ...
    @property
    def harmonic_selections(self) -> 'List[_5757.HarmonicSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HarmonicSelections, constructor.new(_5757.HarmonicSelection))
        return value
