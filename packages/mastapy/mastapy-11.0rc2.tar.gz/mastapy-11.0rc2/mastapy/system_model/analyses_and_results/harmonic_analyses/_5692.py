...
class MassDiscHarmonicAnalysis(_5743.VirtualComponentHarmonicAnalysis):
    '''MassDiscHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2444.MassDiscSystemDeflection':
        ...
        return constructor.new(_2444.MassDiscSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
