...
class AbstractShaftOrHousingHarmonicAnalysis(_5619.ComponentHarmonicAnalysis):
    '''AbstractShaftOrHousingHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2358.AbstractShaftOrHousingSystemDeflection':
