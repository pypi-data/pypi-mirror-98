...
class ConceptGearMeshHarmonicAnalysis(_5667.GearMeshHarmonicAnalysis):
    '''ConceptGearMeshHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2387.ConceptGearMeshSystemDeflection':
        ...
        return constructor.new(_2387.ConceptGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
