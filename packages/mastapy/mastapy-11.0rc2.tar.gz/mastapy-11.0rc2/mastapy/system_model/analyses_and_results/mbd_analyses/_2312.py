...
class MultibodyDynamicsAnalysis(_7189.TimeSeriesLoadAnalysisCase):
    '''MultibodyDynamicsAnalysis
    ...
    @property
    def mbd_options(self) -> '_5117.MBDAnalysisOptions':
        ...
        return constructor.new(_5117.MBDAnalysisOptions)(self.wrapped.MBDOptions) if self.wrapped.MBDOptions else None
