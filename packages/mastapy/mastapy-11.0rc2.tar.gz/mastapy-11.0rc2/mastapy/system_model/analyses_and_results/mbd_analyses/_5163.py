...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5167, _5072
...
class TorqueConverterConnectionMultibodyDynamicsAnalysis(_5072.CouplingConnectionMultibodyDynamicsAnalysis):
    '''TorqueConverterConnectionMultibodyDynamicsAnalysis
    ...
    @property
    def locking_status(self) -> '_5167.TorqueConverterStatus':
        ...
        return constructor.new(_5167.TorqueConverterStatus)(value) if value else None
