...
class DynamicExternalInterfaceOptions(_0.APIBase):
    ...
    @property
    def input_signal_filter_level(self) -> '_5103.InputSignalFilterLevel':
        ...
        return constructor.new(_5103.InputSignalFilterLevel)(value) if value else None

    @input_signal_filter_level.setter
    def input_signal_filter_level(self, value: '_5103.InputSignalFilterLevel'):
