...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5055, _5074
...
class ClutchMultibodyDynamicsAnalysis(_5074.CouplingMultibodyDynamicsAnalysis):
    '''ClutchMultibodyDynamicsAnalysis
    ...
    @property
    def clutch_connection(self) -> '_5055.ClutchConnectionMultibodyDynamicsAnalysis':
        ...
        return constructor.new(_5055.ClutchConnectionMultibodyDynamicsAnalysis)(self.wrapped.ClutchConnection) if self.wrapped.ClutchConnection else None
