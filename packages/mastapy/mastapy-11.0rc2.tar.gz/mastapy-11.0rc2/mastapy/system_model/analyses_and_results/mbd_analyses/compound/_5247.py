...
class HypoidGearMeshCompoundMultibodyDynamicsAnalysis(_5189.AGMAGleasonConicalGearMeshCompoundMultibodyDynamicsAnalysis):
    '''HypoidGearMeshCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5098.HypoidGearMeshMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5098.HypoidGearMeshMultibodyDynamicsAnalysis))
        return value

    @property
    def connection_multibody_dynamics_analysis_load_cases(self) -> 'List[_5098.HypoidGearMeshMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionMultibodyDynamicsAnalysisLoadCases, constructor.new(_5098.HypoidGearMeshMultibodyDynamicsAnalysis))
        return value
