...
from mastapy.system_model.analyses_and_results.mbd_analyses import _2312, _5040
...
class RootAssemblyMultibodyDynamicsAnalysis(_5040.AssemblyMultibodyDynamicsAnalysis):
    '''RootAssemblyMultibodyDynamicsAnalysis
    ...
    @property
    def multibody_dynamics_analysis_inputs(self) -> '_2312.MultibodyDynamicsAnalysis':
        ...
        return constructor.new(_2312.MultibodyDynamicsAnalysis)(self.wrapped.MultibodyDynamicsAnalysisInputs) if self.wrapped.MultibodyDynamicsAnalysisInputs else None
