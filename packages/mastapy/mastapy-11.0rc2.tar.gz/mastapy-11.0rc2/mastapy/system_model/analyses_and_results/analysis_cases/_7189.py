...
class TimeSeriesLoadAnalysisCase(_7173.AnalysisCase):
    '''TimeSeriesLoadAnalysisCase
    ...
    @property
    def load_case(self) -> '_6611.TimeSeriesLoadCase':
        ...
        return constructor.new(_6611.TimeSeriesLoadCase)(self.wrapped.LoadCase) if self.wrapped.LoadCase else None
