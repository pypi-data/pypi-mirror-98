...
from mastapy.system_model.analyses_and_results.load_case_groups.design_entity_static_load_case_groups import _5328, _5329, _5332
from mastapy.system_model.part_model.gears import _2206, _2204
from mastapy.system_model.analyses_and_results.static_loads import _6525, _6527, _6530
...
TGearSet = TypeVar('TGearSet', bound='_2206.GearSet')
TGear = TypeVar('TGear', bound='_2204.Gear')
TGearStaticLoad = TypeVar('TGearStaticLoad', bound='_6525.GearLoadCase')
TGearMesh = TypeVar('TGearMesh', bound='_1992.GearMesh')
TGearMeshStaticLoad = TypeVar('TGearMeshStaticLoad', bound='_6527.GearMeshLoadCase')
TGearSetStaticLoad = TypeVar('TGearSetStaticLoad', bound='_6530.GearSetLoadCase')


class GearSetStaticLoadCaseGroup(_5332.PartStaticLoadCaseGroup, Generic[TGearSet, TGear, TGearStaticLoad, TGearMesh, TGearMeshStaticLoad, TGearSetStaticLoad]):
    '''GearSetStaticLoadCaseGroup
    ...
    @property
    def gears_load_cases(self) -> 'List[_5328.ComponentStaticLoadCaseGroup[TGear, TGearStaticLoad]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsLoadCases, constructor.new(_5328.ComponentStaticLoadCaseGroup)[TGear, TGearStaticLoad])
        return value

    @property
    def meshes_load_cases(self) -> 'List[_5329.ConnectionStaticLoadCaseGroup[TGearMesh, TGearMeshStaticLoad]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesLoadCases, constructor.new(_5329.ConnectionStaticLoadCaseGroup)[TGearMesh, TGearMeshStaticLoad])
        return value
