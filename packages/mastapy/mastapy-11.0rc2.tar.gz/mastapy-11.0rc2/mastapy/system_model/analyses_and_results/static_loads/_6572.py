...
from mastapy.system_model.analyses_and_results.static_loads import _6571, _6561
...
class PlanetCarrierLoadCase(_6561.MountableComponentLoadCase):
    '''PlanetCarrierLoadCase
    ...
    @property
    def planet_manufacture_errors(self) -> 'List[_6571.PlanetarySocketManufactureError]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetManufactureErrors, constructor.new(_6571.PlanetarySocketManufactureError))
        return value
