...
from mastapy.system_model.analyses_and_results.static_loads import _6547, _6534, _6514
...
class HarmonicLoadDataFluxImport(_6534.HarmonicLoadDataCSVImport['_6514.ElectricMachineHarmonicLoadFluxImportOptions']):
    '''HarmonicLoadDataFluxImport
    ...
    @property
    def inner_diameter_reference(self) -> '_6547.InnerDiameterReference':
        ...
        return constructor.new(_6547.InnerDiameterReference)(value) if value else None

    @inner_diameter_reference.setter
    def inner_diameter_reference(self, value: '_6547.InnerDiameterReference'):
