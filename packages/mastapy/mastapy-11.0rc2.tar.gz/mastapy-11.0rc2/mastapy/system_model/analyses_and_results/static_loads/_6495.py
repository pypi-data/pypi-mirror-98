...
from mastapy.system_model.analyses_and_results.static_loads import _6496, _6525
...
class CylindricalGearLoadCase(_6525.GearLoadCase):
    '''CylindricalGearLoadCase
    ...
    @property
    def gear_manufacture_errors(self) -> '_6496.CylindricalGearManufactureError':
        ...
        return constructor.new(_6496.CylindricalGearManufactureError)(self.wrapped.GearManufactureErrors) if self.wrapped.GearManufactureErrors else None
