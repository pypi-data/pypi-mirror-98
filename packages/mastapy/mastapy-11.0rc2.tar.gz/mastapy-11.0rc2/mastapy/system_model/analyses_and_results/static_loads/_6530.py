...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import _6651
from mastapy.system_model.analyses_and_results.static_loads import _6527, _6525, _6589
...
class GearSetLoadCase(_6589.SpecialisedAssemblyLoadCase):
    '''GearSetLoadCase
    ...
    @property
    def gear_mesh_stiffness_model(self) -> '_5094.GearMeshStiffnessModel':
        ...
        return constructor.new(_5094.GearMeshStiffnessModel)(value) if value else None

    @gear_mesh_stiffness_model.setter
    def gear_mesh_stiffness_model(self, value: '_5094.GearMeshStiffnessModel'):
    ...
    @property
    def advanced_time_stepping_analysis_for_modulation_options(self) -> '_6651.AdvancedTimeSteppingAnalysisForModulationOptions':
        ...
        return constructor.new(_6651.AdvancedTimeSteppingAnalysisForModulationOptions)(self.wrapped.AdvancedTimeSteppingAnalysisForModulationOptions) if self.wrapped.AdvancedTimeSteppingAnalysisForModulationOptions else None

    @property
    def meshes_without_planetary_duplicates(self) -> 'List[_6527.GearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesWithoutPlanetaryDuplicates, constructor.new(_6527.GearMeshLoadCase))
        return value

    @property
    def gears(self) -> 'List[_6525.GearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_6525.GearLoadCase))
        return value

    @property
    def gears_without_clones(self) -> 'List[_6525.GearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsWithoutClones, constructor.new(_6525.GearLoadCase))
        return value
