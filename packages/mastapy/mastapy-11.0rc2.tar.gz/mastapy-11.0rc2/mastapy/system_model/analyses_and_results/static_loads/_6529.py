...
from mastapy.system_model.analyses_and_results.static_loads import _6528, _6533
...
class GearSetHarmonicLoadData(_6533.HarmonicLoadDataBase):
    '''GearSetHarmonicLoadData
    ...
    @property
    def gear_mesh_te_order_type(self) -> '_6528.GearMeshTEOrderType':
        ...
        return constructor.new(_6528.GearMeshTEOrderType)(value) if value else None

    @gear_mesh_te_order_type.setter
    def gear_mesh_te_order_type(self, value: '_6528.GearMeshTEOrderType'):
