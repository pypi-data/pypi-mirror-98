...
from mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition import _6628
...
class PointLoadInputOptions(_1572.ColumnInputOptions):
    ...
    @property
    def conversion_to_load_case(self) -> '_6628.AdditionalForcesObtainedFrom':
        ...
        return constructor.new(_6628.AdditionalForcesObtainedFrom)(value) if value else None

    @conversion_to_load_case.setter
    def conversion_to_load_case(self, value: '_6628.AdditionalForcesObtainedFrom'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
