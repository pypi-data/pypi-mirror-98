...
from mastapy.system_model import _1899, _1900, _1901
from mastapy.system_model.analyses_and_results.mbd_analyses import _5171
from mastapy.system_model.analyses_and_results.static_loads import _6617, _6507, _6621
from mastapy.system_model.fe import _2052
...
class PowerLoadLoadCase(_6621.VirtualComponentLoadCase):
    '''PowerLoadLoadCase
    ...
    @property
    def drag_torque_specification_method(self) -> '_1899.PowerLoadDragTorqueSpecificationMethod':
        ...
        return constructor.new(_1899.PowerLoadDragTorqueSpecificationMethod)(value) if value else None

    @drag_torque_specification_method.setter
    def drag_torque_specification_method(self, value: '_1899.PowerLoadDragTorqueSpecificationMethod'):
    ...
    @property
    def wheel_slip_model(self) -> '_5171.WheelSlipType':
        ...
        return constructor.new(_5171.WheelSlipType)(value) if value else None

    @wheel_slip_model.setter
    def wheel_slip_model(self, value: '_5171.WheelSlipType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def target_speed_input_type(self) -> '_1901.PowerLoadPIDControlSpeedInputType':
        ...
        return constructor.new(_1901.PowerLoadPIDControlSpeedInputType)(value) if value else None

    @target_speed_input_type.setter
    def target_speed_input_type(self, value: '_1901.PowerLoadPIDControlSpeedInputType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    def get_harmonic_load_data_for_import(self) -> '_6507.ElectricMachineHarmonicLoadData':
