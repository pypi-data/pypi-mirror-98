...
class TimeSeriesLoadCase(_6440.LoadCase):
    '''TimeSeriesLoadCase
    ...
    @property
    def driva_analysis_options(self) -> '_5117.MBDAnalysisOptions':
        ...
        return constructor.new(_5117.MBDAnalysisOptions)(self.wrapped.DRIVAAnalysisOptions) if self.wrapped.DRIVAAnalysisOptions else None
