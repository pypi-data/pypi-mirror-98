...
from mastapy.system_model.analyses_and_results.static_loads import _6519, _6520, _6530
...
class FaceGearSetLoadCase(_6530.GearSetLoadCase):
    '''FaceGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6519.FaceGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_6519.FaceGearLoadCase))
        return value

    @property
    def face_gears_load_case(self) -> 'List[_6519.FaceGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsLoadCase, constructor.new(_6519.FaceGearLoadCase))
        return value

    @property
    def face_meshes_load_case(self) -> 'List[_6520.FaceGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesLoadCase, constructor.new(_6520.FaceGearMeshLoadCase))
        return value
