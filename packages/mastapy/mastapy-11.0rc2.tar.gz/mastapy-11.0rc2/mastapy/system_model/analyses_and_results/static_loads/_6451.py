...
class AllRingPinsManufacturingError(_0.APIBase):
    ...
    @property
    def all_pins_roundness_chart(self) -> '_7200.SMTBitmap':
        ...
        return constructor.new(_7200.SMTBitmap)(self.wrapped.AllPinsRoundnessChart) if self.wrapped.AllPinsRoundnessChart else None

    @property
    def roundness_specification(self) -> '_1622.RoundnessSpecification':
        ...
        return constructor.new(_1622.RoundnessSpecification)(self.wrapped.RoundnessSpecification) if self.wrapped.RoundnessSpecification else None

    @property
    def ring_pin_manufacturing_errors(self) -> 'List[_6579.RingPinManufacturingError]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RingPinManufacturingErrors, constructor.new(_6579.RingPinManufacturingError))
        return value
