...
from mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition import (
    _6631, _6642, _6633, _6630,
    _6634, _6636, _6643, _6640,
    _6632, _6635, _6629
)
...
class TimeSeriesImporter(_0.APIBase):
    ...
    @property
    def import_type(self) -> '_6545.ImportType':
        '''ImportType: 'ImportType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.ImportType)
        return constructor.new(_6545.ImportType)(value) if value else None

    @import_type.setter
    def import_type(self, value: '_6545.ImportType'):
    ...
    @property
    def time_step_input(self) -> '_6642.TimeStepInputOptions':
        ...
        return constructor.new(_6642.TimeStepInputOptions)(self.wrapped.TimeStepInput) if self.wrapped.TimeStepInput else None

    @property
    def gear_ratio_options(self) -> '_6633.GearRatioInputOptions':
        ...
        return constructor.new(_6633.GearRatioInputOptions)(self.wrapped.GearRatioOptions) if self.wrapped.GearRatioOptions else None

    @property
    def design_state_options(self) -> '_6630.DesignStateOptions':
        ...
        return constructor.new(_6630.DesignStateOptions)(self.wrapped.DesignStateOptions) if self.wrapped.DesignStateOptions else None

    @property
    def load_case_name_inputs(self) -> '_6634.LoadCaseNameOptions':
        ...
        return constructor.new(_6634.LoadCaseNameOptions)(self.wrapped.LoadCaseNameInputs) if self.wrapped.LoadCaseNameInputs else None

    @property
    def file_inputs(self) -> 'List[_6636.MultiTimeSeriesDataInputFileOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FileInputs, constructor.new(_6636.MultiTimeSeriesDataInputFileOptions))
        return value

    @property
    def torque_inputs(self) -> 'List[_6643.TorqueInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TorqueInputs, constructor.new(_6643.TorqueInputOptions))
        return value

    @property
    def speed_inputs(self) -> 'List[_6640.SpeedInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpeedInputs, constructor.new(_6640.SpeedInputOptions))
        return value

    @property
    def force_inputs(self) -> 'List[_6632.ForceInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ForceInputs, constructor.new(_6632.ForceInputOptions))
        return value

    @property
    def moment_inputs(self) -> 'List[_6635.MomentInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MomentInputs, constructor.new(_6635.MomentInputOptions))
        return value

    @property
    def boost_pressure_inputs(self) -> 'List[_6629.BoostPressureLoadCaseInputOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BoostPressureInputs, constructor.new(_6629.BoostPressureLoadCaseInputOptions))
        return value
