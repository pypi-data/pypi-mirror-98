...
from mastapy.system_model.analyses_and_results.static_loads import _6507, _6515
...
class ElectricMachineHarmonicLoadDataFromMotorPackages(_6507.ElectricMachineHarmonicLoadData, Generic[T]):
    '''ElectricMachineHarmonicLoadDataFromMotorPackages
