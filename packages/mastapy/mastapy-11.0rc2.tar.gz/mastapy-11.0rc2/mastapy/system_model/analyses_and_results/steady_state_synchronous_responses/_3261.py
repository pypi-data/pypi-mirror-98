...
from mastapy.system_model.analyses_and_results.steady_state_synchronous_responses import _3272, _3173
...
class RootAssemblySteadyStateSynchronousResponse(_3173.AssemblySteadyStateSynchronousResponse):
    '''RootAssemblySteadyStateSynchronousResponse
    ...
    @property
    def steady_state_synchronous_response_inputs(self) -> '_3272.SteadyStateSynchronousResponse':
        ...
        return constructor.new(_3272.SteadyStateSynchronousResponse)(self.wrapped.SteadyStateSynchronousResponseInputs) if self.wrapped.SteadyStateSynchronousResponseInputs else None
