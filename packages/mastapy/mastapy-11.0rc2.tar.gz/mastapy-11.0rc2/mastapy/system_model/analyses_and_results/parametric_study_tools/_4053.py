...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4044, _4041
...
class ParametricStudyVariable(_2321.AnalysisCaseVariable):
    '''ParametricStudyVariable
    ...
    @property
    def dimension(self) -> '_4044.ParametricStudyDimension':
        ...
        return constructor.new(_4044.ParametricStudyDimension)(value) if value else None

    @dimension.setter
    def dimension(self, value: '_4044.ParametricStudyDimension'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.Dimension = value

    @property
    def distribution(self) -> '_4041.MonteCarloDistribution':
        ...
        return constructor.new(_4041.MonteCarloDistribution)(value) if value else None

    @distribution.setter
    def distribution(self, value: '_4041.MonteCarloDistribution'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
