...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4081, _4080, _3975
...
class StraightBevelDiffGearSetParametricStudyTool(_3975.BevelGearSetParametricStudyTool):
    '''StraightBevelDiffGearSetParametricStudyTool
    ...
    @property
    def straight_bevel_diff_gears_parametric_study_tool(self) -> 'List[_4081.StraightBevelDiffGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearsParametricStudyTool, constructor.new(_4081.StraightBevelDiffGearParametricStudyTool))
        return value

    @property
    def straight_bevel_diff_meshes_parametric_study_tool(self) -> 'List[_4080.StraightBevelDiffGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshesParametricStudyTool, constructor.new(_4080.StraightBevelDiffGearMeshParametricStudyTool))
        return value
