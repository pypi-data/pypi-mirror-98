...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3965
...
class BearingCompoundParametricStudyTool(_4140.ConnectorCompoundParametricStudyTool):
    '''BearingCompoundParametricStudyTool
    ...
    @property
    def bearing_duty_cycle_results(self) -> '_1649.LoadedBearingDutyCycle':
        ...
        if _1649.LoadedBearingDutyCycle.TYPE not in self.wrapped.BearingDutyCycleResults.__class__.__mro__:
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3965.BearingParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3965.BearingParametricStudyTool))
        return value

    @property
    def component_parametric_study_tool_load_cases(self) -> 'List[_3965.BearingParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentParametricStudyToolLoadCases, constructor.new(_3965.BearingParametricStudyTool))
        return value
