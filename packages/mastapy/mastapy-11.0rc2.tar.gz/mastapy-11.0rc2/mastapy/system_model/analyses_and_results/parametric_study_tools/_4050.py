...
from mastapy.system_model.analyses_and_results.static_loads import _6452, _6564
from mastapy.system_model import _1894
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4052, _4053
...
class ParametricStudyToolOptions(_0.APIBase):
    ...
    @property
    def parametric_study_type(self) -> '_6564.ParametricStudyType':
        ...
        return constructor.new(_6564.ParametricStudyType)(value) if value else None

    @parametric_study_type.setter
    def parametric_study_type(self, value: '_6564.ParametricStudyType'):
    ...
    @property
    def external_full_fe_loader(self) -> '_1894.ExternalFullFELoader':
        ...
        return constructor.new(_1894.ExternalFullFELoader)(self.wrapped.ExternalFullFELoader) if self.wrapped.ExternalFullFELoader else None

    @property
    def step_results(self) -> 'List[_4052.ParametricStudyToolStepResult]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StepResults, constructor.new(_4052.ParametricStudyToolStepResult))
        return value

    @property
    def study_variables(self) -> 'List[_4053.ParametricStudyVariable]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StudyVariables, constructor.new(_4053.ParametricStudyVariable))
        return value
