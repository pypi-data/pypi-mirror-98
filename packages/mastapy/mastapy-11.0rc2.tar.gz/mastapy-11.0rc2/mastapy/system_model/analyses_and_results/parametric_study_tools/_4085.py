...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4084, _4083, _3975
...
class StraightBevelGearSetParametricStudyTool(_3975.BevelGearSetParametricStudyTool):
    '''StraightBevelGearSetParametricStudyTool
    ...
    @property
    def straight_bevel_gears_parametric_study_tool(self) -> 'List[_4084.StraightBevelGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearsParametricStudyTool, constructor.new(_4084.StraightBevelGearParametricStudyTool))
        return value

    @property
    def straight_bevel_meshes_parametric_study_tool(self) -> 'List[_4083.StraightBevelGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshesParametricStudyTool, constructor.new(_4083.StraightBevelGearMeshParametricStudyTool))
        return value
