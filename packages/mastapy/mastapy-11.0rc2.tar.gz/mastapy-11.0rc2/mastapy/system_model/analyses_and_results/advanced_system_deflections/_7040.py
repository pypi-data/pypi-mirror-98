...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7038, _7039, _6973
...
class WormGearSetAdvancedSystemDeflection(_6973.GearSetAdvancedSystemDeflection):
    '''WormGearSetAdvancedSystemDeflection
    ...
    @property
    def worm_gears_advanced_system_deflection(self) -> 'List[_7038.WormGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsAdvancedSystemDeflection, constructor.new(_7038.WormGearAdvancedSystemDeflection))
        return value

    @property
    def worm_meshes_advanced_system_deflection(self) -> 'List[_7039.WormGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesAdvancedSystemDeflection, constructor.new(_7039.WormGearMeshAdvancedSystemDeflection))
        return value
