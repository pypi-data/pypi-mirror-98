...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6959, _6972
...
class CylindricalGearMeshAdvancedSystemDeflection(_6972.GearMeshAdvancedSystemDeflection):
    '''CylindricalGearMeshAdvancedSystemDeflection
    ...
    @property
    def contact_chart_max_pressure_gear_a(self) -> '_7200.SMTBitmap':
        ...
        return constructor.new(_7200.SMTBitmap)(self.wrapped.ContactChartMaxPressureGearA) if self.wrapped.ContactChartMaxPressureGearA else None

    @property
    def contact_chart_max_pressure_gear_b(self) -> '_7200.SMTBitmap':
        ...
        return constructor.new(_7200.SMTBitmap)(self.wrapped.ContactChartMaxPressureGearB) if self.wrapped.ContactChartMaxPressureGearB else None

    @property
    def contact_chart_gap_to_loaded_flank_gear_a(self) -> '_7200.SMTBitmap':
        ...
        return constructor.new(_7200.SMTBitmap)(self.wrapped.ContactChartGapToLoadedFlankGearA) if self.wrapped.ContactChartGapToLoadedFlankGearA else None

    @property
    def contact_chart_gap_to_loaded_flank_gear_b(self) -> '_7200.SMTBitmap':
        ...
        return constructor.new(_7200.SMTBitmap)(self.wrapped.ContactChartGapToLoadedFlankGearB) if self.wrapped.ContactChartGapToLoadedFlankGearB else None

    @property
    def contact_chart_gap_to_unloaded_flank_gear_a(self) -> '_7200.SMTBitmap':
        ...
        return constructor.new(_7200.SMTBitmap)(self.wrapped.ContactChartGapToUnloadedFlankGearA) if self.wrapped.ContactChartGapToUnloadedFlankGearA else None

    @property
    def contact_chart_gap_to_unloaded_flank_gear_b(self) -> '_7200.SMTBitmap':
        ...
        return constructor.new(_7200.SMTBitmap)(self.wrapped.ContactChartGapToUnloadedFlankGearB) if self.wrapped.ContactChartGapToUnloadedFlankGearB else None
    ...
    @property
    def cylindrical_gear_mesh_system_deflection_results(self) -> 'List[_2407.CylindricalGearMeshSystemDeflectionTimestep]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearMeshSystemDeflectionResults, constructor.new(_2407.CylindricalGearMeshSystemDeflectionTimestep))
        return value
    ...
    @property
    def cylindrical_gear_advanced_analyses(self) -> 'List[_6959.CylindricalGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearAdvancedAnalyses, constructor.new(_6959.CylindricalGearAdvancedSystemDeflection))
        return value
