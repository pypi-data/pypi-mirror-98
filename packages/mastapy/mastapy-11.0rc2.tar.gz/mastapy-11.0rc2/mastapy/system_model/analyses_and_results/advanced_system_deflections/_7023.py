...
class StraightBevelGearMeshAdvancedSystemDeflection(_6928.BevelGearMeshAdvancedSystemDeflection):
    '''StraightBevelGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_load_case(self) -> '_6602.StraightBevelGearMeshLoadCase':
        ...
        return constructor.new(_6602.StraightBevelGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2481.StraightBevelGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2481.StraightBevelGearMeshSystemDeflection))
        return value
