...
class GuideDxfModelAdvancedSystemDeflection(_6936.ComponentAdvancedSystemDeflection):
    '''GuideDxfModelAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2427.GuideDxfModelSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2427.GuideDxfModelSystemDeflection))
        return value
