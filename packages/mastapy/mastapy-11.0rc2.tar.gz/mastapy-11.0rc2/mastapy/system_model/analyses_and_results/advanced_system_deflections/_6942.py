...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6940, _6941, _6973
...
class ConceptGearSetAdvancedSystemDeflection(_6973.GearSetAdvancedSystemDeflection):
    '''ConceptGearSetAdvancedSystemDeflection
    ...
    @property
    def concept_gears_advanced_system_deflection(self) -> 'List[_6940.ConceptGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsAdvancedSystemDeflection, constructor.new(_6940.ConceptGearAdvancedSystemDeflection))
        return value

    @property
    def concept_meshes_advanced_system_deflection(self) -> 'List[_6941.ConceptGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesAdvancedSystemDeflection, constructor.new(_6941.ConceptGearMeshAdvancedSystemDeflection))
        return value
