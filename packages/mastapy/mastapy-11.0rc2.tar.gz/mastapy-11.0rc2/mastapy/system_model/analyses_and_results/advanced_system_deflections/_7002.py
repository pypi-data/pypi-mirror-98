...
class PulleyAdvancedSystemDeflection(_6951.CouplingHalfAdvancedSystemDeflection):
    '''PulleyAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2458.PulleySystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2458.PulleySystemDeflection))
        return value
