...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6209, _6210, _6242
...
class ConceptGearSetCriticalSpeedAnalysis(_6242.GearSetCriticalSpeedAnalysis):
    '''ConceptGearSetCriticalSpeedAnalysis
    ...
    @property
    def concept_gears_critical_speed_analysis(self) -> 'List[_6209.ConceptGearCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsCriticalSpeedAnalysis, constructor.new(_6209.ConceptGearCriticalSpeedAnalysis))
        return value

    @property
    def concept_meshes_critical_speed_analysis(self) -> 'List[_6210.ConceptGearMeshCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesCriticalSpeedAnalysis, constructor.new(_6210.ConceptGearMeshCriticalSpeedAnalysis))
        return value
