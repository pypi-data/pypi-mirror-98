...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6281, _6282, _6198
...
class SpiralBevelGearSetCriticalSpeedAnalysis(_6198.BevelGearSetCriticalSpeedAnalysis):
    '''SpiralBevelGearSetCriticalSpeedAnalysis
    ...
    @property
    def spiral_bevel_gears_critical_speed_analysis(self) -> 'List[_6281.SpiralBevelGearCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearsCriticalSpeedAnalysis, constructor.new(_6281.SpiralBevelGearCriticalSpeedAnalysis))
        return value

    @property
    def spiral_bevel_meshes_critical_speed_analysis(self) -> 'List[_6282.SpiralBevelGearMeshCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshesCriticalSpeedAnalysis, constructor.new(_6282.SpiralBevelGearMeshCriticalSpeedAnalysis))
        return value
