...
class CoaxialConnectionCompoundCriticalSpeedAnalysis(_6408.ShaftToMountableComponentConnectionCompoundCriticalSpeedAnalysis):
    '''CoaxialConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_6204.CoaxialConnectionCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_6204.CoaxialConnectionCriticalSpeedAnalysis))
        return value

    @property
    def connection_critical_speed_analysis_load_cases(self) -> 'List[_6204.CoaxialConnectionCriticalSpeedAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionCriticalSpeedAnalysisLoadCases, constructor.new(_6204.CoaxialConnectionCriticalSpeedAnalysis))
        return value
