...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _2299, _6187
...
class RootAssemblyCriticalSpeedAnalysis(_6187.AssemblyCriticalSpeedAnalysis):
    '''RootAssemblyCriticalSpeedAnalysis
    ...
    @property
    def critical_speed_analysis_inputs(self) -> '_2299.CriticalSpeedAnalysis':
        ...
        return constructor.new(_2299.CriticalSpeedAnalysis)(self.wrapped.CriticalSpeedAnalysisInputs) if self.wrapped.CriticalSpeedAnalysisInputs else None
