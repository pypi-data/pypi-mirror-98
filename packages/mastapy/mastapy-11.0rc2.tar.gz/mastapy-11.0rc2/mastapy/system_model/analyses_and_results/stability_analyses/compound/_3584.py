...
class CoaxialConnectionCompoundStabilityAnalysis(_3657.ShaftToMountableComponentConnectionCompoundStabilityAnalysis):
    '''CoaxialConnectionCompoundStabilityAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3452.CoaxialConnectionStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3452.CoaxialConnectionStabilityAnalysis))
        return value

    @property
    def connection_stability_analysis_load_cases(self) -> 'List[_3452.CoaxialConnectionStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionStabilityAnalysisLoadCases, constructor.new(_3452.CoaxialConnectionStabilityAnalysis))
        return value
