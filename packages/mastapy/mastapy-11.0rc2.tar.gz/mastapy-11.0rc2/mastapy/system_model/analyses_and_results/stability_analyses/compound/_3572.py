...
class BevelDifferentialGearMeshCompoundStabilityAnalysis(_3577.BevelGearMeshCompoundStabilityAnalysis):
    '''BevelDifferentialGearMeshCompoundStabilityAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3439.BevelDifferentialGearMeshStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3439.BevelDifferentialGearMeshStabilityAnalysis))
        return value

    @property
    def connection_stability_analysis_load_cases(self) -> 'List[_3439.BevelDifferentialGearMeshStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionStabilityAnalysisLoadCases, constructor.new(_3439.BevelDifferentialGearMeshStabilityAnalysis))
        return value
