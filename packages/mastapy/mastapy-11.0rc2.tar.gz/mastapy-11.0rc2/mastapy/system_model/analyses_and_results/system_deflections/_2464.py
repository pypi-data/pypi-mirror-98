...
class RollingRingSystemDeflection(_2397.CouplingHalfSystemDeflection):
    '''RollingRingSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3791.RollingRingPowerFlow':
        ...
        return constructor.new(_3791.RollingRingPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
