...
from mastapy.system_model.analyses_and_results.power_flows import _3804, _3809, _3810
...
class StraightBevelDiffGearSystemDeflection(_2375.BevelGearSystemDeflection):
    '''StraightBevelDiffGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3804.StraightBevelDiffGearPowerFlow':
