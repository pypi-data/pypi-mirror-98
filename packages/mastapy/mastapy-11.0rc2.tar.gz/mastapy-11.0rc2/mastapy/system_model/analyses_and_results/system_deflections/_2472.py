...
class SpiralBevelGearMeshSystemDeflection(_2373.BevelGearMeshSystemDeflection):
    '''SpiralBevelGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3797.SpiralBevelGearMeshPowerFlow':
        ...
        return constructor.new(_3797.SpiralBevelGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
