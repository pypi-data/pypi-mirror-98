...
from mastapy.system_model.analyses_and_results.power_flows import _3704, _3735
...
class BeltConnectionSystemDeflection(_2432.InterMountableComponentConnectionSystemDeflection):
    '''BeltConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3704.BeltConnectionPowerFlow':
