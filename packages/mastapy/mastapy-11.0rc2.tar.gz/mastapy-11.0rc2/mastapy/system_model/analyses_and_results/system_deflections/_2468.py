...
class ShaftSectionSystemDeflection(_123.Bar):
    ...
    @property
    def left_end(self) -> '_2467.ShaftSectionEndResultsSystemDeflection':
        ...
        return constructor.new(_2467.ShaftSectionEndResultsSystemDeflection)(self.wrapped.LeftEnd) if self.wrapped.LeftEnd else None

    @property
    def right_end(self) -> '_2467.ShaftSectionEndResultsSystemDeflection':
        ...
        return constructor.new(_2467.ShaftSectionEndResultsSystemDeflection)(self.wrapped.RightEnd) if self.wrapped.RightEnd else None
