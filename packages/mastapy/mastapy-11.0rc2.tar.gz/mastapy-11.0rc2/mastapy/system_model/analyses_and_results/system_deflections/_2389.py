...
class ConceptGearSystemDeflection(_2426.GearSystemDeflection):
    '''ConceptGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3725.ConceptGearPowerFlow':
        ...
        return constructor.new(_3725.ConceptGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
