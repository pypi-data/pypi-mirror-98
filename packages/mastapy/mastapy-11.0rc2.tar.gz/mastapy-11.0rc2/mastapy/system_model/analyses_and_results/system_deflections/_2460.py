...
from mastapy.system_model.analyses_and_results.system_deflections import _2461, _2432
...
class RingPinsToDiscConnectionSystemDeflection(_2432.InterMountableComponentConnectionSystemDeflection):
    '''RingPinsToDiscConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3788.RingPinsToDiscConnectionPowerFlow':
        ...
        return constructor.new(_3788.RingPinsToDiscConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None

    @property
    def ring_pin_to_disc_contacts(self) -> 'List[_2461.RingPinToDiscContactReporting]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RingPinToDiscContacts, constructor.new(_2461.RingPinToDiscContactReporting))
        return value
