...
class DatumSystemDeflection(_2382.ComponentSystemDeflection):
    '''DatumSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3747.DatumPowerFlow':
        ...
        return constructor.new(_3747.DatumPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
