...
class VirtualComponentSystemDeflection(_2447.MountableComponentSystemDeflection):
    '''VirtualComponentSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3821.VirtualComponentPowerFlow':
