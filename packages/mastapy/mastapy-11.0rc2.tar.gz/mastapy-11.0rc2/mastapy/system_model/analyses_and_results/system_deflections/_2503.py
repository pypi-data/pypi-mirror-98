...
class WormGearSystemDeflection(_2426.GearSystemDeflection):
    '''WormGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3823.WormGearPowerFlow':
        ...
        return constructor.new(_3823.WormGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
