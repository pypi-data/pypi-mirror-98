...
from mastapy.system_model.analyses_and_results.system_deflections import _2460, _2471
...
class CycloidalAssemblySystemDeflection(_2471.SpecialisedAssemblySystemDeflection):
    '''CycloidalAssemblySystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3738.CycloidalAssemblyPowerFlow':
        ...
        return constructor.new(_3738.CycloidalAssemblyPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None

    @property
    def ring_pins_to_disc_connections(self) -> 'List[_2460.RingPinsToDiscConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RingPinsToDiscConnections, constructor.new(_2460.RingPinsToDiscConnectionSystemDeflection))
        return value
