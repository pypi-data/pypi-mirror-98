...
class ConicalGearMeshCompoundSystemDeflection(_2576.GearMeshCompoundSystemDeflection):
    '''ConicalGearMeshCompoundSystemDeflection
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2391.ConicalGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2391.ConicalGearMeshSystemDeflection))
        return value
