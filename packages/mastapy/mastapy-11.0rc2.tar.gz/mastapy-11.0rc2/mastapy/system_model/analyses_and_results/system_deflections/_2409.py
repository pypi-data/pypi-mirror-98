...
from mastapy.system_model.analyses_and_results.power_flows import _3745, _3780
from mastapy.gears.rating.cylindrical import _423
from mastapy.gears.manufacturing.cylindrical import _568
from mastapy.system_model.analyses_and_results.system_deflections import _2412, _2406, _2425
...
class CylindricalGearSetSystemDeflection(_2425.GearSetSystemDeflection):
    '''CylindricalGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3745.CylindricalGearSetPowerFlow':
    ...
    @property
    def cylindrical_gears_system_deflection(self) -> 'List[_2412.CylindricalGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsSystemDeflection, constructor.new(_2412.CylindricalGearSystemDeflection))
        return value

    @property
    def cylindrical_meshes_system_deflection(self) -> 'List[_2406.CylindricalGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesSystemDeflection, constructor.new(_2406.CylindricalGearMeshSystemDeflection))
        return value
