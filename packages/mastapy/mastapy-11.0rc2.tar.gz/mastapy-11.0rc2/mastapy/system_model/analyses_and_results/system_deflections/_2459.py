...
class RingPinsSystemDeflection(_2447.MountableComponentSystemDeflection):
    '''RingPinsSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3787.RingPinsPowerFlow':
        ...
        return constructor.new(_3787.RingPinsPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
