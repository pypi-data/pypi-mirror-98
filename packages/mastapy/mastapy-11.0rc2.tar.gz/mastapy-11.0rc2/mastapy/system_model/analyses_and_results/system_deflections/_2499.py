...
class UnbalancedMassSystemDeflection(_2500.VirtualComponentSystemDeflection):
    '''UnbalancedMassSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3820.UnbalancedMassPowerFlow':
        ...
        return constructor.new(_3820.UnbalancedMassPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
