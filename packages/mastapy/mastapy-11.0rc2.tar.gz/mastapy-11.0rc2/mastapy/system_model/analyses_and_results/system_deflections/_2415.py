...
class CylindricalPlanetGearSystemDeflection(_2412.CylindricalGearSystemDeflection):
    '''CylindricalPlanetGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3746.CylindricalPlanetGearPowerFlow':
        ...
        return constructor.new(_3746.CylindricalPlanetGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
