...
class FaceGearSystemDeflection(_2426.GearSystemDeflection):
    '''FaceGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3750.FaceGearPowerFlow':
        ...
        return constructor.new(_3750.FaceGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
