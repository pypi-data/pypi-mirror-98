...
class BevelDifferentialSunGearSystemDeflection(_2370.BevelDifferentialGearSystemDeflection):
    '''BevelDifferentialSunGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3710.BevelDifferentialSunGearPowerFlow':
        ...
        return constructor.new(_3710.BevelDifferentialSunGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
