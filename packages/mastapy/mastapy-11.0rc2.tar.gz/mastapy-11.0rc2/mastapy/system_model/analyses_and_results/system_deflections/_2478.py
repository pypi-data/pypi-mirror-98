...
class StraightBevelDiffGearMeshSystemDeflection(_2373.BevelGearMeshSystemDeflection):
    '''StraightBevelDiffGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3803.StraightBevelDiffGearMeshPowerFlow':
        ...
        return constructor.new(_3803.StraightBevelDiffGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
