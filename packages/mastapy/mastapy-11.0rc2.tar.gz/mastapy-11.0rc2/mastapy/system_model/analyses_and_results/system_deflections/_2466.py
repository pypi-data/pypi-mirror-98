...
from mastapy.bearings.bearing_results import _1644
...
class ShaftHubConnectionSystemDeflection(_2395.ConnectorSystemDeflection):
    '''ShaftHubConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3793.ShaftHubConnectionPowerFlow':
        ...
        return constructor.new(_3793.ShaftHubConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
    ...
    @property
    def stiffness_matrix_in_local_coordinate_system(self) -> '_1644.BearingStiffnessMatrixReporter':
        ...
        return constructor.new(_1644.BearingStiffnessMatrixReporter)(self.wrapped.StiffnessMatrixInLocalCoordinateSystem) if self.wrapped.StiffnessMatrixInLocalCoordinateSystem else None

    @property
    def stiffness_matrix_in_unrotated_coordinate_system(self) -> '_1644.BearingStiffnessMatrixReporter':
        ...
        return constructor.new(_1644.BearingStiffnessMatrixReporter)(self.wrapped.StiffnessMatrixInUnrotatedCoordinateSystem) if self.wrapped.StiffnessMatrixInUnrotatedCoordinateSystem else None
    ...
    @property
    def left_flank_contacts(self) -> 'List[_2515.SplineFlankContactReporting]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LeftFlankContacts, constructor.new(_2515.SplineFlankContactReporting))
        return value

    @property
    def right_flank_contacts(self) -> 'List[_2515.SplineFlankContactReporting]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RightFlankContacts, constructor.new(_2515.SplineFlankContactReporting))
        return value

    @property
    def tip_contacts(self) -> 'List[_2515.SplineFlankContactReporting]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.TipContacts, constructor.new(_2515.SplineFlankContactReporting))
        return value
