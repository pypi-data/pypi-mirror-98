...
class CVTSystemDeflection(_2367.BeltDriveSystemDeflection):
    '''CVTSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3736.CVTPowerFlow':
        ...
        return constructor.new(_3736.CVTPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
