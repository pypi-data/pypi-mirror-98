...
class RingPinToDiscContactReporting(_0.APIBase):
    ...
    @property
    def contact(self) -> '_2515.SplineFlankContactReporting':
        ...
        return constructor.new(_2515.SplineFlankContactReporting)(self.wrapped.Contact) if self.wrapped.Contact else None

    @property
    def information_at_ring_pin_to_disc_contact_point_from_geometry(self) -> '_6546.InformationAtRingPinToDiscContactPointFromGeometry':
        ...
        return constructor.new(_6546.InformationAtRingPinToDiscContactPointFromGeometry)(self.wrapped.InformationAtRingPinToDiscContactPointFromGeometry) if self.wrapped.InformationAtRingPinToDiscContactPointFromGeometry else None

    @property
    def information_for_contact_points_along_face_width(self) -> 'List[_2431.InformationForContactAtPointAlongFaceWidth]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.InformationForContactPointsAlongFaceWidth, constructor.new(_2431.InformationForContactAtPointAlongFaceWidth))
        return value
