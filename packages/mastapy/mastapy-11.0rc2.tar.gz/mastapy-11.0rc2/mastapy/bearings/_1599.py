...
class RollingBearingDatabase(_1558.SQLDatabase['_1600.RollingBearingKey', '_1852.RollingBearing']):
    '''RollingBearingDatabase
    ...
    def add_to_database(self, bearing: '_1852.RollingBearing'):
    ...
    def remove_from_database(self, bearing: '_1852.RollingBearing'):
    ...
    def search_for_rolling_bearing(self, designation: 'str', catalog: '_1577.BearingCatalog', type_: '_1602.RollingBearingType', bore_range: '_1251.Range', outer_diameter_range: '_1251.Range', width_range: '_1251.Range', dynamic_capacity_range: '_1251.Range', number_of_rows: 'int', material_type: '_1591.HybridSteelAll') -> 'List[_1852.RollingBearing]':
    ...
    def search_for_rolling_bearing_with_name_catalog_and_type(self, designation: 'str', catalog: '_1577.BearingCatalog', type_: '_1602.RollingBearingType') -> 'List[_1852.RollingBearing]':
        ...
        catalog = conversion.mp_to_pn_enum(catalog)
        type_ = conversion.mp_to_pn_enum(type_)
        return conversion.pn_to_mp_objects_in_list(self.wrapped.SearchForRollingBearing.Overloads[_STRING, _BEARING_CATALOG, _ROLLING_BEARING_TYPE](designation if designation else None, catalog, type_), constructor.new(_1852.RollingBearing))

    def search_for_rolling_bearing_with_name_and_catalog(self, designation: 'str', catalog: '_1577.BearingCatalog') -> '_1852.RollingBearing':
        ''' 'SearchForRollingBearing' is the original name of this method.
    ...
    def search_for_rolling_bearing_with_catalog(self, catalog: '_1577.BearingCatalog') -> 'List[_1852.RollingBearing]':
        ''' 'SearchForRollingBearing' is the original name of this method.
        ...
        catalog = conversion.mp_to_pn_enum(catalog)
        return conversion.pn_to_mp_objects_in_list(self.wrapped.SearchForRollingBearing.Overloads[_BEARING_CATALOG](catalog), constructor.new(_1852.RollingBearing))

    def create_bearing(self, type_: '_1602.RollingBearingType', designation: Optional['str'] = 'None') -> '_1852.RollingBearing':
    ...
    def create_bearing_with_type_name(self, type_: 'str', designation: Optional['str'] = 'None') -> '_1852.RollingBearing':
        ''' 'CreateBearing' is the original name of this method.
    ...
    def create_key(self, type_: '_1602.RollingBearingType', designation: Optional['str'] = 'None') -> '_1600.RollingBearingKey':
    ...
    def create_key_with_type_name(self, type_: 'str', designation: Optional['str'] = 'None') -> '_1600.RollingBearingKey':
        ''' 'CreateKey' is the original name of this method.
