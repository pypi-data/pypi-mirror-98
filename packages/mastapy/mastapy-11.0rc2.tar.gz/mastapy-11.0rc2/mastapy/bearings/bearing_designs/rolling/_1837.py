...
from mastapy.bearings.bearing_designs.rolling import _1838
...
class BearingProtectionDetailsModifier(_0.APIBase):
    ...
    @property
    def current_protection_level(self) -> '_1838.BearingProtectionLevel':
        ...
        return constructor.new(_1838.BearingProtectionLevel)(value) if value else None

    @property
    def new_protection_level(self) -> '_1838.BearingProtectionLevel':
    ...
    def new_protection_level(self, value: '_1838.BearingProtectionLevel'):
