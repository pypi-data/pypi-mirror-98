...
from mastapy.bearings.bearing_designs.rolling import _1834, _1852
...
class BallBearing(_1852.RollingBearing):
    '''BallBearing
    ...
    @property
    def shoulders(self) -> 'List[_1834.BallBearingShoulderDefinition]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Shoulders, constructor.new(_1834.BallBearingShoulderDefinition))
        return value
