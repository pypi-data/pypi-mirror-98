...
from mastapy.bearings.bearing_designs.rolling import _1850, _1851, _1849
...
class NonBarrelRollerBearing(_1849.RollerBearing):
    '''NonBarrelRollerBearing
    ...
    @property
    def roller_end_shape(self) -> '_1850.RollerEndShape':
        ...
        return constructor.new(_1850.RollerEndShape)(value) if value else None

    @roller_end_shape.setter
    def roller_end_shape(self, value: '_1850.RollerEndShape'):
    ...
    @property
    def ribs(self) -> 'List[_1851.RollerRibDetail]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Ribs, constructor.new(_1851.RollerRibDetail))
        return value
