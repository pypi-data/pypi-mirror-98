...
class PlainJournalHousing(_0.APIBase):
    ...
    @property
    def heat_emitting_area_method(self) -> '_1645.DefaultOrUserInput':
        ...
        return constructor.new(_1645.DefaultOrUserInput)(value) if value else None

    @heat_emitting_area_method.setter
    def heat_emitting_area_method(self, value: '_1645.DefaultOrUserInput'):
