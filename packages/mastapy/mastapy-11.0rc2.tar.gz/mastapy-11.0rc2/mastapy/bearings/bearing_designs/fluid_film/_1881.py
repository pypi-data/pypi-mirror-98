...
from mastapy.bearings.bearing_designs.fluid_film import _1873
...
class TiltingPadThrustBearing(_1873.PadFluidFilmBearing):
    '''TiltingPadThrustBearing
    ...
    @property
    def tilting_pad_type(self) -> '_1604.TiltingPadTypes':
        ...
        return constructor.new(_1604.TiltingPadTypes)(value) if value else None

    @tilting_pad_type.setter
    def tilting_pad_type(self, value: '_1604.TiltingPadTypes'):
