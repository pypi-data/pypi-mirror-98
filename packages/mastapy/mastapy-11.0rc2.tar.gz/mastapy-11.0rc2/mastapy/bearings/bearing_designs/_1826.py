...
from mastapy.bearings import _1588
...
class LinearBearing(_1823.BearingDesign):
    '''LinearBearing
    ...
    @property
    def stiffness_options(self) -> '_1588.BearingStiffnessMatrixOption':
        ...
        return constructor.new(_1588.BearingStiffnessMatrixOption)(value) if value else None

    @stiffness_options.setter
    def stiffness_options(self, value: '_1588.BearingStiffnessMatrixOption'):
