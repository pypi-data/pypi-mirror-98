...
class GreaseLifeAndRelubricationInterval(_1790.SKFCalculationResult):
    '''GreaseLifeAndRelubricationInterval
    ...
    def grease(self) -> '_1781.Grease':
        ...
        return constructor.new(_1781.Grease)(self.wrapped.Grease) if self.wrapped.Grease else None

    @property
    def initial_fill(self) -> '_1784.InitialFill':
        ...
        return constructor.new(_1784.InitialFill)(self.wrapped.InitialFill) if self.wrapped.InitialFill else None

    @property
    def grease_quantity(self) -> '_1783.GreaseQuantity':
        ...
        return constructor.new(_1783.GreaseQuantity)(self.wrapped.GreaseQuantity) if self.wrapped.GreaseQuantity else None
