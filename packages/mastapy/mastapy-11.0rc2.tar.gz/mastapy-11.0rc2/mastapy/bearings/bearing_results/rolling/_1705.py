...
from mastapy.bearings.bearing_results.rolling import _1704, _1716, _1720
...
class LoadedCylindricalRollerBearingRow(_1720.LoadedNonBarrelRollerBearingRow):
    '''LoadedCylindricalRollerBearingRow
    ...
    @property
    def rib_normal_contact_stress_inner_left(self) -> '_7200.SMTBitmap':
        ...
        return constructor.new(_7200.SMTBitmap)(self.wrapped.RibNormalContactStressInnerLeft) if self.wrapped.RibNormalContactStressInnerLeft else None

    @property
    def rib_normal_contact_stress_inner_right(self) -> '_7200.SMTBitmap':
        ...
        return constructor.new(_7200.SMTBitmap)(self.wrapped.RibNormalContactStressInnerRight) if self.wrapped.RibNormalContactStressInnerRight else None

    @property
    def rib_normal_contact_stress_outer_left(self) -> '_7200.SMTBitmap':
        ...
        return constructor.new(_7200.SMTBitmap)(self.wrapped.RibNormalContactStressOuterLeft) if self.wrapped.RibNormalContactStressOuterLeft else None

    @property
    def rib_normal_contact_stress_outer_right(self) -> '_7200.SMTBitmap':
        ...
        return constructor.new(_7200.SMTBitmap)(self.wrapped.RibNormalContactStressOuterRight) if self.wrapped.RibNormalContactStressOuterRight else None

    @property
    def loaded_bearing(self) -> '_1704.LoadedCylindricalRollerBearingResults':
