...
from mastapy.bearings.bearing_results.rolling import _1684, _1725
...
class LoadedAsymmetricSphericalRollerBearingRow(_1725.LoadedRollerBearingRow):
    '''LoadedAsymmetricSphericalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1684.LoadedAsymmetricSphericalRollerBearingResults':
        ...
        return constructor.new(_1684.LoadedAsymmetricSphericalRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
