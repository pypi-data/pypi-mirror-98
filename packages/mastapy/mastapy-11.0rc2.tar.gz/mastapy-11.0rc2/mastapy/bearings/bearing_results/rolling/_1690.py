...
from mastapy.bearings.bearing_results.rolling import _1689, _1692, _1720
...
class LoadedAxialThrustCylindricalRollerBearingRow(_1720.LoadedNonBarrelRollerBearingRow):
    '''LoadedAxialThrustCylindricalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1689.LoadedAxialThrustCylindricalRollerBearingResults':
