...
from mastapy.bearings.bearing_results.rolling.skf_module import _1788, _1790
...
class DynamicAxialLoadCarryingCapacity(_1790.SKFCalculationResult):
    '''DynamicAxialLoadCarryingCapacity
    ...
    @property
    def permissible_axial_load(self) -> '_1788.PermissibleAxialLoad':
        ...
        return constructor.new(_1788.PermissibleAxialLoad)(self.wrapped.PermissibleAxialLoad) if self.wrapped.PermissibleAxialLoad else None
