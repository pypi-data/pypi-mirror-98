...
from mastapy.bearings.bearing_results.rolling import _1671
...
class ForceAtLaminaGroupReportable(_0.APIBase):
    ...
    @property
    def forces_at_laminae(self) -> 'List[_1671.ForceAtLaminaReportable]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ForcesAtLaminae, constructor.new(_1671.ForceAtLaminaReportable))
        return value
