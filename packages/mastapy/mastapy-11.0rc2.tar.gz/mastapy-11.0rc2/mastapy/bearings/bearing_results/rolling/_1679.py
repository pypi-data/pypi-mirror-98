...
from mastapy.bearings.bearing_results.rolling import _1678, _1681, _1698
...
class LoadedAngularContactBallBearingRow(_1698.LoadedBallBearingRow):
    '''LoadedAngularContactBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1678.LoadedAngularContactBallBearingResults':
