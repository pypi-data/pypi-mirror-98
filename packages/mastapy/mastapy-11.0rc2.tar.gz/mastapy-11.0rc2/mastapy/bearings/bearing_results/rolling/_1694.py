...
class LoadedBallBearingDutyCycle(_1660.LoadedRollingBearingDutyCycle):
    '''LoadedBallBearingDutyCycle
    ...
    @property
    def track_truncation_inner_summary(self) -> '_1565.DutyCyclePropertySummaryPercentage[_1697.LoadedBallBearingResults]':
        ...
        return constructor.new(_1565.DutyCyclePropertySummaryPercentage)[_1697.LoadedBallBearingResults](self.wrapped.TrackTruncationInnerSummary) if self.wrapped.TrackTruncationInnerSummary else None

    @property
    def track_truncation_outer_summary(self) -> '_1565.DutyCyclePropertySummaryPercentage[_1697.LoadedBallBearingResults]':
        ...
        return constructor.new(_1565.DutyCyclePropertySummaryPercentage)[_1697.LoadedBallBearingResults](self.wrapped.TrackTruncationOuterSummary) if self.wrapped.TrackTruncationOuterSummary else None
