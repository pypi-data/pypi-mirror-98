...
from mastapy.bearings.bearing_results.rolling import _1707, _1698
...
class LoadedDeepGrooveBallBearingRow(_1698.LoadedBallBearingRow):
    '''LoadedDeepGrooveBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1707.LoadedDeepGrooveBallBearingResults':
        ...
        return constructor.new(_1707.LoadedDeepGrooveBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
