...
from mastapy.bearings.bearing_results.rolling import _1700, _1725
...
class LoadedCrossedRollerBearingRow(_1725.LoadedRollerBearingRow):
    '''LoadedCrossedRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1700.LoadedCrossedRollerBearingResults':
        ...
        return constructor.new(_1700.LoadedCrossedRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
