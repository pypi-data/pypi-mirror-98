...
from mastapy.bearings.bearing_results.rolling import _1747, _1698
...
class LoadedThreePointContactBallBearingRow(_1698.LoadedBallBearingRow):
    '''LoadedThreePointContactBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1747.LoadedThreePointContactBallBearingResults':
        ...
        return constructor.new(_1747.LoadedThreePointContactBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
