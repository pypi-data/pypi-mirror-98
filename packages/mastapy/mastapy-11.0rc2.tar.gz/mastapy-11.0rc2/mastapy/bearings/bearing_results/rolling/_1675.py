...
from mastapy.bearings import _1602
...
class ISO14179SettingsPerBearingType(_1344.IndependentReportablePropertiesBase['ISO14179SettingsPerBearingType']):
    ...
    @property
    def rolling_bearing_type(self) -> '_1602.RollingBearingType':
        ...
        return constructor.new(_1602.RollingBearingType)(value) if value else None
