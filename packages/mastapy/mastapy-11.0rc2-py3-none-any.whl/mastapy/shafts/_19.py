...
from mastapy.math_utility import _1297, _1288
...
class ShaftDamageResults(_0.APIBase):
    ...
    @property
    def displacement_linear(self) -> 'List[_1297.Vector4D]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DisplacementLinear, constructor.new(_1297.Vector4D))
        return value

    @property
    def displacement_angular(self) -> 'List[_1297.Vector4D]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DisplacementAngular, constructor.new(_1297.Vector4D))
        return value
    ...
    @property
    def force_linear(self) -> 'List[_1297.Vector4D]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ForceLinear, constructor.new(_1297.Vector4D))
        return value

    @property
    def force_angular(self) -> 'List[_1297.Vector4D]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ForceAngular, constructor.new(_1297.Vector4D))
        return value
