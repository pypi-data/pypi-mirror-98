...
from mastapy.bearings.bearing_results.rolling import _1766, _1719
...
class LoadedCylindricalRollerBearingResults(_1719.LoadedNonBarrelRollerBearingResults):
    '''LoadedCylindricalRollerBearingResults
    ...
    @property
    def skf_maximal_constantly_acting_axial_load(self) -> '_1766.SKFMaximalConstantlyActingAxialLoadResults':
        ...
        return constructor.new(_1766.SKFMaximalConstantlyActingAxialLoadResults)(self.wrapped.SKFMaximalConstantlyActingAxialLoad) if self.wrapped.SKFMaximalConstantlyActingAxialLoad else None
