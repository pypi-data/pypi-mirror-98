...
from mastapy.bearings.bearing_results.rolling import _1692, _1690
...
class LoadedAxialThrustNeedleRollerBearingRow(_1690.LoadedAxialThrustCylindricalRollerBearingRow):
    '''LoadedAxialThrustNeedleRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1692.LoadedAxialThrustNeedleRollerBearingResults':
        ...
        return constructor.new(_1692.LoadedAxialThrustNeedleRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
