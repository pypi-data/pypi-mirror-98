...
from mastapy.bearings import _1590
from mastapy.bearings.bearing_results.rolling.fitting import _1806, _1804, _1807
from mastapy.bearings.bearing_results.rolling import (
    _1672, _1769, _1669, _1756,
    _1729
)
from mastapy._internal.cast_exception import CastException
from mastapy.bearings.bearing_results.rolling.abma import _1810, _1808, _1809
from mastapy.bearings.bearing_results.rolling.iso_rating_results import (
    _1797, _1795, _1801, _1800,
    _1796, _1802, _1798
)
...
class LoadedRollingBearingResults(_1655.LoadedDetailedBearingResults):
    '''LoadedRollingBearingResults
    ...
    @property
    def fluid_film_temperature_source(self) -> '_1590.FluidFilmTemperatureOptions':
        ...
        return constructor.new(_1590.FluidFilmTemperatureOptions)(value) if value else None
    ...
    @property
    def outer_ring_fitting_at_assembly(self) -> '_1806.OuterRingFittingThermalResults':
        ...
        return constructor.new(_1806.OuterRingFittingThermalResults)(self.wrapped.OuterRingFittingAtAssembly) if self.wrapped.OuterRingFittingAtAssembly else None

    @property
    def outer_ring_fitting_at_operating_conditions(self) -> '_1806.OuterRingFittingThermalResults':
        ...
        return constructor.new(_1806.OuterRingFittingThermalResults)(self.wrapped.OuterRingFittingAtOperatingConditions) if self.wrapped.OuterRingFittingAtOperatingConditions else None

    @property
    def inner_ring_fitting_at_assembly(self) -> '_1804.InnerRingFittingThermalResults':
        ...
        return constructor.new(_1804.InnerRingFittingThermalResults)(self.wrapped.InnerRingFittingAtAssembly) if self.wrapped.InnerRingFittingAtAssembly else None

    @property
    def inner_ring_fitting_at_operating_conditions(self) -> '_1804.InnerRingFittingThermalResults':
        ...
        return constructor.new(_1804.InnerRingFittingThermalResults)(self.wrapped.InnerRingFittingAtOperatingConditions) if self.wrapped.InnerRingFittingAtOperatingConditions else None
    ...
    @property
    def din732(self) -> '_1669.DIN732Results':
        ...
        return constructor.new(_1669.DIN732Results)(self.wrapped.DIN732) if self.wrapped.DIN732 else None

    @property
    def ansiabma(self) -> '_1810.ANSIABMAResults':
        ...
        if _1810.ANSIABMAResults.TYPE not in self.wrapped.ANSIABMA.__class__.__mro__:
    ...
    @property
    def ansiabma_of_type_ansiabma112014_results(self) -> '_1808.ANSIABMA112014Results':
        ...
        if _1808.ANSIABMA112014Results.TYPE not in self.wrapped.ANSIABMA.__class__.__mro__:
    ...
    @property
    def ansiabma_of_type_ansiabma92015_results(self) -> '_1809.ANSIABMA92015Results':
        ...
        if _1809.ANSIABMA92015Results.TYPE not in self.wrapped.ANSIABMA.__class__.__mro__:
    ...
    @property
    def iso2812007(self) -> '_1797.ISO2812007Results':
        ...
        if _1797.ISO2812007Results.TYPE not in self.wrapped.ISO2812007.__class__.__mro__:
    ...
    @property
    def iso2812007_of_type_ball_iso2812007_results(self) -> '_1795.BallISO2812007Results':
        ...
        if _1795.BallISO2812007Results.TYPE not in self.wrapped.ISO2812007.__class__.__mro__:
    ...
    @property
    def iso2812007_of_type_roller_iso2812007_results(self) -> '_1801.RollerISO2812007Results':
        ...
        if _1801.RollerISO2812007Results.TYPE not in self.wrapped.ISO2812007.__class__.__mro__:
    ...
    @property
    def isots162812008(self) -> '_1800.ISOTS162812008Results':
        ...
        if _1800.ISOTS162812008Results.TYPE not in self.wrapped.ISOTS162812008.__class__.__mro__:
    ...
    @property
    def isots162812008_of_type_ball_isots162812008_results(self) -> '_1796.BallISOTS162812008Results':
        ...
        if _1796.BallISOTS162812008Results.TYPE not in self.wrapped.ISOTS162812008.__class__.__mro__:
    ...
    @property
    def isots162812008_of_type_roller_isots162812008_results(self) -> '_1802.RollerISOTS162812008Results':
        ...
        if _1802.RollerISOTS162812008Results.TYPE not in self.wrapped.ISOTS162812008.__class__.__mro__:
    ...
    @property
    def iso762006(self) -> '_1798.ISO762006Results':
        ...
        return constructor.new(_1798.ISO762006Results)(self.wrapped.ISO762006) if self.wrapped.ISO762006 else None

    @property
    def maximum_static_contact_stress(self) -> '_1756.MaximumStaticContactStress':
        ...
        return constructor.new(_1756.MaximumStaticContactStress)(self.wrapped.MaximumStaticContactStress) if self.wrapped.MaximumStaticContactStress else None

    @property
    def skf_module_results(self) -> '_1792.SKFModuleResults':
        ...
        return constructor.new(_1792.SKFModuleResults)(self.wrapped.SKFModuleResults) if self.wrapped.SKFModuleResults else None

    @property
    def rows(self) -> 'List[_1729.LoadedRollingBearingRow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Rows, constructor.new(_1729.LoadedRollingBearingRow))
        return value

    @property
    def all_mounting_results(self) -> 'List[_1807.RingFittingThermalResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllMountingResults, constructor.new(_1807.RingFittingThermalResults))
        return value
