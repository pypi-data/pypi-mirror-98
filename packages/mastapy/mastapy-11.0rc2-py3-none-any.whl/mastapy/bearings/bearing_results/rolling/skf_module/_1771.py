...
from mastapy.bearings.bearing_results.rolling.skf_module import _1772, _1790
...
class AdjustedSpeed(_1790.SKFCalculationResult):
    '''AdjustedSpeed
    ...
    @property
    def adjustment_factors(self) -> '_1772.AdjustmentFactors':
        ...
        return constructor.new(_1772.AdjustmentFactors)(self.wrapped.AdjustmentFactors) if self.wrapped.AdjustmentFactors else None
