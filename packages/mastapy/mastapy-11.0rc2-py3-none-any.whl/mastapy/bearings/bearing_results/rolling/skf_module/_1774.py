...
from mastapy.bearings.bearing_results.rolling.skf_module import _1785, _1790
...
class BearingRatingLife(_1790.SKFCalculationResult):
    '''BearingRatingLife
    ...
    @property
    def life_model(self) -> '_1785.LifeModel':
        ...
        return constructor.new(_1785.LifeModel)(self.wrapped.LifeModel) if self.wrapped.LifeModel else None
