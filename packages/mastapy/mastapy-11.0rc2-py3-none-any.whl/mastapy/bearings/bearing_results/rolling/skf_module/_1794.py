...
from mastapy.bearings.bearing_results.rolling.skf_module import _1787, _1790
...
class Viscosities(_1790.SKFCalculationResult):
    '''Viscosities
    ...
    @property
    def operating_viscosity(self) -> '_1787.OperatingViscosity':
        ...
        return constructor.new(_1787.OperatingViscosity)(self.wrapped.OperatingViscosity) if self.wrapped.OperatingViscosity else None
