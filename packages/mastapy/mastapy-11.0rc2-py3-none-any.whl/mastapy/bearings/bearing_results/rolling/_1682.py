...
from mastapy.bearings.bearing_results.rolling import _1681, _1679
...
class LoadedAngularContactThrustBallBearingRow(_1679.LoadedAngularContactBallBearingRow):
    '''LoadedAngularContactThrustBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1681.LoadedAngularContactThrustBallBearingResults':
        ...
        return constructor.new(_1681.LoadedAngularContactThrustBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
