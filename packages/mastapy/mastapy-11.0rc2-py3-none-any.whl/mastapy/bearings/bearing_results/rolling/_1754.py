...
from mastapy.bearings.bearing_results.rolling import _1753, _1725
...
class LoadedToroidalRollerBearingRow(_1725.LoadedRollerBearingRow):
    '''LoadedToroidalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1753.LoadedToroidalRollerBearingResults':
        ...
        return constructor.new(_1753.LoadedToroidalRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
