...
from mastapy.bearings.bearing_results.rolling import _1762, _1709
...
class LoadedRollerBearingElement(_1709.LoadedElement):
    '''LoadedRollerBearingElement
    ...
    @property
    def results_at_roller_offsets(self) -> 'List[_1762.ResultsAtRollerOffset]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ResultsAtRollerOffsets, constructor.new(_1762.ResultsAtRollerOffset))
        return value
