...
from mastapy.bearings.bearing_results.rolling import _1750, _1698
...
class LoadedThrustBallBearingRow(_1698.LoadedBallBearingRow):
    '''LoadedThrustBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1750.LoadedThrustBallBearingResults':
        ...
        return constructor.new(_1750.LoadedThrustBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
