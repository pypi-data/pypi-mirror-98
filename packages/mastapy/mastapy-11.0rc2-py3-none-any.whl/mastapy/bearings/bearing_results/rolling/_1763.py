...
class RingForceAndDisplacement(_0.APIBase):
    ...
    @property
    def displacement(self) -> '_1328.VectorWithLinearAndAngularComponents':
        ...
        return constructor.new(_1328.VectorWithLinearAndAngularComponents)(self.wrapped.Displacement) if self.wrapped.Displacement else None

    @property
    def force(self) -> '_1328.VectorWithLinearAndAngularComponents':
        ...
        return constructor.new(_1328.VectorWithLinearAndAngularComponents)(self.wrapped.Force) if self.wrapped.Force else None
