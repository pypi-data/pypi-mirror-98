...
from mastapy.bearings.bearing_results.rolling import _1738, _1725
...
class LoadedSphericalRollerThrustBearingRow(_1725.LoadedRollerBearingRow):
    '''LoadedSphericalRollerThrustBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1738.LoadedSphericalRollerThrustBearingResults':
        ...
        return constructor.new(_1738.LoadedSphericalRollerThrustBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
