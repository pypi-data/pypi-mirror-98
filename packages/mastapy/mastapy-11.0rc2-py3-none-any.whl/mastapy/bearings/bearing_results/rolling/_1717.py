...
from mastapy.bearings.bearing_results.rolling import _1716, _1705
...
class LoadedNeedleRollerBearingRow(_1705.LoadedCylindricalRollerBearingRow):
    '''LoadedNeedleRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1716.LoadedNeedleRollerBearingResults':
        ...
        return constructor.new(_1716.LoadedNeedleRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
