...
from mastapy.bearings import _1586
...
class LoadedPlainJournalBearingRow(_0.APIBase):
    ...
    def row(self) -> '_1586.BearingRow':
        ...
        return constructor.new(_1586.BearingRow)(value) if value else None
    ...
    @property
    def journal_bearing_loading_chart(self) -> '_7200.SMTBitmap':
        ...
        return constructor.new(_7200.SMTBitmap)(self.wrapped.JournalBearingLoadingChart) if self.wrapped.JournalBearingLoadingChart else None
