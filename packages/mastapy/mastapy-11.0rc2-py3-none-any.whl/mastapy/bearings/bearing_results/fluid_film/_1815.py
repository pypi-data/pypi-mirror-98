...
from mastapy.bearings.bearing_results.fluid_film import _1816, _1812
...
class LoadedPlainJournalBearingResults(_1812.LoadedFluidFilmBearingResults):
    '''LoadedPlainJournalBearingResults
    ...
    @property
    def journal_bearing_rows(self) -> 'List[_1816.LoadedPlainJournalBearingRow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.JournalBearingRows, constructor.new(_1816.LoadedPlainJournalBearingRow))
        return value
