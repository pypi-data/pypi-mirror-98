...
from mastapy.bearings.bearing_designs.rolling import _1833
...
class ThrustBallBearing(_1833.BallBearing):
    '''ThrustBallBearing
    ...
    @property
    def outer_ring_mounting(self) -> '_1595.OuterRingMounting':
        ...
        return constructor.new(_1595.OuterRingMounting)(value) if value else None

    @outer_ring_mounting.setter
    def outer_ring_mounting(self, value: '_1595.OuterRingMounting'):
