...
from mastapy.bearings.bearing_designs.rolling import _1851, _1848
...
class TaperRollerBearing(_1848.NonBarrelRollerBearing):
    '''TaperRollerBearing
    ...
    @property
    def bearing_measurement_type(self) -> '_1584.BearingMeasurementType':
        ...
        return constructor.new(_1584.BearingMeasurementType)(value) if value else None

    @bearing_measurement_type.setter
    def bearing_measurement_type(self, value: '_1584.BearingMeasurementType'):
    ...
    @property
    def major_rib_detail(self) -> '_1851.RollerRibDetail':
        ...
        return constructor.new(_1851.RollerRibDetail)(self.wrapped.MajorRibDetail) if self.wrapped.MajorRibDetail else None
