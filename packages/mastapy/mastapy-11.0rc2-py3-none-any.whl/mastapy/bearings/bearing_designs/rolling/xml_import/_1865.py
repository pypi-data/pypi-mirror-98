...
from mastapy.bearings.bearing_designs.rolling.xml_import import _1863, _1862
...
class XmlBearingTypeMapping(_0.APIBase):
    ...
    @property
    def files(self) -> 'List[_1863.BearingImportFile]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Files, constructor.new(_1863.BearingImportFile))
        return value

    @property
    def variables(self) -> 'List[_1862.AbstractXmlVariableAssignment]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Variables, constructor.new(_1862.AbstractXmlVariableAssignment))
        return value
