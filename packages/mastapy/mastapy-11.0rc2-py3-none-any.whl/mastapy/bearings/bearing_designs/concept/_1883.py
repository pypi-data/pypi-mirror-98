...
from mastapy.bearings.bearing_designs.concept import _1882, _1884
...
class ConceptAxialClearanceBearing(_1884.ConceptClearanceBearing):
    '''ConceptAxialClearanceBearing
    ...
    @property
    def node_position(self) -> '_1882.BearingNodePosition':
        ...
        return constructor.new(_1882.BearingNodePosition)(value) if value else None

    @node_position.setter
    def node_position(self, value: '_1882.BearingNodePosition'):
