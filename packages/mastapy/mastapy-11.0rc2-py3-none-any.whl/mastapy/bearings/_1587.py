...
class BearingSettings(_1349.PerMachineSettings):
    ...
    @property
    def failure_probability_for_rating_life_percent(self) -> '_1596.RatingLife':
        ...
        return constructor.new(_1596.RatingLife)(value) if value else None

    @failure_probability_for_rating_life_percent.setter
    def failure_probability_for_rating_life_percent(self, value: '_1596.RatingLife'):
    ...
    @property
    def include_exponent_and_reduction_factors_in_isots162812008(self) -> '_1589.ExponentAndReductionFactorsInISO16281Calculation':
        ...
        return constructor.new(_1589.ExponentAndReductionFactorsInISO16281Calculation)(value) if value else None

    @include_exponent_and_reduction_factors_in_isots162812008.setter
    def include_exponent_and_reduction_factors_in_isots162812008(self, value: '_1589.ExponentAndReductionFactorsInISO16281Calculation'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def skf_credentials(self) -> '_1791.SKFCredentials':
        ...
        return constructor.new(_1791.SKFCredentials)(self.wrapped.SKFCredentials) if self.wrapped.SKFCredentials else None
