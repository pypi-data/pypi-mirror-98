...
from mastapy.bearings.tolerances import _1620, _1612
...
class SupportDetail(_1612.InterferenceDetail):
    '''SupportDetail
    ...
    @property
    def radial_specification_method(self) -> '_1620.RadialSpecificationMethod':
        ...
        return constructor.new(_1620.RadialSpecificationMethod)(value) if value else None

    @radial_specification_method.setter
    def radial_specification_method(self, value: '_1620.RadialSpecificationMethod'):
