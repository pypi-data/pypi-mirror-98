...
from mastapy.bearings.tolerances import _1623, _1628, _1619
...
class RoundnessSpecification(_1344.IndependentReportablePropertiesBase['RoundnessSpecification']):
    ...
    @property
    def specification_type(self) -> '_1623.RoundnessSpecificationType':
        ...
        return constructor.new(_1623.RoundnessSpecificationType)(value) if value else None

    @specification_type.setter
    def specification_type(self, value: '_1623.RoundnessSpecificationType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.SpecificationType = value

    @property
    def type_of_fit(self) -> '_1628.TypeOfFit':
        '''TypeOfFit: 'TypeOfFit' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.TypeOfFit)
        return constructor.new(_1628.TypeOfFit)(value) if value else None

    @type_of_fit.setter
    def type_of_fit(self, value: '_1628.TypeOfFit'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.TypeOfFit = value

    @property
    def roundness_distribution(self) -> 'List[_1619.RaceRoundnessAtAngle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RoundnessDistribution, constructor.new(_1619.RaceRoundnessAtAngle))
        return value
