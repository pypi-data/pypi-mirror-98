...
from mastapy.bearings.tolerances import _1608, _1605
...
class InterferenceTolerance(_1605.BearingConnectionComponent):
    '''InterferenceTolerance
    ...
    @property
    def definition_option(self) -> '_1608.BearingToleranceDefinitionOptions':
    ...
    def definition_option(self, value: '_1608.BearingToleranceDefinitionOptions'):
    ...
    @property
    def mounting_point_surface_finish(self) -> '_1594.MountingPointSurfaceFinishes':
        ...
        return constructor.new(_1594.MountingPointSurfaceFinishes)(value) if value else None

    @mounting_point_surface_finish.setter
    def mounting_point_surface_finish(self, value: '_1594.MountingPointSurfaceFinishes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
