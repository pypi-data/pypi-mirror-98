...
from mastapy.math_utility.stiffness_calculators import _1301
...
class SurfaceToSurfaceContactStiffnessEntity(_122.ArbitraryNodalComponent):
    ...
    @property
    def contact(self) -> '_1301.SurfaceToSurfaceContact':
        ...
        return constructor.new(_1301.SurfaceToSurfaceContact)(self.wrapped.Contact) if self.wrapped.Contact else None
