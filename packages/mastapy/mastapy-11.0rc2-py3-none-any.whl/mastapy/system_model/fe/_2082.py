...
from mastapy.system_model.fe import _2036, _2043
...
class RaceBearingFE(_0.APIBase):
    ...
    @property
    def alignment_method(self) -> '_2036.AlignmentMethodForRaceBearing':
        ...
        return constructor.new(_2036.AlignmentMethodForRaceBearing)(value) if value else None

    @alignment_method.setter
    def alignment_method(self, value: '_2036.AlignmentMethodForRaceBearing'):
    ...
    @property
    def links(self) -> 'List[_2043.BearingRaceNodeLink]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Links, constructor.new(_2043.BearingRaceNodeLink))
        return value
