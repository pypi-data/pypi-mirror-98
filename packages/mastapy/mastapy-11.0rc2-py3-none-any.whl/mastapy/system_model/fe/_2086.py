...
from mastapy.system_model.fe import _2081, _2080
...
class SystemDeflectionFEExportOptions(_0.APIBase):
    ...
    @property
    def nodes(self) -> 'List[_2081.PerNodeExportOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Nodes, constructor.new(_2081.PerNodeExportOptions))
        return value

    @property
    def links(self) -> 'List[_2080.PerLinkExportOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Links, constructor.new(_2080.PerLinkExportOptions))
        return value
