...
from mastapy.system_model.fe import (
    _2041, _2064, _2087, _2035,
    _2037, _2062, _2085, _2063,
    _2059, _2071, _2072, _2070,
    _2067, _2068, _2069
)
from mastapy._internal.python_net import python_net_import
from mastapy.system_model.part_model import _2125, _2121, _2129
...
from mastapy.system_model.fe.links import _2094
...
class FESubstructure(_60.FEStiffness):
    ...
    @property
    def bearing_node_alignment(self) -> '_2041.BearingNodeAlignmentOption':
        ...
        return constructor.new(_2041.BearingNodeAlignmentOption)(value) if value else None

    @bearing_node_alignment.setter
    def bearing_node_alignment(self, value: '_2041.BearingNodeAlignmentOption'):
    ...
    @property
    def alignment_method(self) -> '_2035.AlignmentMethod':
        ...
        return constructor.new(_2035.AlignmentMethod)(value) if value else None

    @alignment_method.setter
    def alignment_method(self, value: '_2035.AlignmentMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def alignment_to_component(self) -> '_1903.RelativeComponentAlignment[_2121.Component]':
        ...
        return constructor.new(_1903.RelativeComponentAlignment)[_2121.Component](self.wrapped.AlignmentToComponent) if self.wrapped.AlignmentToComponent else None

    @property
    def alignment_using_axial_node_positions(self) -> '_2037.AlignmentUsingAxialNodePositions':
        ...
        return constructor.new(_2037.AlignmentUsingAxialNodePositions)(self.wrapped.AlignmentUsingAxialNodePositions) if self.wrapped.AlignmentUsingAxialNodePositions else None
    ...
    @property
    def export(self) -> '_2062.FESubstructureExportOptions':
        ...
        return constructor.new(_2062.FESubstructureExportOptions)(self.wrapped.Export) if self.wrapped.Export else None
    ...
    @property
    def shafts_that_can_be_replaced(self) -> 'List[_2085.ReplacedShaftSelectionHelper]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftsThatCanBeReplaced, constructor.new(_2085.ReplacedShaftSelectionHelper))
        return value
    ...
    @property
    def replaced_shafts(self) -> 'List[_2157.Shaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ReplacedShafts, constructor.new(_2157.Shaft))
        return value

    @property
    def links(self) -> 'List[_2094.FELink]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Links, constructor.new(_2094.FELink))
        return value

    @property
    def thermal_expansion_forces(self) -> 'List[_1328.VectorWithLinearAndAngularComponents]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ThermalExpansionForces, constructor.new(_1328.VectorWithLinearAndAngularComponents))
        return value

    @property
    def thermal_expansion_displacements(self) -> 'List[_1328.VectorWithLinearAndAngularComponents]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ThermalExpansionDisplacements, constructor.new(_1328.VectorWithLinearAndAngularComponents))
        return value

    @property
    def geometries(self) -> 'List[_2059.FEStiffnessGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Geometries, constructor.new(_2059.FEStiffnessGeometry))
        return value

    @property
    def gear_meshing_options(self) -> 'List[_2071.GearMeshingOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshingOptions, constructor.new(_2071.GearMeshingOptions))
        return value

    @property
    def independent_masta_created_condensation_nodes(self) -> 'List[_2072.IndependentMastaCreatedCondensationNode]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.IndependentMastaCreatedCondensationNodes, constructor.new(_2072.IndependentMastaCreatedCondensationNode))
        return value

    @property
    def fe_part(self) -> '_2129.FEPart':
        ...
        return constructor.new(_2129.FEPart)(self.wrapped.FEPart) if self.wrapped.FEPart else None
    ...
    def load_existing_masta_fe_file_with_progress(self, file_name: 'str', progress: '_7195.TaskProgress'):
        ''' 'LoadExistingMastaFEFile' is the original name of this method.
    ...
    def create_fe_substructure_with_selection_for_static_analysis(self) -> '_2070.FESubstructureWithSelectionForStaticAnalysis':
    ...
    def create_fe_substructure_with_selection_components(self) -> '_2067.FESubstructureWithSelectionComponents':
    ...
    def create_fe_substructure_with_selection_for_harmonic_analysis(self) -> '_2068.FESubstructureWithSelectionForHarmonicAnalysis':
    ...
    def create_fe_substructure_with_selection_for_modal_analysis(self) -> '_2069.FESubstructureWithSelectionForModalAnalysis':
    ...
    def import_fe_mesh(self, file_path: 'str', format_: '_149.FEExportFormat', length_scale: Optional['float'] = 1.0, force_scale: Optional['float'] = 1.0, progress: Optional['_7195.TaskProgress'] = None):
    ...
    def links_for(self, node: '_2063.FESubstructureNode') -> 'List[_2094.FELink]':
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.LinksFor(node.wrapped if node else None), constructor.new(_2094.FELink))
