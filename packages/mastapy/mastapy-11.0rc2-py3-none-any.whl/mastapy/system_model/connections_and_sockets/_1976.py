...
from mastapy.system_model.connections_and_sockets import _1977
...
class SocketConnectionOptions(_0.APIBase):
    ...
    @property
    def sockets(self) -> 'List[_1977.SocketConnectionSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Sockets, constructor.new(_1977.SocketConnectionSelection))
        return value
