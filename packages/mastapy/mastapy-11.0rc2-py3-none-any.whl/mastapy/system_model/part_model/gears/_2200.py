...
from mastapy.system_model.part_model.gears.supercharger_rotor_set import _2237
from mastapy.system_model.part_model.gears import _2199, _2206
...
class CylindricalGearSet(_2206.GearSet):
    '''CylindricalGearSet
    ...
    @property
    def supercharger_rotor_set(self) -> '_2237.SuperchargerRotorSet':
        ...
        return constructor.new(_2237.SuperchargerRotorSet)(self.wrapped.SuperchargerRotorSet) if self.wrapped.SuperchargerRotorSet else None

    @property
    def cylindrical_gears(self) -> 'List[_2199.CylindricalGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGears, constructor.new(_2199.CylindricalGear))
        return value

    @property
    def cylindrical_meshes(self) -> 'List[_1988.CylindricalGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshes, constructor.new(_1988.CylindricalGearMesh))
        return value
