...
from mastapy.system_model.part_model.gears import _2217, _2194
...
class SpiralBevelGearSet(_2194.BevelGearSet):
    '''SpiralBevelGearSet
    ...
    @property
    def spiral_bevel_gears(self) -> 'List[_2217.SpiralBevelGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGears, constructor.new(_2217.SpiralBevelGear))
        return value

    @property
    def spiral_bevel_meshes(self) -> 'List[_2002.SpiralBevelGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshes, constructor.new(_2002.SpiralBevelGearMesh))
        return value
