...
from mastapy.system_model.part_model.gears import _2202, _2206
...
class FaceGearSet(_2206.GearSet):
    '''FaceGearSet
    ...
    @property
    def face_gears(self) -> 'List[_2202.FaceGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGears, constructor.new(_2202.FaceGear))
        return value

    @property
    def face_meshes(self) -> 'List[_1990.FaceGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshes, constructor.new(_1990.FaceGearMesh))
        return value
