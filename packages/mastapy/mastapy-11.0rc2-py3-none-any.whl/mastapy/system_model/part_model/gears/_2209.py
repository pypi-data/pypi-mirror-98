...
from mastapy.system_model.part_model.gears import _2208, _2188
...
class HypoidGearSet(_2188.AGMAGleasonConicalGearSet):
    '''HypoidGearSet
    ...
    @property
    def hypoid_gears(self) -> 'List[_2208.HypoidGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGears, constructor.new(_2208.HypoidGear))
        return value

    @property
    def hypoid_meshes(self) -> 'List[_1994.HypoidGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshes, constructor.new(_1994.HypoidGearMesh))
        return value
