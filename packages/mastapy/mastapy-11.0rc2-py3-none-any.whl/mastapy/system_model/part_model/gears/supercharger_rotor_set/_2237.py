...
class SuperchargerRotorSet(_1556.NamedDatabaseItem):
    ...
    @property
    def y_variable_for_imported_data(self) -> '_2239.YVariableForImportedData':
        ...
        return constructor.new(_2239.YVariableForImportedData)(value) if value else None

    @y_variable_for_imported_data.setter
    def y_variable_for_imported_data(self, value: '_2239.YVariableForImportedData'):
    ...
    @property
    def file(self) -> '_2232.RotorSetDataInputFileOptions':
        ...
        return constructor.new(_2232.RotorSetDataInputFileOptions)(self.wrapped.File) if self.wrapped.File else None

    @property
    def rotor_speed(self) -> '_2234.RotorSpeedInputOptions':
        ...
        return constructor.new(_2234.RotorSpeedInputOptions)(self.wrapped.RotorSpeed) if self.wrapped.RotorSpeed else None

    @property
    def boost_pressure(self) -> '_2229.BoostPressureInputOptions':
        ...
        return constructor.new(_2229.BoostPressureInputOptions)(self.wrapped.BoostPressure) if self.wrapped.BoostPressure else None

    @property
    def pressure_ratio(self) -> '_2231.PressureRatioInputOptions':
        ...
        return constructor.new(_2231.PressureRatioInputOptions)(self.wrapped.PressureRatio) if self.wrapped.PressureRatio else None

    @property
    def input_power(self) -> '_2230.InputPowerInputOptions':
        ...
        return constructor.new(_2230.InputPowerInputOptions)(self.wrapped.InputPower) if self.wrapped.InputPower else None

    @property
    def measured_points(self) -> 'List[_2233.RotorSetMeasuredPoint]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeasuredPoints, constructor.new(_2233.RotorSetMeasuredPoint))
        return value
