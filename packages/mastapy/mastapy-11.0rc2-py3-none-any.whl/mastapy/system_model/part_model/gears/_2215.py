...
from mastapy.system_model.part_model.gears import _2214, _2211
...
class KlingelnbergCycloPalloidSpiralBevelGearSet(_2211.KlingelnbergCycloPalloidConicalGearSet):
    '''KlingelnbergCycloPalloidSpiralBevelGearSet
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gears(self) -> 'List[_2214.KlingelnbergCycloPalloidSpiralBevelGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidSpiralBevelGears, constructor.new(_2214.KlingelnbergCycloPalloidSpiralBevelGear))
        return value

    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes(self) -> 'List[_1999.KlingelnbergCycloPalloidSpiralBevelGearMesh]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidSpiralBevelMeshes, constructor.new(_1999.KlingelnbergCycloPalloidSpiralBevelGearMesh))
        return value
