...
from mastapy.system_model.part_model.part_groups import _2161, _2162, _2165
...
class ConcentricPartGroupParallelToThis(_0.APIBase):
    ...
    @property
    def parallel_group(self) -> '_2161.ConcentricOrParallelPartGroup':
        ...
        if _2161.ConcentricOrParallelPartGroup.TYPE not in self.wrapped.ParallelGroup.__class__.__mro__:
    ...
    @property
    def parallel_group_of_type_concentric_part_group(self) -> '_2162.ConcentricPartGroup':
        ...
        if _2162.ConcentricPartGroup.TYPE not in self.wrapped.ParallelGroup.__class__.__mro__:
    ...
    @property
    def parallel_group_of_type_parallel_part_group(self) -> '_2165.ParallelPartGroup':
        ...
        if _2165.ParallelPartGroup.TYPE not in self.wrapped.ParallelGroup.__class__.__mro__:
