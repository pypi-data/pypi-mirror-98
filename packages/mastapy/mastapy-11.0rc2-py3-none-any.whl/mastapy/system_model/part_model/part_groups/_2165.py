...
from mastapy.system_model.part_model.part_groups import _2162, _2164, _2161
...
class ParallelPartGroup(_2161.ConcentricOrParallelPartGroup):
    '''ParallelPartGroup
    ...
    @property
    def concentric_part_groups(self) -> 'List[_2162.ConcentricPartGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConcentricPartGroups, constructor.new(_2162.ConcentricPartGroup))
        return value

    @property
    def design_measurements(self) -> 'List[_2164.DesignMeasurements]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignMeasurements, constructor.new(_2164.DesignMeasurements))
        return value
