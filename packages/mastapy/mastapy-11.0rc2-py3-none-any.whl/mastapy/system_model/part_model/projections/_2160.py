...
from mastapy.system_model.part_model.projections import _2159
...
class SpecifiedParallelPartGroupDrawingOrder(_0.APIBase):
    ...
    @property
    def specified_groups(self) -> 'List[_2159.SpecifiedConcentricPartGroupDrawingOrder]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpecifiedGroups, constructor.new(_2159.SpecifiedConcentricPartGroupDrawingOrder))
        return value
