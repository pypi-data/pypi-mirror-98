...
from mastapy.system_model.part_model.couplings import _2277, _2279
...
class SynchroniserHalf(_2279.SynchroniserPart):
    '''SynchroniserHalf
    ...
    @property
    def cones(self) -> 'List[_2277.SynchroniserCone]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Cones, constructor.new(_2277.SynchroniserCone))
        return value
