...
from mastapy.system_model.part_model.couplings import _2254, _2257
...
class Clutch(_2257.Coupling):
    ...
    @property
    def clutch_type(self) -> '_2254.ClutchType':
        '''ClutchType: 'ClutchType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.ClutchType)
        return constructor.new(_2254.ClutchType)(value) if value else None

    @clutch_type.setter
    def clutch_type(self, value: '_2254.ClutchType'):
    ...
    @property
    def spring_type(self) -> '_5058.ClutchSpringType':
        '''ClutchSpringType: 'SpringType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.SpringType)
        return constructor.new(_5058.ClutchSpringType)(value) if value else None

    @spring_type.setter
    def spring_type(self, value: '_5058.ClutchSpringType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def clutch_connection(self) -> '_2021.ClutchConnection':
        ...
        return constructor.new(_2021.ClutchConnection)(self.wrapped.ClutchConnection) if self.wrapped.ClutchConnection else None
