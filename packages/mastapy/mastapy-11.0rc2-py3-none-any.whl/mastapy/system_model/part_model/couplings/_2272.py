...
class ShaftHubConnection(_2124.Connector):
    '''ShaftHubConnection
    ...
    @property
    def tilt_stiffness_type(self) -> '_2266.RigidConnectorTiltStiffnessTypes':
        ...
        return constructor.new(_2266.RigidConnectorTiltStiffnessTypes)(value) if value else None

    @tilt_stiffness_type.setter
    def tilt_stiffness_type(self, value: '_2266.RigidConnectorTiltStiffnessTypes'):
    ...
    @property
    def two_d_spline_drawing(self) -> '_7200.SMTBitmap':
        ...
        return constructor.new(_7200.SMTBitmap)(self.wrapped.TwoDSplineDrawing) if self.wrapped.TwoDSplineDrawing else None
    ...
    @property
    def left_flank_lead_relief(self) -> '_2273.SplineLeadRelief':
        ...
        return constructor.new(_2273.SplineLeadRelief)(self.wrapped.LeftFlankLeadRelief) if self.wrapped.LeftFlankLeadRelief else None

    @property
    def right_flank_lead_relief(self) -> '_2273.SplineLeadRelief':
        ...
        return constructor.new(_2273.SplineLeadRelief)(self.wrapped.RightFlankLeadRelief) if self.wrapped.RightFlankLeadRelief else None

    @property
    def tooth_locations_external_spline_half(self) -> 'List[_2267.RigidConnectorToothLocation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ToothLocationsExternalSplineHalf, constructor.new(_2267.RigidConnectorToothLocation))
        return value

    @property
    def lead_reliefs(self) -> 'List[_2273.SplineLeadRelief]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LeadReliefs, constructor.new(_2273.SplineLeadRelief))
        return value
