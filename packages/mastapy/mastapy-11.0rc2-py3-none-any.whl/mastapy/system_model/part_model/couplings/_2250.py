...
from mastapy.system_model.part_model.couplings import _2251, _2264
...
class BeltDrive(_2152.SpecialisedAssembly):
    '''BeltDrive
    ...
    @property
    def type_of_belt(self) -> '_2251.BeltDriveType':
        '''BeltDriveType: 'TypeOfBelt' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.TypeOfBelt)
        return constructor.new(_2251.BeltDriveType)(value) if value else None

    @type_of_belt.setter
    def type_of_belt(self, value: '_2251.BeltDriveType'):
    ...
    @property
    def pulleys(self) -> 'List[_2264.Pulley]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Pulleys, constructor.new(_2264.Pulley))
        return value

    @property
    def belt_connections(self) -> 'List[_1947.BeltConnection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BeltConnections, constructor.new(_1947.BeltConnection))
        return value
