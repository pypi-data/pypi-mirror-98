...
class SplineLeadRelief(_0.APIBase):
    ...
    @property
    def contact_position(self) -> '_1300.IndividualContactPosition':
        ...
        return constructor.new(_1300.IndividualContactPosition)(value) if value else None
    ...
    @property
    def crowning(self) -> '_2259.CrowningSpecification':
        ...
        return constructor.new(_2259.CrowningSpecification)(self.wrapped.Crowning) if self.wrapped.Crowning else None
