...
from mastapy.system_model.part_model import _2137, _2140
...
class PlanetCarrier(_2140.MountableComponent):
    '''PlanetCarrier
    ...
    @property
    def load_sharing_settings(self) -> '_2137.LoadSharingSettings':
        ...
        return constructor.new(_2137.LoadSharingSettings)(self.wrapped.LoadSharingSettings) if self.wrapped.LoadSharingSettings else None

    @property
    def planetary_sockets(self) -> 'List[_1967.PlanetarySocket]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetarySockets, constructor.new(_1967.PlanetarySocket))
        return value

    def attach_carrier_shaft(self, shaft: '_2157.Shaft', offset: Optional['float'] = float('nan')):
    ...
    def attach_pin_shaft(self, shaft: '_2157.Shaft', offset: Optional['float'] = float('nan')):
