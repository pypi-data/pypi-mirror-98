...
class ShaftBow(_0.APIBase):
    ...
    @property
    def linear_displacement(self) -> 'List[_1297.Vector4D]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LinearDisplacement, constructor.new(_1297.Vector4D))
        return value
