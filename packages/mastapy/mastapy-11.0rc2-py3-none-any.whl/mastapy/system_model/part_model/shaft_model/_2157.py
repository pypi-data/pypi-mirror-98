...
class Shaft(_2113.AbstractShaft):
    '''Shaft
    ...
    @property
    def guide_image(self) -> '_2132.GuideImage':
        ...
        return constructor.new(_2132.GuideImage)(self.wrapped.GuideImage) if self.wrapped.GuideImage else None
    ...
    def mount_component(self, component: '_2140.MountableComponent', offset: 'float'):
