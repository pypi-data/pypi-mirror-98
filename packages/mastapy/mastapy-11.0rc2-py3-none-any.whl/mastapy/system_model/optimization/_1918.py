...
from mastapy.system_model.optimization import _1919, _1917
...
TStep = TypeVar('TStep', bound='_1917.OptimizationStep')


class OptimizationStrategy(_1919.OptimizationStrategyBase, Generic[TStep]):
    '''OptimizationStrategy
