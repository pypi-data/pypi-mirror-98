...
from mastapy.system_model.drawing import _1934, _1930
...
class ContourDrawStyle(_271.DrawStyleBase):
    ...
    @property
    def deflection_scaling(self) -> '_1934.ScalingDrawStyle':
        ...
        return constructor.new(_1934.ScalingDrawStyle)(self.wrapped.DeflectionScaling) if self.wrapped.DeflectionScaling else None

    @property
    def model_view_options(self) -> '_1930.ModelViewOptionsDrawStyle':
        ...
        return constructor.new(_1930.ModelViewOptionsDrawStyle)(self.wrapped.ModelViewOptions) if self.wrapped.ModelViewOptions else None
