...
from mastapy.system_model.drawing import _1935
...
class ConcentricPartGroupCombinationSystemDeflectionShaftResults(_0.APIBase):
    ...
    @property
    def shaft_system_deflection(self) -> '_2469.ShaftSystemDeflection':
        ...
        return constructor.new(_2469.ShaftSystemDeflection)(self.wrapped.ShaftSystemDeflection) if self.wrapped.ShaftSystemDeflection else None

    @property
    def node_results(self) -> 'List[_1935.ShaftDeflectionDrawingNodeItem]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.NodeResults, constructor.new(_1935.ShaftDeflectionDrawingNodeItem))
        return value
