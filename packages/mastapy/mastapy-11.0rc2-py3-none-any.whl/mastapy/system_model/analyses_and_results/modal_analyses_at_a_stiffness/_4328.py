...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _2310, _4240
...
class RootAssemblyModalAnalysisAtAStiffness(_4240.AssemblyModalAnalysisAtAStiffness):
    '''RootAssemblyModalAnalysisAtAStiffness
    ...
    @property
    def modal_analysis_at_a_stiffness_inputs(self) -> '_2310.ModalAnalysisAtAStiffness':
        ...
        return constructor.new(_2310.ModalAnalysisAtAStiffness)(self.wrapped.ModalAnalysisAtAStiffnessInputs) if self.wrapped.ModalAnalysisAtAStiffnessInputs else None
