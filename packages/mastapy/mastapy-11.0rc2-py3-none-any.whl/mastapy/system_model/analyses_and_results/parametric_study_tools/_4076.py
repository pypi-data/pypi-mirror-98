...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4075, _4074, _3975
...
class SpiralBevelGearSetParametricStudyTool(_3975.BevelGearSetParametricStudyTool):
    '''SpiralBevelGearSetParametricStudyTool
    ...
    @property
    def spiral_bevel_gears_parametric_study_tool(self) -> 'List[_4075.SpiralBevelGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearsParametricStudyTool, constructor.new(_4075.SpiralBevelGearParametricStudyTool))
        return value

    @property
    def spiral_bevel_meshes_parametric_study_tool(self) -> 'List[_4074.SpiralBevelGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshesParametricStudyTool, constructor.new(_4074.SpiralBevelGearMeshParametricStudyTool))
        return value

    @property
    def assembly_system_deflection_results(self) -> 'List[_2473.SpiralBevelGearSetSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2473.SpiralBevelGearSetSystemDeflection))
        return value
