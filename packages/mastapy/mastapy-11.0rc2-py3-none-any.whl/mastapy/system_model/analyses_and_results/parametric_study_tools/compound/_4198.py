...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _4051, _4050
from mastapy._internal import constructor
from mastapy.system_model.analyses_and_results.load_case_groups import (
    _5314, _5313, _5315, _5318,
    _5319, _5321, _5323
)
...
class RootAssemblyCompoundParametricStudyTool(_4111.AssemblyCompoundParametricStudyTool):
    '''RootAssemblyCompoundParametricStudyTool
    ...
    @property
    def compound_load_case(self) -> '_5314.AbstractLoadCaseGroup':
        ...
        if _5314.AbstractLoadCaseGroup.TYPE not in self.wrapped.CompoundLoadCase.__class__.__mro__:
    ...
    @property
    def compound_load_case_of_type_abstract_design_state_load_case_group(self) -> '_5313.AbstractDesignStateLoadCaseGroup':
        ...
        if _5313.AbstractDesignStateLoadCaseGroup.TYPE not in self.wrapped.CompoundLoadCase.__class__.__mro__:
    ...
    @property
    def compound_load_case_of_type_abstract_static_load_case_group(self) -> '_5315.AbstractStaticLoadCaseGroup':
        ...
        if _5315.AbstractStaticLoadCaseGroup.TYPE not in self.wrapped.CompoundLoadCase.__class__.__mro__:
    ...
    @property
    def compound_load_case_of_type_design_state(self) -> '_5318.DesignState':
        ...
        if _5318.DesignState.TYPE not in self.wrapped.CompoundLoadCase.__class__.__mro__:
    ...
    @property
    def compound_load_case_of_type_duty_cycle(self) -> '_5319.DutyCycle':
        ...
        if _5319.DutyCycle.TYPE not in self.wrapped.CompoundLoadCase.__class__.__mro__:
    ...
    @property
    def compound_load_case_of_type_group_of_time_series_load_cases(self) -> '_5321.GroupOfTimeSeriesLoadCases':
        ...
        if _5321.GroupOfTimeSeriesLoadCases.TYPE not in self.wrapped.CompoundLoadCase.__class__.__mro__:
    ...
    @property
    def compound_load_case_of_type_sub_group_in_single_design_state(self) -> '_5323.SubGroupInSingleDesignState':
        ...
        if _5323.SubGroupInSingleDesignState.TYPE not in self.wrapped.CompoundLoadCase.__class__.__mro__:
    ...
    @property
    def root_assembly_duty_cycle_results(self) -> '_2568.DutyCycleEfficiencyResults':
        ...
        return constructor.new(_2568.DutyCycleEfficiencyResults)(self.wrapped.RootAssemblyDutyCycleResults) if self.wrapped.RootAssemblyDutyCycleResults else None
