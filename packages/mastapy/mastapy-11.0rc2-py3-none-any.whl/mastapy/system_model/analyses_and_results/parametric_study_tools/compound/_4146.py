...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4192
...
class CVTPulleyCompoundParametricStudyTool(_4192.PulleyCompoundParametricStudyTool):
    '''CVTPulleyCompoundParametricStudyTool
