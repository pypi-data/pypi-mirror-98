...
class RingPinsToDiscConnectionCompoundParametricStudyTool(_4169.InterMountableComponentConnectionCompoundParametricStudyTool):
    '''RingPinsToDiscConnectionCompoundParametricStudyTool
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4065.RingPinsToDiscConnectionParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4065.RingPinsToDiscConnectionParametricStudyTool))
        return value

    @property
    def connection_parametric_study_tool_load_cases(self) -> 'List[_4065.RingPinsToDiscConnectionParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionParametricStudyToolLoadCases, constructor.new(_4065.RingPinsToDiscConnectionParametricStudyTool))
        return value
