...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _4183
...
class AbstractAssemblyCompoundParametricStudyTool(_4183.PartCompoundParametricStudyTool):
    '''AbstractAssemblyCompoundParametricStudyTool
