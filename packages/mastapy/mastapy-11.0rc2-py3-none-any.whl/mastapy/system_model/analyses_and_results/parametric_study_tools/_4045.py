...
class ParametricStudyDOEResultVariable(_1317.ParetoOptimisationVariableBase):
    '''ParametricStudyDOEResultVariable
    ...
    @property
    def target(self) -> '_1319.PropertyTargetForDominantCandidateSearch':
    ...
    @target.setter
    def target(self, value: '_1319.PropertyTargetForDominantCandidateSearch'):
