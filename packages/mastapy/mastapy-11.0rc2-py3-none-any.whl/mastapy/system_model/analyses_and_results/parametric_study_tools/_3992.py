...
class ConnectionParametricStudyTool(_7176.ConnectionAnalysisCase):
    '''ConnectionParametricStudyTool
    ...
    @property
    def parametric_study_tool(self) -> '_4049.ParametricStudyTool':
        ...
        return constructor.new(_4049.ParametricStudyTool)(self.wrapped.ParametricStudyTool) if self.wrapped.ParametricStudyTool else None
