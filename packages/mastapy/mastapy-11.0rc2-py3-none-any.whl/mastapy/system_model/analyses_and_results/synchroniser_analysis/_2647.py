...
class SynchroniserShift(_0.APIBase):
    ...
    @property
    def cone(self) -> '_2278.SynchroniserHalf':
        ...
        return constructor.new(_2278.SynchroniserHalf)(self.wrapped.Cone) if self.wrapped.Cone else None

    @property
    def sleeve(self) -> '_2280.SynchroniserSleeve':
        ...
        return constructor.new(_2280.SynchroniserSleeve)(self.wrapped.Sleeve) if self.wrapped.Sleeve else None
