...
class DesignEntityAnalysis(_0.APIBase):
    ...
    @property
    def component_design(self) -> '_1890.DesignEntity':
        ...
        if _1890.DesignEntity.TYPE not in self.wrapped.ComponentDesign.__class__.__mro__:
    ...
    @property
    def component_design_of_type_connection(self) -> '_1951.Connection':
    ...
    @property
    def component_design_of_type_part(self) -> '_2144.Part':
