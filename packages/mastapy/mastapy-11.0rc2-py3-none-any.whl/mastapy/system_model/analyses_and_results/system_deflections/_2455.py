...
class PlanetCarrierSystemDeflection(_2447.MountableComponentSystemDeflection):
    '''PlanetCarrierSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3781.PlanetCarrierPowerFlow':
        ...
        return constructor.new(_3781.PlanetCarrierPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None

    @property
    def windup(self) -> 'List[_2511.PlanetCarrierWindup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Windup, constructor.new(_2511.PlanetCarrierWindup))
        return value
