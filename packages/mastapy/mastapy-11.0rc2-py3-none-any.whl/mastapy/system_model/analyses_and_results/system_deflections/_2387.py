...
class ConceptGearMeshSystemDeflection(_2424.GearMeshSystemDeflection):
    '''ConceptGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3724.ConceptGearMeshPowerFlow':
        ...
        return constructor.new(_3724.ConceptGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
