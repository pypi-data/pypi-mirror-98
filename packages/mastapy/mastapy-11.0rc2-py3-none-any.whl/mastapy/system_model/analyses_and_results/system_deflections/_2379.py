...
class ClutchHalfSystemDeflection(_2397.CouplingHalfSystemDeflection):
    '''ClutchHalfSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3717.ClutchHalfPowerFlow':
        ...
        return constructor.new(_3717.ClutchHalfPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
