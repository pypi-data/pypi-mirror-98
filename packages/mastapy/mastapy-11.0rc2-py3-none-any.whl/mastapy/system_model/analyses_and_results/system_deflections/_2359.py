...
from mastapy.system_model.analyses_and_results.power_flows import _3697, _3741, _3794
...
class AbstractShaftSystemDeflection(_2358.AbstractShaftOrHousingSystemDeflection):
    '''AbstractShaftSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3697.AbstractShaftPowerFlow':
