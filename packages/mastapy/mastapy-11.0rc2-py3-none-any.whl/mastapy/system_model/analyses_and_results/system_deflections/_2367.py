...
from mastapy.system_model.analyses_and_results.system_deflections import _2366, _2471
...
class BeltDriveSystemDeflection(_2471.SpecialisedAssemblySystemDeflection):
    '''BeltDriveSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3705.BeltDrivePowerFlow':
    ...
    @property
    def belts(self) -> 'List[_2366.BeltConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Belts, constructor.new(_2366.BeltConnectionSystemDeflection))
        return value
