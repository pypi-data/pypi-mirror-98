...
class SpringDamperHalfSystemDeflection(_2397.CouplingHalfSystemDeflection):
    '''SpringDamperHalfSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3801.SpringDamperHalfPowerFlow':
        ...
        return constructor.new(_3801.SpringDamperHalfPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
