...
class PlanetaryConnectionSystemDeflection(_2470.ShaftToMountableComponentConnectionSystemDeflection):
    '''PlanetaryConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3779.PlanetaryConnectionPowerFlow':
        ...
        return constructor.new(_3779.PlanetaryConnectionPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
