...
class CouplingConnectionSystemDeflection(_2432.InterMountableComponentConnectionSystemDeflection):
    '''CouplingConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3732.CouplingConnectionPowerFlow':
