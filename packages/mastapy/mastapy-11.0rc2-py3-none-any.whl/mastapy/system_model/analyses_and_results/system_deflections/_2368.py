...
class BevelDifferentialGearMeshSystemDeflection(_2373.BevelGearMeshSystemDeflection):
    '''BevelDifferentialGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3706.BevelDifferentialGearMeshPowerFlow':
        ...
        return constructor.new(_3706.BevelDifferentialGearMeshPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
