...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2525
...
class CVTBeltConnectionCompoundSystemDeflection(_2525.BeltConnectionCompoundSystemDeflection):
    '''CVTBeltConnectionCompoundSystemDeflection
