...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2516
...
class SpecialisedAssemblyCompoundSystemDeflection(_2516.AbstractAssemblyCompoundSystemDeflection):
    '''SpecialisedAssemblyCompoundSystemDeflection
