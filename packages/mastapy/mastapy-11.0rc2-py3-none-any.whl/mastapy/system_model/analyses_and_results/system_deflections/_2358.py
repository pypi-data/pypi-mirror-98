...
from mastapy.system_model.part_model import _2114, _2113, _2129
...
class AbstractShaftOrHousingSystemDeflection(_2382.ComponentSystemDeflection):
    '''AbstractShaftOrHousingSystemDeflection
    ...
    @property
    def component_design(self) -> '_2114.AbstractShaftOrHousing':
    ...
    @property
    def power_flow_results(self) -> '_3696.AbstractShaftOrHousingPowerFlow':
        ...
        if _3696.AbstractShaftOrHousingPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_abstract_shaft_power_flow(self) -> '_3697.AbstractShaftPowerFlow':
        ...
        if _3697.AbstractShaftPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_cycloidal_disc_power_flow(self) -> '_3741.CycloidalDiscPowerFlow':
        ...
        if _3741.CycloidalDiscPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_fe_part_power_flow(self) -> '_3752.FEPartPowerFlow':
        ...
        if _3752.FEPartPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
    ...
    @property
    def power_flow_results_of_type_shaft_power_flow(self) -> '_3794.ShaftPowerFlow':
        ...
        if _3794.ShaftPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
