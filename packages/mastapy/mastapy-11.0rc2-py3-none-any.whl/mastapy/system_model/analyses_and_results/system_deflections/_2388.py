...
from mastapy.system_model.analyses_and_results.system_deflections import _2389, _2387, _2425
...
class ConceptGearSetSystemDeflection(_2425.GearSetSystemDeflection):
    '''ConceptGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3726.ConceptGearSetPowerFlow':
        ...
        return constructor.new(_3726.ConceptGearSetPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
    ...
    @property
    def concept_gears_system_deflection(self) -> 'List[_2389.ConceptGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsSystemDeflection, constructor.new(_2389.ConceptGearSystemDeflection))
        return value

    @property
    def concept_meshes_system_deflection(self) -> 'List[_2387.ConceptGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesSystemDeflection, constructor.new(_2387.ConceptGearMeshSystemDeflection))
        return value
