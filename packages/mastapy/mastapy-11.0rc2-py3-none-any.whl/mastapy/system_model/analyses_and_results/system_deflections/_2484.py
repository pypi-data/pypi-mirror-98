...
class StraightBevelPlanetGearSystemDeflection(_2480.StraightBevelDiffGearSystemDeflection):
    '''StraightBevelPlanetGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3809.StraightBevelPlanetGearPowerFlow':
        ...
        return constructor.new(_3809.StraightBevelPlanetGearPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
