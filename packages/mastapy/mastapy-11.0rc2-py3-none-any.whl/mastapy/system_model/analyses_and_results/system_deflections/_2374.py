...
class BevelGearSetSystemDeflection(_2362.AGMAGleasonConicalGearSetSystemDeflection):
    '''BevelGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3713.BevelGearSetPowerFlow':
