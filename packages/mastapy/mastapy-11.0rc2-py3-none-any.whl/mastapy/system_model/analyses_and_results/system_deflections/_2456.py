...
class PointLoadSystemDeflection(_2500.VirtualComponentSystemDeflection):
    '''PointLoadSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3782.PointLoadPowerFlow':
        ...
        return constructor.new(_3782.PointLoadPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
