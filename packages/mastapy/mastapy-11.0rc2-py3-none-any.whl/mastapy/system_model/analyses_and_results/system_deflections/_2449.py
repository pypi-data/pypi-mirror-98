...
class OilSealSystemDeflection(_2395.ConnectorSystemDeflection):
    '''OilSealSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3774.OilSealPowerFlow':
        ...
        return constructor.new(_3774.OilSealPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
