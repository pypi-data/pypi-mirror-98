...
from mastapy.system_model.analyses_and_results.power_flows import _3719, _3739
...
class CoaxialConnectionSystemDeflection(_2470.ShaftToMountableComponentConnectionSystemDeflection):
    '''CoaxialConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3719.CoaxialConnectionPowerFlow':
