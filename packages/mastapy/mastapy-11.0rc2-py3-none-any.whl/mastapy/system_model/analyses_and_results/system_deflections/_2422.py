...
from mastapy.math_utility.measured_vectors import _1328, _1324
...
class FEPartSystemDeflection(_2358.AbstractShaftOrHousingSystemDeflection):
    '''FEPartSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3752.FEPartPowerFlow':
        ...
        return constructor.new(_3752.FEPartPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
    ...
    @property
    def applied_internal_forces_in_world_coordinate_system(self) -> 'List[_1328.VectorWithLinearAndAngularComponents]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AppliedInternalForcesInWorldCoordinateSystem, constructor.new(_1328.VectorWithLinearAndAngularComponents))
        return value

    @property
    def node_results_in_shaft_coordinate_system(self) -> 'List[_1324.ForceAndDisplacementResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.NodeResultsInShaftCoordinateSystem, constructor.new(_1324.ForceAndDisplacementResults))
        return value

    @property
    def export(self) -> '_2086.SystemDeflectionFEExportOptions':
        ...
        return constructor.new(_2086.SystemDeflectionFEExportOptions)(self.wrapped.Export) if self.wrapped.Export else None
