...
from mastapy.system_model.analyses_and_results.power_flows import _3744, _3746
...
class CylindricalGearSystemDeflection(_2426.GearSystemDeflection):
    '''CylindricalGearSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3744.CylindricalGearPowerFlow':
        ...
        if _3744.CylindricalGearPowerFlow.TYPE not in self.wrapped.PowerFlowResults.__class__.__mro__:
