...
from mastapy.system_model.analyses_and_results.system_deflections import (
    _2469, _2409, _2410, _2411,
    _2466, _2448, _2443, _2412,
    _2365, _2471
)
...
class FlexiblePinAssemblySystemDeflection(_2471.SpecialisedAssemblySystemDeflection):
    '''FlexiblePinAssemblySystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3753.FlexiblePinAssemblyPowerFlow':
        ...
        return constructor.new(_3753.FlexiblePinAssemblyPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None

    @property
    def pin_analysis(self) -> '_2469.ShaftSystemDeflection':
        ...
        return constructor.new(_2469.ShaftSystemDeflection)(self.wrapped.PinAnalysis) if self.wrapped.PinAnalysis else None

    @property
    def spindle_analyses(self) -> '_2469.ShaftSystemDeflection':
        ...
        return constructor.new(_2469.ShaftSystemDeflection)(self.wrapped.SpindleAnalyses) if self.wrapped.SpindleAnalyses else None

    @property
    def separate_gear_set_details(self) -> '_2409.CylindricalGearSetSystemDeflection':
        ...
        if _2409.CylindricalGearSetSystemDeflection.TYPE not in self.wrapped.SeparateGearSetDetails.__class__.__mro__:
    ...
    @property
    def separate_gear_set_details_of_type_cylindrical_gear_set_system_deflection_timestep(self) -> '_2410.CylindricalGearSetSystemDeflectionTimestep':
        ...
        if _2410.CylindricalGearSetSystemDeflectionTimestep.TYPE not in self.wrapped.SeparateGearSetDetails.__class__.__mro__:
    ...
    @property
    def separate_gear_set_details_of_type_cylindrical_gear_set_system_deflection_with_ltca_results(self) -> '_2411.CylindricalGearSetSystemDeflectionWithLTCAResults':
        ...
        if _2411.CylindricalGearSetSystemDeflectionWithLTCAResults.TYPE not in self.wrapped.SeparateGearSetDetails.__class__.__mro__:
    ...
    @property
    def flexible_pin_shaft_details(self) -> '_2469.ShaftSystemDeflection':
        ...
        return constructor.new(_2469.ShaftSystemDeflection)(self.wrapped.FlexiblePinShaftDetails) if self.wrapped.FlexiblePinShaftDetails else None

    @property
    def pin_spindle_fit_analyses(self) -> 'List[_2466.ShaftHubConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PinSpindleFitAnalyses, constructor.new(_2466.ShaftHubConnectionSystemDeflection))
        return value

    @property
    def observed_pin_stiffness_reporters(self) -> 'List[_2448.ObservedPinStiffnessReporter]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ObservedPinStiffnessReporters, constructor.new(_2448.ObservedPinStiffnessReporter))
        return value

    @property
    def load_sharing_factor_reporters(self) -> 'List[_2443.LoadSharingFactorReporter]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadSharingFactorReporters, constructor.new(_2443.LoadSharingFactorReporter))
        return value

    @property
    def planet_gear_system_deflections(self) -> 'List[_2412.CylindricalGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetGearSystemDeflections, constructor.new(_2412.CylindricalGearSystemDeflection))
        return value

    @property
    def flexible_pin_fit_details(self) -> 'List[_2466.ShaftHubConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FlexiblePinFitDetails, constructor.new(_2466.ShaftHubConnectionSystemDeflection))
        return value

    @property
    def bearing_static_analyses(self) -> 'List[_2365.BearingSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BearingStaticAnalyses, constructor.new(_2365.BearingSystemDeflection))
        return value
