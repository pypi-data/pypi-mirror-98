...
from mastapy.system_model.drawing import _1934, _1924
...
class SystemDeflectionDrawStyle(_1924.ContourDrawStyle):
    '''SystemDeflectionDrawStyle
    ...
    @property
    def force_arrow_scaling(self) -> '_1934.ScalingDrawStyle':
        ...
        return constructor.new(_1934.ScalingDrawStyle)(self.wrapped.ForceArrowScaling) if self.wrapped.ForceArrowScaling else None
