...
class MassDiscSystemDeflection(_2500.VirtualComponentSystemDeflection):
    '''MassDiscSystemDeflection
    ...
    @property
    def power_flow_results(self) -> '_3771.MassDiscPowerFlow':
        ...
        return constructor.new(_3771.MassDiscPowerFlow)(self.wrapped.PowerFlowResults) if self.wrapped.PowerFlowResults else None
