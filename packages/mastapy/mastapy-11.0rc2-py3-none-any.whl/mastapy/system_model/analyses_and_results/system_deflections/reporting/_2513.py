...
class RigidlyConnectedComponentGroupSystemDeflection(_2325.DesignEntityGroupAnalysis):
    '''RigidlyConnectedComponentGroupSystemDeflection
    ...
    @property
    def components(self) -> 'List[_2382.ComponentSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Components, constructor.new(_2382.ComponentSystemDeflection))
        return value
