...
from mastapy.system_model.analyses_and_results.system_deflections import _2442, _2492
...
class SystemDeflection(_7182.FEAnalysis):
    '''SystemDeflection
    ...
    @property
    def overall_efficiency_results(self) -> '_2442.LoadCaseOverallEfficiencyResult':
        ...
        return constructor.new(_2442.LoadCaseOverallEfficiencyResult)(self.wrapped.OverallEfficiencyResults) if self.wrapped.OverallEfficiencyResults else None

    @property
    def analysis_options(self) -> '_2492.SystemDeflectionOptions':
        ...
        return constructor.new(_2492.SystemDeflectionOptions)(self.wrapped.AnalysisOptions) if self.wrapped.AnalysisOptions else None
