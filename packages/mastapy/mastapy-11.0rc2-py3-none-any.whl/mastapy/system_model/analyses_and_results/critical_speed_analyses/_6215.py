...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _2299
...
class ConnectionCriticalSpeedAnalysis(_7179.ConnectionStaticLoadAnalysisCase):
    '''ConnectionCriticalSpeedAnalysis
