...
class GearMultibodyDynamicsAnalysis(_5120.MountableComponentMultibodyDynamicsAnalysis):
    '''GearMultibodyDynamicsAnalysis
    ...
    @property
    def peak_gear_torque(self) -> 'List[_5181.DynamicTorqueResultAtTime]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PeakGearTorque, constructor.new(_5181.DynamicTorqueResultAtTime))
        return value
