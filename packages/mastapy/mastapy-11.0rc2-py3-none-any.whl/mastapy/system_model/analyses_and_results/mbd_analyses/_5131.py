...
class PulleyMultibodyDynamicsAnalysis(_5073.CouplingHalfMultibodyDynamicsAnalysis):
    '''PulleyMultibodyDynamicsAnalysis
    ...
    @property
    def peak_pulley_torque(self) -> 'List[_5181.DynamicTorqueResultAtTime]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PeakPulleyTorque, constructor.new(_5181.DynamicTorqueResultAtTime))
        return value
