...
class SpringDamperCompoundMultibodyDynamicsAnalysis(_5221.CouplingCompoundMultibodyDynamicsAnalysis):
    '''SpringDamperCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5150.SpringDamperMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5150.SpringDamperMultibodyDynamicsAnalysis))
        return value

    @property
    def assembly_multibody_dynamics_analysis_load_cases(self) -> 'List[_5150.SpringDamperMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyMultibodyDynamicsAnalysisLoadCases, constructor.new(_5150.SpringDamperMultibodyDynamicsAnalysis))
        return value
