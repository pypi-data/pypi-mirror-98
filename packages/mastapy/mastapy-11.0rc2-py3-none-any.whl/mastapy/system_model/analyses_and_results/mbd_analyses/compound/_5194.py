...
class BeltDriveCompoundMultibodyDynamicsAnalysis(_5282.SpecialisedAssemblyCompoundMultibodyDynamicsAnalysis):
    '''BeltDriveCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5044.BeltDriveMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5044.BeltDriveMultibodyDynamicsAnalysis))
        return value

    @property
    def assembly_multibody_dynamics_analysis_load_cases(self) -> 'List[_5044.BeltDriveMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyMultibodyDynamicsAnalysisLoadCases, constructor.new(_5044.BeltDriveMultibodyDynamicsAnalysis))
        return value
