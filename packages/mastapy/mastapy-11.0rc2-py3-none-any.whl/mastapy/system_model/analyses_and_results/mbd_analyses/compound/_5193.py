...
class BeltConnectionCompoundMultibodyDynamicsAnalysis(_5249.InterMountableComponentConnectionCompoundMultibodyDynamicsAnalysis):
    '''BeltConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5043.BeltConnectionMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5043.BeltConnectionMultibodyDynamicsAnalysis))
        return value

    @property
    def connection_multibody_dynamics_analysis_load_cases(self) -> 'List[_5043.BeltConnectionMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionMultibodyDynamicsAnalysisLoadCases, constructor.new(_5043.BeltConnectionMultibodyDynamicsAnalysis))
        return value
