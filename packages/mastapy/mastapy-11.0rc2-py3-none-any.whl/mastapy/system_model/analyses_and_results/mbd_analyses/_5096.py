...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5095, _5093, _5144
...
class GearSetMultibodyDynamicsAnalysis(_5144.SpecialisedAssemblyMultibodyDynamicsAnalysis):
    '''GearSetMultibodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_5095.GearMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_5095.GearMultibodyDynamicsAnalysis))
        return value

    @property
    def meshes(self) -> 'List[_5093.GearMeshMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_5093.GearMeshMultibodyDynamicsAnalysis))
        return value
