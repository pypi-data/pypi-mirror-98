...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5131, _5144
...
class BeltDriveMultibodyDynamicsAnalysis(_5144.SpecialisedAssemblyMultibodyDynamicsAnalysis):
    '''BeltDriveMultibodyDynamicsAnalysis
    ...
    @property
    def pulleys(self) -> 'List[_5131.PulleyMultibodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Pulleys, constructor.new(_5131.PulleyMultibodyDynamicsAnalysis))
        return value
