...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5104, _5143, _5138
...
class MBDRunUpAnalysisOptions(_7174.AbstractAnalysisOptions['_6611.TimeSeriesLoadCase']):
    '''MBDRunUpAnalysisOptions
    ...
    @property
    def input_velocity_processing_type(self) -> '_5104.InputVelocityForRunUpProcessingType':
        ...
        return constructor.new(_5104.InputVelocityForRunUpProcessingType)(value) if value else None

    @input_velocity_processing_type.setter
    def input_velocity_processing_type(self, value: '_5104.InputVelocityForRunUpProcessingType'):
    ...
    @property
    def shape_of_initial_acceleration_period(self) -> '_5143.ShapeOfInitialAccelerationPeriodForRunUp':
        ...
        return constructor.new(_5143.ShapeOfInitialAccelerationPeriodForRunUp)(value) if value else None

    @shape_of_initial_acceleration_period.setter
    def shape_of_initial_acceleration_period(self, value: '_5143.ShapeOfInitialAccelerationPeriodForRunUp'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ShapeOfInitialAccelerationPeriod = value

    @property
    def run_up_driving_mode(self) -> '_5138.RunUpDrivingMode':
        ...
        return constructor.new(_5138.RunUpDrivingMode)(value) if value else None

    @run_up_driving_mode.setter
    def run_up_driving_mode(self, value: '_5138.RunUpDrivingMode'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
