...
class HypoidGearMeshHarmonicAnalysis(_5598.AGMAGleasonConicalGearMeshHarmonicAnalysis):
    '''HypoidGearMeshHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2428.HypoidGearMeshSystemDeflection':
        ...
        return constructor.new(_2428.HypoidGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
