...
from mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results import _5775, _5764
...
class ResultsForResponseOfAComponentOrSurfaceInAHarmonic(_0.APIBase):
    ...
    @property
    def magnitude(self) -> '_5775.ResultsForSingleDegreeOfFreedomOfResponseOfNodeInHarmonic':
        ...
        return constructor.new(_5775.ResultsForSingleDegreeOfFreedomOfResponseOfNodeInHarmonic)(self.wrapped.Magnitude) if self.wrapped.Magnitude else None

    @property
    def result_at_reference_speed(self) -> '_5764.DatapointForResponseOfAComponentOrSurfaceAtAFrequencyInAHarmonic':
        ...
        return constructor.new(_5764.DatapointForResponseOfAComponentOrSurfaceAtAFrequencyInAHarmonic)(self.wrapped.ResultAtReferenceSpeed) if self.wrapped.ResultAtReferenceSpeed else None

    @property
    def data_points(self) -> 'List[_5764.DatapointForResponseOfAComponentOrSurfaceAtAFrequencyInAHarmonic]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DataPoints, constructor.new(_5764.DatapointForResponseOfAComponentOrSurfaceAtAFrequencyInAHarmonic))
        return value
