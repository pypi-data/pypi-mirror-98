...
from mastapy.system_model.analyses_and_results.static_loads import (
    _6533, _6481, _6498, _6507,
    _6508, _6509, _6510, _6511,
    _6529, _6574, _6590, _6619
)
...
class AbstractPeriodicExcitationDetail(_0.APIBase):
    ...
    @property
    def harmonic_load_data(self) -> '_6533.HarmonicLoadDataBase':
        ...
        if _6533.HarmonicLoadDataBase.TYPE not in self.wrapped.HarmonicLoadData.__class__.__mro__:
    ...
    @property
    def harmonic_load_data_of_type_conical_gear_set_harmonic_load_data(self) -> '_6481.ConicalGearSetHarmonicLoadData':
        ...
        if _6481.ConicalGearSetHarmonicLoadData.TYPE not in self.wrapped.HarmonicLoadData.__class__.__mro__:
    ...
    @property
    def harmonic_load_data_of_type_cylindrical_gear_set_harmonic_load_data(self) -> '_6498.CylindricalGearSetHarmonicLoadData':
        ...
        if _6498.CylindricalGearSetHarmonicLoadData.TYPE not in self.wrapped.HarmonicLoadData.__class__.__mro__:
    ...
    @property
    def harmonic_load_data_of_type_electric_machine_harmonic_load_data(self) -> '_6507.ElectricMachineHarmonicLoadData':
        ...
        if _6507.ElectricMachineHarmonicLoadData.TYPE not in self.wrapped.HarmonicLoadData.__class__.__mro__:
    ...
    @property
    def harmonic_load_data_of_type_electric_machine_harmonic_load_data_from_excel(self) -> '_6508.ElectricMachineHarmonicLoadDataFromExcel':
        ...
        if _6508.ElectricMachineHarmonicLoadDataFromExcel.TYPE not in self.wrapped.HarmonicLoadData.__class__.__mro__:
    ...
    @property
    def harmonic_load_data_of_type_electric_machine_harmonic_load_data_from_flux(self) -> '_6509.ElectricMachineHarmonicLoadDataFromFlux':
        ...
        if _6509.ElectricMachineHarmonicLoadDataFromFlux.TYPE not in self.wrapped.HarmonicLoadData.__class__.__mro__:
    ...
    @property
    def harmonic_load_data_of_type_electric_machine_harmonic_load_data_from_jmag(self) -> '_6510.ElectricMachineHarmonicLoadDataFromJMAG':
        ...
        if _6510.ElectricMachineHarmonicLoadDataFromJMAG.TYPE not in self.wrapped.HarmonicLoadData.__class__.__mro__:
    ...
    @property
    def harmonic_load_data_of_type_electric_machine_harmonic_load_data_from_motor_cad(self) -> '_6511.ElectricMachineHarmonicLoadDataFromMotorCAD':
        ...
        if _6511.ElectricMachineHarmonicLoadDataFromMotorCAD.TYPE not in self.wrapped.HarmonicLoadData.__class__.__mro__:
    ...
    @property
    def harmonic_load_data_of_type_gear_set_harmonic_load_data(self) -> '_6529.GearSetHarmonicLoadData':
        ...
        if _6529.GearSetHarmonicLoadData.TYPE not in self.wrapped.HarmonicLoadData.__class__.__mro__:
    ...
    @property
    def harmonic_load_data_of_type_point_load_harmonic_load_data(self) -> '_6574.PointLoadHarmonicLoadData':
        ...
        if _6574.PointLoadHarmonicLoadData.TYPE not in self.wrapped.HarmonicLoadData.__class__.__mro__:
    ...
    @property
    def harmonic_load_data_of_type_speed_dependent_harmonic_load_data(self) -> '_6590.SpeedDependentHarmonicLoadData':
        ...
        if _6590.SpeedDependentHarmonicLoadData.TYPE not in self.wrapped.HarmonicLoadData.__class__.__mro__:
    ...
    @property
    def harmonic_load_data_of_type_unbalanced_mass_harmonic_load_data(self) -> '_6619.UnbalancedMassHarmonicLoadData':
        ...
        if _6619.UnbalancedMassHarmonicLoadData.TYPE not in self.wrapped.HarmonicLoadData.__class__.__mro__:
