...
class BevelDifferentialGearMeshHarmonicAnalysis(_5610.BevelGearMeshHarmonicAnalysis):
    '''BevelDifferentialGearMeshHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2368.BevelDifferentialGearMeshSystemDeflection':
        ...
        return constructor.new(_2368.BevelDifferentialGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
