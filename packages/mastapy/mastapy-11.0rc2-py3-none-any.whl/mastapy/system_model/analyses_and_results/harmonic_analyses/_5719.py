...
class SpiralBevelGearHarmonicAnalysis(_5609.BevelGearHarmonicAnalysis):
    '''SpiralBevelGearHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2474.SpiralBevelGearSystemDeflection':
        ...
        return constructor.new(_2474.SpiralBevelGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
