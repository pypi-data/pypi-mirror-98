...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5718, _5664
...
class HarmonicAnalysisOptions(_0.APIBase):
    ...
    @property
    def excitation_selection(self) -> '_5754.ExcitationSourceSelectionGroup':
        ...
        return constructor.new(_5754.ExcitationSourceSelectionGroup)(self.wrapped.ExcitationSelection) if self.wrapped.ExcitationSelection else None

    @property
    def modal_analysis_options(self) -> '_4831.ModalAnalysisOptions':
        ...
        return constructor.new(_4831.ModalAnalysisOptions)(self.wrapped.ModalAnalysisOptions) if self.wrapped.ModalAnalysisOptions else None
