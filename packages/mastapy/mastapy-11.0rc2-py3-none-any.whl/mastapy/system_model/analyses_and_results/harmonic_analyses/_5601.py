...
class BearingHarmonicAnalysis(_5630.ConnectorHarmonicAnalysis):
    '''BearingHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2365.BearingSystemDeflection':
        ...
        return constructor.new(_2365.BearingSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
