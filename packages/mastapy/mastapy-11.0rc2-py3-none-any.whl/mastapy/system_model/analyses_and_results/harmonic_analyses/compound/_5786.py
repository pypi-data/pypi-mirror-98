...
class BeltConnectionCompoundHarmonicAnalysis(_5842.InterMountableComponentConnectionCompoundHarmonicAnalysis):
    '''BeltConnectionCompoundHarmonicAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5602.BeltConnectionHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5602.BeltConnectionHarmonicAnalysis))
        return value

    @property
    def connection_harmonic_analysis_load_cases(self) -> 'List[_5602.BeltConnectionHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionHarmonicAnalysisLoadCases, constructor.new(_5602.BeltConnectionHarmonicAnalysis))
        return value
