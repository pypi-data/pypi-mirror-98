...
class ConceptCouplingCompoundHarmonicAnalysis(_5814.CouplingCompoundHarmonicAnalysis):
    '''ConceptCouplingCompoundHarmonicAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_5622.ConceptCouplingHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_5622.ConceptCouplingHarmonicAnalysis))
        return value

    @property
    def assembly_harmonic_analysis_load_cases(self) -> 'List[_5622.ConceptCouplingHarmonicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyHarmonicAnalysisLoadCases, constructor.new(_5622.ConceptCouplingHarmonicAnalysis))
        return value
