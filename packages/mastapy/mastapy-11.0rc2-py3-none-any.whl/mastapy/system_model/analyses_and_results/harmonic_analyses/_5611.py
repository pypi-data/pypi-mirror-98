...
class BevelGearSetHarmonicAnalysis(_5599.AGMAGleasonConicalGearSetHarmonicAnalysis):
    '''BevelGearSetHarmonicAnalysis
    ...
    @property
    def assembly_design(self) -> '_2194.BevelGearSet':
    ...
    @property
    def system_deflection_results(self) -> '_2374.BevelGearSetSystemDeflection':
