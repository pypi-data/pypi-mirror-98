...
class DatumHarmonicAnalysis(_5619.ComponentHarmonicAnalysis):
    '''DatumHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2416.DatumSystemDeflection':
        ...
        return constructor.new(_2416.DatumSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
