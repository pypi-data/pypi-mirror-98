...
class AGMAGleasonConicalGearSetHarmonicAnalysis(_5628.ConicalGearSetHarmonicAnalysis):
    '''AGMAGleasonConicalGearSetHarmonicAnalysis
    ...
    @property
    def assembly_design(self) -> '_2188.AGMAGleasonConicalGearSet':
    ...
    @property
    def system_deflection_results(self) -> '_2362.AGMAGleasonConicalGearSetSystemDeflection':
