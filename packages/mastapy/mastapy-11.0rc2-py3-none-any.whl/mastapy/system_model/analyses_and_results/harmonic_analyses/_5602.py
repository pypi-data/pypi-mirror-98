...
from mastapy.system_model.analyses_and_results.system_deflections import _2366, _2399
...
class BeltConnectionHarmonicAnalysis(_5682.InterMountableComponentConnectionHarmonicAnalysis):
    '''BeltConnectionHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2366.BeltConnectionSystemDeflection':
