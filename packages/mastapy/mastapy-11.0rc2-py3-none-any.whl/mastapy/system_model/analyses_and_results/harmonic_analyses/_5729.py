...
class StraightBevelGearMeshHarmonicAnalysis(_5610.BevelGearMeshHarmonicAnalysis):
    '''StraightBevelGearMeshHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2481.StraightBevelGearMeshSystemDeflection':
        ...
        return constructor.new(_2481.StraightBevelGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
