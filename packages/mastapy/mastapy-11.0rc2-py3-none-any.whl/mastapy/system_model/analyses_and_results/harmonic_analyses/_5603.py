...
from mastapy.system_model.analyses_and_results.system_deflections import _2367, _2401
...
class BeltDriveHarmonicAnalysis(_5717.SpecialisedAssemblyHarmonicAnalysis):
    '''BeltDriveHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2367.BeltDriveSystemDeflection':
