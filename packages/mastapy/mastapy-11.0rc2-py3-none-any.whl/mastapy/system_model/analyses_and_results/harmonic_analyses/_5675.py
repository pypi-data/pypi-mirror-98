...
class HarmonicAnalysisFEExportOptions(_5674.HarmonicAnalysisExportOptions['_2327.IHaveFEPartHarmonicAnalysisResults', '_2129.FEPart']):
    '''HarmonicAnalysisFEExportOptions
    ...
    @property
    def analysis_options(self) -> '_5676.HarmonicAnalysisOptions':
        ...
        if _5676.HarmonicAnalysisOptions.TYPE not in self.wrapped.AnalysisOptions.__class__.__mro__:
