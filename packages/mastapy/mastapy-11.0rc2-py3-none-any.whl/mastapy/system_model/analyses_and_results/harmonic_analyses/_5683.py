...
class KlingelnbergCycloPalloidConicalGearHarmonicAnalysis(_5626.ConicalGearHarmonicAnalysis):
    '''KlingelnbergCycloPalloidConicalGearHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2435.KlingelnbergCycloPalloidConicalGearSystemDeflection':
