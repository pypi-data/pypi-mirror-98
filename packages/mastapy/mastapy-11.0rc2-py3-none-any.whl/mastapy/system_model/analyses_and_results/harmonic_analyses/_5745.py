...
class WormGearMeshHarmonicAnalysis(_5667.GearMeshHarmonicAnalysis):
    '''WormGearMeshHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2501.WormGearMeshSystemDeflection':
        ...
        return constructor.new(_2501.WormGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
