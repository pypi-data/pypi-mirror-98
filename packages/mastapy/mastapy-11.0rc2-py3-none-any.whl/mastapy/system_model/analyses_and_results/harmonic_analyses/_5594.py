...
from mastapy.system_model.analyses_and_results.system_deflections import _2359, _2405, _2469
...
class AbstractShaftHarmonicAnalysis(_5595.AbstractShaftOrHousingHarmonicAnalysis):
    '''AbstractShaftHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2359.AbstractShaftSystemDeflection':
