...
class SynchroniserHarmonicAnalysis(_5717.SpecialisedAssemblyHarmonicAnalysis):
    '''SynchroniserHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2489.SynchroniserSystemDeflection':
        ...
        return constructor.new(_2489.SynchroniserSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
