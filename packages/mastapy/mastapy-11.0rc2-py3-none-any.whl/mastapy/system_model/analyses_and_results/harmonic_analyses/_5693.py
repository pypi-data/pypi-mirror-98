...
class MeasurementComponentHarmonicAnalysis(_5743.VirtualComponentHarmonicAnalysis):
    '''MeasurementComponentHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2445.MeasurementComponentSystemDeflection':
        ...
        return constructor.new(_2445.MeasurementComponentSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
