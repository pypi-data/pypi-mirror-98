...
class KlingelnbergCycloPalloidConicalGearSetHarmonicAnalysis(_5628.ConicalGearSetHarmonicAnalysis):
    '''KlingelnbergCycloPalloidConicalGearSetHarmonicAnalysis
    ...
    @property
    def assembly_design(self) -> '_2211.KlingelnbergCycloPalloidConicalGearSet':
    ...
    @property
    def system_deflection_results(self) -> '_2434.KlingelnbergCycloPalloidConicalGearSetSystemDeflection':
