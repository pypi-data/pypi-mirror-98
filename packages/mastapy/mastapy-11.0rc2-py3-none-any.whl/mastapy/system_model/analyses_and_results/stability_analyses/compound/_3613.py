...
class FaceGearCompoundStabilityAnalysis(_3618.GearCompoundStabilityAnalysis):
    '''FaceGearCompoundStabilityAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3484.FaceGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3484.FaceGearStabilityAnalysis))
        return value

    @property
    def component_stability_analysis_load_cases(self) -> 'List[_3484.FaceGearStabilityAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentStabilityAnalysisLoadCases, constructor.new(_3484.FaceGearStabilityAnalysis))
        return value
