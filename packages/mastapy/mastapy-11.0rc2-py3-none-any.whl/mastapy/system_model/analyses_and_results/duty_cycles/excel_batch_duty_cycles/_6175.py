...
from mastapy.system_model.analyses_and_results.duty_cycles.excel_batch_duty_cycles import _6179, _6176, _6178
...
class ExcelBatchDutyCycleSpectraCreatorDetails(_0.APIBase):
    ...
    @property
    def masta_file_details(self) -> '_6179.MASTAFileDetails':
        ...
        return constructor.new(_6179.MASTAFileDetails)(self.wrapped.MASTAFileDetails) if self.wrapped.MASTAFileDetails else None

    @property
    def excel_file_details(self) -> '_6176.ExcelFileDetails':
        ...
        return constructor.new(_6176.ExcelFileDetails)(self.wrapped.ExcelFileDetails) if self.wrapped.ExcelFileDetails else None
    ...
    @property
    def excel_sheet_design_state_selection(self) -> 'List[_6178.ExcelSheetDesignStateSelector]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ExcelSheetDesignStateSelection, constructor.new(_6178.ExcelSheetDesignStateSelector))
        return value
