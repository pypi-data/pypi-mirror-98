...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6054
...
class CVTBeltConnectionCompoundDynamicAnalysis(_6054.BeltConnectionCompoundDynamicAnalysis):
    '''CVTBeltConnectionCompoundDynamicAnalysis
