...
class StraightBevelDiffGearMeshCompoundDynamicAnalysis(_6062.BevelGearMeshCompoundDynamicAnalysis):
    '''StraightBevelDiffGearMeshCompoundDynamicAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_6022.StraightBevelDiffGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_6022.StraightBevelDiffGearMeshDynamicAnalysis))
        return value

    @property
    def connection_dynamic_analysis_load_cases(self) -> 'List[_6022.StraightBevelDiffGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionDynamicAnalysisLoadCases, constructor.new(_6022.StraightBevelDiffGearMeshDynamicAnalysis))
        return value
