...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _2300
...
class ConnectionDynamicAnalysis(_7178.ConnectionFEAnalysis):
    '''ConnectionDynamicAnalysis
    ...
    def dynamic_analysis(self) -> '_2300.DynamicAnalysis':
        ...
        if _2300.DynamicAnalysis.TYPE not in self.wrapped.DynamicAnalysis.__class__.__mro__:
