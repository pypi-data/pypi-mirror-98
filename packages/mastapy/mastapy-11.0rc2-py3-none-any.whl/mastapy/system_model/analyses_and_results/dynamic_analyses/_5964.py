...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _5962, _5963, _5976
...
class CylindricalGearSetDynamicAnalysis(_5976.GearSetDynamicAnalysis):
    '''CylindricalGearSetDynamicAnalysis
    ...
    @property
    def cylindrical_gears_dynamic_analysis(self) -> 'List[_5962.CylindricalGearDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsDynamicAnalysis, constructor.new(_5962.CylindricalGearDynamicAnalysis))
        return value

    @property
    def cylindrical_meshes_dynamic_analysis(self) -> 'List[_5963.CylindricalGearMeshDynamicAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesDynamicAnalysis, constructor.new(_5963.CylindricalGearMeshDynamicAnalysis))
        return value
