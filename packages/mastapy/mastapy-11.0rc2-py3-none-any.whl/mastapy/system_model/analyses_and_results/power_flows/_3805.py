...
from mastapy.system_model.analyses_and_results.power_flows import _3804, _3803, _3713
...
class StraightBevelDiffGearSetPowerFlow(_3713.BevelGearSetPowerFlow):
    '''StraightBevelDiffGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_3804.StraightBevelDiffGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsPowerFlow, constructor.new(_3804.StraightBevelDiffGearPowerFlow))
        return value

    @property
    def straight_bevel_diff_gears_power_flow(self) -> 'List[_3804.StraightBevelDiffGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearsPowerFlow, constructor.new(_3804.StraightBevelDiffGearPowerFlow))
        return value

    @property
    def meshes_power_flow(self) -> 'List[_3803.StraightBevelDiffGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesPowerFlow, constructor.new(_3803.StraightBevelDiffGearMeshPowerFlow))
        return value

    @property
    def straight_bevel_diff_meshes_power_flow(self) -> 'List[_3803.StraightBevelDiffGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshesPowerFlow, constructor.new(_3803.StraightBevelDiffGearMeshPowerFlow))
        return value
