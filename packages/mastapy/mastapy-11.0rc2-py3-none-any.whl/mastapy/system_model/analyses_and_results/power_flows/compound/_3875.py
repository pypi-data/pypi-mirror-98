...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3886
...
class CylindricalGearCompoundPowerFlow(_3886.GearCompoundPowerFlow):
    '''CylindricalGearCompoundPowerFlow
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3744.CylindricalGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3744.CylindricalGearPowerFlow))
        return value

    @property
    def component_power_flow_load_cases(self) -> 'List[_3744.CylindricalGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentPowerFlowLoadCases, constructor.new(_3744.CylindricalGearPowerFlow))
        return value
