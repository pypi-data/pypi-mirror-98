...
from mastapy.system_model.analyses_and_results.power_flows import _3754, _3755, _3796
...
class GearSetPowerFlow(_3796.SpecialisedAssemblyPowerFlow):
    '''GearSetPowerFlow
    ...
    @property
    def meshes_power_flow(self) -> 'List[_3754.GearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesPowerFlow, constructor.new(_3754.GearMeshPowerFlow))
        return value

    @property
    def gears_power_flow(self) -> 'List[_3755.GearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsPowerFlow, constructor.new(_3755.GearPowerFlow))
        return value
