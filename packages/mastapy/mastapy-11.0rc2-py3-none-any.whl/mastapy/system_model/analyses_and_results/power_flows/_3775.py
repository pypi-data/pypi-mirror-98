...
class PartPowerFlow(_7186.PartStaticLoadAnalysisCase):
    '''PartPowerFlow
    ...
    @property
    def two_d_drawing_showing_power_flow(self) -> '_7200.SMTBitmap':
        ...
        return constructor.new(_7200.SMTBitmap)(self.wrapped.TwoDDrawingShowingPowerFlow) if self.wrapped.TwoDDrawingShowingPowerFlow else None
    ...
    def create_viewable(self) -> '_1932.PowerFlowViewable':
