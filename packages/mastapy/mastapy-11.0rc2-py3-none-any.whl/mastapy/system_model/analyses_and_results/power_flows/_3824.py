...
from mastapy.system_model.analyses_and_results.power_flows import _3823, _3822, _3756
...
class WormGearSetPowerFlow(_3756.GearSetPowerFlow):
    '''WormGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_3823.WormGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsPowerFlow, constructor.new(_3823.WormGearPowerFlow))
        return value

    @property
    def worm_gears_power_flow(self) -> 'List[_3823.WormGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsPowerFlow, constructor.new(_3823.WormGearPowerFlow))
        return value

    @property
    def meshes_power_flow(self) -> 'List[_3822.WormGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesPowerFlow, constructor.new(_3822.WormGearMeshPowerFlow))
        return value

    @property
    def worm_meshes_power_flow(self) -> 'List[_3822.WormGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesPowerFlow, constructor.new(_3822.WormGearMeshPowerFlow))
        return value
