...
from mastapy.system_model.analyses_and_results.power_flows import _3759, _3758, _3701
...
class HypoidGearSetPowerFlow(_3701.AGMAGleasonConicalGearSetPowerFlow):
    '''HypoidGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self) -> 'List[_3759.HypoidGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearsPowerFlow, constructor.new(_3759.HypoidGearPowerFlow))
        return value

    @property
    def hypoid_gears_power_flow(self) -> 'List[_3759.HypoidGearPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGearsPowerFlow, constructor.new(_3759.HypoidGearPowerFlow))
        return value

    @property
    def meshes_power_flow(self) -> 'List[_3758.HypoidGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesPowerFlow, constructor.new(_3758.HypoidGearMeshPowerFlow))
        return value

    @property
    def hypoid_meshes_power_flow(self) -> 'List[_3758.HypoidGearMeshPowerFlow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshesPowerFlow, constructor.new(_3758.HypoidGearMeshPowerFlow))
        return value
