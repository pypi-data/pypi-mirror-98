...
from mastapy.system_model.analyses_and_results import _2326, _2324
...
class DesignEntityCompoundAnalysis(_2324.DesignEntityAnalysis):
    '''DesignEntityCompoundAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2326.DesignEntitySingleContextAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2326.DesignEntitySingleContextAnalysis))
        return value
