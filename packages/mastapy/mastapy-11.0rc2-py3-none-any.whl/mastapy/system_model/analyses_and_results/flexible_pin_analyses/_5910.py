...
from mastapy.system_model.analyses_and_results.system_deflections.compound import _2565, _2601, _2524
...
class FlexiblePinAnalysisGearAndBearingRating(_5907.FlexiblePinAnalysis):
    '''FlexiblePinAnalysisGearAndBearingRating
    ...
    @property
    def gear_set_analysis(self) -> '_2565.CylindricalGearSetCompoundSystemDeflection':
        ...
        if _2565.CylindricalGearSetCompoundSystemDeflection.TYPE not in self.wrapped.GearSetAnalysis.__class__.__mro__:
    ...
    @property
    def bearing_analyses(self) -> 'List[_2524.BearingCompoundSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BearingAnalyses, constructor.new(_2524.BearingCompoundSystemDeflection))
        return value
