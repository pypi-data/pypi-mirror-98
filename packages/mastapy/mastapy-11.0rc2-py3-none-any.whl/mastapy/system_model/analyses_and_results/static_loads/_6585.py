...
class RootAssemblyLoadCase(_6453.AssemblyLoadCase):
    '''RootAssemblyLoadCase
    ...
    @property
    def supercharger_rotor_sets(self) -> 'List[_6499.CylindricalGearSetLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SuperchargerRotorSets, constructor.new(_6499.CylindricalGearSetLoadCase))
        return value
