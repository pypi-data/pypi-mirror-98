...
from mastapy.system_model.fe import _2038, _2061
...
class FEPartLoadCase(_6443.AbstractShaftOrHousingLoadCase):
    '''FEPartLoadCase
    ...
    @property
    def angle_source(self) -> '_2038.AngleSource':
        ...
        return constructor.new(_2038.AngleSource)(value) if value else None
