...
from mastapy.system_model.analyses_and_results.static_loads import _6597, _6446, _6611
...
class ConnectionLoadCase(_2322.ConnectionAnalysis):
    '''ConnectionLoadCase
    ...
    @property
    def static_load_case(self) -> '_6597.StaticLoadCase':
        ...
        if _6597.StaticLoadCase.TYPE not in self.wrapped.StaticLoadCase.__class__.__mro__:
    ...
    @property
    def time_series_load_case(self) -> '_6611.TimeSeriesLoadCase':
        ...
        return constructor.new(_6611.TimeSeriesLoadCase)(self.wrapped.TimeSeriesLoadCase) if self.wrapped.TimeSeriesLoadCase else None
