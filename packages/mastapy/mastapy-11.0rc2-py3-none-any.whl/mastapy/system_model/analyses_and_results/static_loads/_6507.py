...
from mastapy.system_model.analyses_and_results.static_loads import _6616, _6541, _6590
...
class ElectricMachineHarmonicLoadData(_6590.SpeedDependentHarmonicLoadData):
    '''ElectricMachineHarmonicLoadData
    ...
    @property
    def force_distribution(self) -> '_7200.SMTBitmap':
        ...
        return constructor.new(_7200.SMTBitmap)(self.wrapped.ForceDistribution) if self.wrapped.ForceDistribution else None
