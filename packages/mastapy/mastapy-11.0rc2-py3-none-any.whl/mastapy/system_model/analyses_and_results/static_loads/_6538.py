...
from mastapy.system_model.analyses_and_results.static_loads import _6541, _6537, _6515
...
class HarmonicLoadDataImportFromMotorPackages(_6537.HarmonicLoadDataImportBase['T'], Generic[T]):
    '''HarmonicLoadDataImportFromMotorPackages
