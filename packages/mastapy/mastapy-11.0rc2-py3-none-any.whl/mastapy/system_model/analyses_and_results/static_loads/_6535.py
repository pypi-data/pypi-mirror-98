...
from mastapy.system_model.analyses_and_results.static_loads import _6562, _6537, _6513
...
class HarmonicLoadDataExcelImport(_6537.HarmonicLoadDataImportBase['_6513.ElectricMachineHarmonicLoadExcelImportOptions']):
    '''HarmonicLoadDataExcelImport
    ...
    @property
    def speeds(self) -> 'List[_6562.NamedSpeed]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Speeds, constructor.new(_6562.NamedSpeed))
        return value
