...
from mastapy.system_model.analyses_and_results.static_loads import _6490, _6456
...
class CVTLoadCase(_6456.BeltDriveLoadCase):
    '''CVTLoadCase
    ...
    @property
    def pulleys(self) -> 'List[_6490.CVTPulleyLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Pulleys, constructor.new(_6490.CVTPulleyLoadCase))
        return value
