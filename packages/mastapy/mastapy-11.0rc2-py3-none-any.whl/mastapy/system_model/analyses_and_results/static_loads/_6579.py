...
class RingPinManufacturingError(_0.APIBase):
    ...
    @property
    def pin_roundness_chart(self) -> '_7200.SMTBitmap':
        '''SMTBitmap: 'PinRoundnessChart' is the original name of this property.

        Note:
            This property is readonly.
        '''

        return constructor.new(_7200.SMTBitmap)(self.wrapped.PinRoundnessChart) if self.wrapped.PinRoundnessChart else None
