...
from mastapy.bearings.tolerances import _1618, _1624
...
class BearingLoadCase(_6484.ConnectorLoadCase):
    '''BearingLoadCase
    ...
    @property
    def bearing_stiffness_model(self) -> '_5042.BearingStiffnessModel':
        ...
        return constructor.new(_5042.BearingStiffnessModel)(value) if value else None

    @bearing_stiffness_model.setter
    def bearing_stiffness_model(self, value: '_5042.BearingStiffnessModel'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.BearingStiffnessModel = value

    @property
    def bearing_stiffness_model_used_in_analysis(self) -> '_5042.BearingStiffnessModel':
    ...
    @property
    def left_ring_detail(self) -> '_1618.RaceDetail':
        ...
        return constructor.new(_1618.RaceDetail)(self.wrapped.LeftRingDetail) if self.wrapped.LeftRingDetail else None

    @property
    def right_ring_detail(self) -> '_1618.RaceDetail':
        ...
        return constructor.new(_1618.RaceDetail)(self.wrapped.RightRingDetail) if self.wrapped.RightRingDetail else None
    ...
    @property
    def inner_ring_detail(self) -> '_1618.RaceDetail':
        ...
        return constructor.new(_1618.RaceDetail)(self.wrapped.InnerRingDetail) if self.wrapped.InnerRingDetail else None
    ...
    @property
    def outer_ring_detail(self) -> '_1618.RaceDetail':
        ...
        return constructor.new(_1618.RaceDetail)(self.wrapped.OuterRingDetail) if self.wrapped.OuterRingDetail else None
