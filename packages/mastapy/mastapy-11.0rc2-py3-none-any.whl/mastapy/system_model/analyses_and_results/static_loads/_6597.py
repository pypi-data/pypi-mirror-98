...
from mastapy.system_model.analyses_and_results.load_case_groups import _5316, _5317, _5318
...
class StaticLoadCase(_6440.LoadCase):
    '''StaticLoadCase
    ...
    @property
    def advanced_system_deflection_options(self) -> '_6913.AdvancedSystemDeflectionOptions':
        ...
        return constructor.new(_6913.AdvancedSystemDeflectionOptions)(self.wrapped.AdvancedSystemDeflectionOptions) if self.wrapped.AdvancedSystemDeflectionOptions else None

    @property
    def te_set_up_for_dynamic_analyses_options(self) -> '_2355.TESetUpForDynamicAnalysisOptions':
        ...
        return constructor.new(_2355.TESetUpForDynamicAnalysisOptions)(self.wrapped.TESetUpForDynamicAnalysesOptions) if self.wrapped.TESetUpForDynamicAnalysesOptions else None
    ...
    @property
    def harmonic_analysis_options_for_atsam(self) -> '_5676.HarmonicAnalysisOptions':
        ...
        if _5676.HarmonicAnalysisOptions.TYPE not in self.wrapped.HarmonicAnalysisOptionsForATSAM.__class__.__mro__:
    ...
    @property
    def clutch_engagements(self) -> 'List[_5316.ClutchEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ClutchEngagements, constructor.new(_5316.ClutchEngagementStatus))
        return value

    @property
    def concept_clutch_engagements(self) -> 'List[_5317.ConceptSynchroGearEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptClutchEngagements, constructor.new(_5317.ConceptSynchroGearEngagementStatus))
        return value
    ...
    def duplicate(self, new_design_state_group: '_5318.DesignState', name: Optional['str'] = 'None') -> 'StaticLoadCase':
