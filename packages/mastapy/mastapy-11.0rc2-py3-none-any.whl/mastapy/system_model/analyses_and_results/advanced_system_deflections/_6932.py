...
class ClutchAdvancedSystemDeflection(_6949.CouplingAdvancedSystemDeflection):
    '''ClutchAdvancedSystemDeflection
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2380.ClutchSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2380.ClutchSystemDeflection))
        return value
