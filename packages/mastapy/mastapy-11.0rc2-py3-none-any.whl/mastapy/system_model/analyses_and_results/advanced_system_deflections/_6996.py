...
class PartToPartShearCouplingHalfAdvancedSystemDeflection(_6951.CouplingHalfAdvancedSystemDeflection):
    '''PartToPartShearCouplingHalfAdvancedSystemDeflection
    ...
    @property
    def component_system_deflection_results(self) -> 'List[_2452.PartToPartShearCouplingHalfSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2452.PartToPartShearCouplingHalfSystemDeflection))
        return value
