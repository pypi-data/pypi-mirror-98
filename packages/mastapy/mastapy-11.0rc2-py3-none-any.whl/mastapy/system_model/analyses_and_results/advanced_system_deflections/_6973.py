...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6988, _7012
...
class GearSetAdvancedSystemDeflection(_7012.SpecialisedAssemblyAdvancedSystemDeflection):
    '''GearSetAdvancedSystemDeflection
    ...
    @property
    def use_ltca_in_advanced_system_deflection(self) -> '_6988.UseLtcaInAsdOption':
        ...
        return constructor.new(_6988.UseLtcaInAsdOption)(value) if value else None

    @use_ltca_in_advanced_system_deflection.setter
    def use_ltca_in_advanced_system_deflection(self, value: '_6988.UseLtcaInAsdOption'):
