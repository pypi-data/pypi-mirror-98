...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6912, _6918
...
class RootAssemblyAdvancedSystemDeflection(_6918.AssemblyAdvancedSystemDeflection):
    '''RootAssemblyAdvancedSystemDeflection
    ...
    @property
    def advanced_system_deflection_inputs(self) -> '_6912.AdvancedSystemDeflection':
        ...
        return constructor.new(_6912.AdvancedSystemDeflection)(self.wrapped.AdvancedSystemDeflectionInputs) if self.wrapped.AdvancedSystemDeflectionInputs else None
