...
from mastapy.system_model.analyses_and_results.modal_analyses import _4815, _4814, _4756
...
class HypoidGearSetModalAnalysis(_4756.AGMAGleasonConicalGearSetModalAnalysis):
    '''HypoidGearSetModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2429.HypoidGearSetSystemDeflection':
        ...
        return constructor.new(_2429.HypoidGearSetSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None

    @property
    def hypoid_gears_modal_analysis(self) -> 'List[_4815.HypoidGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGearsModalAnalysis, constructor.new(_4815.HypoidGearModalAnalysis))
        return value

    @property
    def hypoid_meshes_modal_analysis(self) -> 'List[_4814.HypoidGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshesModalAnalysis, constructor.new(_4814.HypoidGearMeshModalAnalysis))
        return value
