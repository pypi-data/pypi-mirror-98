...
class CycloidalAssemblyCompoundModalAnalysis(_5001.SpecialisedAssemblyCompoundModalAnalysis):
    '''CycloidalAssemblyCompoundModalAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4794.CycloidalAssemblyModalAnalysis]':
        '''List[CycloidalAssemblyModalAnalysis]: 'LoadCaseAnalysesReady' is the original name of this property.

        Note:
            This property is readonly.
        '''

        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4794.CycloidalAssemblyModalAnalysis))
        return value

    @property
    def assembly_modal_analysis_load_cases(self) -> 'List[_4794.CycloidalAssemblyModalAnalysis]':
        '''List[CycloidalAssemblyModalAnalysis]: 'AssemblyModalAnalysisLoadCases' is the original name of this property.

        Note:
            This property is readonly.
        '''

        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyModalAnalysisLoadCases, constructor.new(_4794.CycloidalAssemblyModalAnalysis))
        return value
