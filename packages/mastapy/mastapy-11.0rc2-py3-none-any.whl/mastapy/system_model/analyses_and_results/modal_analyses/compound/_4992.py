...
class RingPinsCompoundModalAnalysis(_4980.MountableComponentCompoundModalAnalysis):
    '''RingPinsCompoundModalAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4845.RingPinsModalAnalysis]':
        '''List[RingPinsModalAnalysis]: 'LoadCaseAnalysesReady' is the original name of this property.

        Note:
            This property is readonly.
        '''

        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4845.RingPinsModalAnalysis))
        return value

    @property
    def component_modal_analysis_load_cases(self) -> 'List[_4845.RingPinsModalAnalysis]':
        '''List[RingPinsModalAnalysis]: 'ComponentModalAnalysisLoadCases' is the original name of this property.

        Note:
            This property is readonly.
        '''

        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentModalAnalysisLoadCases, constructor.new(_4845.RingPinsModalAnalysis))
        return value
