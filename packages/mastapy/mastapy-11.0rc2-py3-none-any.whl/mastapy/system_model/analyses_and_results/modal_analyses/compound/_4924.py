...
class ClutchCompoundModalAnalysis(_4940.CouplingCompoundModalAnalysis):
    '''ClutchCompoundModalAnalysis
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_4773.ClutchModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_4773.ClutchModalAnalysis))
        return value

    @property
    def assembly_modal_analysis_load_cases(self) -> 'List[_4773.ClutchModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyModalAnalysisLoadCases, constructor.new(_4773.ClutchModalAnalysis))
        return value
