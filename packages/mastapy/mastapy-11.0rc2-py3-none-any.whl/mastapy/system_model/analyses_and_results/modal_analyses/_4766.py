...
class BevelGearMeshModalAnalysis(_4754.AGMAGleasonConicalGearMeshModalAnalysis):
    '''BevelGearMeshModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2373.BevelGearMeshSystemDeflection':
