...
TConnection = TypeVar('TConnection', bound='_1951.Connection')
TConnectionStaticLoad = TypeVar('TConnectionStaticLoad', bound='_6483.ConnectionLoadCase')


class ConnectionStaticLoadCaseGroup(_5330.DesignEntityStaticLoadCaseGroup, Generic[TConnection, TConnectionStaticLoad]):
    '''ConnectionStaticLoadCaseGroup
