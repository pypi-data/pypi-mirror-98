...
from mastapy.system_model.analyses_and_results.load_case_groups.design_entity_static_load_case_groups import _5332
...
TAssembly = TypeVar('TAssembly', bound='_2112.AbstractAssembly')
TAssemblyStaticLoad = TypeVar('TAssemblyStaticLoad', bound='_6441.AbstractAssemblyLoadCase')


class AbstractAssemblyStaticLoadCaseGroup(_5332.PartStaticLoadCaseGroup, Generic[TAssembly, TAssemblyStaticLoad]):
    '''AbstractAssemblyStaticLoadCaseGroup
