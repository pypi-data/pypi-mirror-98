...
TReal = TypeVar('TReal', bound='_2121.Component')
TComponentStaticLoad = TypeVar('TComponentStaticLoad', bound='_6471.ComponentLoadCase')


class ComponentStaticLoadCaseGroup(_5332.PartStaticLoadCaseGroup, Generic[TReal, TComponentStaticLoad]):
    '''ComponentStaticLoadCaseGroup
