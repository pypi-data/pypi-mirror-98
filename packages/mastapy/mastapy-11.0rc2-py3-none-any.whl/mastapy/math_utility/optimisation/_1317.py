...
from mastapy.math_utility.optimisation import _1322, _1321
...
class ParetoOptimisationVariableBase(_0.APIBase):
    ...
    @property
    def specification_type(self) -> '_1322.TargetingPropertyTo':
        ...
        return constructor.new(_1322.TargetingPropertyTo)(value) if value else None

    @specification_type.setter
    def specification_type(self, value: '_1322.TargetingPropertyTo'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.SpecificationType = value

    @property
    def specify_input_range_as(self) -> '_1321.SpecifyOptimisationInputAs':
        ...
        return constructor.new(_1321.SpecifyOptimisationInputAs)(value) if value else None

    @specify_input_range_as.setter
    def specify_input_range_as(self, value: '_1321.SpecifyOptimisationInputAs'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
