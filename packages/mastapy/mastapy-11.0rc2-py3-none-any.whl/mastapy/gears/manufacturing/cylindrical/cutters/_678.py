...
class CylindricalGearRealCutterDesign(_671.CylindricalGearAbstractCutterDesign):
    ...
    @property
    def nominal_cutter_drawing(self) -> '_7200.SMTBitmap':
        ...
        return constructor.new(_7200.SMTBitmap)(self.wrapped.NominalCutterDrawing) if self.wrapped.NominalCutterDrawing else None
