...
from mastapy.math_utility.optimisation import _1315
...
class ChartInfoBase(_0.APIBase, Generic[TAnalysis, TCandidate]):
    ...
    @property
    def select_chart_type(self) -> '_1315.ParetoOptimisationStrategyChartInformation.ScatterOrBarChart':
        ...
        return constructor.new(_1315.ParetoOptimisationStrategyChartInformation.ScatterOrBarChart)(value) if value else None

    @select_chart_type.setter
    def select_chart_type(self, value: '_1315.ParetoOptimisationStrategyChartInformation.ScatterOrBarChart'):
    ...
    @property
    def result_chart_scatter(self) -> '_7200.SMTBitmap':
        ...
        return constructor.new(_7200.SMTBitmap)(self.wrapped.ResultChartScatter) if self.wrapped.ResultChartScatter else None

    @property
    def result_chart_bar_and_line(self) -> '_7200.SMTBitmap':
        ...
        return constructor.new(_7200.SMTBitmap)(self.wrapped.ResultChartBarAndLine) if self.wrapped.ResultChartBarAndLine else None
