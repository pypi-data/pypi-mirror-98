...
from mastapy.math_utility.optimisation import _1313, _1304, _1310
...
class DesignSpaceSearchBase(_0.APIBase, Generic[TAnalysis, TCandidate]):
    ...
    @property
    def selected_design_space_search_strategy(self) -> '_1313.ParetoOptimisationStrategy':
        ...
        return constructor.new(_1313.ParetoOptimisationStrategy)(self.wrapped.SelectedDesignSpaceSearchStrategy) if self.wrapped.SelectedDesignSpaceSearchStrategy else None
    ...
    @property
    def input_setters(self) -> 'List[_1304.InputSetter[TAnalysis]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.InputSetters, constructor.new(_1304.InputSetter)[TAnalysis])
        return value
    ...
    @property
    def filters(self) -> 'List[_1310.ParetoOptimisationFilter]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Filters, constructor.new(_1310.ParetoOptimisationFilter))
        return value
