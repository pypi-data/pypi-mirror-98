...
class CylindricalGearMeshDesign(_879.GearMeshDesign):
    ...
    @property
    def valid_normal_module_range(self) -> '_1329.ShortLengthRange':
        ...
        return constructor.new(_1329.ShortLengthRange)(self.wrapped.ValidNormalModuleRange) if self.wrapped.ValidNormalModuleRange else None
