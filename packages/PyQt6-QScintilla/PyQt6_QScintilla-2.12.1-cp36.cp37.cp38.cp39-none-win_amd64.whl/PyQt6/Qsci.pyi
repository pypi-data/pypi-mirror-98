...
class QsciScintillaBase(QtWidgets.QAbstractScrollArea):
    ...
    def SCN_MACRORECORD(self, a0: int, a1: int, a2: PyQt6.sip.voidptr) -> None: ...
    ...
    @typing.overload
    def SendScintilla(self, msg: int, wParam: int, lParam: PyQt6.sip.voidptr) -> int: ...
    @typing.overload
...
class QsciScintilla(QsciScintillaBase):
    ...
    def marginRightClicked(self, margin: int, line: int, state: QtCore.Qt.KeyboardModifiers) -> None: ...
