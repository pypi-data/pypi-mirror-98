...
class File:
    def __init__(self, name=None, location=None):
        ...
        Attributes:
            ...
            self.location (str): Store file directory and if none is given,
                set to current directory. Also, cannot be accessed from
    ...
    def __str__(self):
        ...
        Note:
            Use the class directly in a print statement or as aggregation
            to get the full directory of the file as string.

        Returns:
            Returns the full directory as string.
        """
