...
class Table:
    ...
    def add(self, *tables):
        ...
        Note:
            Add one or many tables at ones. Make sure to separate
            their names while passing as parameter.
    ...
    def drop(self, *tables):
        ...
        Returns:
            Returns the fetch fetch result after executing the query.
        """
    ...
    def form(self, table, **columns):
        ...
        Note:
            ...
            names alon with their data types in the second parameter.
            If you want to add a foreign key column, do not include
            the column name in here. Instead, create the table with normal
            columns and then use 'add_fk()' function from the Column
            class to add a new column with foreign key constraint.
        ...
        Args:
            ...
            **columns (:obj:`kwargs`): Add these columns the the table.

        Keyword Args:
            **columns (:obj:`kwargs`): Form table using the given
                columns. First part in key='val' represents column name
