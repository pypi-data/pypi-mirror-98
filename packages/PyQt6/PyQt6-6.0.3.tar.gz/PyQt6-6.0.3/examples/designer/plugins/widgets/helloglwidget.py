...
from PyQt6.QtCore import pyqtProperty, pyqtSignal, pyqtSlot, QPointF, QSize, Qt
...
class HelloGLWidget(QOpenGLWidget):
    ...
    def mousePressEvent(self, event):
        self.lastPos = QPointF(event.position())
    ...
    def mouseMoveEvent(self, event):
        ...
        elif event.buttons() & Qt.MouseButtons.RightButton:
            self.setXRotation(self.xRot + 8 * dy)
