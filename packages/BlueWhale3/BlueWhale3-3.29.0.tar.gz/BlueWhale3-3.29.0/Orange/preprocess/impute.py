...
class DoNotImpute(BaseImputeMethod):
    name = __("impute.don't_impute")
    short_name = __("impute.don't_impute_abbr")
    description = ""
...
class DropInstances(BaseImputeMethod):
    name = __("impute.remove_instance")
    short_name = __("impute.remove_instance_abbr")
    description = ""
...
class Average(BaseImputeMethod):
    name = __("impute.average_frequent")
    short_name = __("impute.average_frequent_abbr")
    description = __("impute.average_frequent_desc")
...
class Default(BaseImputeMethod):
    name = __("impute.value")
    short_name = __("impute.value_abbr")
    description = ""
    columns_only = True
...
class Model(BaseImputeMethod):
    _name = __("impute.model_based_impute")
    short_name = __("impute.model_based_impute_abbr")
    description = ""
...
class AsValue(BaseImputeMethod):
    name = __("impute.distinct_value")
    short_name = __("impute.distinct_value_abbr")
    description = ""
...
class Random(BaseImputeMethod):
    name = __("impute.random_value")
    short_name = __("impute.random_value_abbr")
    description = __("impute.random_value_desc")
