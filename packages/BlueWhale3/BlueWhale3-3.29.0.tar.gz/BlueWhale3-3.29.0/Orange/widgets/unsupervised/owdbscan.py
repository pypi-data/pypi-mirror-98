...
def __(key):
    return i18n.t("widget.unsupervised.unsupervised.owdbscan." + key)
...
class OWDBSCAN(widget.OWWidget):
    ...
    class Error(widget.OWWidget.Error):
        not_enough_instances = Msg(__("msg_unique_data"))

    METRICS = [
        (i18n.t("common.algorithm.euclidean"), "euclidean"),
        (i18n.t("common.algorithm.manhattan"), "cityblock"),
    ...
    def __init__(self):
        ...
        gui.doubleSpin(box, self, "eps", EPS_BOTTOM_LIMIT, 1000, 0.01,
                       ...
                       label=__("row_neighborhood"))

        box = gui.widgetBox(self.controlArea, self.tr(__("box_distance_metric")))
        ...
        self.plot = SliderGraph(
            x_axis_label=__("x_axis_label"),
            y_axis_label=__("y_axis_label"),
