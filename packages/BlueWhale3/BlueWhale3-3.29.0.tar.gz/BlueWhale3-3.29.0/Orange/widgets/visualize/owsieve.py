...
def __(key):
    return i18n.t("widget.visualize.visualize.owsieve." + key)
...
class SieveRank(VizRankDialogAttrPair):
    captionTitle = __("captiontitle_sieve_rank")
...
class OWSieveDiagram(OWWidget):
    ...
    def __init__(self):
        ...
        self.vizrank, self.vizrank_button = SieveRank.add_vizrank(
            self.attr_box, self, __("btn_score_combinations"), self.set_attr)
