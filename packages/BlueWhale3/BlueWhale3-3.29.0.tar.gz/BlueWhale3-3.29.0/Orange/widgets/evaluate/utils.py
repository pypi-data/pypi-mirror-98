...
def __(key):
    return i18n.t("widget.evaluate.evaluate.utils." + key)
...
class ScoreTable(OWComponent, QObject):
    ...
    def __init__(self, master):
        ...
        self.model.setHorizontalHeaderLabels([__("header.method")])
    ...
    def update_header(self, scorers):
        ...
        self.model.setHorizontalHeaderItem(0, QStandardItem(__("header.model")))
        self.model.setHorizontalHeaderItem(1, QStandardItem(__("header.train_time")))
        self.model.setHorizontalHeaderItem(2, QStandardItem(__("header.test_time")))
