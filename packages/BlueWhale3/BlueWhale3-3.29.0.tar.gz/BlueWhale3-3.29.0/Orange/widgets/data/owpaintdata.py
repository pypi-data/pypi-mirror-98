...
def __(key):
    return i18n.t("widget.data.data.owpaintdata." + key)
...
class OWPaintData(OWWidget):
    TOOLS = [
        (__("btn.brush"), __("btn.brush_desc"), AirBrushTool, _icon("brush.svg")),
        (__("btn.put"), __("btn.put_desc"), PutInstanceTool, _icon("put.svg")),
        (__("btn.select"), __("btn.select_desc"), SelectTool,
         _icon("select-transparent_42px.png")),
        (__("btn.jitter"), __("btn.jitter_desc"), JitterTool, _icon("jitter.svg")),
        (__("btn.magnet"), __("btn.magnet_desc"), MagnetTool, _icon("magnet.svg")),
        (__("btn.clear"), __("btn.clear_desc"), ClearTool, _icon("../../../icons/Dlg_clear.png"))
    ]
    ...
    class Warning(OWWidget.Warning):
        no_input_variables = Msg(__("msg.input_data_no_var"))
        continuous_target = Msg(__("msg.not_used_continuous_target"))
        sparse_not_supported = Msg(__("msg.sparse_data_ignore"))
        renamed_vars = Msg(__("msg.var_avoid_duplicate"))

    class Information(OWWidget.Information):
        use_first_two = \
            Msg(__("msg.paint_data_use_two_attr"))
    ...
    def _init_ui(self):
        ...
        gui.widgetLabel(namesBox, __("row.label"))
        ...
        tBox = gui.vBox(self.buttonsArea, __("box_tools"))
        ...
        form.addRow(__("row.radius"), slider)
        ...
        form.addRow(__("row.intensity"), slider)
        ...
        form.addRow(__("row.symbol"), slider)

        self.btResetToInput = gui.button(
            tBox, self, __("btn.reset_input"), self.reset_to_input)
