...
def __(key):
    return i18n.t("widget.data.data.owcorrelations." + key)
...
class CorrelationType(IntEnum):
    ...
    def items():
        ...
        """
        return [__("gbox_pearson"), __("gbox_spearman")]
...
class OWCorrelations(OWWidget):
    ...
    class Outputs:
        ...
        correlations = Output("Correlations", Table, label=i18n.t("widget.data.data.common.correlation"))
    ...
    class Information(OWWidget.Information):
        removed_cons_feat = Msg(__("msg_constant_remove"))

    class Warning(OWWidget.Warning):
        not_enough_vars = Msg(__("msg_two_continuous"))
        not_enough_inst = Msg(__("msg_two_instance"))
    ...
    def __init__(self):
        ...
        self.feature_model = DomainModel(
            ...
            placeholder=__("gbox_combinations"), valid_types=ContinuousVariable)
        gui.comboBox(
