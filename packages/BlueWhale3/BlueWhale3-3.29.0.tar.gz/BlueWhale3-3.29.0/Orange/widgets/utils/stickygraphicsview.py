...
def __(key):
    return i18n.t("widget.utils.utils.stickygraphicsview." + key)
__all__ = [
    "StickyGraphicsView"
]
...
def main(args):  # pragma: no cover
    ...
    view.show()
    zoomin = QAction(__("btn.zoom_in"), view, shortcut=QKeySequence.ZoomIn)
    zoomout = QAction(__("btn.zoom_out"), view, shortcut=QKeySequence.ZoomOut)
    zoomreset = QAction(
        i18n.t("common.btn.reset"), view, shortcut=QKeySequence(Qt.ControlModifier | Qt.Key_0)
    )
    view._zoom = 100
