...
def __(key):
    return i18n.t("widget.utils.utils.owplotgui." + key)
...
class OWPlotGUI:
    ...
    def __init__(self, master):
        ...
        self.color_model = DomainModel(
            placeholder=__("placeholder.same_color"), valid_types=DomainModel.PRIMITIVE)
        self.shape_model = DomainModel(
            placeholder=__("placeholder.same_shape"), valid_types=DiscreteVariable)
        self.size_model = DomainModel(
            placeholder=__("placeholder.same_size"), valid_types=ContinuousVariable)
    ...
    def antialiasing_check_box(self, widget):
        ...
        '''
        self._check_box(widget, 'use_antialiasing', __('checkbox.use_antialiasing'), 'update_antialiasing')

    def jitter_size_slider(self, widget, label=__("label.jittering")):
    ...
    def jitter_numeric_check_box(self, widget):
        self._check_box(
            widget=widget,
            value="jitter_continuous", label=__("checkbox.jitter_numeric"),
    ...
    def show_legend_check_box(self, widget):
        ...
        '''
        self._check_box(widget, 'show_legend', i18n.t("common.software.show_legend"),
    ...
    def label_only_selected_check_box(self, widget):
        self._check_box(widget=widget, value="label_only_selected",
                        label=__("checkbox.label_content"),
    ...
    def grid_lines_check_box(self, widget):
        self._check_box(widget, 'show_grid', __('checkbox.show_gridline'),
    ...
    def point_size_slider(self, widget, label=__("label.symbol_size")):
        '''
            Creates a slider that controls point size
        '''
        return self._slider(widget, 'point_width', label, 1, 20, 1, 'sizes_changed')

    def alpha_value_slider(self, widget, label=__("label.opacity")):
        '''
    ...
    def point_properties_box(self, widget, box=__("box.attributes")):
        '''
    ...
    def box_zoom_select(self, parent):
        box_zoom_select = gui.vBox(parent, __("box.zoom_select"))
