...
class CA(ClassificationScore):
    ...
    long_name = __("name.classification_accuracy")
...
class MSE(RegressionScore):
    ...
    long_name = __("name.mean_square_error")


class RMSE(RegressionScore):
    long_name = __("name.root_mean_square_error")
...
class MAE(RegressionScore):
    ...
    long_name = __("name.mean_absolute_error")


# pylint: disable=invalid-name
class R2(RegressionScore):
    __wraps__ = skl_metrics.r2_score
    long_name = __("name.coefficient_of_determination")


class CVRMSE(RegressionScore):
    long_name = __("name.coefficient_of_variation_of_the_rmse")
