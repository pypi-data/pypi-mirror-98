...
class SimpleTreeModel(Model):
    def __init__(self, learner, data):
        ...
        if len(data.domain.class_vars) != 1:
            ...
            raise ValueError(__("value_error.classes_number").format(n_cls))
        ...
        if data.domain.has_discrete_class:
            ...
            raise ValueError(__("value_error.not_support"))
        ...
        if isinstance(learner.skip_prob, (float, int)):
            ...
            raise ValueError(
                __("value_error.skip_prob_invalid").format(learner.skip_prob))
