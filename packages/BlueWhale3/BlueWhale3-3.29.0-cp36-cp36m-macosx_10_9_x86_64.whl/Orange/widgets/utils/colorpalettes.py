...
def __(key):
    return i18n.t("widget.utils.utils.colorpalettes." + key)
...
class LimitedDiscretePalette(DiscretePalette):
    ...
    def __init__(self, number_of_colors, nan_color=NAN_COLOR,
        ...
        if force_hsv is not None:
            warnings.warn(
                __("msg_parameter_replace"), DeprecationWarning,
                stacklevel=2)
...
Linear = __("category.linear")
Diverging = __("category.diverging")
ColorBlindFriendly = __("category.color_blind_friendly")
Other = __("category.other")

# pylint: disable=line-too-long
ContinuousPalettes = {
    'linear_bgyw_20_98_c66': ContinuousPalette(
        __('palettes.blue_green_yellow'), 'linear_bgyw_20_98_c66',
    ...
    'linear_bmy_10_95_c78': ContinuousPalette(
        __('palettes.blue_magenta_yellow'), 'linear_bmy_10_95_c78',
    ...
    'linear_grey_10_95_c0': ContinuousPalette(
        __('palettes.dim_gray'), 'linear_grey_10_95_c0',
    ...
    'linear_inferno': ContinuousPalette(
        __('palettes.inferno'), 'linear_inferno',
    ...
    'linear_viridis': ContinuousPalette(
        __('palettes.viridis'), 'linear_viridis',
    ...
    'diverging_bwr_40_95_c42': ContinuousPalette(
        __('palettes.coolwarm'), 'diverging_bwr_40_95_c42',
        ...
        category=Diverging, flags=Palette.Diverging
    ),
    'diverging_gkr_60_10_c40': ContinuousPalette(
        __('palettes.green_red'), 'diverging_gkr_60_10_c40',
    ...
    'diverging_protanopic_deuteranopic_bwy_60_95_c32': ContinuousPalette(
        __('palettes.diverging_protanopic'), 'diverging_protanopic_deuteranopic_bwy_60_95_c32',
        ...
        category=ColorBlindFriendly, flags=Palette.ColorBlindSafe | Palette.Diverging
    ),
    'diverging_tritanopic_cwr_75_98_c20': ContinuousPalette(
        __('palettes.diverging_tritanopic'), 'diverging_tritanopic_cwr_75_98_c20',
    ...
    'linear_protanopic_deuteranopic_kbw_5_98_c40': ContinuousPalette(
        __('palettes.linear_protanopic'), 'linear_protanopic_deuteranopic_kbw_5_98_c40',
        ...
        category=ColorBlindFriendly, flags=Palette.ColorBlindSafe
    ),
    'linear_tritanopic_krjcw_5_95_c24': ContinuousPalette(
        __('palettes.linear_tritanopic'), 'linear_tritanopic_krjcw_5_95_c24',
    ...
    'isoluminant_cgo_80_c38': ContinuousPalette(
        __('palettes.isoluminant'), 'isoluminant_cgo_80_c38',
    ...
    'rainbow_bgyr_35_85_c73': ContinuousPalette(
        __('palettes.rainbow'), 'rainbow_bgyr_35_85_c73',
