...
def __(key):
    return i18n.t("widget.utils.utils.concurrent." + key)
...
class ThreadExecutor(QObject, concurrent.futures.Executor):
    ...
    def submit(self, func, *args, **kwargs):
        ...
        with self._state_lock:
            ...
            if isinstance(func, Task):
                warnings.warn(__("msg.submit_task_run_task"),
    ...
    def submit_task(self, task):
        ...
        warnings.warn(__("msg.submit_task_deprecate"),
...
class Task(QObject):
    ...
    def __init__(self, parent=None, function=None):
        ...
        warnings.warn(
            __("msg.task_deprecate"), PendingDeprecationWarning,
            stacklevel=2)
