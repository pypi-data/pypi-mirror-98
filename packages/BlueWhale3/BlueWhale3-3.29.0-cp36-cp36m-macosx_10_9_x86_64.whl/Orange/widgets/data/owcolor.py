...
def __(key):
    return i18n.t("widget.data.data.owcolor." + key)
...
class OWColor(widget.OWWidget):
    ...
    def __init__(self):
        ...
        box = gui.hBox(self.controlArea, __("box_discrete_var"))
        ...
        box = gui.hBox(self.controlArea,  __("box_numeric_var"))
        ...
        gui.button(box, self, i18n.t("common.btn.save"), callback=self.save)
        gui.button(box, self, i18n.t("common.btn.load"), callback=self.load)
        gui.button(box, self, i18n.t("common.btn.reset"), callback=self.reset)
