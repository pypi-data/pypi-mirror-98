...
def __(key):
    return i18n.t("widget.visualize.visualize.customizableplot." + key)
...
class Updater:
    ...
    FONT_FAMILY_LABEL, SIZE_LABEL, IS_ITALIC_LABEL = \
        __("font_family"), __("font_size"), __("italic")

    WIDTH_LABEL, ALPHA_LABEL, STYLE_LABEL, ANTIALIAS_LABEL = \
        __("width"), __("opacity"), __("style"), __("antialias")
...
class CommonParameterSetter:
    ...
    LABELS_BOX = __("fonts")
    ANNOT_BOX = __("annotations")
    PLOT_BOX = __("figure")

    FONT_FAMILY_LABEL = __("font_family")
    AXIS_TITLE_LABEL = __("axis_title")
    AXIS_TICKS_LABEL = __("axis_ticks")
    LEGEND_LABEL = __("legend")
    LABEL_LABEL = __("label")
    X_AXIS_LABEL = __("x-axis_title")
    Y_AXIS_LABEL = __("y-axis_title")
