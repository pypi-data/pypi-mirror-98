...
class Port(object):
    ...
    def __init__(self, director=None, name=None, enabled=None, iscsi_name=None, port_name=None, port_wwn=None, node_wwn=None, export_status=None, discovered_initiators=None, director_id=None, exports=None):  # noqa: E501
