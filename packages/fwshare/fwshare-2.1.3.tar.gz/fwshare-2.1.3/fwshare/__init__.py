...
1.1.13:
当非交易日时，fwshare主动抛出Warning，并返回None，搜索多日的情况除外
1.1.14:
...
大宗商品现货价格及基差
"""
# from fwshare.basis import (get_spotPrice_daily,
#                            get_spotPrice)
from fwshare.basis import (get_spotPrice_daily)
...
期货持仓成交排名数据
"""
from fwshare.cot import (get_rank_sum_daily,
                         get_rank_sum,
                         get_shfe_rank_table,
                         get_czce_rank_table,
                         get_dce_rank_table,
                         get_cffex_rank_table,
                         get_future_rank_table)


"""
大宗商品仓单数据
"""
from fwshare.receipt import (get_reciept)


"""
展期收益率
"""
from fwshare.rollYield import (get_rollYield_bar, get_rollYield)


"""
交易所行情数据日线
"""
from fwshare.dailyBar import (get_cffex_daily,
                              get_czce_daily,
                              get_shfe_vwap,
                              get_shfe_daily,
                              get_dce_daily,
...
发邮件模块
"""
from fwshare.sendEmail import sendEmail