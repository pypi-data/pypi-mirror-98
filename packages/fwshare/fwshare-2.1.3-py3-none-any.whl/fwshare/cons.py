...
'czce':['WH','PM','CF','SR','TA','OI','RI','MA','ME','FG','RS','RM','ZC','JR','LR','SF','SM','WT','TC','GN','RO','ER','SRX','SRY','WSX','WSY','CY','AP','SA','UR','CJ','PF','WS','PK'],
'shfe':['CU','AL','ZN','PB','NI','SN','AU','AG','RB','WR','HC','FU','BU','RU','SC','NR','LU','SP','SS']
}
...
DCE_VOLRANK_URL2 = 'http://www.dce.com.cn/publicweb/quotesdata/exportMemberDealPosiQuotesData.html?memberDealPosiQuotes.variety=%s&memberDealPosiQuotes.trade_type=0&contract.contract_id=all&contract.variety_id=%s&year=%s&month=%s&day=%s&exportFlag=txt'
DCE_VOLRANK_URL = 'http://www.dce.com.cn/publicweb/quotesdata/exportMemberDealPosiQuotesData.html?memberDealPosiQuotes.variety=%s&memberDealPosiQuotes.trade_type=0&contract.contract_id=%s&contract.variety_id=%s&year=%s&month=%s&day=%s&exportFlag=txt'
...
CFFEX_COLUMNS = ['open','high','low','volume','turnover','open_interest','oi_chg','close','settle','change1','change2']
...
def get_calendar():
    ...
    return json.load(open(settingfilePath,"rb"))
...
if __name__ == '__main__':
    d = datetime.datetime(2020,5,22,17,1,0)
