...
# source: protoc_gen_swagger/options/openapiv2.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='protoc_gen_swagger/options/openapiv2.proto',
...
_RESPONSE_EXAMPLESENTRY = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='grpc.gateway.protoc_gen_swagger.options.Response.ExamplesEntry.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='value', full_name='grpc.gateway.protoc_gen_swagger.options.Response.ExamplesEntry.value', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_RESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='examples', full_name='grpc.gateway.protoc_gen_swagger.options.Response.examples', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='extensions', full_name='grpc.gateway.protoc_gen_swagger.options.Response.extensions', index=3,
  ...
  nested_types=[_RESPONSE_EXAMPLESENTRY, _RESPONSE_EXTENSIONSENTRY, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_SCHEMA = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='example_string', full_name='grpc.gateway.protoc_gen_swagger.options.Schema.example_string', index=5,
