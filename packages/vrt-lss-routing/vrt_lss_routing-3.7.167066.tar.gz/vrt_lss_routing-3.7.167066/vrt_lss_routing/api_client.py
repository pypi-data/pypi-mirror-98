...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.build_matrix  # this is an instance of the class Endpoint
        api_instance.build_matrix()  # this invokes api_instance.build_matrix.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.build_matrix.callable or self.callable in this class
