...
from contextual_ner.models.utils import (
    init_tokenizer,
    save_model,
...
def main(
    ...
    for id_fold, fold in enumerate(folds.split(dataset)):
        ...
        wandb.watch(model)
        mm = load_from_fine_tuned(
            "cpu",
            "/home/simon/PycharmProjects/name-entity-extraction-for-contextual-embedding/models/bin/camembert-base-2021-03-15-09-57-03-fold-2.bin",
            labels,
        )
        mm("matrifen 100 micrograms/hour transdermal patch")
        train_model(
            model,
            classifier,
            train_dataloader,
