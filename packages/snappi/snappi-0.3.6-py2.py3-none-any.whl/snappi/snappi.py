...
class CaptureFilterIter(SnappiIter):
    ...
    def __getitem__(self, key):
        # type: () -> Union[CaptureIpv4, CaptureVlan, CaptureEthernet, CaptureCustom, CaptureFilter]
        return self._getitem(key)
...
class FlowHeaderIter(SnappiIter):
    ...
    def __getitem__(self, key):
        # type: () -> Union[FlowUdp, FlowIpv6, FlowGre, FlowEthernet, FlowHeader, FlowIpv4, FlowPpp, FlowCustom, FlowGtpv2, FlowArp, FlowGtpv1, FlowIcmp, FlowTcp, FlowEthernetPause, FlowIgmpv1, FlowVxlan, FlowIcmpv6, FlowPfcPause, FlowVlan]
        return self._getitem(key)
