...
python -u -c "from shyft.energy_market.service.stm_run_boot import start_service; start_service(web_ip='${web_ip}',port_num=${port_num},api_port_num=${api_port_num}, doc_root='${web_doc_root}', model_root='${model_root}', log_file='${log_file}')"
