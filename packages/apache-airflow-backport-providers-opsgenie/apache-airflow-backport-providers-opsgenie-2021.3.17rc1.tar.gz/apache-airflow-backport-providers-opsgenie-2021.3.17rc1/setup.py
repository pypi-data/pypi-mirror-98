...
"""Setup.py for the apache-airflow-backport-providers-opsgenie package."""
...
def do_setup():
    """Perform the package apache-airflow-backport-providers-opsgenie setup."""
    setup(
        name='apache-airflow-backport-providers-opsgenie',
        description='Backport provider package '
        'apache-airflow-backport-providers-opsgenie for Apache Airflow',
