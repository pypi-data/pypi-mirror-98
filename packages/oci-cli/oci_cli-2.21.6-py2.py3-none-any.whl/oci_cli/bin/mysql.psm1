...
function GetOciSubcommands_mysql() {
    $ociSubcommands = @{
        ...
        'mysql db-system' = 'analytics-cluster analytics-cluster-memory-estimate clone create delete get import list restart start stop update'
...
function GetOciCommandsToLongParams_mysql() {
    $ociCommandsToLongParams = @{
        ...
        'mysql db-system list' = 'all compartment-id configuration-id db-system-id display-name from-json help is-analytics-cluster-attached is-up-to-date lifecycle-state limit page page-size sort-by sort-order'
