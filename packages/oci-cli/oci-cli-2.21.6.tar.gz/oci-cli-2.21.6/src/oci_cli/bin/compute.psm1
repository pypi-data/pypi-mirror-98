...
function GetOciCommandsToLongParams_compute() {
    $ociCommandsToLongParams = @{
        ...
        'compute instance launch' = 'agent-config assign-public-ip availability-config availability-domain boot-volume-size-in-gbs compartment-id dedicated-vm-host-id defined-tags display-name extended-metadata fault-domain freeform-tags from-json help hostname-label image-id instance-options ipxe-script-file is-pv-encryption-in-transit-enabled launch-options max-wait-seconds metadata nsg-ids platform-config private-ip shape shape-config skip-source-dest-check source-boot-volume-id source-details ssh-authorized-keys-file subnet-id user-data-file vnic-display-name wait-for-state wait-interval-seconds'
        ...
        'compute instance update' = 'agent-config availability-config defined-tags display-name extended-metadata fault-domain force freeform-tags from-json help if-match instance-id instance-options launch-options max-wait-seconds metadata shape shape-config wait-for-state wait-interval-seconds'
