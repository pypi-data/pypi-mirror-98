...
class FeatureEngineer:
    ...
    def act(self,
        ...
        print('Last generated feature:', _last_generated_feature)
        print('actor:', actor)
        print('Last gen feature in DF:', _last_generated_feature in DATA_PROCESSING.get('df').columns)
        print('Last generated feature:', _last_generated_feature)
        print('DF[_actor, _last_generated_feature]', DATA_PROCESSING.get('df')[[_actor, _last_generated_feature]])
