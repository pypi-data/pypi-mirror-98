#!/usr/bin/env python
# ------------------------------------------------------------------------------------------------------%
# Created by "Thieu" at 17:59, 02/03/2021                                                               %
#                                                                                                       %
...
md1 = BaseICA(obj_func, lb1, ub1, verbose, epoch, pop_size)
...
lb2 = -5
ub2 = 10
md2 = BaseICA(obj_func, lb2, ub2, verbose, epoch, pop_size, problem_size=problemSize)  # Remember the keyword "problem_size"
...
lb3 = [-5]
ub3 = [10]
md3 = BaseICA(obj_func, lb3, ub3, verbose, epoch, pop_size, problem_size=problemSize)  # Remember the keyword "problem_size"
best_pos1, best_fit1, list_loss1 = md3.train()
print(md3.solution[1])

lb4 = [-5] * problemSize
ub4 = [10] * problemSize
md4 = BaseICA(obj_func, lb4, ub4, verbose, epoch, pop_size)  # No need the keyword "problem_size"
