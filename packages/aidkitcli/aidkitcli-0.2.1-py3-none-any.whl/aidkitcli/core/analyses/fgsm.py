...
def fgsm(data: str,
    ...
    """
    Create a RequestModel for a Fast Gradient Sign Method Attack. The execution
    of this request creates a perturbation per eligible data point in each file
    of the data set. Furthermore, the execution of this request returns a plot
    showing the performance of the model on the clean and the perturbed data.
