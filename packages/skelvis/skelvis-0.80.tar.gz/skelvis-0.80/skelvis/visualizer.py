...
class FrameUpdater:
    def __init__(self, skeletons: List[DrawableSkeleton], frames: np.ndarray, joint_set: JointSet):
...
class SkeletonVisualizer:
    ...
    def visualize_video(self, frames: np.ndarray, colors: List[Color] = None, fps: int = 15) -> None:
        ...
        frame_updater = FrameUpdater(self.skeletons, frames, self.joint_set)
        ...
        display(widgets.HBox([video_player, frame_slider]))
