...
class Embedding:
    ...
    def get_similar(self, positives_used, negatives_used=list(), positives_unused=list(), negatives_unused=list(), n=20):
        ...
        not_a_suggestion = [str(not_suggestion).replace(' ', '_') for not_suggestion in negatives_used + positives_unused + negatives_unused if str(not_suggestion).replace(' ', '_') in self.model.wv.vocab]
