...
model_server_timeout = environment.environment_variables.int('MODEL_SERVER_TIMEOUT', 60)
model_server_workers = environment.environment_variables.int('MODEL_SERVER_WORKERS', cpu_count)
