""" 
    Environment Handling Script
    (Only needed for training environment)
        - handles loading vars from ENV vars in container
        - handles create directories for data channels
        - handles getting container specs e.g. num_gpus, num_cpus, etc

        This module contains functionality related to the container environment.
        This includes:
                - constants
                - utility functions
                - classes which provide access to relevant aspects of the environment (including system characteristics,
...
BASE_PATH_ENV = "SAGEMAKER_BASE_DIR"
...
class Environment(mapping.MappingMixin):  # pylint:disable=too-many-public-methods
    ...
    def __init__(self, resource_config=None, input_data_config=None, hyperparameters=None):
        ...
        self.environment_variables = environs.Env()
        ...
        sagemaker_region = sagemaker_hyperparameters.get(
            params.REGION_NAME_PARAM, "sagemaker_region"
        )
