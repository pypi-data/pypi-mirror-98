...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', '4.14.0-alpha.1615811962+e3c41bff'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp 4.14.0-alpha.1615811962+e3c41bff`
                """)
            else:
                raise
