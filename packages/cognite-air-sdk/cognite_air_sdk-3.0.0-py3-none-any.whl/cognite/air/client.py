...
class AIRClient:
    def __init__(self, data: Dict[str, Any], client: CogniteClient, secrets: Dict[str, Any], debug: bool = False):
        ...
        if not self._testing:
            ...
            model_version = retrieve_model_version()
            ...
            if is_string_truthy(retrieve_backfilling()) and is_string_truthy(data.get("backfilling")):
            ...
            self._config = AIRClientConfig(
                ...
                schedule_asset_ext_id=sa_ext_id,
                data_fields=data,
                data_fields_defs=self.create_data_field_dct(retrieve_field_definitions()),
