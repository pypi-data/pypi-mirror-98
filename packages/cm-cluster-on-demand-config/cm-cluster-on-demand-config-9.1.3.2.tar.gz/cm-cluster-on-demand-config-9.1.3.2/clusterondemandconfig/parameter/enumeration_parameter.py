...
class EnumerationParameter(OptionalParameter):
    def __init__(self, name, advanced=False, boot=False, choices=None, default=None, env=None, flags=None,
                 help="", help_choices=None, help_section=None, help_varname=None, key=None,
                 parser=None, secret=False, serializer=str, type=None, validation=None):
        super(EnumerationParameter, self).__init__(
