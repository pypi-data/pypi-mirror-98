...
class OpenPR:
    ...
    def _create_pr(self, youtrack_id):
        ...
        pr_body = self._ask_for_description("", base_branch)
    ...
    def _edit_pr(self, pr):
        pr_body = self._ask_for_description(pr.body, pr.base.ref)
    ...
    def _ask_for_description(self, pr_body, base_branch):
        if pr_body == "" and self._config.user["use_commits_in_pr_body"]:
        ...
        if description == "":
            ...
            return self._ask_for_description(pr_body, base_branch)
        return description
