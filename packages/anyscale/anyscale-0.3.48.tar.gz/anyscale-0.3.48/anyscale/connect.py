...
def _get_wheel_url(ray_release: str) -> str:
    ...
    return (
        ...
        "{}/ray-2.0.0.dev0-cp{}-cp{}m-{}.whl".format(
            ray_release, py_version, py_version, platform
        )
    )
    ...
    def _check_required_ray_version(self, ray_version: str, ray_commit: str) -> None:
        if ray_version != REQUIRED_RAY_VERSION or ray_commit != REQUIRED_RAY_COMMIT:
            msg = (
                ...
                "Ray version by running `pip install -U {}`. To unsafely "
