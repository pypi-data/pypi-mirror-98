...
class TestTimer():
    ...
    def test_calltimes(self):
        ...
        timer = Timer(
            period, self._callback, None, strict_timing=True, sleep=0.05, n=n
        )
