...
_BULKRECORD = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name='protocol.BulkRecord.organization_id',
            index=0,
            number=1,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(name='model_id',
                                    full_name='protocol.BulkRecord.model_id',
                                    index=1,
                                    number=2,
                                    type=9,
                                    cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='model_version',
            full_name='protocol.BulkRecord.model_version',
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(name='timestamp',
                                    full_name='protocol.BulkRecord.timestamp',
                                    index=3,
                                    number=4,
                                    type=11,
                                    cpp_type=10,
                                    ...
                                    serialized_options=None,
                                    file=DESCRIPTOR),
        _descriptor.FieldDescriptor(name='records',
                                    full_name='protocol.BulkRecord.records',
                                    index=4,
                                    number=5,
                                    type=11,
                                    cpp_type=10,
...
_RECORD = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='organization_id',
            full_name='protocol.Record.organization_id',
            index=0,
            number=1,
            type=3,
            cpp_type=2,
            ...
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(name='model_id',
                                    full_name='protocol.Record.model_id',
                                    index=1,
                                    number=2,
                                    type=9,
                                    cpp_type=9,
        ...
        _descriptor.FieldDescriptor(name='prediction_id',
                                    full_name='protocol.Record.prediction_id',
                                    index=2,
                                    number=3,
                                    type=9,
                                    cpp_type=9,
        ...
        _descriptor.FieldDescriptor(name='prediction',
                                    full_name='protocol.Record.prediction',
                                    index=3,
                                    number=4,
                                    type=11,
                                    cpp_type=10,
                                    ...
                                    serialized_options=None,
                                    file=DESCRIPTOR),
        _descriptor.FieldDescriptor(name='actual',
                                    full_name='protocol.Record.actual',
                                    index=4,
                                    number=5,
                                    type=11,
                                    cpp_type=10,
    ...
    oneofs=[
        _descriptor.OneofDescriptor(
            name='prediction_or_actual',
            full_name='protocol.Record.prediction_or_actual',
            index=0,
            containing_type=None,
            fields=[]),
    ],
...
_LABEL = _descriptor.Descriptor(
    ...
    containing_type=None,
    fields=[
        _descriptor.FieldDescriptor(name='binary',
                                    full_name='protocol.Label.binary',
                                    index=0,
                                    number=1,
                                    type=8,
                                    cpp_type=7,
                                    ...
                                    serialized_options=None,
                                    file=DESCRIPTOR),
        _descriptor.FieldDescriptor(name='categorical',
                                    full_name='protocol.Label.categorical',
                                    index=1,
                                    number=2,
                                    type=9,
                                    cpp_type=9,
                                    ...
                                    serialized_options=None,
                                    file=DESCRIPTOR),
        _descriptor.FieldDescriptor(name='numeric',
                                    full_name='protocol.Label.numeric',
                                    index=2,
                                    number=3,
                                    type=1,
                                    cpp_type=5,
...
_PREDICTION_FEATURESENTRY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='key',
            full_name='protocol.Prediction.FeaturesEntry.key',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='value',
            full_name='protocol.Prediction.FeaturesEntry.value',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_PREDICTION = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(name='timestamp',
                                    full_name='protocol.Prediction.timestamp',
                                    index=0,
                                    number=1,
                                    type=11,
                                    cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='model_version',
            full_name='protocol.Prediction.model_version',
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(name='label',
                                    full_name='protocol.Prediction.label',
                                    index=2,
                                    number=3,
                                    type=11,
                                    cpp_type=10,
        ...
        _descriptor.FieldDescriptor(name='features',
                                    full_name='protocol.Prediction.features',
                                    index=3,
                                    number=4,
                                    type=11,
                                    cpp_type=10,
...
_VALUE = _descriptor.Descriptor(
    ...
    containing_type=None,
    fields=[
        _descriptor.FieldDescriptor(name='string',
                                    full_name='protocol.Value.string',
                                    index=0,
                                    number=1,
                                    type=9,
                                    cpp_type=9,
                                    ...
                                    serialized_options=None,
                                    file=DESCRIPTOR),
        _descriptor.FieldDescriptor(name='int',
                                    full_name='protocol.Value.int',
                                    index=1,
                                    number=2,
                                    type=3,
                                    cpp_type=2,
                                    ...
                                    serialized_options=None,
                                    file=DESCRIPTOR),
        _descriptor.FieldDescriptor(name='double',
                                    full_name='protocol.Value.double',
                                    index=2,
                                    number=3,
                                    type=1,
                                    cpp_type=5,
...
_ACTUAL = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(name='timestamp',
                                    full_name='protocol.Actual.timestamp',
                                    index=0,
                                    number=1,
                                    type=11,
                                    cpp_type=10,
                                    ...
                                    file=DESCRIPTOR),
        _descriptor.FieldDescriptor(name='label',
                                    full_name='protocol.Actual.label',
                                    index=1,
                                    number=2,
                                    type=11,
                                    cpp_type=10,
...
_RECORD.fields_by_name['prediction'].containing_oneof = _RECORD.oneofs_by_name[
    'prediction_or_actual']
_RECORD.oneofs_by_name['prediction_or_actual'].fields.append(
    _RECORD.fields_by_name['actual'])
_RECORD.fields_by_name['actual'].containing_oneof = _RECORD.oneofs_by_name[
    'prediction_or_actual']
_LABEL.oneofs_by_name['data'].fields.append(_LABEL.fields_by_name['binary'])
_LABEL.fields_by_name['binary'].containing_oneof = _LABEL.oneofs_by_name[
    'data']
_LABEL.oneofs_by_name['data'].fields.append(
    _LABEL.fields_by_name['categorical'])
_LABEL.fields_by_name['categorical'].containing_oneof = _LABEL.oneofs_by_name[
    'data']
_LABEL.oneofs_by_name['data'].fields.append(_LABEL.fields_by_name['numeric'])
_LABEL.fields_by_name['numeric'].containing_oneof = _LABEL.oneofs_by_name[
    'data']
_PREDICTION_FEATURESENTRY.fields_by_name['value'].message_type = _VALUE
_PREDICTION_FEATURESENTRY.containing_type = _PREDICTION
_PREDICTION.fields_by_name[
    'timestamp'].message_type = google_dot_protobuf_dot_timestamp__pb2._TIMESTAMP
...
_VALUE.oneofs_by_name['data'].fields.append(_VALUE.fields_by_name['string'])
_VALUE.fields_by_name['string'].containing_oneof = _VALUE.oneofs_by_name[
    'data']
_VALUE.oneofs_by_name['data'].fields.append(_VALUE.fields_by_name['int'])
_VALUE.fields_by_name['int'].containing_oneof = _VALUE.oneofs_by_name['data']
_VALUE.oneofs_by_name['data'].fields.append(_VALUE.fields_by_name['double'])
_VALUE.fields_by_name['double'].containing_oneof = _VALUE.oneofs_by_name[
    'data']
_ACTUAL.fields_by_name[
    'timestamp'].message_type = google_dot_protobuf_dot_timestamp__pb2._TIMESTAMP
...
BulkRecord = _reflection.GeneratedProtocolMessageType(
    'BulkRecord',
    (_message.Message, ),
    {
...
Actual = _reflection.GeneratedProtocolMessageType(
    'Actual',
    (_message.Message, ),
    {
        'DESCRIPTOR': _ACTUAL,
...
ReceiverResult = _reflection.GeneratedProtocolMessageType(
    'ReceiverResult',
    (_message.Message, ),
    {
