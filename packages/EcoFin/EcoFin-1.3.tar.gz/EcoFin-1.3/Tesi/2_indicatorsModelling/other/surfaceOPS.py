...
Created by Luca Camerani at 25/02/2021, University of Milano-Bicocca.
...
try:
    ...
    deepSurface = DeepOptionSurface(optSurface, computeIV=False, computeBSM=False, progressBar=True)
