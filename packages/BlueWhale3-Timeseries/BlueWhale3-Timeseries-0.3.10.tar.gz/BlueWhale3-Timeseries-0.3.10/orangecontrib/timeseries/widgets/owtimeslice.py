...
def __(key):
    return i18n.t("timeseries.owtimeslice." + key)
...
class OWTimeSlice(widget.OWWidget):
    ...
    class Outputs:
        subset = Output('Subset', Table, label=i18n.t("timeseries.common.subset"))
    ...
    class Error(widget.OWWidget.Error):
        no_time_variable = widget.Msg(__('msg.miss_time_var'))
        no_time_delta = widget.Msg(__('msg.no_time_delta'))
    ...
    def __init__(self):
        ...
        selectBox = gui.vBox(self.controlArea, __('box.time_slice'))
        ...
        gui.rubber(playBox)
        intervalBox = gui.vBox(vControlsBox, __('box.track_interval'))
        intervalBox.setToolTip(__('box.track_interval_tip'))
        ...
        gui.valueSlider(intervalBox, self, 'playback_interval',
                        label=__('label_delay'), labelFormat=__('sec'),
