...
def __(key):
    return i18n.t("timeseries.owlinechart." + key)
...
class OWLineChart(OWWidget):
    ...
    class Inputs:
        ...
        features = Input("Features", AttributeList, label=i18n.t("timeseries.common.features"))
        forecast = Input('Forecast', Timeseries, multiple=True, label=i18n.t("timeseries.common.forecast"))
    ...
    def __init__(self):
        ...
        self.add_button = button = QPushButton(icon, __('btn_add_plot'), self)
