...
class DBTable(object):
    ...
    def __load_table_names(self):
        self.__table_names = MtDataClient.instance().get_table_orm(db=self.db_name)
    ...
    def run_query(self, query_object):
        ...
        df = MtDataClient.instance().db_query(db=self.db_name, sql=sql)
        return df
    ...
    def __load_table_class(self, table_name):
        ...
        data = MtDataClient.instance().get_table_orm(db=self.db_name, table=table_name)
        dct = {}
