...
static PyObject *fht1_int(PyObject *self, PyObject *args);
static PyObject *fht2_int(PyObject *self, PyObject *args);
void hadamard_apply_vector(PyArrayObject *y, PyArrayObject *x, unsigned m);

static PyMethodDef _py_hadamardMethods[] = {
  {"fht1_int", fht1_int, METH_VARARGS},
  {"fht2_int", fht2_int, METH_VARARGS},
...
void init_C_fht_int()  {
    (void) Py_InitModule("_C_fht_int", _py_hadamardMethods);
    import_array();  // Must be present for NumPy.  Called first after above line.
    Py_Initialize();
}
