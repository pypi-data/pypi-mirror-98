...
static PyObject *fht1_float(PyObject *self, PyObject *args);
static PyObject *fht2_float(PyObject *self, PyObject *args);
void hadamard_apply_vector(PyArrayObject *y, PyArrayObject *x, unsigned m);

static PyMethodDef _py_hadamardMethods[] = {
  {"fht1_float", fht1_float, METH_VARARGS},
  {"fht2_float", fht2_float, METH_VARARGS},
...
void init_C_fht_float()  {
    (void) Py_InitModule("_C_fht_float", _py_hadamardMethods);
    import_array();  // Must be present for NumPy.  Called first after above line.
    Py_Initialize();
}
