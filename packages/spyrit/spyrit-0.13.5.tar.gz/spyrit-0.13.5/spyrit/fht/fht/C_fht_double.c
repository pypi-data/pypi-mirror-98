...
static PyObject *fht1_double(PyObject *self, PyObject *args);
static PyObject *fht2_double(PyObject *self, PyObject *args);
void hadamard_apply_vector(PyArrayObject *y, PyArrayObject *x, unsigned m);

static PyMethodDef _py_hadamardMethods[] = {
  {"fht1_double", fht1_double, METH_VARARGS},
  {"fht2_double", fht2_double, METH_VARARGS},
...
void init_C_fht_double()  {
    (void) Py_InitModule("_C_fht_double", _py_hadamardMethods);
    import_array();  // Must be present for NumPy.  Called first after above line.
    Py_Initialize();
}
