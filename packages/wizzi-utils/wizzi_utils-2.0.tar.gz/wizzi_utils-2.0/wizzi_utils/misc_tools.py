...
def to_str(var, title: str, data_chars: int = 100) -> str:
    ...
    examples:
        ...
        print(to_str(var=[1, 3], title='1d list of ints no data', data_chars=0))  # dont print data
        print(to_str(var=[15] * 1000, title='1d long list'))  # print 100 first chars
    ...
    if isinstance(var, (int, float, str)):
        ...
        if data_chars < 0:  # all data
            string += ': {}'.format(str(var))
        elif data_chars > 0:  # first 'data_chars' characters
            string += ': {}'.format(str(var)[:data_chars])
        ...
        if data_chars < 0:  # all data
            ...
            var_str = str(var)
            string += ': {}'.format(var_str[:data_chars])
            if len(var_str) > data_chars:
                string += '...too long'
        ...
        if data_chars < 0:  # all data
            string += ': {}'.format(str(var.tolist()))
        elif data_chars > 0:  # first 'data_chars' characters
            var_str = str(var.tolist())
            string += ': {}'.format(var_str[:data_chars])
            if len(var_str) > data_chars:
                string += '...too long'
