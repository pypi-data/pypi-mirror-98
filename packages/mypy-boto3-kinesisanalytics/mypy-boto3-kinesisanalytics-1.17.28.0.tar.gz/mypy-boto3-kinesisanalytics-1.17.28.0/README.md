...
[boto3.KinesisAnalytics 1.17.28](https://boto3.amazonaws.com/v1/documentation/api/1.17.28/reference/services/kinesisanalytics.html#KinesisAnalytics) service
compatible with
