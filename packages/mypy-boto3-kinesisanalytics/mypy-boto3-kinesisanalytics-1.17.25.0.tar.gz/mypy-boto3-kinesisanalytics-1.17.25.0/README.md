...
[boto3.KinesisAnalytics 1.17.25](https://boto3.amazonaws.com/v1/documentation/api/1.17.25/reference/services/kinesisanalytics.html#KinesisAnalytics) service
compatible with
