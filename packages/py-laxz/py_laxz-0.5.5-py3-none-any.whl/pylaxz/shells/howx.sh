...
--how-enc)
    ...
    refMd "'More on [RSA-Encryption](https://gist.github.com/minlaxz/71a997c38665aa2fe530a6b4ba4308ed#rsa-encryptions)'"
    refMdSelf
    ;;
...
--how-dec)
    ...
    refMd "'More on [RSA-Decryption](https://gist.github.com/minlaxz/71a997c38665aa2fe530a6b4ba4308ed#rsa-decryptions)'"
    refMdSelf
    ;;
