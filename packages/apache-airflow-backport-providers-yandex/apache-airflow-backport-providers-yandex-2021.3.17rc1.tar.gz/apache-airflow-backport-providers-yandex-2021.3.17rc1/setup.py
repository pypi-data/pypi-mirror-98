...
"""Setup.py for the apache-airflow-backport-providers-yandex package."""
...
def do_setup():
    """Perform the package apache-airflow-backport-providers-yandex setup."""
    setup(
        name='apache-airflow-backport-providers-yandex',
        description='Backport provider package '
        'apache-airflow-backport-providers-yandex for Apache Airflow',
