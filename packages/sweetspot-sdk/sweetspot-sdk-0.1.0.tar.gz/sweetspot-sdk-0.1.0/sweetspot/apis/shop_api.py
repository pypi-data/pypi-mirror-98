...
class ShopApi(BaseApi):
    ...
    def get_categories(self, shop_id, page=1, size=20):
    ...
    def get_options(self, shop_id, page=1, size=20):
    ...
    def get_items(self, shop_id, page=1, size=20):
    ...
    def get_modifiers(self, shop_id, page=1, size=20):
