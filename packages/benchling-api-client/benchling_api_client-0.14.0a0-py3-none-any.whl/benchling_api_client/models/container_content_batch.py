...
T = TypeVar("T", bound="ContainerContentBatch")


@attr.s(auto_attribs=True)
class ContainerContentBatch:
    """  """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        container_content_batch.additional_properties = d
        return container_content_batch
