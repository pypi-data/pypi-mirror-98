...
def _parse_response(*, response: httpx.Response) -> Optional[Union[AssayResultSchemasPaginatedList, BadRequestError]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[AssayResultSchemasPaginatedList, BadRequestError]]:
    return Response(
