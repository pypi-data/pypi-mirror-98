...
from ...models.dna_sequences_archive import DnaSequencesArchive
...
def _parse_response(*, response: httpx.Response) -> Optional[Union[DnaSequencesArchivalChange, BadRequestError]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[DnaSequencesArchivalChange, BadRequestError]]:
    return Response(
