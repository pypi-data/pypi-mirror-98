...
def _parse_response(*, response: httpx.Response) -> Optional[Union[EntitySchemasPaginatedList, BadRequestError]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[EntitySchemasPaginatedList, BadRequestError]]:
    return Response(
