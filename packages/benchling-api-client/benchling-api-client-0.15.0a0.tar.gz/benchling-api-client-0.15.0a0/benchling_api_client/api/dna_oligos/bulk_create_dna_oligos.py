...
from ...models.dna_oligos_bulk_create_request import DnaOligosBulkCreateRequest
...
def _get_kwargs(
    *,
    client: Client,
    json_body: DnaOligosBulkCreateRequest,
) -> Dict[str, Any]:
    url = "{}/dna-oligos:bulk-create".format(client.base_url)
