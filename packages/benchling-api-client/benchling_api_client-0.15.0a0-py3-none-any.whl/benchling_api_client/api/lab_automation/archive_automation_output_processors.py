...
from ...models.automation_output_processors_archive import AutomationOutputProcessorsArchive
...
def _get_kwargs(
    *,
    client: Client,
    json_body: AutomationOutputProcessorsArchive,
) -> Dict[str, Any]:
    url = "{}/automation-output-processors:archive".format(client.base_url)
