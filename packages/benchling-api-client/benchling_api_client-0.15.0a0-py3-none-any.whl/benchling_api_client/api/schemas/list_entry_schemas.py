...
def _parse_response(*, response: httpx.Response) -> Optional[Union[EntrySchemasPaginatedList, BadRequestError]]:
...
def _build_response(*, response: httpx.Response) -> Response[Union[EntrySchemasPaginatedList, BadRequestError]]:
    return Response(
