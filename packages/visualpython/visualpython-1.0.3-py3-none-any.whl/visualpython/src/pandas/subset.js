define([
    ...
    , 'nbextensions/visualpython/src/common/vpDataSelector'
], function (requirejs, $, vpCommon, vpConst, sb, vpFuncJS, libPandas, pdGen, vpDataSelector) {
    // 옵션 속성
    const funcOptProp = {
        stepCount : 1
        , funcName : "Subset"
    ...
    PandasPackage.prototype.initHtml = function() {
        ...
        this.dataSelector = new vpDataSelector(this, "i0");
    }
