...
#
    ...
    def new_PhasableSample(self, sample: str, reference_sequence_paths: list = None, auto_simulate_samples: bool = False) -> object:
        ...
        phasable_sample = PhasableSample.PhasableSample(sample, vcf_file_path, ignore_phase_sets, self.sample_to_alignment_files[sample], self.RG_ID_dict,
                reference_sequence_names, reference_sequence_paths = reference_sequence_paths, simulate_haplotypes = auto_simulate_samples, output_directory_path=self.output_directory)
