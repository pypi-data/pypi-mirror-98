...
class PhasableSample:
    ...
    def __init__(
        ...
        if output_directory_path is None:
            self.output_directory = str(sample)+'/'
        else:
    ...
    def simulate_reads(self, path_to_pbsim = 'pbsim', depth = 1,
        ...
        for haplotype in haplotypes:
            self.haplotype_simulated_reads[haplotype] = SimulatePhasedData.simulate_reads_pbsim2(self.haplotype_reference_sequences[haplotype], path_to_pbsim = path_to_pbsim, depth = depth,
        ...
        prefix = prefix, id_prefix = id_prefix, output_directory = self.output_directory + '/simulated', sample = self.sample,
        haplotype = haplotype)
