...
class PhasedRead:
    ...
    def __init__(
            self, aligned_segment, phasable_sample = None, vcf_file = None, sample = None, haplotype = None, ignore_phase_sets = False, error_model = 0,
    ...
    def phase_read(
        ...
        _Phase_Set_max = self._select_best_phasing(
            self._find_PhaseSets(error_model, error_rate_threshold, prior_probabilities,liftover_converters = self.liftover_converters),
            error_model,
