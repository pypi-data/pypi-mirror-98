...
def simulate_reads_pbsim2(
        reference_sequence: object, path_to_pbsim: object = 'pbsim', depth: object = 1,
        simulation_mode: object = 'pbsim2/data/R103.model',
        difference_ratio: object = '23:31:46', length_mean: object = 20000,
        length_max: object = 1000000, length_min: object = 100,
        length_sd: object = 15000, accuracy_min: object = 0.01,
        accuracy_max: object = 1.00, accuracy_mean: object = 0.80,
        prefix: object = None, id_prefix: object = 'S', output_directory: object = None, sample: object = None,
    ...
    final_combined_simulated_long_reads_fastq_path: str = str(
            os.path.dirname(combined_simulated_long_reads_fastq_path)
            ) + '/' + str(os.path.splitext(os.path.basename(reference_sequence))[0]) + '.fastq'
...
def convert_coordinates(
        haplotype, sample, contig, position, reference_sequence, reference_liftover_converters = None, chain_file = None
        ):
    """
...
def generate_haplotype_specific_fasta(
        haplotype: object, sample: object, input_reference_sequence_path: object, haplotype_vcf: object,
        output_reference_sequence_path: object = None,
    ...
    if output_reference_sequence_path is None:
        output_reference_sequence_path = str(os.path.splitext(input_reference_sequence_path)[0]) + '_hap' + str(
                haplotype
                ) + '_' + str(sample) + '.fa'
...
def index_fasta_file(fasta_file_path: object) -> object:
    """
...
def create_fasta_file(
        input_fasta_file_path: object, output_fasta_file_path = None, regions = None, only_autosomal = False
        ) -> object:
    """
...
def true_alignment_match(
        aligned_segment, needs_liftover = False, contig = None, ref_start = None, ref_end = None, strand = None,
        tag_read = False, only_output_match_label = False, only_output_overlap = False,
        true_reference_sequence_path = None, aligned_reference_sequence_path = None, liftover_converter = None,
        chain_file_path: object = None, sample = None, haplotype = None, reference_liftover_converters = None
        ) -> object:
    """
...
def alignment_type(aligned_segment: object, tag_read: object = False) -> object:
    """
