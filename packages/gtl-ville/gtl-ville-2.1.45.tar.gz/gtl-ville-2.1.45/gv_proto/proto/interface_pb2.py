...
_INTERFACE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='get_zones_travel_time',
    full_name='gv_proto.proto.Interface.get_zones_travel_time',
    index=5,
    containing_service=None,
    input_type=gv__proto_dot_proto_dot_archivist__pb2._ZONESTRAVELTIMEREQUEST,
    output_type=gv__proto_dot_proto_dot_archivist__pb2._ZONESTRAVELTIME,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='get_zone_points',
    full_name='gv_proto.proto.Interface.get_zone_points',
    index=11,
    containing_service=None,
    input_type=gv__proto_dot_proto_dot_geographer__pb2._LOCATIONSREQUEST,
    output_type=gv__proto_dot_proto_dot_geographer__pb2._LOCATIONS,
