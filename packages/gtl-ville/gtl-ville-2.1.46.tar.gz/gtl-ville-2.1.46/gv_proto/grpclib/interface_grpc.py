...
class InterfaceBase(abc.ABC):
    ...
    @abc.abstractmethod
    async def get_zones_travel_time(self, stream: 'grpclib.server.Stream[gv_proto.proto.archivist_pb2.ZonesTravelTimeRequest, gv_proto.proto.archivist_pb2.ZonesTravelTime]') -> None:
        pass
    ...
    @abc.abstractmethod
    async def get_zone_points(self, stream: 'grpclib.server.Stream[gv_proto.proto.geographer_pb2.LocationsRequest, gv_proto.proto.geographer_pb2.Locations]') -> None:
        pass
    ...
    def __mapping__(self) -> typing.Dict[str, grpclib.const.Handler]:
        return {
            ...
            '/gv_proto.proto.Interface/get_zones_travel_time': grpclib.const.Handler(
                self.get_zones_travel_time,
                grpclib.const.Cardinality.UNARY_UNARY,
                gv_proto.proto.archivist_pb2.ZonesTravelTimeRequest,
                gv_proto.proto.archivist_pb2.ZonesTravelTime,
            ),
            ...
            '/gv_proto.proto.Interface/get_zone_points': grpclib.const.Handler(
                self.get_zone_points,
                grpclib.const.Cardinality.UNARY_UNARY,
                gv_proto.proto.geographer_pb2.LocationsRequest,
                gv_proto.proto.geographer_pb2.Locations,
            ),
...
class InterfaceStub:
    ...
    def __init__(self, channel: grpclib.client.Channel) -> None:
        ...
        self.get_zones_travel_time = grpclib.client.UnaryUnaryMethod(
            channel,
        ...
        self.get_zone_points = grpclib.client.UnaryUnaryMethod(
            channel,
