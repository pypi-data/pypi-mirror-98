...
class InterfaceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.get_zones_travel_time = channel.unary_unary(
                '/gv_proto.proto.Interface/get_zones_travel_time',
                request_serializer=gv__proto_dot_proto_dot_archivist__pb2.ZonesTravelTimeRequest.SerializeToString,
                response_deserializer=gv__proto_dot_proto_dot_archivist__pb2.ZonesTravelTime.FromString,
                )
...
class InterfaceServicer(object):
    ...
    def get_zones_travel_time(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_InterfaceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'get_zones_travel_time': grpc.unary_unary_rpc_method_handler(
                    servicer.get_zones_travel_time,
                    request_deserializer=gv__proto_dot_proto_dot_archivist__pb2.ZonesTravelTimeRequest.FromString,
                    response_serializer=gv__proto_dot_proto_dot_archivist__pb2.ZonesTravelTime.SerializeToString,
            ),
...
class Interface(object):
    ...
    @staticmethod
    def get_zones_travel_time(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/gv_proto.proto.Interface/get_zones_travel_time',
            gv__proto_dot_proto_dot_archivist__pb2.ZonesTravelTimeRequest.SerializeToString,
            gv__proto_dot_proto_dot_archivist__pb2.ZonesTravelTime.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
