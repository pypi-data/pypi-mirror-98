...
@click.option('--image', default='lagerdata/gatewaypy3:v0.1.80', help='Docker image to use for running script', show_default=True)
@click.option(
    '--env',
...
def python(ctx, runnable, gateway, image, env, passenv, kill, signum, timeout, detach, port, args):
    """
