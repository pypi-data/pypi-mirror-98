...
class ChunkOutDidxs:
    ...
    @staticmethod
    def from_dict(src_dict: Dict[str, Any]) -> "ChunkOutDidxs":
        d = src_dict.copy()
        chunk_out_didxs = ChunkOutDidxs()
        ...
        chunk_out_didxs.additional_properties = additional_properties
        return chunk_out_didxs
