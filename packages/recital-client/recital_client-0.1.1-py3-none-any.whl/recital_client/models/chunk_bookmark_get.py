...
from ..models.chunk_bookmark_get_didxs import ChunkBookmarkGetDidxs
...
class ChunkBookmarkGet:
    ...
    div_idxs: ChunkBookmarkGetDidxs
    pages: List[int]
    display_name: str
    ...
    @staticmethod
    def from_dict(src_dict: Dict[str, Any]) -> "ChunkBookmarkGet":
        d = src_dict.copy()
        ...
        div_idxs = ChunkBookmarkGetDidxs.from_dict(d.pop("div_idxs"))
        ...
        if _coordinates is not None and not isinstance(_coordinates, Unset):
            coordinates = ChunkBookmarkGetCoordinates.from_dict(cast(Dict[str, Any], _coordinates))

        chunk_bookmark_get = ChunkBookmarkGet(
            collection_id=collection_id,
            id=id,
            query=query,
            version_id=version_id,
