...
class OrganizationCreateOut:
    ...
    @staticmethod
    def from_dict(src_dict: Dict[str, Any]) -> "OrganizationCreateOut":
        d = src_dict.copy()
        org: Union[OrganizationOut, Unset] = UNSET
        _org = d.pop("org", UNSET)
        if _org is not None and not isinstance(_org, Unset):
            org = OrganizationOut.from_dict(cast(Dict[str, Any], _org))

        admin: Union[OrganizationAdminOut, Unset] = UNSET
        _admin = d.pop("admin", UNSET)
        if _admin is not None and not isinstance(_admin, Unset):
            admin = OrganizationAdminOut.from_dict(cast(Dict[str, Any], _admin))

        organization_create_out = OrganizationCreateOut(
            org=org,
            admin=admin,
        )
