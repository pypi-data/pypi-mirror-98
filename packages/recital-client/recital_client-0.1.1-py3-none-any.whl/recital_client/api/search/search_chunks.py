...
def _get_kwargs(
    *,
    ...
    if skip_autosuggest is not UNSET:
        params["skip_autosuggest"] = skip_autosuggest
...
) -> Optional[Union[SearchResultChunks, None, None, None, None, None, None]]:
...
def _build_response(
    *, response: httpx.Response
) -> Response[Union[SearchResultChunks, None, None, None, None, None, None]]:
    return Response(
