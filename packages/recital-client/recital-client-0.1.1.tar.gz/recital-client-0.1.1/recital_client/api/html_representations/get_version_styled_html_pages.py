...
from ...models.get_version_styled_html_pages_responseersiotyletmagepileersionersiotyletmet import (
...
def _parse_response(
    *, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = GetVersionStyledHtmlPagesResponseersiotyletmagepileersionersiotyletmet.from_dict(response.json())
