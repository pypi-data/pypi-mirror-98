...
from ..models.questionnaire_out_sourcuery import QuestionnaireOutSourcuery
...
class QuestionnaireOut:
    ...
    source_query: QuestionnaireOutSourcuery
    id: int
    ...
    @staticmethod
    def from_dict(src_dict: Dict[str, Any]) -> "QuestionnaireOut":
        d = src_dict.copy()
        ...
        source_query = QuestionnaireOutSourcuery.from_dict(d.pop("source_query"))
        ...
        if _completed_on is not None:
            completed_on = isoparse(cast(str, _completed_on))
