...
class BodyPostMetadataImportApiV1MetadataImport_Post:
    ...
    @staticmethod
    def from_dict(src_dict: Dict[str, Any]) -> "BodyPostMetadataImportApiV1MetadataImport_Post":
        d = src_dict.copy()
        metadata_file = File(payload=BytesIO(d.pop("metadata_file")))

        body_post_metadata_import_api_v1_metadata_import_post = BodyPostMetadataImportApiV1MetadataImport_Post(
            metadata_file=metadata_file,
        )
