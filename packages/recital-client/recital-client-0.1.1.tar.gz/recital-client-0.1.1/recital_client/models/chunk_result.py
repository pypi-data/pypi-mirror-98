...
from ..models.chunk_result_didxs import ChunkResultDidxs
...
class ChunkResult:
    ...
    @staticmethod
    def from_dict(src_dict: Dict[str, Any]) -> "ChunkResult":
        d = src_dict.copy()
        name = d.pop("name")
        ...
        div_idxs = ChunkResultDidxs.from_dict(d.pop("div_idxs"))
        ...
        if _metadata is not None and not isinstance(_metadata, Unset):
            metadata = ChunkResultMetadata.from_dict(cast(Dict[str, Any], _metadata))
        ...
        image = File(payload=BytesIO(d.pop("image", UNSET)))

        coordinates: Union[ChunkResultCoordinates, Unset] = UNSET
        _coordinates = d.pop("coordinates", UNSET)
        if _coordinates is not None and not isinstance(_coordinates, Unset):
            coordinates = ChunkResultCoordinates.from_dict(cast(Dict[str, Any], _coordinates))
