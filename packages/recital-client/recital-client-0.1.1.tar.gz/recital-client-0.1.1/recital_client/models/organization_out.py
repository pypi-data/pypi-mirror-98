...
class OrganizationOut:
    ...
    @staticmethod
    def from_dict(src_dict: Dict[str, Any]) -> "OrganizationOut":
        d = src_dict.copy()
        id = d.pop("id")
        ...
        if _license_expires_on is not None:
            license_expires_on = isoparse(cast(str, _license_expires_on))
        ...
        organization_out = OrganizationOut(
            id=id,
            n_users=n_users,
            n_groups=n_groups,
            name=name,
