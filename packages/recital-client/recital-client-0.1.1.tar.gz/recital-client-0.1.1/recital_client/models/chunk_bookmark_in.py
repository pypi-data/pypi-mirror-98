...
class ChunkBookmarkIn:
    ...
    @staticmethod
    def from_dict(src_dict: Dict[str, Any]) -> "ChunkBookmarkIn":
        d = src_dict.copy()
        ...
        if _coordinates is not None and not isinstance(_coordinates, Unset):
            coordinates = ChunkBookmarkInCoordinates.from_dict(cast(Dict[str, Any], _coordinates))

        chunk_bookmark_in = ChunkBookmarkIn(
            collection_id=collection_id,
            id=id,
            query=query,
            version_id=version_id,
