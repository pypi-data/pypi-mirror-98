...
class SearchConfigurationOut:
    ...
    @staticmethod
    def from_dict(src_dict: Dict[str, Any]) -> "SearchConfigurationOut":
        d = src_dict.copy()
        org_id = d.pop("org_id")
        ...
        synonyms_updated_on = None
        _synonyms_updated_on = d.pop("synonyms_updated_on", UNSET)
        if _synonyms_updated_on is not None:
            synonyms_updated_on = isoparse(cast(str, _synonyms_updated_on))

        synonyms_updated_by = d.pop("synonyms_updated_by", UNSET)

        synonyms_file = d.pop("synonyms_file", UNSET)

        search_configuration_out = SearchConfigurationOut(
            org_id=org_id,
            auto_semantic=auto_semantic,
            lemma_language=lemma_language,
            stop_words_language=stop_words_language,
