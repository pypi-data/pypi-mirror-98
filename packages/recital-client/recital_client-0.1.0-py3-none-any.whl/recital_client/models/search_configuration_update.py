...
class SearchConfigurationUpdate:
    ...
    @staticmethod
    def from_dict(src_dict: Dict[str, Any]) -> "SearchConfigurationUpdate":
        d = src_dict.copy()
        ...
        if _lemma_language is not None:
        ...
        if _stop_words_language is not None:
        ...
        search_configuration_update = SearchConfigurationUpdate(
