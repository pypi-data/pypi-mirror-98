...
class BodyPutSynonymsApiV1SearchConfigSynonyms_Put:
    ...
    @staticmethod
    def from_dict(src_dict: Dict[str, Any]) -> "BodyPutSynonymsApiV1SearchConfigSynonyms_Put":
        d = src_dict.copy()
        synonyms_in = File(payload=BytesIO(d.pop("synonyms_in")))

        body_put_synonyms_api_v1_search_config_synonyms_put = BodyPutSynonymsApiV1SearchConfigSynonyms_Put(
            synonyms_in=synonyms_in,
        )
