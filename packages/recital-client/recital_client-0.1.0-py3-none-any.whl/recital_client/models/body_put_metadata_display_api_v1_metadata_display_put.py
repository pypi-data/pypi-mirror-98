...
class BodyPutMetadataDisplayApiV1MetadataDisplay_Put:
    ...
    @staticmethod
    def from_dict(src_dict: Dict[str, Any]) -> "BodyPutMetadataDisplayApiV1MetadataDisplay_Put":
        d = src_dict.copy()
        ...
        body_put_metadata_display_api_v1_metadata_display_put = BodyPutMetadataDisplayApiV1MetadataDisplay_Put(
            primary_filters=primary_filters,
            secondary_filters=secondary_filters,
            chunks_results=chunks_results,
            sorting_metadata=sorting_metadata,
