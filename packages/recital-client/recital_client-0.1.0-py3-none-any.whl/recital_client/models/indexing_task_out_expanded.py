...
class IndexingTaskOutExpanded:
    ...
    @staticmethod
    def from_dict(src_dict: Dict[str, Any]) -> "IndexingTaskOutExpanded":
        d = src_dict.copy()
        ...
        if _finished_on is not None:
            finished_on = isoparse(cast(str, _finished_on))
        ...
        indexing_task_out_expanded = IndexingTaskOutExpanded(
            bkg_task_id=bkg_task_id,
            org_id=org_id,
            run_by=run_by,
            report_id=report_id,
