...
class Login:
    ...
    @staticmethod
    def from_dict(src_dict: Dict[str, Any]) -> "Login":
        d = src_dict.copy()
        ...
        if _policy is not None and not isinstance(_policy, Unset):
            policy = PasswordPolicyExpected.from_dict(cast(Dict[str, Any], _policy))
