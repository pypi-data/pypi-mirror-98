...
from ..models.extract_result_out_versioetadata import ExtractResultOutVersioetadata
...
class ExtractResultOut:
    ...
    version_metadata: Union[ExtractResultOutVersioetadata, Unset] = UNSET
    ...
    @staticmethod
    def from_dict(src_dict: Dict[str, Any]) -> "ExtractResultOut":
        d = src_dict.copy()
        ...
        if _version_metadata is not None and not isinstance(_version_metadata, Unset):
            version_metadata = ExtractResultOutVersioetadata.from_dict(cast(Dict[str, Any], _version_metadata))

        extract_result_out = ExtractResultOut(
            task_id=task_id,
            doc_id=doc_id,
            doc_filename=doc_filename,
            doc_path=doc_path,
