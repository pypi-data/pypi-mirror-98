...
class SearchQueryKeywords:
    ...
    @staticmethod
    def from_dict(src_dict: Dict[str, Any]) -> "SearchQueryKeywords":
        d = src_dict.copy()
        ...
        if _filters is not None and not isinstance(_filters, Unset):
            filters = SearchQueryKeywordsFilters.from_dict(cast(Dict[str, Any], _filters))

        keyword_op = None

        search_query_keywords = SearchQueryKeywords(
            keywords=keywords,
