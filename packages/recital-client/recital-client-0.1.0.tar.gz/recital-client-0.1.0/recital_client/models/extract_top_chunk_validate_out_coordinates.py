...
class ExtractTopChunkValidateOutCoordinates:
    ...
    @staticmethod
    def from_dict(src_dict: Dict[str, Any]) -> "ExtractTopChunkValidateOutCoordinates":
        d = src_dict.copy()
        extract_top_chunk_validate_out_coordinates = ExtractTopChunkValidateOutCoordinates()
