...
class ExtractTaskOut:
    ...
    @staticmethod
    def from_dict(src_dict: Dict[str, Any]) -> "ExtractTaskOut":
        d = src_dict.copy()
        ...
        if _source_filters is not None and not isinstance(_source_filters, Unset):
            source_filters = SourceFilters.from_dict(cast(Dict[str, Any], _source_filters))

        extract_task_out = ExtractTaskOut(
            model_id=model_id,
            org_id=org_id,
            type=type,
            name=name,
