...
class BodyPostRefreshTokenApiV1RefreshToken_Post:
    ...
    @staticmethod
    def from_dict(src_dict: Dict[str, Any]) -> "BodyPostRefreshTokenApiV1RefreshToken_Post":
        d = src_dict.copy()
        refresh_token = d.pop("refresh_token")

        body_post_refresh_token_api_v1_refresh_token_post = BodyPostRefreshTokenApiV1RefreshToken_Post(
            refresh_token=refresh_token,
        )
