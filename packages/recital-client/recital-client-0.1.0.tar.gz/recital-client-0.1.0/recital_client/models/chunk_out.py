...
from ..models.chunk_out_didxs import ChunkOutDidxs
...
class ChunkOut:
    ...
    @staticmethod
    def from_dict(src_dict: Dict[str, Any]) -> "ChunkOut":
        d = src_dict.copy()
        div_idxs = ChunkOutDidxs.from_dict(d.pop("div_idxs"))
        ...
        if _coordinates is not None and not isinstance(_coordinates, Unset):
            coordinates = ChunkOutCoordinates.from_dict(cast(Dict[str, Any], _coordinates))
        ...
        if _metadata is not None and not isinstance(_metadata, Unset):
            metadata = ChunkOutMetadata.from_dict(cast(Dict[str, Any], _metadata))
