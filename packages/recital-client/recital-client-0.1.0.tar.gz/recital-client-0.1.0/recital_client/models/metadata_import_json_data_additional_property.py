...
class MetadataImportJSONDataAdditionalProperty:
    ...
    @staticmethod
    def from_dict(src_dict: Dict[str, Any]) -> "MetadataImportJSONDataAdditionalProperty":
        d = src_dict.copy()
        metadata_import_json_data_additional_property = MetadataImportJSONDataAdditionalProperty()
