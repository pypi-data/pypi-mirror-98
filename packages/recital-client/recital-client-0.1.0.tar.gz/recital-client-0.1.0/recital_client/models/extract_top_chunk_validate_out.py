...
from ..models.extract_top_chunk_validate_out_didxs import ExtractTopChunkValidateOutDidxs
...
class ExtractTopChunkValidateOut:
    ...
    page: int
    text: str
    div_idxs: Union[ExtractTopChunkValidateOutDidxs, Unset] = UNSET
    ...
    @staticmethod
    def from_dict(src_dict: Dict[str, Any]) -> "ExtractTopChunkValidateOut":
        d = src_dict.copy()
        ...
        if _div_idxs is not None and not isinstance(_div_idxs, Unset):
            div_idxs = ExtractTopChunkValidateOutDidxs.from_dict(cast(Dict[str, Any], _div_idxs))

        coordinates: Union[ExtractTopChunkValidateOutCoordinates, Unset] = UNSET
        _coordinates = d.pop("coordinates", UNSET)
        if _coordinates is not None and not isinstance(_coordinates, Unset):
            coordinates = ExtractTopChunkValidateOutCoordinates.from_dict(cast(Dict[str, Any], _coordinates))

        extract_top_chunk_validate_out = ExtractTopChunkValidateOut(
            result_id=result_id,
            rank=rank,
            chunk_id=chunk_id,
            page=page,
