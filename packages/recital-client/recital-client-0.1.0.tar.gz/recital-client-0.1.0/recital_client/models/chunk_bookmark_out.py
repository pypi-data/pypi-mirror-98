...
from ..models.chunk_bookmark_out_didxs import ChunkBookmarkOutDidxs
...
class ChunkBookmarkOut:
    ...
    div_idxs: ChunkBookmarkOutDidxs
    pages: List[int]
    display_name: str
    ...
    @staticmethod
    def from_dict(src_dict: Dict[str, Any]) -> "ChunkBookmarkOut":
        d = src_dict.copy()
        ...
        div_idxs = ChunkBookmarkOutDidxs.from_dict(d.pop("div_idxs"))
        ...
        if _coordinates is not None and not isinstance(_coordinates, Unset):
            coordinates = ChunkBookmarkOutCoordinates.from_dict(cast(Dict[str, Any], _coordinates))

        chunk_bookmark_out = ChunkBookmarkOut(
            collection_id=collection_id,
            id=id,
            query=query,
            version_id=version_id,
