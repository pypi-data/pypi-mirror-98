...
from ...models.body_post_file_api_v1_files_post import BodyPostFileApiV1Files_Post
...
def _get_kwargs(
    *,
    ...
    multipart_data: BodyPostFileApiV1Files_Post,
    ...
    if idx_task_id is not UNSET:
        params["idx_task_id"] = idx_task_id
