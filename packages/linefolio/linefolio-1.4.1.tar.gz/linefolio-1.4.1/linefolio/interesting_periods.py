...
PERIODS['New Normal'] = (pd.Timestamp('20130101'),
                         pd.Timestamp('20200301'))

PERIODS['Crypto Bubble'] = (pd.Timestamp('20170101'),
                            pd.Timestamp('20171230'))

PERIODS['Corona Crash'] = (pd.Timestamp('20200301'),
                           pd.Timestamp('20200415'))

PERIODS['After Corona'] = (pd.Timestamp('20200415'),
                           pd.Timestamp('today'))
