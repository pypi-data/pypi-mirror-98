...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'digitalocean', '3.6.0-alpha.1615479129+f4e48d64'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource digitalocean 3.6.0-alpha.1615479129+f4e48d64`
                """)
            else:
                raise
