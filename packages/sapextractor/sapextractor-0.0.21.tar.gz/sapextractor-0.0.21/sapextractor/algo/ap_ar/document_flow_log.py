...
def apply(con, gjahr="1997", mandt="800", bukrs="1000", ref_type="Goods receipt", **ext_args):
    dataframe = document_flow_dataframe.apply(con, gjahr=gjahr, bukrs=bukrs, mandt=mandt, ref_type=ref_type)
