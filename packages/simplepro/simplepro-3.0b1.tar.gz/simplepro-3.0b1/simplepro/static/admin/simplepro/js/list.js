...
var app = new Vue({
    ...
    methods: {
        ...
        customButtonClick: function (btn, key) {
            ...
            if (btn.confirm) {
                this.$confirm(btn.confirm, _language.tips, {
        ...
        modalChange(row) {
            ...
            self.modalDialog.visible = true;
            self.$nextTick(() => {

                console.log(self.$refs.modalDialog)
                data.append('csrfmiddlewaretoken', crsf_token);
                data.append('action', 'modal_change');
                axios.post('', data).then(res => {
                    console.log(res.data);
                    self.modalDialog.html = res.data;
                    // self.setInnerHTML(self.$refs.modalDialog, res.data);
                })
            });
        },
