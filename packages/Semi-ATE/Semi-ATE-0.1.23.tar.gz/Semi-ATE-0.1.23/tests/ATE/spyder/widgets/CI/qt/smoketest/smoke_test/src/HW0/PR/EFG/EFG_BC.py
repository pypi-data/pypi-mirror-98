...
If you have the need to add things, add it to 'EFG.py' or 'common.py'
...
class EFG_OP:
    """Class definition for the output parameters of EFG."""
...
class EFG_IP:
    """Class definition for the input parameters of EFG."""

    def __init__(self):
        self.Temperature = None
        self.new_parameter1 = None
...
class EFG_BC(DutTestCaseBase):
    '''Base class definition for EFG'''

    hardware = 'HW0'
    base = 'PR'
    Type = 'custom'

    def __init__(self, instance_name: str, context):
        super().__init__(None, None, context)
        self.ip = EFG_IP()
        self.op = EFG_OP()
        self._sbin = None
        self._test_num = None
