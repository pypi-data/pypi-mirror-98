...
if __name__ == '__main__':
    ...
    from smoke_test_HW0_PR_Die1_production_TheTest_auto_script import AutoScript
    ...
    from DBC.DBC import DBC
    _ate_var_DBC_1 = DBC("DBC_1", context)
    _ate_var_DBC_1.set_sbin(60000)
    _ate_var_DBC_1.set_test_num(100)

    _ate_var_DBC_1.ip.set_parameter('Temperature', 'static', 25, -40.0, 170.0, 0, context)

    _ate_var_DBC_1.op.set_parameter('new_parameter1', 101, nan, nan, 1, 1, 'DBC_1')

    sequencer.register_test(_ate_var_DBC_1)
    from DBC.DBC import DBC
    _ate_var_DBC_2 = DBC("DBC_2", context)
    _ate_var_DBC_2.set_sbin(60001)
    _ate_var_DBC_2.set_test_num(200)

    _ate_var_DBC_2.ip.set_parameter('Temperature', 'static', 25, -40.0, 170.0, 0, context)

    _ate_var_DBC_2.op.set_parameter('new_parameter1', 201, nan, nan, 1, 1, 'DBC_2')

    sequencer.register_test(_ate_var_DBC_2)
