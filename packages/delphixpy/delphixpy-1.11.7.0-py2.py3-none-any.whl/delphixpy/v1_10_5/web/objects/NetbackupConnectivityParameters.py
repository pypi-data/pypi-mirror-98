    ...
    *(extends* :py:class:`v1_10_5.web.vo.TypedObject` *)* Parameters needed to
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._master_server_name[0] is not None and obj._master_server_name[0] is not obj.__undef__:
            assert isinstance(obj._master_server_name[0], TEXT_TYPE), ("Expected one of ['string'], but got %s of type %s" % (obj._master_server_name[0], type(obj._master_server_name[0])))
