    ...
    *(extends* :py:class:`v1_11_2.web.vo.PersistentObject` *)* Represents an
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._work_source_principal[0] is not None and obj._work_source_principal[0] is not obj.__undef__:
            assert isinstance(obj._work_source_principal[0], TEXT_TYPE), ("Expected one of ['string'], but got %s of type %s" % (obj._work_source_principal[0], type(obj._work_source_principal[0])))
        ...
        if obj._failure_description[0] is not None and obj._failure_description[0] is not obj.__undef__:
            assert isinstance(obj._failure_description[0], TEXT_TYPE), ("Expected one of ['string'], but got %s of type %s" % (obj._failure_description[0], type(obj._failure_description[0])))
        ...
        if obj._failure_action[0] is not None and obj._failure_action[0] is not obj.__undef__:
            assert isinstance(obj._failure_action[0], TEXT_TYPE), ("Expected one of ['string'], but got %s of type %s" % (obj._failure_action[0], type(obj._failure_action[0])))
        ...
        if obj._failure_message_code[0] is not None and obj._failure_message_code[0] is not obj.__undef__:
            assert isinstance(obj._failure_message_code[0], TEXT_TYPE), ("Expected one of ['string'], but got %s of type %s" % (obj._failure_message_code[0], type(obj._failure_message_code[0])))
