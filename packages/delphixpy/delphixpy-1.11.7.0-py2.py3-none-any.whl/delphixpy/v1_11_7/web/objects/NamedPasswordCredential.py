...
class NamedPasswordCredential(TypedObject):
    ...
    *(extends* :py:class:`v1_11_7.web.vo.TypedObject` *)* Pair of username and
    ...
    def __init__(self, undef_enabled=True):
        super(NamedPasswordCredential, self).__init__()
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        obj = super(NamedPasswordCredential, cls).from_dict(data, dirty, undef_enabled)
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(NamedPasswordCredential, self).to_dict(dirty, belongs_to_parent)
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NamedPasswordCredential):
            return False
        return super(NamedPasswordCredential, self).__eq__(other) and \
