    ...
    *(extends* :py:class:`v1_11_5.web.vo.SourceRepository` *)* The Oracle
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._oracle_base_config[0] is not None and obj._oracle_base_config[0] is not obj.__undef__:
            assert isinstance(obj._oracle_base_config[0], TEXT_TYPE), ("Expected one of ['string'], but got %s of type %s" % (obj._oracle_base_config[0], type(obj._oracle_base_config[0])))
        ...
        if obj._oracle_base_home[0] is not None and obj._oracle_base_home[0] is not obj.__undef__:
            assert isinstance(obj._oracle_base_home[0], TEXT_TYPE), ("Expected one of ['string'], but got %s of type %s" % (obj._oracle_base_home[0], type(obj._oracle_base_home[0])))
