...
class MSSqlBaseClusterRepository(MSSqlRepository):
    """
    *(extends* :py:class:`v1_6_0.web.vo.MSSqlRepository` *)* The representation
    ...
    def instances(self):
        ...
        :rtype: ``list`` of :py:class:`v1_6_0.web.vo.MSSqlBaseClusterInstance`
        """
    ...
    def listeners(self):
        ...
        :rtype: ``list`` of :py:class:`v1_6_0.web.vo.MSSqlBaseClusterListener`
        """
