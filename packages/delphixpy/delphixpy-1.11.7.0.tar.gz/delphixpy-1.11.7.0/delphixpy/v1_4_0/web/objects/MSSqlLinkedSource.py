    ...
    *(extends* :py:class:`v1_4_0.web.vo.MSSqlSource` *)* A linked MSSQL source.
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._shared_backup_location[0] is not None and obj._shared_backup_location[0] is not obj.__undef__:
            assert isinstance(obj._shared_backup_location[0], TEXT_TYPE), ("Expected one of ['string'], but got %s of type %s" % (obj._shared_backup_location[0], type(obj._shared_backup_location[0])))
