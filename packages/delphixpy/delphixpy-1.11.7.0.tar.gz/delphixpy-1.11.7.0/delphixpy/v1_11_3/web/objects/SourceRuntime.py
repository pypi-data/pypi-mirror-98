    ...
    *(extends* :py:class:`v1_11_3.web.vo.TypedObject` *)* Runtime properties of
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._accessible_timestamp[0] is not None and obj._accessible_timestamp[0] is not obj.__undef__:
            assert isinstance(obj._accessible_timestamp[0], TEXT_TYPE), ("Expected one of ['string'], but got %s of type %s" % (obj._accessible_timestamp[0], type(obj._accessible_timestamp[0])))
