    ...
    *(extends* :py:class:`v1_8_2.web.vo.Host` *)* The representation of a Unix
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._truststore_password[0] is not None and obj._truststore_password[0] is not obj.__undef__:
            assert isinstance(obj._truststore_password[0], TEXT_TYPE), ("Expected one of ['string'], but got %s of type %s" % (obj._truststore_password[0], type(obj._truststore_password[0])))
