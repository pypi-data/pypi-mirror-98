    ...
    *(extends* :py:class:`v1_10_4.web.vo.DatapointStream` *)* A stream of
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._network_interface[0] is not None and obj._network_interface[0] is not obj.__undef__:
            assert isinstance(obj._network_interface[0], TEXT_TYPE), ("Expected one of ['string'], but got %s of type %s" % (obj._network_interface[0], type(obj._network_interface[0])))
