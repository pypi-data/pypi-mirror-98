...
class ASEInstance(SourceRepository):
    """
    *(extends* :py:class:`v1_11_5.web.vo.SourceRepository` *)* The SAP ASE
    source repository.
    """
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._dump_history_file[0] is not None and obj._dump_history_file[0] is not obj.__undef__:
            assert isinstance(obj._dump_history_file[0], TEXT_TYPE), ("Expected one of ['string'], but got %s of type %s" % (obj._dump_history_file[0], type(obj._dump_history_file[0])))
