...
class SNMPV2Config(TypedObject):
    ...
    *(extends* :py:class:`v1_11_6.web.vo.TypedObject` *)* SNMP configuration.
    ...
    def __init__(self, undef_enabled=True):
        super(SNMPV2Config, self).__init__()
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        obj = super(SNMPV2Config, cls).from_dict(data, dirty, undef_enabled)
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(SNMPV2Config, self).to_dict(dirty, belongs_to_parent)
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SNMPV2Config):
            return False
        return super(SNMPV2Config, self).__eq__(other) and \
