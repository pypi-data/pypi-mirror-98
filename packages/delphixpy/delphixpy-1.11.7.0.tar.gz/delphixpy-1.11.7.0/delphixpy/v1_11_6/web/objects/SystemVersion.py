    ...
    *(extends* :py:class:`v1_11_6.web.vo.NamedUserObject` *)* Describes a
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._min_reboot_optional_version[0] is not None and obj._min_reboot_optional_version[0] is not obj.__undef__:
            assert isinstance(obj._min_reboot_optional_version[0], TEXT_TYPE), ("Expected one of ['string'], but got %s of type %s" % (obj._min_reboot_optional_version[0], type(obj._min_reboot_optional_version[0])))
