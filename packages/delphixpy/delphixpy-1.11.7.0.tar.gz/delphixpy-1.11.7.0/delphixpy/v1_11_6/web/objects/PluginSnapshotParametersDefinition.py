...
class PluginSnapshotParametersDefinition(TypedObject):
    ...
    *(extends* :py:class:`v1_11_6.web.vo.TypedObject` *)* Defines the snapshot
    ...
    def __init__(self, undef_enabled=True):
        super(PluginSnapshotParametersDefinition, self).__init__()
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        obj = super(PluginSnapshotParametersDefinition, cls).from_dict(data, dirty, undef_enabled)
    ...
    def to_dict(self, dirty=False, belongs_to_parent=False):
        dct = super(PluginSnapshotParametersDefinition, self).to_dict(dirty, belongs_to_parent)
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PluginSnapshotParametersDefinition):
            return False
        return super(PluginSnapshotParametersDefinition, self).__eq__(other) and \
