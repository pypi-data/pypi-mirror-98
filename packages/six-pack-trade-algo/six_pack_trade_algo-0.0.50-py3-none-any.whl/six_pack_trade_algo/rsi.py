...
from algos import AlgoRsi as Algo
from util import algoLogger.log as log
from util import DataSource

FILE_ALGO_TYPE = "RSI"

def main():
    log.info(FILE_ALGO_TYPE + " started")
    parser = argparse.ArgumentParser()
    parser.add_argument('--test_mode', default="True", type=str)
    parser.add_argument('--data_source_mode', default="backtest", type=str)    
