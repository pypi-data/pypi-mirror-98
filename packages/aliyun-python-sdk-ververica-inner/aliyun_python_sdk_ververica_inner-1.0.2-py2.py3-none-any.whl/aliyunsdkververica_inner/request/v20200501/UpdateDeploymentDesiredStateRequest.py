...
class UpdateDeploymentDesiredStateRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'ververica-inner', '2020-05-01', 'UpdateDeploymentDesiredState')
		self.set_uri_pattern('/pop/workspaces/[workspace]/api/v1/namespaces/[namespace]/deployments/[deploymentId]/state')
		self.set_method('PUT')
