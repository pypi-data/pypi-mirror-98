...
class UpdateDeploymentLockStateRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'ververica-inner', '2020-05-01', 'UpdateDeploymentLockState')
		self.set_uri_pattern('/pop/workspaces/[workspace]/deployments/v1/namespaces/[namespace]/deployments/[deploymentId]/lockState')
		self.set_method('PUT')
