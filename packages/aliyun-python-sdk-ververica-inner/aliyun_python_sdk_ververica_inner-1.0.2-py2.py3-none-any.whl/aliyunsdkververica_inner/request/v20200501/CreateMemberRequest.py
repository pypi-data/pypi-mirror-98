...
class CreateMemberRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'ververica-inner', '2020-05-01', 'CreateMember')
		self.set_uri_pattern('/pop/workspaces/[workspace]/members/v1/namespaces/[namespace]')
