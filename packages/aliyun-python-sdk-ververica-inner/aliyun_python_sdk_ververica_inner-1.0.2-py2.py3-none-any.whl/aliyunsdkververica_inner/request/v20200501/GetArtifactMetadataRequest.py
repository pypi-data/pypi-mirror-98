...
class GetArtifactMetadataRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'ververica-inner', '2020-05-01', 'GetArtifactMetadata')
		self.set_uri_pattern('/pop/workspaces/[workspace]/artifacts/v1/namespaces/[namespace]/artifacts:getMetadata')
		self.set_method('GET')
