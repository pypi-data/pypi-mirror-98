...
class SetPreviewSessionClusterRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'ververica-inner', '2020-05-01', 'SetPreviewSessionCluster')
		self.set_uri_pattern('/pop/workspaces/[workspace]/namespaces/v1/namespaces/[namespace]:setPreviewSessionCluster')
