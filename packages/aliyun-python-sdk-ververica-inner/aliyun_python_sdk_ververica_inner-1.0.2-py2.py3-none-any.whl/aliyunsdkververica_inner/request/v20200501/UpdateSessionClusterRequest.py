...
class UpdateSessionClusterRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'ververica-inner', '2020-05-01', 'UpdateSessionCluster')
		self.set_uri_pattern('/pop/workspaces/[workspace]/api/v1/namespaces/[namespace]/sessionclusters/[name]/patch')
		self.set_method('PUT')
