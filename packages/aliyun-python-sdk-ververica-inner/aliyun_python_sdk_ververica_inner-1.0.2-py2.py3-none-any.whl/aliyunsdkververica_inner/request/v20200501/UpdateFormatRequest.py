...
class UpdateFormatRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'ververica-inner', '2020-05-01', 'UpdateFormat')
		self.set_uri_pattern('/pop/workspaces/[workspace]/sql/v1beta1/namespaces/[namespace]/formats/[name]')
		self.set_method('PUT')
