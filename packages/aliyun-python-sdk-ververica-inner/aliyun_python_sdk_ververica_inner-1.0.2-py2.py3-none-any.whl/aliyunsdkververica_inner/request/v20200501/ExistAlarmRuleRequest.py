...
class ExistAlarmRuleRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'ververica-inner', '2020-05-01', 'ExistAlarmRule')
		self.set_uri_pattern('/pop/workspaces/[workspace]/alert/v1/namespaces/[namespace]/deployments/[deploymentId]/alarmRules/[name]/exist')
		self.set_method('GET')
