...
class DeleteDeploymentTargetRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'ververica-inner', '2020-05-01', 'DeleteDeploymentTarget')
		self.set_uri_pattern('/pop/workspaces/[workspace]/api/v1/namespaces/[namespace]/deployment-targets/[name]')
