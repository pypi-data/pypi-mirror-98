...
class ParseFormatRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'ververica-inner', '2020-05-01', 'ParseFormat')
		self.set_uri_pattern('/pop/workspaces/[workspace]/sql/v1beta1/namespaces/[namespace]/formats:analyze-jars')
