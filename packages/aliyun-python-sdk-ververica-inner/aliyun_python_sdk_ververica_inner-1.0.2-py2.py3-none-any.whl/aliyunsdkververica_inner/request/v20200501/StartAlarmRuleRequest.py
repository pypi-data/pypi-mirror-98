...
class StartAlarmRuleRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'ververica-inner', '2020-05-01', 'StartAlarmRule')
		self.set_uri_pattern('/pop/workspaces/[workspace]/alert/v1/namespaces/[namespace]/deployments/[deploymentId]/alarmRules/[alarmId]/start')
	...
	def get_alarmId(self):
		return self.get_path_params().get('alarmId')

	def set_alarmId(self,alarmId):
		self.add_path_param('alarmId',alarmId)