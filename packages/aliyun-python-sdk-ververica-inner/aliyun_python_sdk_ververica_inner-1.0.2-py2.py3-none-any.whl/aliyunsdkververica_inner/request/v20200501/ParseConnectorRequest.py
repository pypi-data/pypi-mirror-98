...
class ParseConnectorRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'ververica-inner', '2020-05-01', 'ParseConnector')
		self.set_uri_pattern('/pop/workspaces/[workspace]/sql/v1beta1/namespaces/[namespace]/connectors:analyze-jars')
