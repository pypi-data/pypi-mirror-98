...
class DeleteArtifactRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'ververica-inner', '2020-05-01', 'DeleteArtifact')
		self.set_uri_pattern('/pop/workspaces/[workspace]/artifacts/v1/namespaces/[namespace]/artifacts:delete')
