...
class CreateAlarmTemplateRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'ververica-inner', '2020-05-01', 'CreateAlarmTemplate')
		self.set_uri_pattern('/pop/workspaces/[workspace]/alert/v1/namespaces/[namespace]/templates')
