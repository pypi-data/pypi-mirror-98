...
def runAnalyses(genome,
    ...
    if (genome==GRCh37) and (epigenomics_files==None):
        epigenomics_files = [DEFAULT_H3K27ME3_OCCUPANCY_FILE,
        ...
        epigenomics_files = [ENCFF993SRY_mm10_embryonic_fibroblast_H3K4me1,
        ...
        # These strings must be within filenames (without file extension)
        # Order is not important
        epigenomics_dna_elements = ['H3K4me1', 'H3K4me3', 'CTCF', 'POLR2A', 'H3K27ac']
