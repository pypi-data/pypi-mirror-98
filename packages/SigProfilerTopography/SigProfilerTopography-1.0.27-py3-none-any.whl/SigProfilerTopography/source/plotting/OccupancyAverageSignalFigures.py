...
def compute_fold_change_with_combined_p_values_plot_heatmaps(combine_p_values_method,
    ...
    if any(step5_dbs_signature2dna_element2avg_fold_change_dict):
        ...
        print('DEBUG step5_dbs_signature2dna_element2avg_fold_change_dict:%s' %(step5_dbs_signature2dna_element2avg_fold_change_dict))
        print('DEBUG signature2dna_element2significancedict:%s' % (signature2dna_element2significancedict))
