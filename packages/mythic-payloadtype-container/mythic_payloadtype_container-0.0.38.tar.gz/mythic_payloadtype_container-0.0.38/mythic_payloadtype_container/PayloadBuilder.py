...
class BuildResponse:
    def __init__(self, status: BuildStatus, payload: bytes = None, message: str = None, build_error: str = None):
        self.status = status
        self.payload = payload if payload is not None else b""
        self.message = message if message is not None else ""
        self.build_error = build_error if build_error is not None else ""
