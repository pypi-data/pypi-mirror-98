...
def lazy_import():
    ...
    globals()['AlertsPath'] = AlertsPath


class GetAlertsPathsResponse(ModelNormal):
    ...
    def __init__(self, items, *args, **kwargs):  # noqa: E501
        """GetAlertsPathsResponse - a model defined in OpenAPI

        Args:
            items ([AlertsPath]): A list of alerts
