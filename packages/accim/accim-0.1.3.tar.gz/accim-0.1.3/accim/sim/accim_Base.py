...
def setComfFieldsPeople(self):
    ...
    for i in range(len(peoplelist)):
        self.idf1.newidfobject(
            ...
            Number_of_People_Calculation_Method=peoplelist[i].Number_of_People_Calculation_Method,
            ...
            Enable_ASHRAE_55_Comfort_Warnings=peoplelist[i].Enable_ASHRAE_55_Comfort_Warnings,
            Mean_Radiant_Temperature_Calculation_Type=peoplelist[i].Mean_Radiant_Temperature_Calculation_Type,
            Surface_NameAngle_Factor_List_Name=peoplelist[i].Surface_NameAngle_Factor_List_Name,
            Work_Efficiency_Schedule_Name=peoplelist[i].Work_Efficiency_Schedule_Name,
            Clothing_Insulation_Calculation_Method=peoplelist[i].Clothing_Insulation_Calculation_Method,
            Clothing_Insulation_Calculation_Method_Schedule_Name=peoplelist[i].Clothing_Insulation_Calculation_Method_Schedule_Name,
            Clothing_Insulation_Schedule_Name=peoplelist[i].Clothing_Insulation_Schedule_Name,
