...
class Client(ABC):
    ...
    def xml_import(self,
        ...
        object_element = XmlElement('Object', s=[ XmlElement(
        ...
        xml = XmlElement('DMSData', s=[
                XmlElement('Archive', s=[
                    object_type_element := XmlElement('ObjectType', {'internal_name': object_name}, [object_element])
                ])
        ])

        if main_type and isinstance(main_type, MainTypeId):
            object_type_element.set('maintype', str(main_type.value))
        elif main_type:
            object_type_element.set('maintype', str(main_type))
