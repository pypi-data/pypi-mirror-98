    ...
    def mousePressEvent(self, event):
        ...
        if anchor_item is not None and event.button() == Qt.LeftButton:
            ...
            helpevent = QuickHelpTipEvent(
                self.tr(__("tip.create_link")),
                self.tr(__("tip.create_link_detail")
...
#                        'More ...</a>'
    ...
    def mouseReleaseEvent(self, event):
        ...
        if self.tmp_link_item is not None:
            ...
            self.macro = UndoCommand(self.tr(__("tip.add_link")))
...
def edit_links(
    ...
    dlg = EditLinksDialog(parent, windowTitle=__("msg.edit_link_title"))
...
class EditNodeLinksAction(UserInteraction):
    ...
    def edit_links(self, initial_links=None):
        ...
        dlg = EditLinksDialog(self.document, windowTitle=__("msg.edit_link_title"))
...
class NewArrowAnnotation(UserInteraction):
    ...
    def start(self):
        ...
        helpevent = QuickHelpTipEvent(
            self.tr(__("tip.new_arrow")),
            self.tr(__('tip.new_arrow_annotation')
...
class NewTextAnnotation(UserInteraction):
    ...
    def start(self):
        ...
        helpevent = QuickHelpTipEvent(
            self.tr(__("tip.text_annotation")),
            self.tr(__("tip.text_annotation_way")
