...
class TextAnnotation(Annotation):
    ...
    def __init__(self, parent=None, **kwargs):
        ...
        self.__textItem.setPlaceholderText(self.tr(_("tip.enter_text")))
    ...
    def contextMenuEvent(self, event):
        ...
        formatmenu = menu.addMenu(_("menu.render_as"))
        ...
        formatactions = [
            makeaction("Plain Text", group, checkable=True,
                       toolTip=self.tr(_("tip.contents_text")),
                       data="text/plain"),
            makeaction("HTML", group, checkable=True,
                       toolTip=self.tr(_("tip.contents_html")),
                       data="text/html"),
            makeaction("RST", group, checkable=True,
                       toolTip=self.tr(_("tip.contents_rst")),
                       data="text/rst"),
            makeaction("Markdown", group, checkable=True,
                       toolTip=self.tr(_("tip.contents_markdown")),
                       data="text/markdown")
        ]
