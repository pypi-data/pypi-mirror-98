...
class SchemeInfoEdit(QWidget):
    ...
    def __setupUi(self):
        ...
        self.name_edit.setPlaceholderText(self.tr(__("noun.untitled")))
        self.name_edit.setSizePolicy(QSizePolicy.Expanding,
                                     QSizePolicy.Fixed)
        self.desc_edit = QTextEdit(self)
        self.desc_edit.setTabChangesFocus(True)

        layout.addRow(self.tr(__("noun.title")), self.name_edit)
        layout.addRow(self.tr(__("noun.description")), self.desc_edit)
    ...
    def setScheme(self, scheme):
        ...
        self.scheme = scheme
        if not scheme.title:
            self.name_edit.setText(self.tr(__("noun.untitled")))
    ...
    def commit(self):
        ...
        if self.__schemeIsUntitled and \
            self.name_edit.text() == self.tr(__("noun.untitled")):
...
class SchemeInfoDialog(QDialog):
    ...
    def __setupUi(self):
        ...
        self.buttonbox.button(QDialogButtonBox.Ok).setText(__("btn.ok"))
        self.buttonbox.button(QDialogButtonBox.Cancel).setText(__("btn.cancel"))
        # Insert button box
        ...
        self.__showAtNewSchemeCheck = \
            QCheckBox(self.tr(__("err_tip.show_new_workflow")),
                      self,
        ...
        check_layout.addWidget(
               QLabel(self.tr(__("tip.edit_workflow")),
                      self,
