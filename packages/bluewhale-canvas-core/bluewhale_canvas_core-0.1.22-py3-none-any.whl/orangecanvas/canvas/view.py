...
class CanvasView(QGraphicsView):
    ...
    def __init__(self, *args):
        ...
        self.__zoomInAction = QAction(
            self.tr(_("view.zoom_in")), self, objectName="action-zoom-in",
            shortcut=QKeySequence.ZoomIn,
            triggered=self.zoomIn,
        )

        self.__zoomOutAction = QAction(
            self.tr(_("view.zoom_out")), self, objectName="action-zoom-out",
            shortcut=QKeySequence.ZoomOut,
            triggered=self.zoomOut
        )
        self.__zoomResetAction = QAction(
            self.tr(_("view.zoom_reset")), self, objectName="action-zoom-reset",
