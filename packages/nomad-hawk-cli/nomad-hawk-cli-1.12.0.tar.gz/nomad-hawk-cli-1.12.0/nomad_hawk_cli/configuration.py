...
class Configuration(object):
    ...
    :param signing_info: Configuration parameters for HTTP signature.
        Must be an instance of nomad_hawk_cli.signing.HttpSigningConfiguration
    ...
    You can programmatically set the cookie:
      conf = nomad_hawk_cli.Configuration(
    ...
    Note you can use the constants defined in the nomad_hawk_cli.signing module, and you can
    ...
    are not going to be modified in transit.
      ...
      conf = nomad_hawk_cli.Configuration(
        signing_info = nomad_hawk_cli.signing.HttpSigningConfiguration(
            key_id =                 'my-key-id',
    ...
    def __init__(self, host="https://nomad.samarkand-global.cn/hawk",
