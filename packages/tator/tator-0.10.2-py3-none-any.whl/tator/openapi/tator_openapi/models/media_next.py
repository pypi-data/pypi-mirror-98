...
class MediaNext(object):
    ...
    def __init__(self, next=None, local_vars_configuration=None):  # noqa: E501
        """MediaNext - a model defined in OpenAPI"""
    ...
    def next(self):
        ...
        :return: The next of this MediaNext. 
        :rtype: int
        """
        return self._next
    ...
    def next(self, next):
        ...
        :param next: The next of this MediaNext.
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MediaNext):
            return False
