...
class AudioDefinition(object):
    ...
    def __init__(self, bit_rate=None, codec=None, codec_description=None, codec_mime=None, host=None, http_auth=None, path=None, size=None, local_vars_configuration=None):  # noqa: E501
