...
class SMLRunner(object):
    ...
    def __init__(self, path):
        ...
        self._get_model_header = clf_lib.get_model_header
        ...
        self._get_model_pattern = clf_lib.get_model_pattern
        ...
        self._flush_model = clf_lib.flush_model
        self._flush_model.argtypes = [ctypes.c_int]
        self._flush_model.restype = ctypes.c_int

        try:
            self._get_feature_vector = clf_lib.sml_get_feature_vector
        ...
        try:
            self._set_feature_vector = clf_lib.sml_set_feature_vector
        ...
        try:
            self._recognize_feature_vector = clf_lib.sml_recognize_feature_vector
            self._recognize_feature_vector.argtypes = [
                ctypes.c_int,
            ]
        ...
        try:
            self._classification_result_info = clf_lib.sml_classification_result_info
