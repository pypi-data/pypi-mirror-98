...
class TrufflehogResult(Result):
    ...
    Config = Config.copy({"FILE_ENCODING":"utf-16"})
    ...
    def give_result_dict_list(fname):
        ...
        # # output_raw = Result.force_read_file_to_string(fname)
        # with open(fname, "rb") as f:
        #     output_bytes = f.read()
        # output_bytes = output_bytes.replace(b"\xff\xfe",b"")
        # output_raw = output_bytes.decode("utf-8-sig")
