...
class SampleResult(Result):
    ...
    # This is a function defined in the base Result class - don't uncomment it. You can use this function to read files
    # if you're running into weird encoding issues when opening files.
    #
    # @staticmethod
