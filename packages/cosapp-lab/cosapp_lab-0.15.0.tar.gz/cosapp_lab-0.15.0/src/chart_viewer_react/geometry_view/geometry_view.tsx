 ...
 * @class GeometryViewWidget
 * @extends {Component<AppProps, AppState>}
 */
class GeometryViewWidget extends Component<AppProps, AppState> {
  divRef: any;
  time_step: number;
...
export default withStyles(styles)(
  connect(mapStateToProps, mapDispatchToProps)(GeometryViewWidget)
);
