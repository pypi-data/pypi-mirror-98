...
@click.argument("name")
def cosapp_module_register(name):
...
@cosapp_module.command("update", short_help="Update all modules configuration")
def cosapp_module_register():
    cosapp_script["cosapp_module_update"]()
