...
from nyoibo.entities.entity import MetaEntity
...
def test_entity_sub_type():
    ...
    link_field = fields.LinkField(to=Model)

    assert isinstance(link_field, fields.LinkField)
    assert link_field.to == Model
