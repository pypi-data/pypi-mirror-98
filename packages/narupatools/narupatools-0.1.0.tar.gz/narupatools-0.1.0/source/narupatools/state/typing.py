...
Serializable = Union[None, str, int, float, bool, List['Serializable'], Mapping[str, 'Serializable']]  # type: ignore

SerializableDictionary = MutableMapping[str, Serializable]  # type: ignore[misc]
