...
class Classifier_RESNET:
    ...
    def __init__(self, output_directory, input_shape, nb_classes, verbose=False, build=True, load_weights=False, nb_epochs=1500, class_weights=None):
        self.output_directory = output_directory
        self.nb_epochs = 1500 if nb_epochs is None else nb_epochs
