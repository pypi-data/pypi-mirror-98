...
babylocust_dataset = dataset_base.copy({
    ...
    'train_info': './data/babylocust_train/annotations.json',
    'valid_info': './data/babylocust_train/annotations.json',
    'train_images': './data/babylocust_train/',
    'valid_images': './data/babylocust_train/',
    'has_gt': True,
