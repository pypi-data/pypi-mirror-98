...
class CfnCertificate(
    ...
    def domain_validation_options(
        ...
        '''
        return typing.cast(typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union["CfnCertificate.DomainValidationOptionProperty", aws_cdk.core.IResolvable]]]], jsii.get(self, "domainValidationOptions"))
...
class CfnCertificateProps:
    ...
    def domain_validation_options(
        ...
        return typing.cast(typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[CfnCertificate.DomainValidationOptionProperty, aws_cdk.core.IResolvable]]]], result)
