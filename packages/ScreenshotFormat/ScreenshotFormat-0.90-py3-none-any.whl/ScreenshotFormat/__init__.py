...
class ScreenshotFormat:
    ...
    def __init__(self, screenshot_path=None, screenshot_img=None, store_size_name=None, store_size=None,
        ...
        :param StoreSizeName store_size_name: Value of the enum of the desired image
    ...
    def add_text_with_halo(self, img, text, position, color, halo_color, font_path, font_size, filter_=None):
        """
        ...
        :param tuple halo_color: RGB color of the halo
        ...
        halo = self.create_text_image(img_size, position, text, halo_color, font_path, font_size)
        # Add blur effect
