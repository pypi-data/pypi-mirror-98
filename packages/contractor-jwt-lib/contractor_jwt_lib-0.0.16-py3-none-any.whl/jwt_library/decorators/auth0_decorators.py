...
from jwt_library.jwt_operations.auth0 import get_token_verified_payload
            ...
            try:
                ...
                for key in jwks["keys"]:
                    if key["kid"] == unverified_header["kid"]:
                        rsa_key = key
                if rsa_key and \
                validate_claims(get_token_verified_payload(token=token, rsa_key=rsa_key, issuer=iss, audience=aud), issuer=iss, audience=aud) and \
