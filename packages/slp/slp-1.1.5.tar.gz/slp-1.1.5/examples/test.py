...
class LightningMNISTClassifier(pl.LightningModule):
    def __init__(self, config, data_dir=None):
        ...
        self.accuracy = FromLogits(pl.metrics.Accuracy())
...
def train_mnist_tune(
    config, data_dir=None, num_epochs=10, num_gpus=0, train=None, test=None
):
    model = LightningMNISTClassifier(config, data_dir)
    dm = PLDataModuleFromDatasets(train, test=test, batch_size=64)
