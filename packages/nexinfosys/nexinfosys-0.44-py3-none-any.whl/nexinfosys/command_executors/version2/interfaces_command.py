...
class InterfacesAndQualifiedQuantitiesCommand(BasicCommand):
    ...
    def _process_row(self, field_values: Dict[str, Any], subrow=None) -> None:
        ...
        if interface_type.opposite_processor_type:
            if interface_type.opposite_processor_type.lower() in ["local", "environment"]:
                opposite_processor_type = processor.subsystem_type
            elif interface_type.opposite_processor_type.lower() == "external":
                if processor.subsystem_type.lower() == "external":
                    opposite_processor_type = ""
                elif processor.subsystem_type.lower() == "externalenvironment":
                    opposite_processor_type = ""
                elif processor.subsystem_type.lower() == "local":
                    opposite_processor_type = ""
                elif processor.subsystem_type.lower() == "environment":
                    opposite_processor_type = ""
        else:
