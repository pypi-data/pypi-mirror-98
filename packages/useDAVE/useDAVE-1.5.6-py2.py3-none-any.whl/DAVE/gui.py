"""
    ...
    Or by running this file as nodeA
...
import numpy as np
import math
import DAVE.gui.element_widgets as element_widgets
...
class Gui:
    ...
    def view3d_select_element(self, info):
        ...
        if data is not None:
            ...
            if self.selected_node is not None:
                ...
                # cycle between node and its nodeA
                if self.selected_node['node'] == data['node']:
                    node = data['node']
                    try:
                        node = node.nodeA
    ...
    def new_axis(self):
        self.new_something(DAVE.gui.element_widgets.add_axis)

    def new_body(self):
        self.new_something(DAVE.gui.element_widgets.add_body)

    def new_poi(self):
        self.new_something(DAVE.gui.element_widgets.add_poi)

    def new_cable(self):
        self.new_something(DAVE.gui.element_widgets.add_cable)

    def new_force(self):
        self.new_something(DAVE.gui.element_widgets.add_force)

    def new_linear_connector(self):
        self.new_something(DAVE.gui.element_widgets.add_linear_connector)

    def new_connector2d(self):
        self.new_something(DAVE.gui.element_widgets.add_connector2d)

    def new_beam(self):
        self.new_something(DAVE.gui.element_widgets.add_beam_connector)

    def new_linear_hydrostatics(self):
        self.new_something(DAVE.gui.element_widgets.add_linear_hydrostatics)

    def new_visual(self):
        self.new_something(DAVE.gui.element_widgets.add_visual)

    def new_buoyancy_mesh(self):
        self.new_something(DAVE.gui.element_widgets.add_buoyancy)
