...
class TestAutoAIRemote(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.wml_credentials['ts_enabled'] = True
    ...
    def test_03_initialize_optimizer(self):
        TestAutoAIRemote.remote_auto_pipelines = self.experiment.optimizer(
            ...
            prediction_type=self.experiment.PredictionType._FORECASTING,
            prediction_columns=[1], #[self.prediction_column],
            ...
            include_only_estimators=[AutoAI._ForecastingAlgorithms.ENSEMBLER],
