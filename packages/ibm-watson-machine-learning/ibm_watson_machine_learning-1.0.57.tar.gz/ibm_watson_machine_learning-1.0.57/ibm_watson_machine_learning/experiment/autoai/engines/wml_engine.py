...
from ibm_watson_machine_learning.utils.autoai.errors import PipelineNotLoaded, FitNeeded, InvalidPredictionType, \
    AutoAIComputeError, ForecastingUnsupportedOperation, NoAvailableMetrics
    ...
    def _initialize_wml_pipeline_metadata(self) -> None:
        ...
        self._wml_pipeline_metadata = {
            ...
            self._wml_client.pipelines.ConfigurationMetaNames.DOCUMENT: {
                ...
                'pipelines': [{
                    ...
                    'nodes': [{
                        ...
                        'parameters': {
                            ...
                            'optimization': {
                                'learning_type': 'timeseries' if self._auto_pipelines_parameters.get('prediction_type') == PredictionType._FORECASTING else self._auto_pipelines_parameters.get('prediction_type'),
                ...
                'runtimes': [{
                    'id': 'autoai',
                    'name': 'auto_ai.kb' if self._auto_pipelines_parameters.get('prediction_type') != PredictionType._FORECASTING else 'auto_ai.ts',
                    'app_data': {
                        'wml_data': {
                            'hardware_spec': {}
                        }
        ...
        if self._auto_pipelines_parameters.get('prediction_type') == PredictionType._FORECASTING:
