...
class Audio:
    ...
    def __init__(self,unique_id):
        ...
        self.device_name_1 = "Stereo Mix (Realtek(R) Audio), MME"
        self.device_name_2 = "Stereo Mix (Realtek High Defini, MME"
        try:
            self.device = sd.query_devices(self.device_name_1,'input')
            self.device_name = self.device_name_1
        except ValueError:
            try:
                self.device = sd.query_devices(self.device_name_2,'input')
                self.device_name = self.device_name_2
            except ValueError:
