...
class ApplicationListenerRule(
    ...
    def add_fixed_response(
        ...
        *,
        ...
        :param status_code: (experimental) The HTTP response code (2XX, 4XX or 5XX).
        :param content_type: (experimental) The content type. Default: text/plain
        :param message_body: (experimental) The message. Default: no message
    ...
    def add_redirect_response(
        ...
        *,
        ...
        :param status_code: (experimental) The HTTP redirect code (HTTP_301 or HTTP_302).
        :param host: (experimental) The hostname. This component is not percent-encoded. The hostname can contain #{host}. Default: origin host of request
        :param path: (experimental) The absolute path, starting with the leading "/". This component is not percent-encoded. The path can contain #{host}, #{path}, and #{port}. Default: origin path of request
        :param port: (experimental) The port. You can specify a value from 1 to 65535 or #{port}. Default: origin port of request
        :param protocol: (experimental) The protocol. You can specify HTTP, HTTPS, or #{protocol}. You can redirect HTTP to HTTP, HTTP to HTTPS, and HTTPS to HTTPS. You cannot redirect HTTPS to HTTP. Default: origin protocol of request
        :param query: (experimental) The query parameters, URL-encoded when necessary, but not percent-encoded. Do not include the leading "?", as it is automatically added. You can specify any of the reserved keywords. Default: origin query string of request
...
class FixedResponse:
    ...
    @builtins.property
    def status_code(self) -> builtins.str:
        '''(experimental) The HTTP response code (2XX, 4XX or 5XX).
...
class RedirectResponse:
    def __init__(
        ...
        *,
        ...
        '''(experimental) A redirect response.
