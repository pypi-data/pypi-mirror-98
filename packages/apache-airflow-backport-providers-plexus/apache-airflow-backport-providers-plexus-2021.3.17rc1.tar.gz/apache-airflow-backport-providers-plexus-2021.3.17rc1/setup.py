...
"""Setup.py for the apache-airflow-backport-providers-plexus package."""
...
def do_setup():
    """Perform the package apache-airflow-backport-providers-plexus setup."""
    setup(
        name='apache-airflow-backport-providers-plexus',
        description='Backport provider package '
        'apache-airflow-backport-providers-plexus for Apache Airflow',
        ...
        install_requires=['apache-airflow~=1.10', 'arrow>=0.16.0'],
