...
class Tensor(torch.Tensor):
    ...
    def unsqueeze(self, *dims: int, dim=None):
        ...
        return self.as_subclass(Tensor).set_special_(special=[a, b], bf=self._batch_first).set_special_(batch_dim=ibatch, channel_dim=ichannel)
