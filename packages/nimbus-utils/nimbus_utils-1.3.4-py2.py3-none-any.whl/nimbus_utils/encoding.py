...
import six
from six.moves.urllib.parse import quote, unquote, unquote_to_bytes


class ScrapyUnicodeDecodeError(UnicodeDecodeError):
...
def force_text(s, encoding='utf-8', strings_only=False, errors='strict'):
    ...
    try:
        ...
        if not isinstance(s, Exception):
            raise ScrapyUnicodeDecodeError(s, *e.args)
        else:
