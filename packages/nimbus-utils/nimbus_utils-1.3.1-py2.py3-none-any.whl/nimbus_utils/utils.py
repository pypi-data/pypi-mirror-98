...
from .encrypt import aes_cbc_cryptor
...
def encrypt_aes(data, password):
    return aes_cbc_cryptor.encrypt(data=data, password=password)


def decrypt_aes(data, password):
    return aes_cbc_cryptor.decrypt(data=data, password=password)
