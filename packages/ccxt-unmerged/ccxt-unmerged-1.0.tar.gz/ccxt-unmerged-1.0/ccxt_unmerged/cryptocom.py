...
class cryptocom(Exchange):
    ...
    def fetch_balance(self, params={}):
        self.load_markets()
        response = self.privatePostAccount(params)
        #    {
        #      "code": "0",
        #      "msg": "suc",
        #      "data": {
    ...
    def cancel_all_orders(self, symbol=None, params={}):
        ...
        return self.privatePostCancelAllOrders(self.extend(request, params))
    ...
    def fetch_order(self, id, symbol=None, params={}):
        ...
        response = self.privatePostShowOrder(self.extend(request, params))
        #    {
        #      'code': '0',
        #      'msg': 'suc',
        #      'data': {
    ...
    def fetch_closed_orders(self, symbol=None, since=None, limit=None, params={}):
        ...
        response = self.privatePostAllOrders(self.extend(request, params))
        #    {
        #      'code': '0',
        #      'msg': 'suc',
        #      'data': {
