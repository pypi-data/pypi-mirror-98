...
class duedex(Exchange):
    ...
    def fetch_markets(self, params={}):
        response = self.publicGetInstrument(params)
    ...
    def fetch_balance(self, params={}):
        self.load_markets()
        response = self.privateGetMargin(params)
        #
        #     {
        #         code: 0,
        #         data: [{
    ...
    def fetch_ticker(self, symbol, params={}):
        ...
        response = self.publicGetTickerInstrument(self.extend(request, params))
        #
        #     {
        #         "code": 0,
        #         "data": {
    ...
    def fetch_ohlcv(self, symbol, timeframe='1m', since=None, limit=None, params={}):
        ...
        response = self.barsGetTradingViewHistory(self.extend(request, params))
    ...
    def edit_order(self, id, symbol, type, side, amount, price=None, params={}):
        ...
        self.privatePatchOrder(self.extend(request, params))
    ...
    def cancel_order(self, id, symbol=None, params={}):
        ...
        if clientOrderId is not None:
            ...
            request['orderId'] = id
        # This endpoint has no response data.
        self.privateDeleteOrder(self.extend(request, params))
        return self.fetch_order(id, symbol, params)
    ...
    def fetch_orders(self, symbol=None, since=None, limit=None, params={}):
        ...
        if limit is not None:
            request['limit'] = limit
        response = self.privateGetOrderAll(self.extend(request, params))
        data = self.safe_value(response, 'data', [])
    ...
    def fetch_open_orders(self, symbol=None, since=None, limit=None, params={}):
        ...
        if symbol is not None:
            self.load_markets()
            market = self.market(symbol)
        response = self.privateGetOrderActive()
        data = self.safe_value(response, 'data', [])
        return self.parse_orders(data, market, since, limit)
