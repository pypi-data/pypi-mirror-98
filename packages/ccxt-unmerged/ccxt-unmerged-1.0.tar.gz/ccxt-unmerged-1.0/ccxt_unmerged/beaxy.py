...
class beaxy(Exchange):
    ...
    def fetch_trades(self, symbol, since=None, limit=None, params={}):
        ...
        response = self.publicGetSymbolsMarketTrades(self.extend(request, params))
        #
        # [
        #     {
        #        "price":8.3E-7,
    ...
    def fetch_ticker(self, symbol, params={}):
        ...
        response = self.publicGetSymbolsMarketRate(self.extend(request, params))
        return self.parse_ticker(response, market)

    def fetch_tickers(self, symbols=None, params={}):
        self.load_markets()
        response = self.publicGetSymbolsRates(params)
        result = {}
    ...
    def fetch_ohlcv(self, symbol, timeframe='1m', since=None, limit=None, params={}):
        ...
        if limit is not None:
            request['count'] = limit
        response = self.publicGetSymbolsMarketChart(self.extend(request, params))
    ...
    def fetch_order_book(self, symbol, limit=None, params={}):
        ...
        response = self.publicGetSymbolsMarketBook(self.extend(request, params))
        #
        # {
