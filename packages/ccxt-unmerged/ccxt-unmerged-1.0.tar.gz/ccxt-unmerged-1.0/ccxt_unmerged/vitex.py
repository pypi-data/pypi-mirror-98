...
class vitex(Exchange):
    ...
    def fetch_ticker(self, symbol, params={}):
        ...
        response = self.publicGetTicker24hr(self.extend(query, params))
    ...
    def fetch_trades(self, symbol, since=None, limit=None, params={}):
        ...
        response = self.publicGetTradesAll(self.extend(request, params))
        # {
        #     "code": 0,
        #     "msg": "ok",
        #     "data": {
    ...
    def fetch_bids_asks(self, symbol, params={}):
        # {
        #     "code": 0,
        #     "msg": "ok",
        #     "data": {
    ...
    def fetch_order(self, id, symbol=None, params={}):
        ...
        response = self.publicGetOrder(self.extend(request, params))
        data = self.safe_value(response, 'data')
    ...
    def fetch_deposits(self, code=None, since=None, limit=None, params={}):
        ...
        response = self.publicGetDepositWithdraw(self.extend(request, params))
        #
        # "data": {
        #     "record": [
        #       {
