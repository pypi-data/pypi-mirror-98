...
class coinsuper(Exchange):
    ...
    async def fetch_markets(self, params={}):
        response = await self.privatePostMarketSymbolList(params)
    ...
    async def fetch_order_book(self, symbol, limit=None, params={}):
        ...
        response = await self.privatePostMarketOrderBook(self.extend(request, params))
    ...
    async def fetch_ohlcv(self, symbol, timeframe='5m', since=None, limit=None, params={}):
        ...
        response = await self.privatePostMarketKline(self.extend(request, params))
    ...
    async def fetch_trades(self, symbol, params={}):
        ...
        response = await self.privatePostMarketTickers(self.extend(request, params))
        data = self.safe_value(response['data'], 'result', {})
