...
class remitano(Exchange):
    ...
    async def fetch_balance(self, params={}):
        await self.load_markets()
        response = await self.privateGetUsersCoinAccounts(params)
        # [{
        #     user_id: 1860848,
    ...
    async def fetch_currencies(self, params={}):
        ...
        # alt coins
        altcoins = await self.publicGetAltcoins(params)
        # [
        #     {
        #         "currency": "bnb",
        #         "name": "Binance Coin",
        ...
        # fiats
        fiats = await self.publicGetRatesAds(params)
        # [{
        #     "ae": {
        #         "currency": "AED",
        #         "btc_bid": null,
    ...
    async def fetch_markets(self, params={}):
        ...
        countries = await self.publicGetRatesAds(params)
        # {
        #     "ae": {
        #         "currency": "AED",
        #         "btc_bid": null,
