...
class bitopro(Exchange):
    ...
    async def fetch_ohlcv(self, symbol, timeframe='5m', since=None, limit=500, params={}):
    ...
    async def fetch_currencies(self, params={}):
        response = await self.fetch_tickers()
    ...
    async def fetch_orders(self, symbol=None, since=None, limit=None, params={}):
        ...
        response = await self.privateGetOrdersPair(self.extend(request, params), params)
