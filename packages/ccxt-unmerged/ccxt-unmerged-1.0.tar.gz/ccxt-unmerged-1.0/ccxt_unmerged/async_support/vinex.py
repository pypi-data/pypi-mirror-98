...
class vinex(Exchange):
    ...
    async def fetch_trades(self, symbol, since=None, limit=20, params={}):
        ...
        trades = await self.publicGetGetMarketHistory(self.extend(request, params))
    ...
    async def fetch_ohlcv(self, symbol, timeframe='1m', since=None, limit=None, params={}):
        ...
        candles = await self.publicGetCandles(self.extend(request, params))
    ...
    async def _fetch_orders(self, symbol=None, since=None, limit=None, params={}, status=None):
        await self.load_markets()
        request = {}
        market = None
        if symbol:
        ...
        orders = await self.privateGetGetMyOrders(self.extend(request, params))
    ...
    async def create_order(self, symbol, type, side, amount, price=None, params={}):
        ...
        if side == 'buy':
            ...
            request['type'] = 'SELL'
        data = await self.privatePostPlaceOrder(self.extend(request, params))
    ...
    async def fetch_my_trades(self, symbol=None, since=None, limit=None, params={}):
        ...
        if limit:
            request['limit'] = limit
        trades = await self.privateGetGetMyTrading(self.extend(request, params))
