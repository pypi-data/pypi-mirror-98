...
class tokensnet (Exchange):
    ...
    async def fetch_markets(self, params={}):
        markets = await self.publicGetPublicTradingPairsGetAll(params)
        #    {
        #        "xtzeurs": {
    ...
    async def fetch_tickers(self, symbols=None, params={}):
        ...
        tickers = await self.publicGetPublicTickerAll(params)
        #    {
        #        "status": "ok",
    ...
    async def fetch_ticker(self, symbol, params={}):
        ...
        ticker = await self.publicGetPublicTickerPair(self.extend({
    ...
    async def fetch_currencies(self, params={}):
        response = await self.publicGetPublicCurrencyAll(params)
        #    {
        #        "status": "ok",
        #        "timestamp": 1572945773,
        #        "currencies": {
    ...
    async def fetch_order_book(self, symbol, limit=None, params={}):
        ...
        orderbook = await self.publicGetPublicOrderBookPair(self.extend({
            'pair': market['id'],
        }, params))
        #    {
    ...
    async def fetch_trades(self, symbol, since=None, limit=None, params={}):
        await self.load_markets()
        market = self.market(symbol)
        response = await self.publicGetPublicTradesHourPair(self.extend({
            'pair': market['id'],
        }, params))
        #    {
    ...
    async def fetch_balance(self, params={}):
        await self.load_markets()
        response = await self.privateGetPrivateBalanceAll(params)
        #    {
    ...
    async def fetch_open_orders(self, symbol=None, since=None, limit=None, params={}):
        ...
        response = None
        if symbol is None:
            response = await self.privateGetPrivateOrdersGetAll()
        else:
            response = await self.privateGetPrivateOrdersGetPair()
        #    {
        #        timestamp: 1573045496,
        #        status: 'ok',
        #        openOrders: [
        ...
        for i in range(0, len(orders)):
            ...
            order = await self.parse_order(orderExchange)
            result.append(order)
        return self.filter_by_since_limit(result, since, limit)

    async def fetch_order(self, id, symbol=None, params={}):
        await self.load_markets()
        response = await self.privateGetPrivateOrdersGetId(self.extend({
            'id': id,
        }, params))
        #    {
    ...
    async def create_order(self, symbol, type, side, amount, price=None, params={}):
        ...
        response = await self.privatePostPrivateOrdersAddLimit(self.extend(request, params))
        order = {
    ...
    async def cancel_order(self, id, symbol=None, params={}):
        response = await self.privatePostPrivateOrdersCancelId(self.extend({
            'id': id,
        }, params))
        return response
    ...
    async def fetch_my_trades(self, symbol=None, since=None, limit=None, params={}):
        ...
        response = None
        if symbol is None:
            response = await self.privateGetPrivateTradesAllPage(self.extend({
                'page': '1',
            }, params))
        else:
            market = self.market(symbol)
            response = await self.privateGetPrivateTradesPairPage(self.extend({
                'pair': market['id'],
                'page': '1',
            }, params))
        #    {
