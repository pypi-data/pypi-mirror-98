...
class bitclude(Exchange):
    ...
    async def fetch_markets(self, params={}):
        response = await self.publicGetStatsTickerJson(params)
        result = []
    ...
    async def fetch_currencies(self, params={}):
        ...
        response = await self.privateGet(self.extend(request, params))
        ids = list(response.keys())
        result = {}
        for i in range(0, len(ids)):
            id = ids[i]
    ...
    async def fetch_trades(self, symbol, since=None, limit=None, params={}):
        ...
        response = await self.publicGetStatsHistoryBaseQuoteJson(self.extend(request, params))
    ...
    async def cancel_order(self, id, symbol=None, params={}):
        ...
        return await self.privateGet(self.extend(request, params))
