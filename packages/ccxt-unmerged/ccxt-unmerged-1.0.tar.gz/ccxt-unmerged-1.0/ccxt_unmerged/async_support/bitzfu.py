...
class bitzfu(bitz):
    ...
    async def fetch_markets(self, params={}):
        response = await self.publicGetCoin(params)
        #
        #  {
        #      "status": 200,
        #      "msg": "",
    ...
    async def create_order(self, symbol, type, side, amount, price=None, params={}):
        ...
        if price is not None:
            request['price'] = price
        response = await self.privatePostAddTrade(self.extend(request, params))
        #
        #  {
        #      "status": 200,
        #      "msg": "",
    ...
    async def fetch_order(self, id, symbol=None, params={}):
        ...
        response = await self.privatePostGetOrderResult(self.extend(request, params))
        # {
        #      "status":200,
        #      "msg":"",
        #      "data":{
    ...
    async def fetch_my_trades(self, symbol=None, since=None, limit=None, params={}):
        ...
        if limit is not None:
            request['pageSize'] = limit
        response = await self.privatePostGetMyTrades(self.extend(request, params))
        #
        #  {
        #      "status":200,
        #      "msg":"",
