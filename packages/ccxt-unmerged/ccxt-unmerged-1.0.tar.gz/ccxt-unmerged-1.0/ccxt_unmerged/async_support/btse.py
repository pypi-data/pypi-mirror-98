...
class btse(Exchange):
    ...
    async def create_deposit_address(self, currency, params={}):
        ...
        response = await self.spotv3privatePostUserWalletAddress(self.extend(request, params))
        return {
            'currency': currency,
    ...
    async def fetch_deposit_address(self, currency, params={}):
        ...
        response = await self.spotv3privateGetUserWalletAddress(self.extend(request, params))
        return {
            'currency': currency,
            'address': response[0]['address'].split(':')[0],
            'tag': response[0]['address'].split(':')[1],
    ...
    async def withdraw(self, code, amount, address, tag=None, params={}):
        ...
        if tag is not None:
            request['tag'] = tag
        response = await self.spotv3privatePostUserWalletWithdraw(self.extend(request, params))
        return {
