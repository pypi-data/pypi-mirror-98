...
class bitbns(Exchange):
    ...
    async def fetch_markets(self, params={}):
        data = await self.publicGetFetchMarkets(params)
    ...
    async def fetch_tickers(self, symbols=None, params={}):
        data = await self.publicGetFetchTickers(params)
    ...
    async def fetch_trades(self, symbol, since=None, limit=None, params={}):
        ...
        trades = await self.publicGetFetchTrades(self.extend(request, params))
    ...
    async def fetch_order_book(self, symbol=None, limit=None, params={}):
        ...
        return await self.publicGetFetchOrderBook(self.extend(request, params))
    ...
    async def create_order(self, symbol, type, side, amount, price=None, params={}):
        ...
        resp = await self.privatePostOrders(self.extend(request, params))
        return {
            'info': resp,
    ...
    async def fetch_order(self, id, symbol=None, params={}):
        ...
        resp = await self.private1PostOrderStatus(self.extend(request, params))
    ...
    async def fetch_open_orders(self, symbol=None, since=None, limit=None, params={}):
        ...
        resp = await self.privatePostGetordersnew(self.extend(request, params))
    ...
    async def fetch_balance(self, params={}):
        ...
        data = await self.private1PostCurrentCoinBalance(self.extend(request, params))
        balances = {}
        balances['info'] = data
    ...
    async def fetch_my_trades(self, symbol=None, since=None, limit=None, params={}):
        ...
        if since is not None:
            request['since'] = since
        resp = await self.private1PostListExecutedOrders(self.extend(request, params))
