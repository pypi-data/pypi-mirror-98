...
class ceo(zb):
    ...
    def public_get_markets(self, params):
        response = self.publicGetMarketMarkets()
        return response['data']

    def private_get_get_account_info(self, params):
        response = self.privateGetDealAccountInfo(params)
        response['result'] = response['data']
        return response

    def fetch_markets(self, params={}):
        markets = super(ceo, self).fetch_markets(params)
    ...
    def fetch_deposit_address(self, code, params={}):
        ...
        response = self.privateGetDealGetUserAddress({
    ...
    def public_get_depth(self, params):
        response = self.publicGetMarketEntrust(params)
        return {
    ...
    def fetch_tickers(self, symbols=None, params={}):
        self.load_markets()
        response = self.publicGetMarketAllTicker(params)
        result = {}
    ...
    def public_get_kline(self, params):
        response = self.publicGetMarketKline(self.extend(params))
    ...
    def public_get_trades(self, params):
        response = self.publicGetMarketTrades(params)
        return response['data']
    ...
    def create_order(self, symbol, type, side, amount, price=None, params={}):
        ...
        response = self.privateGetDealOrder(self.extend(order, params))
        return {
            'info': response['data'],
            'id': response['data']['orderId'],
        }

    def private_get_cancel_order(self, params):
        return self.privateGetDealCancelOrder(params)

    def private_get_get_order(self, params):
        response = self.privateGetDealGetOrder(params)
        return response['data']

    def private_get_get_orders_ignore_trade_type(self, params):
        return self.private_get_get_orders_new(params)

    def private_get_get_unfinished_orders_ignore_trade_type(self, params):
        return self.private_get_get_orders_new(self.deep_extend({'tradeStatus': 1}, params))

    def private_get_get_orders_new(self, params):
        response = self.privateGetDealGetOrders(params)
        return response['data']
