...
class silgonex(Exchange):

    def describe(self):
        return self.deep_extend(super(silgonex, self).describe(), {
            'id': 'silgonex',
            'name': 'silgonex',
            'countries': ['ZA'],
            'rateLimit': 500,
            ...
            'urls': {
                'logo': 'https://user-images.githubusercontent.com/246404/90484720-282bdb80-e169-11ea-8e3a-a99f0deeffc2.png',
                'api': {
                    'market': 'https://api-v2.silgonex.com',
                    'public': 'https://api-v2.silgonex.com',
                },
                'www': 'https://www.silgonex.io/',
                'doc': 'https://docs.silgonex.com',
            },
            'api': {
                'market': {
                    'get': [
    ...
    def fetch_currencies(self, params={}):
        ...
        for i in range(0, len(currencies)):
            ...
            # in silgonex DEX, request https://api-v2.silgonex.com/currencies will return currencies,
            # the api doc is https://docs.silgonex.com
            ...
            # that is because silgonex is a DEX, supports people create coin with the same name, but the id(code) of coin is unique, so we should use the id or name and id as the identity of coin.
