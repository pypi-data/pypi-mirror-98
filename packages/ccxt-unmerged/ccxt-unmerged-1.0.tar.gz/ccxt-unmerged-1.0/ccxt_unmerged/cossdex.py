...
class cossdex(Exchange):

    def describe(self):
        return self.deep_extend(super(cossdex, self).describe(), {
            'id': 'cossdex',
            'name': 'COSSDEX',
            'countries': ['SG', 'NL'],
            'rateLimit': 500,
            ...
            'urls': {
                ...
                'api': {
                    'market': 'https://dex-api.coss.io',
                    'public': 'https://dex-api.coss.io',
                },
                'www': 'https://dex.coss.io',
                'doc': 'https://docs.coss.io',
            },
            'api': {
                'market': {
                    'get': [
    ...
    def fetch_currencies(self, params={}):
        ...
        for i in range(0, len(currencies)):
            ...
            # in dex-api.coss.io DEX, request https://dex-api.coss.io/currencies will return currencies,
            # the api doc is https://docs.coss.io
            ...
            # that is because cossdex is a DEX, supports people create coin with the same name, but the id(code) of coin is unique, so we should use the id or name and id as the identity of coin.
