...
class Map:
    ...
    def addPoint(self, kwargs :Dict,
        ...
        params = Dict(kwargs)
        objectImage = os.path.join("../", params.detectedObjectPath)
        area = '{:.3f}'.format(area)
        html = "<section class="'container'" style="'width:450px'"> \
        	        <div class="'value'"> \
                        ...
                        <a href="'{imgUrl}'">Panorma Url </a> \
        		    </div> \
        	    </section>".format(id1=str(params.imgid), area=area,
                                   detectedObjectPath=objectImage,
