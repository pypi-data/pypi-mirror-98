...
[boto3.CustomerProfiles 1.17.28](https://boto3.amazonaws.com/v1/documentation/api/1.17.28/reference/services/customer-profiles.html#CustomerProfiles) service
compatible with
