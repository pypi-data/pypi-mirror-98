...
class OrderFeatures(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """OrderFeatures - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([str]): Order features list..  # noqa: E501

        Keyword Args:
            value ([str]): Order features list..  # noqa: E501
