...
class TrackPoint(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, latitude, longitude, time, *args, **kwargs):  # noqa: E501
        """TrackPoint - a model defined in OpenAPI

        Args:
            latitude (float): Latitude in degrees.
            longitude (float): Longitude in degrees.
            time (datetime): Date and time in the [RFC 3339, section 5.6](https://tools.ietf.org/html/rfc3339#section-5.6) format.
