...
class Builder:
    ...
    def build(self):
        ...
        self.__build_pipeline.deployer = pf.create(key=configuration['orhcestration_artifact_deployer']['type'],
                                                   configuration=configuration['orhcestration_artifact_deployer']['conf'])
