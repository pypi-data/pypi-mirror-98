...
def chain(*args, **kwargs):
    """This function is deprecated. Please use `airflow.utils.helpers.chain`."""
    warnings.warn(
        "This function is deprecated. Please use `airflow.utils.helpers.chain`.",
        DeprecationWarning,
        stacklevel=2,
    )
    return import_string('airflow.utils.helpers.chain')(*args, **kwargs)


def cross_downstream(*args, **kwargs):
    """This function is deprecated. Please use `airflow.utils.helpers.cross_downstream`."""
    warnings.warn(
        "This function is deprecated. Please use `airflow.utils.helpers.cross_downstream`.",
        DeprecationWarning,
        stacklevel=2,
    )
    return import_string('airflow.utils.helpers.cross_downstream')(*args, **kwargs)
