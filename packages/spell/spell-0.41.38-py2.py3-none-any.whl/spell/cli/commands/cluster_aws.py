...
def add_eks_auth(stack):
    ...
    try:
        ...
        if "arn:aws:iam:{}:{}".format(deployment_constants.aws_account_id, auth_role) in conf_map.data["mapRoles"]:
...
def get_role_arn(iam, bucket_name):
    ...
    spell_aws_arn = "arn:aws:iam::{}:root".format(deployment_constants.aws_account_id)
