...
def generate_ambassador_host_yaml(spell_domain_name, uses_letsencrypt_cert):
    """
    ...
    uses_letsencrypt_cert: uses a cert issued by letsencrypt as the CA and managed by cert-manager,
        this is only available to public clusters
    TODO: private clusters should accept the option to take a cert provided by the user, possibly
    issued from their private CA
    """
  ...
  tlsSecret:
    name: ambassador-certs"""
        ...
        tls_secret = r""
    return ambassador_http_host_yaml.format(
        tls_secret=tls_secret, spell_domain_name=spell_domain_name
    )
