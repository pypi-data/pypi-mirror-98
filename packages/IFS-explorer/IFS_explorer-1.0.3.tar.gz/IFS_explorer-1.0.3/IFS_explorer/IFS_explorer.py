    ...
    def __init__(self): 
        ...
        def filters_(name_1):
            ...
            if self.flag_system == 0:
                filter_dir=filePath.replace('IFS_explorer.py', 'Filters\\')
            else:
                filter_dir=filePath.replace('IFS_explorer.py', 'Filters/')
       ...
       '''
        ...
        operative_system()
        if self.flag_system == 0:
            filePath=filePath.replace('IFS_explorer.py', 'Img\\logoIFSexplorer.ico')
        ...
        if self.flag_system == 0:
            ...
            filePath = __file__
            filePath=filePath.replace('IFS_explorer.py', 'Img/logoIFSexplorer.png')
