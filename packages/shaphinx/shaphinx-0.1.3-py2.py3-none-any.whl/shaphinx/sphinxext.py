"""Sphinx Extensions to simplify writing shaphinx's Reference documentation.

This provides a single `shaphinx-demo` directive, which:
...
class _shaphinxDemoDirective(SphinxDirective):
    has_content = True
...
def setup(app: Sphinx) -> None:
    ...
    app.add_directive("shaphinx-demo", _shaphinxDemoDirective)
