...
# @Last Modified time: 2021-03-11 22:22:53
import os
	...
	def getPodServerInfos(self,service_name,env,helloBikeToken,
		...
		if isServer:
			if env.upper() == "FAT":
				...
				filterStatusUrl = "https://gaia-inner.hellobike.cn/container-business-service/api/v1/soa/6/{}/list".format(service_name)
			else:
				...
				filterStatusUrl = "https://gaia-inner.hellobike.cn/container-business-service/api/v1/soa/2/{}/list".format(service_name)
		else:
			if env.upper() == "FAT":
				...
				filterStatusUrl = "https://gaia.hellobike.cn/container-business-service/api/v1/soa/6/{}/list".format(service_name)
			else:
				...
				filterStatusUrl = "https://gaia.hellobike.cn/container-business-service/api/v1/soa/2/{}/list".format(service_name)
