...
from alaya.utils.toolz.curried import (
    keymap,
    valmap,
)
...
pythonic_middleware = construct_formatting_middleware(
    ...
    result_formatters={
        ...
        'platon_coinbase': to_checksum_address,
        'platon_estimateGas': to_integer_if_hex,
        'platon_gasPrice': to_integer_if_hex,
        'platon_getBalance': to_integer_if_hex,
        'platon_getBlockByHash': apply_formatter_if(is_not_null, block_formatter),
        'platon_getBlockByNumber': apply_formatter_if(is_not_null, block_formatter),
        'platon_getBlockTransactionCountByHash': to_integer_if_hex,
        'platon_getBlockTransactionCountByNumber': to_integer_if_hex,
        'platon_getCode': HexBytes,
        'platon_getFilterChanges': filter_result_formatter,
        'platon_getFilterLogs': filter_result_formatter,
        'platon_getLogs': filter_result_formatter,
        'platon_getStorageAt': HexBytes,
        'platon_getTransactionByBlockHashAndIndex': apply_formatter_if(
            is_not_null,
            transaction_formatter,
        ),
        'platon_getTransactionByBlockNumberAndIndex': apply_formatter_if(
            is_not_null,
            transaction_formatter,
        ),
        'platon_getTransactionByHash': apply_formatter_if(is_not_null, transaction_formatter),
        'platon_getTransactionCount': to_integer_if_hex,
        'platon_getTransactionReceipt': apply_formatter_if(
            is_not_null,
            receipt_formatter,
        ),
        'platon_getUncleCountByBlockHash': to_integer_if_hex,
        'platon_getUncleCountByBlockNumber': to_integer_if_hex,
        'platon_hashrate': to_integer_if_hex,
        'platon_protocolVersion': compose(
            apply_formatter_if(is_integer, str),
            to_integer_if_hex,
        ),
        'platon_sendRawTransaction': to_hexbytes(32),
        'platon_sendTransaction': to_hexbytes(32),
        'platon_sign': HexBytes,
        'platon_syncing': apply_formatter_if(is_not_false, syncing_formatter),
        # personal
