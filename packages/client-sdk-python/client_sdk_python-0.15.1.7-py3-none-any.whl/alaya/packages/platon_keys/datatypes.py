...
from alaya.packages.platon_keys.utils.padding import (
    pad32,
)
...
from alaya.packages.platon_keys.validation import (
...
class LazyBackend:
    def __init__(self,
        ...
        from alaya.packages.platon_keys.backends.base import (  # noqa: F811
            BaseECCBackend,
        )
    ...
    def get_backend(cls, *args: Any, **kwargs: Any) -> 'BaseECCBackend':
        from alaya.packages.platon_keys.backends import get_backend
