...
class BaseAccount(ABC):
    ...
    def signHash(self, message_hash):
        '''
        Sign the hash of a message, as in :meth:`~platon_account.account.Account.signHash`
    ...
    def signTransaction(self, transaction_dict):
        '''
        Sign a transaction, as in :meth:`~platon_account.account.Account.signTransaction`
        but without specifying the private key.
