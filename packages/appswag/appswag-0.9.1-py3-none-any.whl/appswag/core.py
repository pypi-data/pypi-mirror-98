...
from appswag import utils, errs, consts
import copy
import base64
import six
import weakref
...
class App(object):
    ...
    def __init__(self, url=None, url_load_hook=None, sep=consts.private.SCOPE_SEPARATOR, prim=None, mime_codec=None, resolver=None):
        ...
        :param prim appswag.primitives.Primitive: factory for primitives in Swagger.
        :param resolver: appswag.resolve.Resolver: customized resolver used as default when none is provided when resolving
        """
    ...
    def root(self):
        ...
        :type: appswag.spec.v2_0.objects.Swagger
        """
        return self.__root
    ...
    def raw(self):
        ...
        :type: ex. when loading Swagger 1.2, the type is appswag.spec.v1_2.objects.ResourceList
        """
        return self.__raw
    ...
    def op(self):
        ...
        :type: appswag.utils.ScopeDict of appswag.spec.v2_0.objects.Operation
        """
        return self.__op
    ...
    def prim_factory(self):
        ...
        :type: appswag.primitives.Primitive
        """
        return self.__prim
    ...
    def mime_codec(self):
        ...
        :type: appswag.primitives.MimeCodec
        """
    ...
    def load(kls, url, getter=None, parser=None, url_load_hook=None, sep=consts.private.SCOPE_SEPARATOR, prim=None, mime_codec=None, resolver=None):
        ...
        :type parser: appswag.base.Context
        ...
        :param mime_codec appswag.primitives.MimeCodec: MIME codec
        :param resolver: appswag.resolve.Resolver: customized resolver used as default when none is provided when resolving
...
class BaseClient(object):
    ...
    def prepare_schemes(self, req):
        ...
        :param appswag.io.Request req: current request object
        """
    ...
    def compose_headers(self, req, headers=None, opt=None, as_dict=False):
        """ a utility to compose headers from appswag.io.Request and customized headers
