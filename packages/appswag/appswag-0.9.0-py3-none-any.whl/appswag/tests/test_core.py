from appswag import App, utils
from .utils import get_test_data_folder
from appswag.spec.base import BaseObj
import appswag
import unittest
import httpretty
import os
...
class SwaggerCoreTestCase(unittest.TestCase):
    ...
    def test_backward_compatible_v1_2(self):
        ...
        self.assertEqual(appswag.SwaggerAuth, appswag.Security)
        self.assertEqual(appswag.App._create_, appswag.App.create)
