...
class AgentConnectorSpec(object):
    ...
    def __init__(self, name=None, name_slug=None, org_id=None, max_number_connections=None, connection_uri=None, service_account_required=None, local_vars_configuration=None):  # noqa: E501
