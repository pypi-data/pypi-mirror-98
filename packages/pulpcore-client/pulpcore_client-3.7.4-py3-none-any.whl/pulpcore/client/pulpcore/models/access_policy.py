...
class AccessPolicy(object):
    ...
    def __init__(self, permissions_assignment=None, statements=None, viewset_name=None, local_vars_configuration=None):  # noqa: E501
    ...
    def viewset_name(self):
        """Gets the viewset_name of this AccessPolicy.  # noqa: E501

        The name of ViewSet this AccessPolicy authorizes.  # noqa: E501

        :return: The viewset_name of this AccessPolicy.  # noqa: E501
        :rtype: str
        """
    ...
    def viewset_name(self, viewset_name):
        """Sets the viewset_name of this AccessPolicy.

        The name of ViewSet this AccessPolicy authorizes.  # noqa: E501

        :param viewset_name: The viewset_name of this AccessPolicy.  # noqa: E501
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and viewset_name is None:  # noqa: E501
            raise ValueError("Invalid value for `viewset_name`, must not be `None`")  # noqa: E501
