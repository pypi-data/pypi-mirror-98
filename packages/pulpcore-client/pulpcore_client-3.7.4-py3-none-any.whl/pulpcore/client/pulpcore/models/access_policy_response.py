...
class AccessPolicyResponse(object):
    ...
    def __init__(self, pulp_href=None, pulp_created=None, permissions_assignment=None, statements=None, viewset_name=None, local_vars_configuration=None):  # noqa: E501
