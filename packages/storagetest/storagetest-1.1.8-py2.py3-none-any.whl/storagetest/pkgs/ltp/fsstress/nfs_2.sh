...
mkdir -p /mnt/nfs/xfs/udp/2/${HOSTNAME}1
mkdir -p /mnt/nfs/xfs/udp/3/${HOSTNAME}2
mkdir -p /mnt/nfs/xfs/tcp/2/${HOSTNAME}3
mkdir -p /mnt/nfs/xfs/tcp/3/${HOSTNAME}4
...
./fsstress -l 0 -d /mnt/nfs/xfs/udp/2/${HOSTNAME}1 -n 1000 -p 50 -r > xfs.udp.2.log 2>&1 &
./fsstress -l 0 -d /mnt/nfs/xfs/udp/3/${HOSTNAME}2 -n 1000 -p 50 -r > xfs.udp.3.log 2>&1 &
./fsstress -l 0 -d /mnt/nfs/xfs/tcp/2/${HOSTNAME}3 -n 1000 -p 50 -r > xfs.tcp.2.log 2>&1 &
./fsstress -l 0 -d /mnt/nfs/xfs/tcp/3/${HOSTNAME}4 -n 1000 -p 50 -r > xfs.tcp.3.log 2>&1 &
