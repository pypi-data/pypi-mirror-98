...
class Browser:
    ...
    def get_attribute_names(self, selector: str, assertion_operator: Optional[AssertionOperator] = None, *assertion_expected, message: Optional[Optional[str]] = None): ...
    ...
    def get_classes(self, selector: str, assertion_operator: Optional[AssertionOperator] = None, *assertion_expected, message: Optional[Optional[str]] = None): ...
