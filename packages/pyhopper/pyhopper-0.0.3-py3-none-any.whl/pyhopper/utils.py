...
if __name__ == "__main__":
    ...
    print_t("1:01:30")
    print_t("1h 1m 30s")
    time_to_pretty_str(0.0004)
    time_to_pretty_str(0.004)
    time_to_pretty_str(0.04)
    time_to_pretty_str(0.4)
    time_to_pretty_str(4.4)
    time_to_pretty_str(47.4)
    time_to_pretty_str(474.4)
    time_to_pretty_str(4746.4)
    time_to_pretty_str(47467.4)
    time_to_pretty_str(474678.4)
    time_to_pretty_str(4746788.4)
    time_to_pretty_str(47467888.4)
    time_to_pretty_str(474678888.4)