...
class HBaseCli(object):
    ...
    def scan(self, ns, tableName, family=None, cols=None, startRow=None, stopRow=None, caching=20, limit=None):
        """ 扫描表
...
if __name__ == "__main__":
    ...
    for rowInfo in result:
        ...
        for columnValue in rowInfo.columnValues:
            ...
            print(columnValue.qualifier.decode("utf-8"),":",columnValue.value.decode("utf-8"))
