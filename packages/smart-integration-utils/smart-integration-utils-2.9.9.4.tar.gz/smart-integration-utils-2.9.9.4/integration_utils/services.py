...
class BaseDataManager(object):
    ...
    def _generate_file(self, skip: int, s3_filename: str, fields: list) -> str:
        ...
        return get_file_link(s3_file_data['s3_filename'])
    ...
    def _generate_result(self, filename: str, fields: list) -> dict:
        ...
        if self.default_limit >= count:
            links.append(self._generate_file(skip, f'{filename}.tsv', fields))
