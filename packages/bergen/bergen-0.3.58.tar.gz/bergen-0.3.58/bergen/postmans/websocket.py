...
class WebsocketPostman(BasePostman):
    ...
    async def buildAssignMessage(self, reference: str = None, node: Node = None, pod: Pod = None, args=None, kwargs = None, params= None, with_progress=False):
    ...
    async def stream(self, node: Node = None, pod: Pod = None, args = None, kwargs = None, params= None, on_progress: Callable = None):
        ...
        assign = await self.buildAssignMessage(reference=reference, node=node, pod=pod, args = args, kwargs = kwargs, params=params, with_progress=with_progress)
    ...
    async def assign(self, node: Node = None, pod: Pod = None, args = None, kwargs = None, params= None, on_progress: Callable = None):
        reference = str(uuid.uuid4()) 
