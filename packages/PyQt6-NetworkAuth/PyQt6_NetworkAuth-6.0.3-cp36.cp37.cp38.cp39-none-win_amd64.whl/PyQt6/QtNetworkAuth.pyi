...
class QAbstractOAuth(QtCore.QObject):
    ...
    def resourceOwnerAuthorization(self, url: QtCore.QUrl, parameters: typing.Any) -> None: ...
    def callback(self) -> str: ...
    def setStatus(self, status: 'QAbstractOAuth.Status') -> None: ...
    def replyDataReceived(self, data: QtCore.QByteArray) -> None: ...
    ...
    def grant(self) -> None: ...
    def prepareRequest(self, request: QtNetwork.QNetworkRequest, verb: QtCore.QByteArray, body: QtCore.QByteArray = ...) -> None: ...
...
class QAbstractOAuth2(QAbstractOAuth):
    ...
    def put(self, url: QtCore.QUrl, parameters: typing.Dict[str, typing.Any] = ...) -> QtNetwork.QNetworkReply: ...
    @typing.overload
    def put(self, url: QtCore.QUrl, data: QtCore.QByteArray) -> QtNetwork.QNetworkReply: ...
    @typing.overload
    def put(self, url: QtCore.QUrl, multiPart: QtNetwork.QHttpMultiPart) -> QtNetwork.QNetworkReply: ...
    @typing.overload
    def post(self, url: QtCore.QUrl, parameters: typing.Dict[str, typing.Any] = ...) -> QtNetwork.QNetworkReply: ...
    @typing.overload
    def post(self, url: QtCore.QUrl, data: QtCore.QByteArray) -> QtNetwork.QNetworkReply: ...
    @typing.overload
...
class QAbstractOAuthReplyHandler(QtCore.QObject):
    ...
    def callbackDataReceived(self, data: QtCore.QByteArray) -> None: ...
    def replyDataReceived(self, data: QtCore.QByteArray) -> None: ...
...
class QOAuth1(QAbstractOAuth):
    ...
    @typing.overload
    def setup(self, request: QtNetwork.QNetworkRequest, signingParameters: typing.Dict[str, typing.Any], operationVerb: QtCore.QByteArray) -> None: ...
...
class QOAuth1Signature(PyQt6.sip.simplewrapper):
    ...
    @typing.overload
    def __init__(self, url: QtCore.QUrl = ..., method: 'QOAuth1Signature.HttpRequestMethod' = ..., parameters: typing.Any = ...) -> None: ...
    @typing.overload
    def __init__(self, url: QtCore.QUrl, clientSharedKey: str, tokenSecret: str, method: 'QOAuth1Signature.HttpRequestMethod' = ..., parameters: typing.Any = ...) -> None: ...
    @typing.overload
    def __init__(self, other: 'QOAuth1Signature') -> None: ...

    def setCustomMethodString(self, verb: QtCore.QByteArray) -> None: ...
    ...
    def parameters(self) -> typing.Dict[str, typing.List[typing.Any]]: ...
...
class QOAuth2AuthorizationCodeFlow(QAbstractOAuth2):
    ...
    def buildAuthenticateUrl(self, parameters: typing.Any = ...) -> QtCore.QUrl: ...
