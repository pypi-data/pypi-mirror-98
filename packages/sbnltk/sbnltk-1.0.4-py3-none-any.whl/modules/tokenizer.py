...
class wordTokenizer:
    ...
    def customized_tokenizer(self,text,punc=True,norm=False,dust=False):
        ...
        try:
            ...
            print(f"{sbnltk.bcolors.FAIL} ERROR 301: Error in Customized word Tokenizer!! {sbnltk.bcolors.ENDC}")
            return tokens
...
class sentenceTokenizer:
    ...
    def customized_tokenizer(self,text,punc=True,norm=False,dust=False):
        ...
        try:
            ...
            print(f"{sbnltk.bcolors.FAIL} ERROR 302: Error in Customized Sentence Tokenizer!! {sbnltk.bcolors.ENDC}")
            return tokens
    ...
    def sentence_cluster(self,text,max_length=100,punc=True,norm=False,dust=False):
        ...
        try:
            ...
            print(f"{sbnltk.bcolors.FAIL} ERROR 303: Error in Sentence clustering!! {sbnltk.bcolors.ENDC}")
            return tokens
