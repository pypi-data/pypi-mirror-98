...
class preprocessor:
    ...
    __stopwords=[]
    def __init__(self):
        self.__dl.download('bangla_word_list', 'dataset/')
        self.__dl.download('stopword_list', 'dataset/')
        for line in open('../dataset/bangla_word_list.txt', 'r'):
            line = line.rstrip('\n')
            self.__word_list[line] = 1
        model_path = "../dataset/stopword_list.txt"
    ...
    def punctuation_remove(self,text):
        try:
            ...
            print(f"{sbnltk.bcolors.FAIL} ERROR 201: Error in Removing punctuation!! {sbnltk.bcolors.ENDC}")
            return text
    ...
    def dust_removal(self,word):
        ...
        try:
            ...
            print(f"{sbnltk.bcolors.FAIL} ERROR 202: Error in Removing dust!! {sbnltk.bcolors.ENDC}")
            return word
    ...
    def stopword_remove(self,text):
        try:
            ...
            print(f"{sbnltk.bcolors.FAIL} ERROR 203: Error in Removing stop word!! {sbnltk.bcolors.ENDC}")
            return text
    ...
    def word_normalize(self,word):
        try:
            ...
            print(f"{sbnltk.bcolors.FAIL} ERROR 204: Error in word normalization!! {sbnltk.bcolors.ENDC}")
            return word
    ...
    def bangla_to_english_Conversion(self,word):
        try:
            ...
            print(f"{sbnltk.bcolors.FAIL} ERROR 205: Error in Bangla to English Conversion!! {sbnltk.bcolors.ENDC}")
            return word
    ...
    def bn_word_sort_en_sys(self,vec):
        try:
            ...
            print(f"{sbnltk.bcolors.FAIL} ERROR 206: Error in Sort bangla words according English alphabet!! {sbnltk.bcolors.ENDC}")
            return vec
    ...
    def bn_word_sort_bn_sys(self,vec):
        try:
            ...
            print(f"{sbnltk.bcolors.FAIL} ERROR 207: Error in Sort Bangla words according Bangla alphabet!! {sbnltk.bcolors.ENDC}")
            return vec
