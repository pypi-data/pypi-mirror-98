...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "sage.cpython.cython_metaclass",
        "sources": [
            "sage/cpython/cython_metaclass.pyx"
        ]
    },
    "module_name": "sage.cpython.cython_metaclass"
}
END: Cython Metadata */
...
static struct PyModuleDef __pyx_moduledef = {
    ...
    "cython_metaclass",
    __pyx_k_File_sage_cpython_cython_metacla, /* m_doc */
  #if CYTHON_PEP489_MULTI_PHASE_INIT
    0, /* m_size */
  #else
    -1, /* m_size */
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initcython_metaclass(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initcython_metaclass(void)
#else
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_cython_metaclass(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("cython_metaclass", __pyx_methods, __pyx_k_File_sage_cpython_cython_metacla, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
