...
[boto3.WorkMailMessageFlow 1.17.26](https://boto3.amazonaws.com/v1/documentation/api/1.17.26/reference/services/workmailmessageflow.html#WorkMailMessageFlow) service
compatible with
