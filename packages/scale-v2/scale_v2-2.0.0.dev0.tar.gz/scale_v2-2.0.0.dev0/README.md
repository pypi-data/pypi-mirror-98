...
scale_v2 is implemented in [Pytorch](https://pytorch.org/) framework.  
Running scale_v2 on CUDA is recommended if available.   
...
#### Help
Look for more usage of scale_v2
...
SCALE is still available in SCALE_v2
