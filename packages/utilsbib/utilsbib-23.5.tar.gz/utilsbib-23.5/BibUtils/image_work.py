...
class Face_cropper:
    ...
    def check_inside_v2(self,img_no,img_yes, show_plot = True,dist_default=5):
        nb_tiles = [2,3]
        ...
        mouth = image_work.reduce_glare(mouth)
        original_slice = self.slice_img("", row = nb_tiles[0], col =nb_tiles[1], pre_img=mouth)
        makeup_slice = self.slice_img("", row = nb_tiles[0], col =nb_tiles[1], pre_img=image_work.how_close_to_color2(mouth,colo_nat,dist_default,dif_color_mark = [255,255,255])[-1])
