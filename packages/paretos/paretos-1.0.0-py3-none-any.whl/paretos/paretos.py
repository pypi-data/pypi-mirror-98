...
from . import EnvironmentInterface, TerminatorInterface, OptimizationProblem, \
    KpiGoalMinimum, KpiGoalMaximum
...
class Paretos:
    ...
    def optimize(
        ...
        if terminators is None:
            terminators = [
                optimization.DefaultTerminator()
            ]
    ...
    def obtain(self, name: str) -> OptimizationResult:
        ...
        if project is None:
            self.__logger.error("Project not found.", extra={
                "projectName": name
            })
    ...
    def __create_problem_definition(
        self,
        definition: OptimizationProblem
    ...
    def __optimize(
        ...
        while (
            ...
            if len(planned_evaluations) == 0:
                ...
                self.__persistence.save_planned_evaluations(planned_evaluations,
                                                            project)
            ...
            for evaluation in planned_evaluations:
                ...
                try:
                    dirty_kpis = environment.evaluate(
                ...
                try:
                    self.__persistence.update_evaluation_add_kpis(
