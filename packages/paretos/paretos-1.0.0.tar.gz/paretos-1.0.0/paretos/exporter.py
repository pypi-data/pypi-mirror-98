...
def export(data_source_name: str, project_name: str):
    ...
    with engine.connect() as con:
        ...
        sql_result = con.execute(statement.params(
        ...
        for simulation_id in parameters_by_simulation_id:
            ...
            for parameter_id in simulation:
                ...
                if "evaluation_id" not in simulation_export:
                    ...
                    simulation_export["is_pareto_optimal"] = parameter_data["simulation_is_pareto"]

                column_name = parameter_data["parameter_type"] + '__' + parameter_data["parameter_name"]
