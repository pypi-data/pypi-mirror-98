...
from .exceptions import ResponseParsingError, InvalidResponseStructure, RequestFailed
...
class SocratesAPIClient(object):
    ...
    def __request(
        ...
        try:
            ...
            self.__logger.error(
                "Unable to connect to Socrates API.",
                extra={"url": url}
            )
    ...
    def __authenticate(
        self, customer_token: str, version: str = "v1"
    ) -> AccessToken:
