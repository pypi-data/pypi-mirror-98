        ...
        if self.combination_data is None:
            ...
            if self.combination_data.endswith(".h5") or self.combination_data.endswith(".hdf5"):
                ...
                for h5_groups in h5.walk_groups("/"):
                    for table in h5.list_nodes(h5_groups, classname='Table'):
                        ...
                        if (table_info[2], table_info[1]) not in combination_info and table_info[2] in self.sources and table_info[1] in self.collaborations.keys():
            ...
            if os.path.isdir(self.combination_data):
                ...
                for txt_file in txt_files:
                    ...
                    print(self.collaborations.keys())
                    if (file_info[1], file_info[2]) not in combination_info and file_info[1] in self.sources and file_info[2] in self.collaborations.keys():
